...
<body>
    ...
    <script>
        ...
        // The exact bounding logic from RegionSystem.ts
        ...
        // Boundaries: 
        // Lng: 60 to 145 (width 85)
        // Lat: 15 to 55 (height 40)
        const minLng = 60, maxLng = 145;
        ...
        cities.forEach(city => {
            ...
            if (keyCities.includes(city.name)) {
                ...
                // Highlight key city with a ring
                ctx.beginPath();
