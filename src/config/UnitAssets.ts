...
export const SPRITE_PATHS = {
    ...
    UNIT_ASSETS: {
        ...
        'ship_small': {
            // 【船贴图三档（2026-06-12 磁盘实测修正）】按军团兵力选档（NavalShipTiers.ts）：
            //   1万船=小型运兵船 / 2万船=中型战船 / 5万船=蓝顶楼船
            // 小船(1万) 实际文件 = 863-902。旧注释"860-899"有误：860-862 磁盘上不存在，
        ...
        'ship_large': {
            // 大船(5万): 949-988（磁盘实测齐全；992-994 为散件未接线）
