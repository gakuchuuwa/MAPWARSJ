...
export const SPRITE_PATHS = {
    ...
    UNIT_ASSETS: {
        ...
        'ship_small': {
            // 小船 <10000: 860-899 (8 向/动作), 900-902 预留
            MOVE: [860, 861, 862, 863, 864, 865, 866, 867].map(id => `/SUCAI/S10DB/${id}-1.png`),
            ATTACK: [868, 869, 870, 871, 872, 873, 874, 875].map(id => `/SUCAI/S10DB/${id}-1.png`),
            IDLE: [876, 877, 878, 879, 880, 881, 882, 883].map(id => `/SUCAI/S10DB/${id}-1.png`),
            DAMAGE: [884, 885, 886, 887, 888, 889, 890, 891].map(id => `/SUCAI/S10DB/${id}-1.png`),
            DEATH: [892, 893, 894, 895, 896, 897, 898, 899].map(id => `/SUCAI/S10DB/${id}-1.png`),
        },
        'ship_medium': {
            // 中船 10000-19999: 906-945
