...
export const SPRITE_PATHS = {
    ...
    GENERAL_PORTRAITS: {
        ...
        'yangzhou_wangping': '/assets/shuguo/yangzhou_wangping.png',
        'pagan_anuluvtuo': '/assets/dianmian/pagan_anuluvtuo.png',
        'unassigned_machao': '/assets/hexi/unassigned_machao.png',
        'qiuci_baiba': '/assets/xiyu/qiuci_baiba.png',
        'gar_lunqinling': '/assets/tubo/gar_lunqinling.png',
        'menggu_d_chengjisihan': '/assets/caoyuan/menggu_d_chengjisihan.png',
        'bohai_dazuorong': '/assets/dongbei/bohai_dazuorong.png',
        'goryeo_jiangganzan': '/assets/chaoxian/goryeo_jiangganzan.png',
        'ashikaga_zulijunshi': '/assets/riben/ashikaga_zulijunshi.png',
        'tiemuer_tiemuer': '/assets/zhongya/tiemuer_tiemuer.png',
        'siam_nalixuan': '/assets/dianmian/siam_nalixuan.png',
        'shang_fuhao': '/assets/xianqin/shang_fuhao.png',
        'pizhou_lvbu': '/assets/zhongyuan/pizhou_lvbu.png',
        'han_d_hanxin': '/assets/liuhan/han_d_hanxin.png',
        'wei_wuqi': '/assets/xianqin/wei_wuqi.png',
        'manzhou_nuerhachi': '/assets/dongbei/manzhou_nuerhachi.png',
        'xinluo_jinyixin': '/assets/chaoxian/xinluo_jinyixin.png',
        'benduozhongsheng': '/assets/riben/benduozhongsheng.png',
        'seljuq_sangjiaer': '/assets/zhongya/seljuq_sangjiaer.png',
