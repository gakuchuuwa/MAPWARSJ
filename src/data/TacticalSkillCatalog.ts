...
const ENHANCE: TacticalSkillEntry[] = [
    ...
    {
        id: 'ts_815', ownerName: '王翦', ownerGeneralId: 'ruo_wangjian', usageTag: '防御', situationTag: '优势', layer: 'tactical', series: 'troop', index: 815,
...
const SANSHILIU: TacticalSkillEntry[] = [
    ...
    },
    {
        ...
        displayName: '借刀杀人', ownerName: '子贡', usageTag: '双行', situationTag: '优势', sourceQuote: '【三十六计】利用矛盾借敌之手除患，借刀杀人。',
        baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.08, engineStatus: 'ready',
    ...
    {
        id: 'ts_398', usageTag: '双行', situationTag: '优势', ownerName: '耿弇', ownerGeneralId: 'you_gengyan', layer: 'tactical', series: 'enhance', index: 398,
    ...
    {
        id: 'ts_407', ownerName: '范雎', usageTag: '双行', situationTag: '均势', layer: 'tactical', series: 'counter', index: 407,
    ...
    {
        id: 'ts_408', ownerName: '晋献公', usageTag: '双行', situationTag: '均势', layer: 'tactical', series: 'counter', index: 408,
...
const UNIQUE_T1_EXPAND: TacticalSkillEntry[] = [
    ...
    { id: 'ts_744', usageTag: '攻击', situationTag: '均势', layer: 'tactical', series: 'fate', index: 744, displayName: '暗渡陈仓', ownerName: '邓艾', ownerGeneralId: 'wudu_dengai', sourceQuote: '【邓艾】《三国志·邓艾传》：偷渡阴平，出奇兵直取成都。', baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll', magnitude: 1, luckMin: 0.6, luckMax: 1.4, engineStatus: 'ready', note: '【敌战计·衡】暗渡陈仓；三十六计（阴平同典）' },
    ...
    { id: 'ts_748', usageTag: '双行', situationTag: '优势', layer: 'tactical', series: 'troop', index: 748, displayName: '围魏救赵', ownerName: '孙膑', ownerGeneralId: 'dongxian_sunbin', sourceQuote: '【孙膑】《史记·孙子吴起列传》：攻其必救，解友军之围。', baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops', magnitude: 0.08, engineStatus: 'ready', note: '【胜战计·全】围魏救赵；三十六计' },
    ...
    { id: 'ts_759', ownerName: '刘备', ownerGeneralId: 'shu_liubei', usageTag: '双行', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 759, displayName: '反客为主', sourceQuote: '【刘备】《三国志·先主传》：入蜀助璋，反客为主取益州。', baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive', magnitude: 0.2, engineStatus: 'ready', note: '【并战计·借】反客为主；三十六计' },
    ...
    { id: 'ts_814', ownerName: '贾诩', usageTag: '双行', situationTag: '均势', layer: 'tactical', series: 'counter', index: 814, displayName: '将计就计', sourceQuote: '【贾诩】《三国志·贾诩传》注引：“因其计而用之。”', baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'opening_roll', magnitude: 0.4, engineStatus: 'ready', note: '【贾诩】绝品·专属·借敌之计反制' },
    {
