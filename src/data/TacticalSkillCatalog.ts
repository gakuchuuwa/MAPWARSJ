...
const FATE: TacticalSkillEntry[] = [
    ...
    {
        id: 'ts_020', ownerName: '项羽', ownerGeneralId: 'xichu_xiangyu', usageTag: '攻击', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 20,
...
const TROOP: TacticalSkillEntry[] = [
    ...
    {
        id: 'ts_025', usageTag: '通用', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 25,
...
const CASUALTY: TacticalSkillEntry[] = [
    {
        id: 'ts_031', usageTag: '通用', situationTag: '优势', layer: 'tactical', series: 'enhance', index: 31,
        displayName: '游刃有余', sourceQuote: '《庄子·养生主》：“恢恢乎其于游刃必有余地矣。”',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.05, engineStatus: 'ready'},
    {
        id: 'ts_032', usageTag: '通用', situationTag: '优势', layer: 'tactical', series: 'troop', index: 32,
    ...
    {
        id: 'ts_036', ownerName: '吴起', ownerGeneralId: 'wei_wuqi', usageTag: '通用', situationTag: '优势', layer: 'tactical', series: 'enhance', index: 36,
    ...
    },
    {
        ...
        note: '我败时，胜方战后恢复率归零'},
    {
        id: 'ts_040', usageTag: '通用', situationTag: '优势', layer: 'tactical', series: 'enhance', index: 40,
        displayName: '如臂使指', sourceQuote: '《汉书·贾谊传》：“如身之使臂，臂之使指，莫不制从。”',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.05, engineStatus: 'ready'},
    {
        id: 'ts_041', usageTag: '通用', situationTag: '优势', layer: 'tactical', series: 'troop', index: 41,
...
const UNIQUE_T1: TacticalSkillEntry[] = [
    ...
    },
    {
        ...
        magnitude: 1.25, engineStatus: 'ready'},
    {
        id: 'ts_110', usageTag: '通用', situationTag: '优势', layer: 'tactical', series: 'troop', index: 110,
    ...
    {
        id: 'ts_123', ownerName: '孙武', ownerGeneralId: 'wu_sunwu', usageTag: '通用', situationTag: '优势', layer: 'tactical', series: 'troop', index: 123,
    ...
    {
        id: 'ts_127', ownerName: '司马懿', ownerGeneralId: 'sima_d_simayi', usageTag: '防御', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 127,
    ...
    },
    {
        ...
        magnitude: 1.05, engineStatus: 'ready'},
    {
        id: 'ts_134', usageTag: '通用', situationTag: '优势', layer: 'tactical', series: 'enhance', index: 134,
    ...
    {
        id: 'ts_138', ownerName: '项羽', ownerGeneralId: 'xichu_xiangyu', usageTag: '攻击', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 138,
        ...
        magnitude: 0.3, engineStatus: 'ready'},
    {
        ...
        magnitude: 1.05, engineStatus: 'ready'},
    {
        id: 'ts_147', usageTag: '通用', situationTag: '优势', layer: 'tactical', series: 'enhance', index: 147,
    ...
    {
        id: 'ts_159', ownerName: '诸葛亮', ownerGeneralId: 'huizhou_zhugeliang', usageTag: '通用', situationTag: '均势', layer: 'tactical', series: 'fate', index: 159,
    ...
    },
    {
        ...
        displayName: '隐锋待时', sourceQuote: '【勾践】《史记·越王勾践世家》：卧薪尝胆隐忍二十年待时灭吴。',
        baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive',
        magnitude: 0.3, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '临机决水', sourceQuote: '【韩信】《史记·淮阴侯列传》：潍水之战决水半渡而击龙且。',
        baseEffect: 'ally_add_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.1, engineStatus: 'ready',
    },
    {
    ...
    {
        id: 'ts_211', usageTag: '攻击', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 211,
    ...
    },
    {
        ...
        displayName: '张乐却虏', sourceQuote: '【赵云】《云别传》：汉水空营大开营门张乐却虏，疑兵退曹。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.25, engineStatus: 'ready',
    },
    {
...
const UNIQUE_T0_REVISE: TacticalSkillEntry[] = [
    ...
    {
        id: 'ts_421', usageTag: '防御', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 421,
        displayName: '空寨掩击', sourceQuote: '【赵云】《云别传》：汉水空营偃旗息鼓，空寨掩击退曹军。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'always', phase: 'post_battle',
        magnitude: 1.25, engineStatus: 'ready',
    },
    {
...

    {
        ...
        displayName: '阵遏锋摧', sourceQuote: '【刘裕】《宋书·武帝纪》：却月阵以步制骑，大破北魏铁骑。',
        baseEffect: 'ally_add_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.1, engineStatus: 'ready',
    },
    {
...
const UNIQUE_T1_PRECISION: TacticalSkillEntry[] = [
    { id: 'ts_686', usageTag: '防御', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 686, displayName: '据险持重', sourceQuote: '【廉颇】《史记·廉颇列传》：长平坚壁拒王龁，据险持重。', baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive', magnitude: 1.25, engineStatus: 'ready' },
    ...
    { id: 'ts_710', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'enhance', index: 710, displayName: '斩将肃阵', sourceQuote: '【关羽】《三国志·关羽传》：斩颜良解白马围，万军之中取上将首级。', baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll', magnitude: 1.05, engineStatus: 'ready' },
    ...
    { id: 'ts_725', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'enhance', index: 725, displayName: '绝域摧锋', sourceQuote: '长途远征在极远之地摧破敌军，如侯君集灭高昌、班超定西域等。', baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll', magnitude: 1.05, engineStatus: 'ready' },
    ...
    { id: 'ts_729', usageTag: '防御', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 729, displayName: '坚壁养锐', sourceQuote: '【司马懿】《晋书·宣帝纪》：对蜀闭垒不出，养精蓄锐待敌自退。', baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive', magnitude: 0.3, engineStatus: 'ready' },
...
const UNIQUE_T1_EXPAND: TacticalSkillEntry[] = [
    ...
    { id: 'ts_748', usageTag: '双行', situationTag: '均势', layer: 'tactical', series: 'fate', index: 748, displayName: '围魏救赵', sourceQuote: '【孙膑】《史记·孙子吴起列传》：攻其必救，解友军之围。', baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll', magnitude: 1, luckMin: 0.7, luckMax: 1.3, engineStatus: 'ready' },
    { id: 'ts_749', usageTag: '攻击', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 749, displayName: '威震逍遥', sourceQuote: '【张辽】《三国志·张辽传》：逍遥津八百人冲孙权十万大营。', baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive', magnitude: 1.5, engineStatus: 'ready' },
    ...
    { id: 'ts_754', usageTag: '防御', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 754, displayName: '偃旗息鼓', sourceQuote: '【赵云】《三国志·赵云传》：汉水空营偃旗息鼓退曹军。', baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive', magnitude: 1.25, engineStatus: 'ready' },
    ...
    { id: 'ts_761', usageTag: '双行', situationTag: '均势', layer: 'tactical', series: 'counter', index: 761, displayName: '草船借箭', sourceQuote: '【诸葛亮】草船借箭化敌之攻为己用，以智取胜。', baseEffect: 'steal_enemy_skill', condition: 'always', phase: 'opening_roll', magnitude: 0.5, engineStatus: 'ready' },
    ...
    { id: 'ts_765', usageTag: '攻击', situationTag: '均势', layer: 'tactical', series: 'troop', index: 765, displayName: '火烧连营', sourceQuote: '【陆逊】《三国志·陆逊传》：夷陵之战火攻刘备七百里连营。', baseEffect: 'ally_add_troops_opening', condition: 'always', phase: 'pre_opening_troops', magnitude: 0.1, engineStatus: 'ready' },
    ...
    { id: 'ts_802', usageTag: '防御', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 802, displayName: '疏勒孤忠', sourceQuote: '【耿恭】《后汉书·耿恭传》：孤军守疏勒城凿山得泉，十三将士归玉门。', baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive', magnitude: 1.5, engineStatus: 'ready' },
    // ── 帝王专属 ──
