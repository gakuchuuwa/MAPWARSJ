...
const UNIQUE_T1_GENERAL: TacticalSkillEntry[] = [
    ...
    },
    {
        ...
        displayName: '郡山诱击', sourceQuote: '毛利元就历史记载：吉田郡山诱敌深入两面夹击尼子军',
        baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'opening_roll',
        magnitude: 1, luckMin: 0.7, luckMax: 1.3,engineStatus: 'ready',
...
const UNIQUE_T1_PRECISION: TacticalSkillEntry[] = [
    ...
    { id: 'ts_722', layer: 'tactical', series: 'fate', index: 722, displayName: '孤军渡江', situationTag: '均势', sourceQuote: '孤军渡江', baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll', magnitude: 1, luckMin: 0.7, luckMax: 1.3, luckMin: 0.7, luckMax: 1.3, engineStatus: 'ready', note: '【孤军渡江】三势精修·劣局' },
...
const UNIQUE_T1_EXPAND: TacticalSkillEntry[] = [
    ...
    { id: 'ts_748', usageTag: '双行', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 748, displayName: '围魏救赵', sourceQuote: '【孙膑】《史记·孙子吴起列传》：攻其必救，解友军之围。', baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive', magnitude: 0.3, engineStatus: 'ready' },
