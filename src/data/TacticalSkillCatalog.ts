...
const SANSHILIU: TacticalSkillEntry[] = [
    {
        ...
        displayName: '瞒天过海', sourceQuote: '《薛仁贵征辽事略》：设彩幕蔽海，三军安渡。',
        baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.12, engineStatus: 'ready',
    ...
    },
    {
        ...
        displayName: '围魏救赵', sourceQuote: '《史记·孙子吴起列传》：批亢捣虚，形格势禁。',
        baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.12, engineStatus: 'ready',
    ...
    },
    {
        ...
        displayName: '借刀杀人', sourceQuote: '《三十六计》：引友杀敌，不自出力。',
        baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.12, engineStatus: 'ready',
        note: '【胜战计·全】郑桓公；三十六计补充',
    },
    {
        id: 'ts_392', layer: 'tactical', series: 'troop', index: 392,
        displayName: '趁火打劫', sourceQuote: '《三十六计》：敌之害大，就势取利。',
        baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.12, engineStatus: 'ready',
        note: '【胜战计·全】勾践；三十六计补充',
    },
    {
        id: 'ts_393', layer: 'tactical', series: 'fate', index: 393,
        displayName: '无中生有', sourceQuote: '《新唐书·张巡传》：缚草为人千余，夜缒城下，得矢数十万。',
        baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll',
        magnitude: 1, luckMin: 0.55, luckMax: 1.0, engineStatus: 'ready',
        note: '【敌战计·衡】张巡；三十六计补充',
    },
    {
        id: 'ts_394', layer: 'tactical', series: 'fate', index: 394,
        displayName: '隔岸观火', sourceQuote: '《三十六计》：阳乖序乱，阴以待逆。',
        baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll',
        magnitude: 1, luckMin: 0.55, luckMax: 1.0, engineStatus: 'ready',
        note: '【敌战计·衡】刘秀；三十六计补充',
    },
    {
        id: 'ts_395', layer: 'tactical', series: 'fate', index: 395,
        displayName: '笑里藏刀', sourceQuote: '《三十六计》：信而安之，阴以图之。',
        baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll',
        magnitude: 1, luckMin: 0.55, luckMax: 1.0, engineStatus: 'ready',
    ...
    },
    {
        ...
        displayName: '李代桃僵', sourceQuote: '《三十六计》：势必有损，损阴以益阳。',
        baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll',
        magnitude: 1, luckMin: 0.55, luckMax: 1.0, engineStatus: 'ready',
        note: '【敌战计·衡】程婴；三十六计补充',
    },
    {
        id: 'ts_397', layer: 'tactical', series: 'fate', index: 397,
        displayName: '顺手牵羊', sourceQuote: '《新唐书·李愬传》：雪夜入蔡，沿途拔栅，敌不之觉。',
        baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll',
        magnitude: 1, luckMin: 0.55, luckMax: 1.0, engineStatus: 'ready',
        note: '【敌战计·衡】李愬；三十六计补充',
    },
    {
        id: 'ts_398', layer: 'tactical', series: 'enhance', index: 398,
        displayName: '打草惊蛇', sourceQuote: '《旧唐书·裴行俭传》：伪为畋猎，掩执叛酋。',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.3, engineStatus: 'ready',
        note: '【攻战计·机】裴行俭；三十六计补充',
    },
    {
        id: 'ts_399', layer: 'tactical', series: 'enhance', index: 399,
        displayName: '借尸还魂', sourceQuote: '《史记·项羽本纪》：立楚怀王孙心，从民所望。',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.3, engineStatus: 'ready',
    ...
    },
    {
        ...
        displayName: '调虎离山', sourceQuote: '《三十六计》：待天以困之，用人以诱之。',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.3, engineStatus: 'ready',
        note: '【攻战计·机】孙策；三十六计补充',
    },
    {
        id: 'ts_401', layer: 'tactical', series: 'enhance', index: 401,
        displayName: '欲擒故纵', sourceQuote: '《华阳国志》：七纵七擒，孟获心服。',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.3, engineStatus: 'ready',
    ...
    },
    {
        ...
        displayName: '抛砖引玉', sourceQuote: '《左传》：楚伐绞，为采樵者诱之，绞人争出。',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.3, engineStatus: 'ready',
        note: '【攻战计·机】楚武王；三十六计补充',
    },
    {
        id: 'ts_403', layer: 'tactical', series: 'counter', index: 403,
        displayName: '釜底抽薪', sourceQuote: '《三国志·武帝纪》：夜袭乌巢，尽焚其粮。',
        baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'opening_roll',
        magnitude: 1, engineStatus: 'ready',
        note: '【混战计·乱】曹操；三十六计补充',
    },
    {
        id: 'ts_404', layer: 'tactical', series: 'counter', index: 404,
        displayName: '浑水摸鱼', sourceQuote: '《晋书·谢玄传》：淝水乱之，秦兵大溃。',
        baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'opening_roll',
        magnitude: 1, engineStatus: 'ready',
        note: '【混战计·乱】谢玄；三十六计补充',
    },
    {
        id: 'ts_405', layer: 'tactical', series: 'counter', index: 405,
        displayName: '金蝉脱壳', sourceQuote: '《宋史·毕再遇传》：悬羊击鼓，全军夜遁。',
        baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'opening_roll',
        magnitude: 1, engineStatus: 'ready',
        note: '【混战计·乱】毕再遇；三十六计补充',
    },
    {
        id: 'ts_406', layer: 'tactical', series: 'counter', index: 406,
        displayName: '关门捉贼', sourceQuote: '《史记·白起传》：绝赵粮道，围而歼之。',
        baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'opening_roll',
        magnitude: 1, engineStatus: 'ready',
    ...
    },
    {
        ...
        displayName: '远交近攻', sourceQuote: '《史记·范雎传》：远交近攻，得寸则王之寸。',
        baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'opening_roll',
        magnitude: 1, engineStatus: 'ready',
        note: '【混战计·乱】范雎；三十六计补充',
    },
    {
        id: 'ts_408', layer: 'tactical', series: 'counter', index: 408,
        displayName: '假道伐虢', sourceQuote: '《左传·僖公五年》：假道于虞以伐虢，还灭虞。',
        baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'opening_roll',
        magnitude: 1, engineStatus: 'ready',
        note: '【混战计·乱】晋献公；三十六计补充',
    },
    {
        id: 'ts_409', layer: 'tactical', series: 'casualty', index: 409,
        displayName: '偷梁换柱', sourceQuote: '《史记·秦始皇本纪》：沙丘矫诏，易嗣夺权。',
        baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive',
        magnitude: 0.2, engineStatus: 'ready',
        note: '【并战计·借】赵高；三十六计补充',
    },
    {
        id: 'ts_410', layer: 'tactical', series: 'casualty', index: 410,
        displayName: '反客为主', sourceQuote: '《三国志·袁绍传》：诱韩馥让冀州，反客而据之。',
        baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive',
        magnitude: 0.2, engineStatus: 'ready',
        note: '【并战计·借】袁绍；三十六计补充',
    },
    {
        id: 'ts_411', layer: 'tactical', series: 'casualty', index: 411,
        displayName: '指桑骂槐', sourceQuote: '《史记·司马穰苴传》：斩庄贾以徇，三军股栗。',
        baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive',
        magnitude: 0.2, engineStatus: 'ready',
        note: '【并战计·借】司马穰苴；三十六计补充',
    },
    {
        id: 'ts_412', layer: 'tactical', series: 'casualty', index: 412,
        displayName: '假痴不癫', sourceQuote: '《晋书·宣帝纪》：诈疾赚爽，一朝夺柄。',
        baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive',
        magnitude: 0.2, engineStatus: 'ready',
    ...
    },
    {
        ...
        displayName: '上屋抽梯', sourceQuote: '《史记·项羽本纪》：破釜沉舟，绝其归路。',
        baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive',
        magnitude: 0.2, engineStatus: 'ready',
        note: '【并战计·借】项羽；三十六计补充',
    },
    {
        id: 'ts_414', layer: 'tactical', series: 'casualty', index: 414,
        displayName: '树上开花', sourceQuote: '《史记·田单传》：束兵刃于牛角，燔而奔敌。',
        baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive',
        magnitude: 0.2, engineStatus: 'ready',
        note: '【并战计·借】田单；三十六计补充',
    },
    {
        id: 'ts_415', layer: 'tactical', series: 'casualty', index: 415,
        displayName: '倾城误敌', sourceQuote: '《吴越春秋》：进西施以惑吴，倾其社稷。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'post_battle',
        magnitude: 1.5, engineStatus: 'ready',
        note: '【败战计·险】范蠡；三十六计补充',
    },
    {
        id: 'ts_416', layer: 'tactical', series: 'casualty', index: 416,
        displayName: '反间除帅', sourceQuote: '《清史稿·太宗纪》：纵反间，明帝自戮崇焕。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'always', phase: 'post_battle',
        magnitude: 1.5, engineStatus: 'ready',
        note: '【败战计·险】皇太极；三十六计补充',
    },
    {
        id: 'ts_417', layer: 'tactical', series: 'casualty', index: 417,
        displayName: '苦肉诈降', sourceQuote: '《三国志·周瑜传》：盖诈降，火攻赤壁。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'always', phase: 'post_battle',
        magnitude: 1.5, engineStatus: 'ready',
    ...
    },
    {
        ...
        displayName: '连环离间', sourceQuote: '《后汉书·王允传》：结貂蝉为连环，间布杀卓。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'always', phase: 'post_battle',
        magnitude: 1.5, engineStatus: 'ready',
        note: '【败战计·险】王允；三十六计补充',
    },
    {
        id: 'ts_419', layer: 'tactical', series: 'casualty', index: 419,
        displayName: '全师而退', sourceQuote: '《南史·檀道济传》：唱筹量沙，全军而返。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'always', phase: 'post_battle',
        magnitude: 1.5, engineStatus: 'ready',
        note: '【败战计·险】檀道济；三十六计补充',
    },
];
