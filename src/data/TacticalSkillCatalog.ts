    ...
    },
{
    ...
    },
    {
        ...
        displayName: '袭帐破汗', sourceQuote: '【李靖】《旧唐书·李靖传》：趁夜袭破颉利可汗牙帐。',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.05, engineStatus: 'ready',
    },
    {
    ...
    },
{
    ...
    },
    {
        ...
        displayName: '散骑扰后', ownerName: '哈斯木', ownerGeneralId: 'kazakh_hasimu', sourceQuote: '哈斯木专题记载',
        baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'opening_roll',
        magnitude: 1, engineStatus: 'ready',
    ...
    },
    {
        ...
        displayName: '锐骑摧坚', ownerName: '固始汗', ownerGeneralId: 'khoshut_gushihan', sourceQuote: '固始汗专题记载',
        baseEffect: 'ally_power_mult', condition: 'battle_field', phase: 'opening_roll',
        magnitude: 1.1, engineStatus: 'ready',
    ...
    },
{
    ...
    },
    {
        ...
        displayName: '收残再起', sourceQuote: '【刘备】《三国志·先主传》：屡败屡战，收拾残兵东山再起。',
        baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive',
        magnitude: 0.3, engineStatus: 'ready',
    },
    {
...
const UNIQUE_T1_TAIL: TacticalSkillEntry[] = [
    ...
    },
    {
        ...
        displayName: '出奇袭虚', sourceQuote: '【韩信】《史记·淮阴侯列传》：暗度陈仓，出奇袭虚。',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.05, engineStatus: 'ready',
    },
    {
...
const SANSHILIU: TacticalSkillEntry[] = [
    ...
    },
    {
        ...
        displayName: '浑水摸鱼', ownerName: '李靖', ownerGeneralId: 'dingxiang_d_lijing', sourceQuote: '《旧唐书·李靖传》：趁秋水暴涨，萧铣不备，舰队直捣江陵灭南梁。',
        baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'opening_roll',
        magnitude: 0.25, engineStatus: 'ready',
...
{ id: 'ts_688', layer: 'tactical', series: 'fate', index: 688, displayName: '设伏疲敌', sourceQuote: '枣阳设伏疲金', baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll', magnitude: 1, luckMin: 0.7, luckMax: 1.3, engineStatus: 'ready', note: '【设伏疲敌】三势精修·均局' },
    ...
    { id: 'ts_699', layer: 'tactical', series: 'casualty', index: 699, displayName: '火器遏冲', ownerName: '袁崇焕', sourceQuote: '【袁崇焕】宁远红夷大炮遏后金冲势', baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive', magnitude: 0.3, engineStatus: 'ready', note: '【火器遏冲】三势精修·均局' },
    { id: 'ts_700', layer: 'tactical', series: 'casualty', index: 700, displayName: '诱敌据险', ownerName: '吴玠', sourceQuote: '【吴玠】和尚原诱敌深入，据险大破金军。', baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive', magnitude: 0.3, engineStatus: 'ready', note: '【诱敌据险】三势精修·均局' },
    ...
    { id: 'ts_707', usageTag: '防御', situationTag: '均势', layer: 'tactical', series: 'counter', index: 707, displayName: '草人诱射', ownerName: '张巡', sourceQuote: '【张巡】《新唐书·张巡传》：睢阳草人借箭，智守孤城。', baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'mid_battle_passive', magnitude: 1, engineStatus: 'ready' },
    ...
    { id: 'ts_711', layer: 'tactical', series: 'fate', index: 711, displayName: '穷搜死战', ownerName: '张巡', sourceQuote: '【张巡】睢阳粮尽，掘鼠雀穷搜死战抗击燕军。', baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'post_battle', magnitude: 1, luckMin: 0.7, luckMax: 1.3, engineStatus: 'ready', note: '【穷搜死战】三势精修·劣局' },
    ...
    { id: 'ts_713', layer: 'tactical', series: 'enhance', index: 713, displayName: '据险死拒', ownerName: '耿恭', sourceQuote: '疏勒城据险死拒，匈奴数月攻之不下。', baseEffect: 'ally_power_mult', condition: 'always', phase: 'mid_battle_passive', magnitude: 1.35, engineStatus: 'ready', note: '【据险死拒】三势精修·劣局' },
    { id: 'ts_714', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'troop', index: 714, displayName: '攻坚摧碉', ownerName: '阿桂', sourceQuote: '【阿桂】清平大小金川以火炮攻坚摧碉堡。', baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops', magnitude: 0.15, engineStatus: 'ready' },
    { id: 'ts_715', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'troop', index: 715, displayName: '矫制绝诛', ownerName: '陈汤', sourceQuote: '【陈汤】《汉书·陈汤传》：矫诏发兵灭郅支单于。', baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops', magnitude: 0.15, engineStatus: 'ready' },
...
{ id: 'ts_729', usageTag: '防御', situationTag: '优势', layer: 'tactical', series: 'enhance', index: 729, displayName: '坚壁养锐', ownerName: '司马懿', ownerGeneralId: 'wei_simayi', sourceQuote: '【司马懿】《晋书·宣帝纪》：对蜀闭垒不出，养精蓄锐待敌自退。', baseEffect: 'ally_power_mult', condition: 'always', phase: 'mid_battle_passive', magnitude: 1.05, engineStatus: 'ready' },
    ...
    { id: 'ts_734', layer: 'tactical', series: 'enhance', index: 734, displayName: '驰掠脱困', ownerName: '赵云', sourceQuote: '【赵云】长坂坡七进七出，驰掠突围脱困。', baseEffect: 'ally_power_mult', condition: 'always', phase: 'post_battle', magnitude: 1.05, engineStatus: 'ready', note: '【驰掠脱困】三势精修·劣局' },
...
const UNIQUE_T1_EXPAND: TacticalSkillEntry[] = [
    ...
    { id: 'ts_752', layer: 'tactical', series: 'casualty', index: 752, displayName: '结营凭险', ownerName: '陆逊', sourceQuote: '《三国志·陆逊传》夷陵之战陆逊坚守不出，拒敌锋锐', baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive', magnitude: 0.3, engineStatus: 'ready' },
    ...
    { id: 'ts_793', layer: 'tactical', series: 'casualty', index: 793, displayName: '林中保全', ownerName: '图门吉尔嘎勒', sourceQuote: '布里亚特部史：图门吉尔嘎勒率部散入贝加尔林中，保全部众。', baseEffect: 'lose_enemy_casualty_boost', condition: 'always', phase: 'mid_battle_passive', magnitude: 1.25, engineStatus: 'ready', note: '【图门吉尔嘎勒】势reverse·劣局专属' },
    ...
    { id: 'ts_810', layer: 'tactical', series: 'fate', index: 810, displayName: '料敌机先', ownerName: '孙膑', sourceQuote: '【孙膑】《史记》：马陵道预判庞涓行程设伏', baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll', magnitude: 1.0, luckMin: 0.7, luckMax: 1.3, engineStatus: 'ready', note: '【孙膑】绝品·专属·一人一张·原主复活' },
