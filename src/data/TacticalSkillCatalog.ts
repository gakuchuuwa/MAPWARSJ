...
const UNIQUE_T1_PRECISION: TacticalSkillEntry[] = [
    ...
    { id: 'ts_703', layer: 'tactical', series: 'enhance', index: 703, displayName: '恩威抚讨', sourceQuote: '【诸葛亮】南征恩威抚讨', baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll', magnitude: 1.3, engineStatus: 'ready', note: '【恩威抚讨】三势精修·优局' },
    ...
    { id: 'ts_706', layer: 'tactical', series: 'troop', index: 706, displayName: '钓野诱歼', sourceQuote: '钓野伏（岛津家久）', baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops', magnitude: 0.13, engineStatus: 'ready', note: '【钓野诱歼】三势精修·优局' },
...
const UNIQUE_T1_EXPAND: TacticalSkillEntry[] = [
    ...
    { id: 'ts_770', layer: 'tactical', series: 'counter', index: 770, displayName: '锦囊妙计', sourceQuote: '《三国演义》诸葛亮预留锦囊，在关键时刻化解敌方计谋', baseEffect: 'partial_negate_enemy_skill', condition: 'always', phase: 'opening_roll', magnitude: 0.5, engineStatus: 'ready' },    { id: 'ts_772', layer: 'tactical', series: 'counter', index: 772, displayName: '割须弃袍', sourceQuote: '《三国演义》曹操狼狈逃窜，但也借此化解了马超的致命一击', baseEffect: 'partial_negate_enemy_skill', condition: 'always', phase: 'opening_roll', magnitude: 0.5, engineStatus: 'ready' },
    ...
    { id: 'ts_796', layer: 'tactical', series: 'casualty', index: 796, displayName: '御边据险', sourceQuote: '【图门吉尔嘎勒】守御边境据守险要', baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive', magnitude: 0.35, engineStatus: 'ready', note: '【戈达尔兹】势reverse·劣局专属' },
    // ── 名将专属新技 ──
    { id: 'ts_801', layer: 'tactical', series: 'troop', index: 801, displayName: '夜火焚营', sourceQuote: '《三国志·陆逊传》：逊乘夜火攻，大破刘备于猇亭，焚其舟船器械。', baseEffect: 'enemy_sub_troops_opening', condition: 'ratio_underdog', phase: 'pre_opening_troops', magnitude: 0.15, engineStatus: 'ready', note: '【陆逊】夷陵之战·劣势开局火攻烧营·势reverse·劣局专属' },
    ...
    // ── 帝王专属 ──
    { id: 'ts_806', layer: 'tactical', series: 'enhance', index: 806, displayName: '日月重开', sourceQuote: '《明太祖实录》：“驱除胡虏，恢复中华，立纲陈纪，救济斯民。”（朱元璋）', baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll', magnitude: 1.30, engineStatus: 'ready', note: '【朱元璋】大明开国·常驻战力·势create·优局专属' },
