        ...
        magnitude: 1.0, engineStatus: 'ready'},
{
    ...
    },
    {
        ...
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.05, engineStatus: 'ready',
    }tion: 'always', phase: 'opening_roll',
        magnitude: 1.05, engineStatus: 'ready',
    },
    {
        ...
        magnitude: 1.05, engineStatus: 'ready'},
    {
        ...
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.05, engineStatus: 'ready'}ude: 1.05, engineStatus: 'ready'},
    {
    ...
    },
{
    ...
    {
        id: 'ts_228', usageTag: '双行', situationTag: '优势', layer: 'tactical', series: 'enhance', index: 228,
        displayName: '并骑破阵', sourceQuote: '《明史·瓦剌传》：脱欢并诸部，破阿鲁台。',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.05, engineStatus: 'ready',
    }: 1.05, engineStatus: 'ready',
    },
    {
...
{ id: 'ts_687', usageTag: '双行', situationTag: '均势', layer: 'tactical', series: 'fate', index: 687, displayName: '步阵遏骑', ownerName: '刘裕', ownerGeneralId: 'wang_d_liuyu', sourceQuote: '【刘裕】以步阵遏骑兵冲击。', baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll', magnitude: 1, luckMin: 0.7, luckMax: 1.3, engineStatus: 'ready', note: '【步阵遏骑】三势精修·均局' },
{ id: 'ts_688', layer: 'tactical', series: 'fate', index: 688, displayName: '设伏疲敌', sourceQuote: '枣阳设伏疲金', baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll', magnitude: 1, luckMin: 0.7, luckMax: 1.3, engineStatus: 'ready', note: '【设伏疲敌】三势精修·均局' },
    ...
    { id: 'ts_716', layer: 'tactical', series: 'casualty', index: 716, displayName: '据城退敌', ownerName: '刘仁恭', ownerGeneralId: 'cangzhou_liurengong', sourceQuote: '【刘仁恭】据幽州退朱温', baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive', magnitude: 0.3, engineStatus: 'ready', note: '【据城退敌】三势精修·劣局' },
...
{ id: 'ts_729', usageTag: '防御', situationTag: '优势', layer: 'tactical', series: 'enhance', index: 729, displayName: '坚壁养锐', ownerName: '司马懿', ownerGeneralId: 'sima_d_simayi', sourceQuote: '【司马懿】《晋书·宣帝纪》：对蜀闭垒不出，养精蓄锐待敌自退。', baseEffect: 'ally_power_mult', condition: 'always', phase: 'mid_battle_passive', magnitude: 1.05, engineStatus: 'ready' },
    ...
    { id: 'ts_732', usageTag: '双行', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 732, displayName: '断后殉节', sourceQuote: '陈家谷', baseEffect: 'lose_enemy_casualty_boost', condition: 'always', phase: 'post_battle', magnitude: 1.25, engineStatus: 'ready', note: '【断后殉节】三势精修·劣局' }s', phase: 'post_battle', magnitude: 1.25, engineStatus: 'ready', note: '【断后殉节】三势精修·劣局' },
...
const UNIQUE_T1_EXPAND: TacticalSkillEntry[] = [
    ...
    { id: 'ts_751', ownerName: '先轸', ownerGeneralId: 'jin_xianzhen', usageTag: '双行', situationTag: '均势', layer: 'tactical', series: 'counter', index: 751, displayName: '退避三舍', sourceQuote: '《左传·僖公二十二年》城濮之战晋文公主动后退避开楚军锋芒', baseEffect: 'nullify_enemy_opening_cut', condition: 'always', phase: 'opening_roll', magnitude: 1, engineStatus: 'ready' }t', condition: 'always', phase: 'opening_roll', magnitude: 1, engineStatus: 'ready' },
