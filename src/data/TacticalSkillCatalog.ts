...
const FATE: TacticalSkillEntry[] = [
        ...
        note: '淝水追击溃敌，己方乘胜摧锋；谢玄率北府兵趁势掩杀，秦军全线崩溃。'},
    {
        ...
        displayName: '济河焚舟', usageTag: '攻击', situationTag: '劣势', sourceQuote: '《左传·僖公二十八年》：“济河焚舟，示无还心。”',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.5, engineStatus: 'ready',
        mutexGroup: 'deep_gamble',
...
const UNIQUE_T0: TacticalSkillEntry[] = [
    {
        id: 'ts_051', ownerName: '李世民', ownerGeneralId: 'tang_lishimin', layer: 'tactical', series: 'enhance', index: 51,
...
const UNIQUE_T1: TacticalSkillEntry[] = [
    ...
    {
        id: 'ts_071', situationTag: '优势', layer: 'tactical', series: 'troop', index: 71,
    ...
    {
        id: 'ts_121', ownerName: '司马错', ownerGeneralId: 'qin_simacuo', layer: 'tactical', series: 'enhance', index: 121,
...
const UNIQUE_T1_GENERAL: TacticalSkillEntry[] = [
    ...
    {
        id: 'ts_490', situationTag: '均势', ownerName: '达延汗', ownerGeneralId: 'dada_ming_dayanhan', layer: 'tactical', series: 'fate', index: 490,
    ...
    {
        id: 'ts_518', ownerName: '李定国', ownerGeneralId: 'guizhou_lidingguo', layer: 'tactical', series: 'casualty', index: 518,
...
const UNIQUE_T1_GENERAL2: TacticalSkillEntry[] = [
    ...
    {
        id: 'ts_547', situationTag: '均势', ownerName: '完颜宗弼', ownerGeneralId: 'jurchen_wanyanzongbi', layer: 'tactical', series: 'fate', index: 547,
...
const UNIQUE_T0_REVISE: TacticalSkillEntry[] = [
    ...
    {
        id: 'ts_433', ownerName: '张辽', ownerGeneralId: 'lu_zhangliao', layer: 'tactical', series: 'casualty', index: 433,
