...
const UNIQUE_T1: TacticalSkillEntry[] = [
    ...
    {
        id: 'ts_297', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'troop', index: 297,
    ...
    {
        id: 'ts_309', usageTag: '攻击', situationTag: '均势', layer: 'tactical', series: 'enhance', index: 309,
    ...
    },
    {
        ...
        baseEffect: 'negate_enemy_skill', condition: 'ratio_underdog', phase: 'opening_roll',
        magnitude: 1, engineStatus: 'ready',
    },
    {
...
const UNIQUE_T1_GENERAL: TacticalSkillEntry[] = [
    ...
    },
    {
        ...
        baseEffect: 'win_casualty_reduction', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 0.3, engineStatus: 'ready',
    },
    {
...
const UNIQUE_T1_PRECISION: TacticalSkillEntry[] = [
    ...
    { id: 'ts_695', layer: 'tactical', series: 'casualty', index: 695, displayName: '阵变惑敌', sourceQuote: '八阵图', baseEffect: 'lose_enemy_casualty_boost', condition: 'always', phase: 'mid_battle_passive', magnitude: 1.25, engineStatus: 'ready', note: '【阵变惑敌】三势精修·均局' },
    ...
    { id: 'ts_729', usageTag: '防御', situationTag: '优势', layer: 'tactical', series: 'enhance', index: 729, displayName: '坚壁养锐', sourceQuote: '【司马懿】《晋书·宣帝纪》：对蜀闭垒不出，养精蓄锐待敌自退。', baseEffect: 'ally_power_mult', condition: 'always', phase: 'mid_battle_passive', magnitude: 1.05, engineStatus: 'ready' },
...
const UNIQUE_T1_EXPAND: TacticalSkillEntry[] = [
    ...
    { id: 'ts_749', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'troop', index: 749, displayName: '威震逍遥', sourceQuote: '【张辽】《三国志·张辽传》：逍遥津八百人冲孙权十万大营。', baseEffect: 'enemy_sub_troops_opening', condition: 'ratio_underdog', phase: 'pre_opening_troops', magnitude: 1.5, engineStatus: 'ready' },
    ...
    { id: 'ts_802', usageTag: '防御', situationTag: '均势', layer: 'tactical', series: 'fate', index: 802, displayName: '疏勒孤忠', sourceQuote: '【耿恭】《后汉书·耿恭传》：孤军守疏勒城凿山得泉，十三将士归玉门。', baseEffect: 'luck_variance_enemy', condition: 'ratio_underdog', phase: 'opening_roll', magnitude: 1.5, luckMin: 0.7, luckMax: 1.3, engineStatus: 'ready' },
    // ── 帝王专属 ──
