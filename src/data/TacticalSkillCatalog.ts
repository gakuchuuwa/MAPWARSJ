...
const ENHANCE: TacticalSkillEntry[] = [
    ...
    },
    {
        ...
        displayName: '擒贼擒王', ownerName: '三势六计', sourceQuote: '《杜甫·前出塞》：“射人先射马，擒贼先擒王。”',
    ...
    {
        id: 'ts_815', ownerName: '三势六计', usageTag: '防御', situationTag: '优势', layer: 'tactical', series: 'troop', index: 815,
    ...
    {
        id: 'ts_816', ownerName: '三势六计', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'enhance', index: 816,
...
const COUNTER: TacticalSkillEntry[] = [
    ...
    {
        id: 'ts_046', ownerName: '三势六计', layer: 'tactical', series: 'fate', index: 46,
    ...
    },
    {
        ...
        displayName: '空城退敌', ownerName: '三势六计', sourceQuote: '《三国志·蜀书·赵云传》注引《云别传》：“更大开门，偃旗息鼓。”',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'always', phase: 'post_battle',
        magnitude: 1.25, engineStatus: 'ready',
...
const SANSHILIU: TacticalSkillEntry[] = [
    {
        id: 'ts_389', ownerName: '三势六计', usageTag: '双行', situationTag: '优势', layer: 'tactical', series: 'troop', index: 389,
    ...
    },
    {
        ...
        displayName: '围点打援', ownerName: '三势六计', sourceQuote: '【耿弇】《后汉书·耿弇传》：攻张步，先灭援军而后取城，围点打援。',
        baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.08, engineStatus: 'ready',
    ...
    },
    {
        ...
        displayName: '借刀杀人', ownerName: '三势六计', usageTag: '双行', situationTag: '优势', sourceQuote: '【三十六计】利用矛盾借敌之手除患，借刀杀人。',
        baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.08, engineStatus: 'ready',
    ...
    },
    {
        ...
        displayName: '趁火打劫', ownerName: '三势六计', sourceQuote: '《三国志·孙策传》：欲趁官渡相持袭许昌挟帝，未行而遇刺。',
        baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.08, engineStatus: 'ready',
    ...
    },
    {
        ...
        displayName: '无中生有', ownerName: '三势六计', sourceQuote: '《南史·檀道济传》：唱筹量沙，全军而反，魏人不敢逼。',
        baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll',
        magnitude: 1, luckMin: 0.6, luckMax: 1.4, engineStatus: 'ready',
    ...
    },
    {
        ...
        displayName: '隔岸观火', ownerName: '三势六计', sourceQuote: '【曹操】观袁尚袁谭相争，坐收渔利，隔岸观火。',
        baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll',
        magnitude: 1, luckMin: 0.6, luckMax: 1.4, engineStatus: 'ready',
    ...
    },
    {
        ...
        displayName: '笑里藏刀', ownerName: '三势六计', sourceQuote: '《史记·商君列传》：致书公子卬约盟，饮而伏甲掳之，遂破魏。',
        baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll',
        magnitude: 1, luckMin: 0.6, luckMax: 1.4, engineStatus: 'ready',
        note: '【敌战计·衡】商鞅；三十六计补充',
    },
    {
        id: 'ts_396', ownerName: '三势六计', usageTag: '防御', situationTag: '均势', layer: 'tactical', series: 'fate', index: 396,
        displayName: '李代桃僵', sourceQuote: '【曹操】官渡之战以卒代己诱敌，舍小保大，主力得转。',
        baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll',
        magnitude: 1, luckMin: 0.7, luckMax: 1.3, engineStatus: 'ready',
    },
    {
        id: 'ts_397', ownerName: '三势六计', usageTag: '攻击', situationTag: '均势', layer: 'tactical', series: 'fate', index: 397,
    ...
    {
        id: 'ts_398', usageTag: '双行', situationTag: '优势', ownerName: '三势六计', layer: 'tactical', series: 'enhance', index: 398,
    ...
    },
    {
        ...
        displayName: '借尸还魂', ownerName: '三势六计', sourceQuote: '【刘备】借汉室宗亲之旗号立势，复振汉统。',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.2, engineStatus: 'ready',
        note: '【攻战计·机】借尸还魂',
    },
    {
        ...
        displayName: '调虎离山', ownerName: '三势六计', sourceQuote: '《晋书·慕容恪载记》：慕容恪围广固，守将段龛据城坚守。恪围而不攻、诱其出城野战，段龛屡出屡败，终城破被俘。',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.2, engineStatus: 'ready',
    ...
    },
    {
        ...
        displayName: '欲擒故纵', ownerName: '三势六计', sourceQuote: '《华阳国志》：七纵七禽，南人不复反。',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.2, engineStatus: 'ready',
        note: '【攻战计·机】诸葛亮；三十六计补充',
    },
    {
        id: 'ts_402', ownerName: '三势六计', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'enhance', index: 402,
    ...
    {
        id: 'ts_403', ownerName: '三势六计', layer: 'tactical', series: 'counter', index: 403,
    ...
    },
    {
        ...
        displayName: '浑水摸鱼', ownerName: '三势六计', sourceQuote: '【吕蒙】《三国志·吕蒙传》：白衣渡江，伪装商船趁关羽不备奇袭江陵，于乱局中取荆州。',
        baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'opening_roll',
        magnitude: 0.8, engineStatus: 'ready',
        note: '【混战计·乱】浑水摸鱼；三十六计',
    },
    {
        id: 'ts_405', ownerName: '三势六计', usageTag: '防御', situationTag: '均势', layer: 'tactical', series: 'counter', index: 405,
        displayName: '金蝉脱壳', sourceQuote: '三十六计之混战计，均势时脱身之计，多将皆有。',
        baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'opening_roll',
        magnitude: 0.4, engineStatus: 'ready',
    },
    {
        id: 'ts_406', ownerName: '三势六计', usageTag: '攻击', situationTag: '均势', layer: 'tactical', series: 'counter', index: 406,
        displayName: '关门捉贼', sourceQuote: '【白起】《史记·白起列传》：长平两翼骑兵包抄，合围赵军于谷地。',
        baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'opening_roll',
        magnitude: 0.8, engineStatus: 'ready',
    },
    {
        id: 'ts_407', ownerName: '三势六计', usageTag: '双行', situationTag: '均势', layer: 'tactical', series: 'counter', index: 407,
    ...
    {
        id: 'ts_408', ownerName: '三势六计', usageTag: '双行', situationTag: '均势', layer: 'tactical', series: 'counter', index: 408,
    ...
    {
        id: 'ts_409', ownerName: '三势六计', usageTag: '双行', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 409,
        displayName: '偷梁换柱', sourceQuote: '三十六计之并战计，暗中替换，劣势时用，多将皆有。',
        baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive',
        magnitude: 0.2, engineStatus: 'ready',
    },
    {
        id: 'ts_410', ownerName: '三势六计', usageTag: '双行', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 410,
    ...
    },
    {
        ...
        displayName: '指桑骂槐', ownerName: '三势六计', sourceQuote: '【曹操】《三国志·武帝纪》注：尝以粮少，借仓官首以安军心，惩一儆百。',
        baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive',
        magnitude: 0.2, engineStatus: 'ready',
    ...
    },
    {
        ...
        displayName: '假痴不癫', ownerName: '三势六计', sourceQuote: '《三国志·先主传》：种菜灌园，闻雷失箸，曹操不疑。',
        baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive',
        magnitude: 0.2, engineStatus: 'ready',
        note: '【并战计·借】假痴不癫；三十六计',
    },
    {
        id: 'ts_413', ownerName: '三势六计', usageTag: '攻击', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 413,
        displayName: '上屋抽梯', sourceQuote: '诱敌深入后断其退路，如刘琦求计、背水诱敌等多将皆有。',
        baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive',
        magnitude: 0.2, engineStatus: 'ready',
    },
    {
        id: 'ts_414', ownerName: '三势六计', usageTag: '双行', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 414,
    ...
    {
        id: 'ts_415', ownerName: '三势六计', layer: 'tactical', series: 'casualty', index: 415,
    ...
    },
    {
        ...
        displayName: '反间除帅', ownerName: '三势六计', sourceQuote: '【田单】《史记·田单列传》：反间计使燕惠王换将，乐毅去而骑劫来。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'always', phase: 'mid_battle_passive',
        magnitude: 1.25, engineStatus: 'ready',
        note: '【败战计·险】反间除帅；三十六计',
    },
    {
        id: 'ts_417', ownerName: '三势六计', layer: 'tactical', series: 'casualty', index: 417,
    ...
    },
    {
        ...
        displayName: '连环离间', ownerName: '三势六计', sourceQuote: '【王允】《后汉书·王允传》：连环计结吕布诛董卓。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'always', phase: 'post_battle',
        magnitude: 1.25, engineStatus: 'ready',
    },
    {
        id: 'ts_419', layer: 'tactical', series: 'casualty', index: 419,
        displayName: '全师而退', ownerName: '三势六计', sourceQuote: '【刘邦】《史记·项羽本纪》：鸿门宴辞出，间道走霸上，全师而退。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'always', phase: 'post_battle',
        magnitude: 1.25, engineStatus: 'ready',
...
const UNIQUE_T1_EXPAND: TacticalSkillEntry[] = [
    ...
    { id: 'ts_744', usageTag: '攻击', situationTag: '均势', layer: 'tactical', series: 'fate', index: 744, displayName: '暗渡陈仓', ownerName: '三势六计', sourceQuote: '【邓艾】《三国志·邓艾传》：偷渡阴平，出奇兵直取成都。', baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll', magnitude: 1, luckMin: 0.6, luckMax: 1.4, engineStatus: 'ready', note: '【敌战计·衡】暗渡陈仓；三十六计（阴平同典）' },
    ...
    { id: 'ts_748', usageTag: '双行', situationTag: '优势', layer: 'tactical', series: 'troop', index: 748, displayName: '围魏救赵', ownerName: '三势六计', sourceQuote: '【孙膑】《史记·孙子吴起列传》：攻其必救，解友军之围。', baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops', magnitude: 0.08, engineStatus: 'ready', note: '【胜战计·全】围魏救赵；三十六计' },
    ...
    { id: 'ts_759', ownerName: '三势六计', usageTag: '双行', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 759, displayName: '反客为主', sourceQuote: '【刘备】《三国志·先主传》：入蜀助璋，反客为主取益州。', baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive', magnitude: 0.2, engineStatus: 'ready', note: '【并战计·借】反客为主；三十六计' },
    ...
    {
        id: 'ts_822', ownerName: '三势六计', usageTag: '双行', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 822,
