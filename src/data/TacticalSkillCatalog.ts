...
const ENHANCE: TacticalSkillEntry[] = [
    ...
    },
    {
        ...
        magnitude: 0.08, engineStatus: 'ready',
    },
    {
...
const TROOP: TacticalSkillEntry[] = [
    ...
    {
        id: 'ts_027', usageTag: '攻击', layer: 'tactical', series: 'troop', index: 27,
...
const UNIQUE_T1: TacticalSkillEntry[] = [
        ...
        magnitude: 1.2, engineStatus: 'ready'},
    {
        ...
        magnitude: 0.08, engineStatus: 'ready', note: '同源：李世民·勒骑（与 ts_618 勒骑摧阵同典）',
    },
    {
    ...
    {
        id: 'ts_181', ownerGeneralId: 'yuan_cj_d_lishuo', usageTag: '攻击', situationTag: '均势', layer: 'tactical', series: 'troop', index: 181,
    ...
    {
        id: 'ts_260', ownerGeneralId: 'yuan_cj_d_lishuo', ownerName: '李愬', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'enhance', index: 260,
    ...
    },
    {
        ...
        baseEffect: 'negate_enemy_skill', condition: 'terrain_mountain', phase: 'opening_roll',
        magnitude: 0.8, engineStatus: 'ready',
    },
    {
    ...
    {
        id: 'ts_300', ownerGeneralId: 'yuan_cj_d_lishuo', ownerName: '李愬', usageTag: '攻击', situationTag: '均势', layer: 'tactical', series: 'troop', index: 300,
    ...
    },
    {
        ...
        displayName: '迂回袭砦', sourceQuote: '【邓艾】《三国志·邓艾传》：自阴平道行无人之地七百余里，凿山通道，奇袭绵竹，成都遂降。',baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'opening_roll',
        magnitude: 0.8, engineStatus: 'ready',
        note: '迂回袭砦：阴平奇袭',
    },
    {
    ...
    {
        id: 'ts_366', ownerGeneralId: 'yuan_cj_d_lishuo', ownerName: '李愬', usageTag: '攻击', situationTag: '均势', layer: 'tactical', series: 'troop', index: 366,
    ...
    {
        id: 'ts_372', ownerGeneralId: 'yuan_cj_d_lishuo', ownerName: '李愬', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'enhance', index: 372,
    ...
    {
        id: 'ts_380', ownerGeneralId: 'yuan_cj_d_lishuo', ownerName: '李愬', usageTag: '攻击', situationTag: '均势', layer: 'tactical', series: 'troop', index: 380,
...
const UNIQUE_T1_GENERAL: TacticalSkillEntry[] = [
    ...
    {
        id: 'ts_474', ownerGeneralId: 'yuan_cj_d_lishuo', ownerName: '李愬', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'enhance', index: 474,
    ...
    },
    {
        ...
        baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'opening_roll',
        magnitude: 0.4, luckMin: 0.7, luckMax: 1.3,engineStatus: 'ready',
    ...
    },
    {
        ...
        magnitude: 0.09, luckMin: 0.6, luckMax: 1.4, engineStatus: 'ready',
    ...
    },
    {
        ...
        baseEffect: 'reflect_enemy_opening_cut', condition: 'always', phase: 'opening_roll',
        magnitude: 0.08, engineStatus: 'ready',
    },
    {
        id: 'ts_486', ownerGeneralId: 'cao_d_caocao', ownerName: '曹操', usageTag: '攻击', situationTag: '均势', layer: 'tactical', series: 'troop', index: 486,
    ...
    {
        id: 'ts_492', ownerGeneralId: 'shu_liubei', usageTag: '双行', situationTag: '均势', layer: 'tactical', series: 'counter', index: 492,
    ...
    {
        id: 'ts_519', ownerGeneralId: 'yuan_cj_d_lishuo', ownerName: '李愬', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'enhance', index: 519,
    ...
    {
        id: 'ts_523', ownerGeneralId: 'pingnan_muying', ownerName: '沐英', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'enhance', index: 523,
...
const UNIQUE_T1_GENERAL2: TacticalSkillEntry[] = [
    ...
    },
    {
        ...
        baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'opening_roll',
        magnitude: 0.8, engineStatus: 'ready', note: '设伏摧锋：马陵设伏',
    },
    {
    ...
    },
    {
        ...
        baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll',
        magnitude: 1, luckMin: 0.6, luckMax: 1.4, engineStatus: 'ready', note: '诱敌夹击：官渡诱敌军虚（潍水夹击已留囊沙壅流）',
    },
    {
    ...
    {
        id: 'ts_594', ownerGeneralId: 'huaiyang_zhouyafu', usageTag: '双行', situationTag: '优势', layer: 'tactical', series: 'troop', index: 594,
    ...
    {
        id: 'ts_601', ownerGeneralId: 'shuofang_weiqing', ownerName: '卫青', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'enhance', index: 601,
...
const UNIQUE_T1_GENERAL3: TacticalSkillEntry[] = [
    ...
    {
        id: 'ts_638', ownerGeneralId: 'xiongnu_maodun', ownerName: '冒顿', usageTag: '防御', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 638,
...
const UNIQUE_T0_REVISE: TacticalSkillEntry[] = [
    ...
    },
    {
        ...
        baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'opening_roll',
        magnitude: 0.8, engineStatus: 'ready', note: '鹤翼散击：鸳鸯分合散击',
    },
    {
...
const UNIQUE_T1_PRECISION: TacticalSkillEntry[] = [
    ...
    { id: 'ts_702', ownerName: '司马懿', ownerGeneralId: 'sima_d_simayi', layer: 'tactical', series: 'troop', index: 702, displayName: '倍道袭擒', sourceQuote: '【司马懿】《晋书·宣帝纪》：倍道兼行，八日抵新城，擒孟达。', baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops', magnitude: 0.08, engineStatus: 'ready', note: '【倍道袭擒】三势精修·优局' },
    ...
    { id: 'ts_714', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'troop', index: 714, displayName: '攻坚摧碉', ownerName: '阿桂', ownerGeneralId: 'agui', sourceQuote: '【阿桂】清平大小金川以火炮攻坚摧碉堡。', baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops', magnitude: 0.08, engineStatus: 'ready' },
    { id: 'ts_715', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'troop', index: 715, displayName: '矫制绝诛', ownerName: '陈汤', ownerGeneralId: 'quli_chentang', sourceQuote: '【陈汤】《汉书·陈汤传》：矫诏发兵灭郅支单于。', baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops', magnitude: 0.08, engineStatus: 'ready' },
    ...
    { id: 'ts_725', ownerName: '班超', ownerGeneralId: 'xiyuduhu_banchao', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'troop', index: 725, displayName: '绝域摧锋', sourceQuote: '长途远征在极远之地摧破敌军，如侯君集灭高昌、班超定西域等。', baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops', magnitude: 0.08, engineStatus: 'ready' },
    ...
    { id: 'ts_737', usageTag: '攻击', situationTag: '均势', layer: 'tactical', series: 'troop', index: 737, displayName: '伏隘摧锋', ownerName: '韩信', ownerGeneralId: 'xianyu_hanxin', sourceQuote: '【韩信】《史记·淮阴侯列传》：井陉口狭，信背水为阵，诱赵空壁逐利，伏兵夺其壁，大破赵军。', baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'opening_roll', magnitude: 0.8, engineStatus: 'ready', note: '伏隘摧锋：井陉隘道破赵' },
    { id: 'ts_738', ownerName: '诸葛亮', ownerGeneralId: 'huizhou_zhugeliang', layer: 'tactical', series: 'fate', index: 738, displayName: '疑兵惑敌', sourceQuote: '疑兵惑敌', baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll', magnitude: 1, luckMin: 0.6, luckMax: 1.4, engineStatus: 'ready', note: '【疑兵惑敌】三势精修·均局' },
...
const UNIQUE_T1_EXPAND: TacticalSkillEntry[] = [
    ...
    { id: 'ts_748', usageTag: '双行', situationTag: '优势', layer: 'tactical', series: 'troop', index: 748, displayName: '围魏救赵', ownerName: '三十六计', sourceQuote: '【孙膑】《史记·孙子吴起列传》：攻其必救，解友军之围。', baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops', magnitude: 0.05, engineStatus: 'ready', note: '【胜战计·全】围魏救赵；三十六计' },
    { id: 'ts_749', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'troop', index: 749, displayName: '威震逍遥', ownerName: '张辽', ownerGeneralId: 'lu_zhangliao', sourceQuote: '【张辽】《三国志·张辽传》：逍遥津八百人冲孙权十万大营。', baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops', magnitude: 0.08, engineStatus: 'ready' },
    ...
    { id: 'ts_765', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'troop', index: 765, displayName: '火烧连营', ownerName: '陆逊', ownerGeneralId: 'yidou_luxun', sourceQuote: '【陆逊】《三国志·陆逊传》：夷陵之战火攻刘备七百里连营。', baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops', magnitude: 0.08, engineStatus: 'ready' },
    ...
    { id: 'ts_769', ownerName: '王允', layer: 'tactical', series: 'counter', index: 769, displayName: '连环妙计', sourceQuote: '《三十六计》将多兵众，不可以敌，使其自累，化解半数攻势', baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'opening_roll', magnitude: 0.4, engineStatus: 'ready' },
    { id: 'ts_770', ownerName: '诸葛亮', ownerGeneralId: 'huizhou_zhugeliang', layer: 'tactical', series: 'troop', index: 770, displayName: '锦囊妙计', situationTag: '优势', sourceQuote: '《三国演义》诸葛亮预留锦囊，在关键时刻化解敌方计谋', baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops', magnitude: 0.08, engineStatus: 'ready', note: '同源：诸葛亮·演义锦囊' },
    ...
    { id: 'ts_775', ownerName: '韩非子', layer: 'tactical', series: 'counter', index: 775, displayName: '兵不厌诈', sourceQuote: '《韩非子·难一》战阵之间，不厌诈伪，以此看破敌方诡计', baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'opening_roll', magnitude: 0.4, engineStatus: 'ready' },
    ...
    { id: 'ts_795', ownerName: '左宗棠', layer: 'tactical', series: 'casualty', index: 795, displayName: '西北固守', sourceQuote: '《弥兰陀王问经》背景：米南德据西北印度华氏城固守，威震诸邦。', baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive', magnitude: 0.1, engineStatus: 'ready', note: '【米南德】势create·劣局专属' },
    ...
    { id: 'ts_802', usageTag: '防御', situationTag: '均势', layer: 'tactical', series: 'fate', index: 802, displayName: '疏勒孤忠', ownerName: '耿恭', ownerGeneralId: 'chagatai_genggong', sourceQuote: '【耿恭】《后汉书·耿恭传》：孤军守疏勒城凿山得泉，十三将士归玉门。', baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll', magnitude: 1.5, luckMin: 0.6, luckMax: 1.4, engineStatus: 'ready' },
    ...
    { id: 'ts_810', layer: 'tactical', series: 'fate', index: 810, displayName: '料敌机先', ownerName: '孙膑', ownerGeneralId: 'dongxian_sunbin', sourceQuote: '【孙膑】《史记》：马陵道预判庞涓行程设伏', baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll', magnitude: 1.0, luckMin: 0.6, luckMax: 1.4, engineStatus: 'ready', note: '【孙膑】绝品·专属·一人一张·原主复活' },
    { id: 'ts_811', layer: 'tactical', series: 'counter', index: 811, displayName: '长平合围', ownerName: '白起', ownerGeneralId: 'xin_baiqi', sourceQuote: '《三十六计·混战计》：“小敌困之。”（白起·长平合围）', baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'opening_roll', magnitude: 0.8, engineStatus: 'ready', note: '【白起】绝品·专属·长平围歼典故' },
    { id: 'ts_812', ownerName: '曹操', ownerGeneralId: 'cao_d_caocao', usageTag: '双行', situationTag: '均势', layer: 'tactical', series: 'counter', index: 812, displayName: '乌巢断粮', sourceQuote: '《三十六计·混战计》：“不敌其力，而消其势。”（曹操·乌巢烧粮）', baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'opening_roll', magnitude: 0.8, engineStatus: 'ready', note: '【曹操】绝品·专属·乌巢断粮典故' },
    { id: 'ts_813', layer: 'tactical', series: 'counter', index: 813, displayName: '辕门射戟', ownerName: '吕布', ownerGeneralId: 'pizhou_lvbu', sourceQuote: '《三国志·吕布传》：布于沛城设宴，树戟于营门，一箭中戟小支，慑退纪灵三万兵。', baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'opening_roll', magnitude: 0.8, engineStatus: 'ready', note: '【吕布】绝品·专属·辕门射戟原主' },
    {
...
export const TACTICAL_ASSIGN_TIER: Readonly<Record<string, TacticalAssignTier>> = {
    ...
    ts_315: 'common', ts_316: 'common', ts_317: 'common', ts_318: 'common',
    ...
    ts_570: 'limited', ts_571: 'limited', ts_572: 'limited', ts_573: 'limited',
    ...
    ts_801: 'underdog', ts_802: 'gamble', ts_806: 'underdog', ts_807: 'limited',
