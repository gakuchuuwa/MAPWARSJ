...
const TROOP: TacticalSkillEntry[] = [
    ...
    }起 negate 按 magnitude 概率触发，修复此前必否决 bug）',
    },
    {
...
const UNIQUE_T1: TacticalSkillEntry[] = [
    ...
    },
    {
        ...
        baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.05, engineStatus: 'ready',
    }lways', phase: 'pre_opening_troops',
        magnitude: 0.05, engineStatus: 'ready',
    },
    {
...
const UNIQUE_T1_GENERAL: TacticalSkillEntry[] = [
    ...
    }.7, luckMax: 1.3,engineStatus: 'ready',
        note: '【李定国】T1精锐·三势精修·势reverse·均局专属',
    },
    {
...
const UNIQUE_T1_PRECISION: TacticalSkillEntry[] = [
    ...
    { id: 'ts_732', ownerName: '杨业', ownerGeneralId: 'heng1_yangye', usageTag: '双行', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 732, displayName: '断后殉节', sourceQuote: '陈家谷', baseEffect: 'lose_enemy_casualty_boost', condition: 'always', phase: 'post_battle', magnitude: 1.25, engineStatus: 'ready', note: '【断后殉节】三势精修·劣局' }5, engineStatus: 'ready', note: '【断后殉节】三势精修·劣局' },
...
const UNIQUE_T1_EXPAND: TacticalSkillEntry[] = [
    ...
    { id: 'ts_762', ownerName: '周瑜', ownerGeneralId: 'jiujiang_zhouyu', usageTag: '双行', situationTag: '均势', layer: 'tactical', series: 'counter', index: 762, displayName: '借东风势',  sourceQuote: '《三国演义》诸葛亮借东风，窃取天时为己方火攻之利', baseEffect: 'steal_enemy_skill', condition: 'always', phase: 'opening_roll', magnitude: 0.5, engineStatus: 'ready' }ll', condition: 'always', phase: 'opening_roll', magnitude: 0.5, engineStatus: 'ready' },
    ...
    { id: 'ts_766', ownerName: '武则天', ownerGeneralId: 'wuzhou_d_wuzetian', usageTag: '双行', situationTag: '均势', layer: 'tactical', series: 'counter', index: 766, displayName: '请君入瓮', sourceQuote: '《资治通鉴》周兴酷吏被来俊臣以其人之道还治其人之身', baseEffect: 'reflect_enemy_opening_cut', condition: 'always', phase: 'opening_roll', magnitude: 1, engineStatus: 'ready' }ing_cut', condition: 'always', phase: 'opening_roll', magnitude: 1, engineStatus: 'ready' },
