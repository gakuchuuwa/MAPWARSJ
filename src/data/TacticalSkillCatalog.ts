...
const ENHANCE: TacticalSkillEntry[] = [
    ...
    {
        id: 'ts_008', usageTag: '攻击', situationTag: '劣势', ownerName: '周瑜', ownerGeneralId: 'jiujiang_zhouyu', layer: 'tactical', series: 'enhance', index: 8,
...
const FATE: TacticalSkillEntry[] = [
    ...
    {
        id: 'ts_020', ownerName: '秦穆公', ownerGeneralId: null, usageTag: '攻击', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 20,
...
const UNIQUE_T0: TacticalSkillEntry[] = [
    ...
    {
        id: 'ts_059', ownerName: '成吉思汗', ownerGeneralId: 'menggu_d_chengjisihan', layer: 'tactical', series: 'counter', index: 59,
        displayName: '长生天佑', situationTag: '劣势', sourceQuote: '大蒙古国圣旨固定起首：“长生天气力里，大福荫护助里”。（成吉思汗）',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.5, engineStatus: 'ready',
...
const UNIQUE_T1: TacticalSkillEntry[] = [
    ...
    {
        id: 'ts_072', ownerName: '张辽', ownerGeneralId: 'lu_zhangliao', usageTag: '攻击', situationTag: '劣势', layer: 'tactical', series: 'enhance', index: 72,
    ...
    },
    {
        ...
        magnitude: 1.05, engineStatus: 'ready'},
    {
        id: 'ts_085', ownerName: '完颜宗弼', ownerGeneralId: 'jurchen_wanyanzongbi', layer: 'tactical', series: 'enhance', index: 85,
        displayName: '铁甲冲突', situationTag: '优势', sourceQuote: '【完颜宗弼】金兀术率铁浮屠重甲骑兵冲锋陷阵',
        baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.09, engineStatus: 'ready',
    }g_troops',
        magnitude: 0.09, engineStatus: 'ready',
    ...
    {
        id: 'ts_102', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'enhance', index: 102,
    ...
    },
    {
        ...
        displayName: '草木皆兵', sourceQuote: '【谢玄】《晋书·谢玄传》：淝水之战秦军溃败，草木皆兵风声鹤唳。',
        baseEffect: 'ally_power_mult', condition: 'ratio_underdog', phase: 'opening_roll',
        magnitude: 1.1, engineStatus: 'ready',
    },
    {
    ...
    {
        id: 'ts_165', usageTag: '攻击', situationTag: '均势', layer: 'tactical', series: 'troop', index: 165,
        displayName: '减灶诱歼', sourceQuote: '【孙膑】《史记·孙子吴起列传》：马陵道减灶示弱诱庞涓深入设伏全歼。',
        baseEffect: 'ally_add_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.1, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '孤骑擒将', sourceQuote: '【辛弃疾】《宋史·辛弃疾传》：率五十骑突入五万金营擒叛将张安国。',
        baseEffect: 'ally_power_mult', condition: 'ratio_underdog', phase: 'opening_roll',
        magnitude: 1.1, engineStatus: 'ready',
    },
    {
    ...
    {
        id: 'ts_297', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'enhance', index: 297,
    ...
    {
        id: 'ts_309', usageTag: '攻击', situationTag: '劣势', layer: 'tactical', series: 'enhance', index: 309,
        displayName: '寡骑破众', sourceQuote: '【张辽】《三国志·张辽传》：逍遥津八百骑兵破孙权十万，寡骑破众。',
        baseEffect: 'ally_power_mult', condition: 'ratio_underdog', phase: 'opening_roll',
        magnitude: 1.1, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '设伏歼锐', sourceQuote: '【孙膑】《史记·孙子吴起列传》：马陵设伏歼灭魏军精锐。',
        baseEffect: 'ally_add_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.1, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '百骑劫营', sourceQuote: '【甘宁】《三国志·甘宁传》：百骑夜劫曹营不折一人，以寡击众。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.25, engineStatus: 'ready',
    },
    {
    ...
    {
        id: 'ts_341', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'enhance', index: 341,
    ...
    },
    {
        ...
        displayName: '闻鸡起舞', sourceQuote: '【祖逖】《晋书·祖逖传》：闻鸡起舞立志北伐，虽处劣势不坠其志。',
        baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive',
        magnitude: 0.3, engineStatus: 'ready',
    },
    {
    ...
    {
        id: 'ts_386', usageTag: '防御', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 386,
        displayName: '拔刀刺山', sourceQuote: '【耿恭】《后汉书·耿恭传》：疏勒城拔刀刺山飞泉，绝境求生。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.25, engineStatus: 'ready',
    },
    {
...
const UNIQUE_T1_GENERAL: TacticalSkillEntry[] = [
    ...
    },
    {
        ...
        displayName: '长围断援', sourceQuote: '【白起】《史记·白起列传》：长平围赵绝其粮道与援兵，长围断援。',
        baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.05,engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '据险摧锋', sourceQuote: '【吴玠】《宋史·吴玠传》：和尚原据险要摧破金军先锋。',
        baseEffect: 'ally_add_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.1, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '屡蹶振击', sourceQuote: '【刘备】《三国志·先主传》：屡败屡战折而不挠，屡蹶振击。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.25, engineStatus: 'ready',
    },
    {
...
const UNIQUE_T1_GENERAL2: TacticalSkillEntry[] = [
    ...
    },
    {
        ...
        displayName: '复土摧敌', sourceQuote: '【祖逖】《晋书·祖逖传》：北伐收复失地，中流击楫。',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.05, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '以弱摧强', sourceQuote: '【谢玄】《晋书·谢玄传》：淝水之战以寡敌众，以弱摧强。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.25, engineStatus: 'ready',
    },
    {
    ...
    {
        id: 'ts_564', ownerName: '赵武灵王', ownerGeneralId: 'lingqiu_zhaowuling', layer: 'tactical', series: 'enhance', index: 564,
        displayName: '胡服摧阵', situationTag: '优势', sourceQuote: '赵武灵王专题记载',
        baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.09, engineStatus: 'ready',
    ...
    },
    {
        ...
        displayName: '持重挫敌', sourceQuote: '【廉颇】《史记·廉颇列传》：长平持重对峙，挫秦军锐气。',
        baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll',
        magnitude: 1, luckMin: 0.7, luckMax: 1.3,engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '奇兵斩首', sourceQuote: '【关羽】《三国志·关羽传》：白马之战斩颜良，奇兵斩首。',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.05, engineStatus: 'ready',
    },
    {
...
const UNIQUE_T1_GENERAL3: TacticalSkillEntry[] = [
    ...
    {
        id: 'ts_632', usageTag: '防御', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 632,
        displayName: '闭垒疲敌', sourceQuote: '【司马懿】《晋书·宣帝纪》：对蜀闭垒不出，消耗蜀军。',
        baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive',
        magnitude: 0.3, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '伪病懈敌', sourceQuote: '【司马懿】《晋书·宣帝纪》：诈病骗曹爽，使其松懈后夺权。',
        baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll',
        magnitude: 1, luckMin: 0.7, luckMax: 1.3,engineStatus: 'ready',
    },
    {
    ...
    {
        id: 'ts_652', ownerName: '班超', ownerGeneralId: 'xiyuduhu_banchao', layer: 'tactical', series: 'counter', index: 652,
        displayName: '纵火乱敌', situationTag: '优势', sourceQuote: '《史传》班超：于阗趁夜纵火扰乱趁乱攻杀',
        baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.09, engineStatus: 'ready',
    ...
    },
    {
        ...
        displayName: '坚壁挫敌', sourceQuote: '【廉颇】《史记·廉颇列传》：长平之战坚壁挫秦军锐气。',
        baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive',
        magnitude: 0.3, engineStatus: 'ready',
    },
    {
    ...
    {
        id: 'ts_655', usageTag: '防御', situationTag: '均势', layer: 'tactical', series: 'fate', index: 655,
...
const SANSHILIU: TacticalSkillEntry[] = [
    ...
    },
    {
        ...
        displayName: '隔岸观火', sourceQuote: '【曹操】观袁尚袁谭相争，坐收渔利，隔岸观火。',
        baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll',
        magnitude: 1, luckMin: 0.7, luckMax: 1.3, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '借尸还魂', sourceQuote: '【刘备】借荆州为基业，借尸还魂之策，劣势翻盘。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.25, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '反客为主', sourceQuote: '三十六计之并战计，变被动为主动，劣势时用，多将皆有。',
        baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive',
        magnitude: 0.3, engineStatus: 'ready',
    },
    {
...
const UNIQUE_T0_REVISE: TacticalSkillEntry[] = [
    ...
    },
    {
        ...
        displayName: '溃围突冲', situationTag: '均势', sourceQuote: '【张辽】《三国志》：合肥八百人溃围突冲孙权大营',
        baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'opening_roll',
        magnitude: 0.7, engineStatus: 'ready',
        note: '【刘秀】T0精锐·reverse·势劣局专属（三势精修）',
    }ote: '【刘秀】T0精锐·reverse·势劣局专属（三势精修）',
    },
    {
    ...
    {
        id: 'ts_444', ownerName: '李世民', ownerGeneralId: 'tang_lishimin', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'enhance', index: 444,
...
const UNIQUE_T1_PRECISION: TacticalSkillEntry[] = [
    ...
    { id: 'ts_722', layer: 'tactical', series: 'fate', index: 722, displayName: '孤军渡江', situationTag: '均势', sourceQuote: '孤军渡江', baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll', magnitude: 1, luckMin: 0.7, luckMax: 1.3, engineStatus: 'ready', note: '【孤军渡江】三势精修·劣局' },
...
const UNIQUE_T1_EXPAND: TacticalSkillEntry[] = [
    ...
    { id: 'ts_749', ownerName: '张辽', ownerGeneralId: 'lu_zhangliao', usageTag: '攻击', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 749, displayName: '威震逍遥', sourceQuote: '【张辽】《三国志·张辽传》：逍遥津八百人冲孙权十万大营。', baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll', magnitude: 1, luckMax: 1.5, luckMin: 0.5, engineStatus: 'ready' } 1, luckMax: 1.5, luckMin: 0.5, engineStatus: 'ready' },
