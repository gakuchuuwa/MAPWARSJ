...
const UNIQUE_T1: TacticalSkillEntry[] = [
    ...
    },
    {
        ...
        displayName: '示弱诱歼', sourceQuote: '《史记·廉颇蔺相如列传》：“李牧多为奇陈……大破杀匈奴十余万骑。”',
        baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.05, engineStatus: 'ready'},
    {
    ...
    {
        id: 'ts_159', ownerName: '诸葛亮', ownerGeneralId: 'huizhou_zhugeliang', usageTag: '双行', situationTag: '均势', layer: 'tactical', series: 'fate', index: 159,
    ...
    },
    {
        ...
        displayName: '裹毡疾进', sourceQuote: '【邓艾】《三国志·邓艾传》：阴平道裹毡而下，翻越天险灭蜀。',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.1, engineStatus: 'ready',
    },
    {
        id: 'ts_163', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'enhance', index: 163,
        displayName: '白袍破阵', sourceQuote: '【陈庆之】《梁书·陈庆之传》：七千白袍横扫中原，以少打多攻克洛阳。',
        baseEffect: 'ally_power_mult', condition: 'ratio_underdog', phase: 'opening_roll',
        magnitude: 1.1, engineStatus: 'ready',
    },
    {
        id: 'ts_164', usageTag: '攻击', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 164,
        displayName: '火牛奔冲', sourceQuote: '【田单】《史记·田单列传》：即墨火牛阵大破燕军，绝地翻盘复国。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.5, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '无当拒锋', sourceQuote: '【王平】蜀汉无当飞军以步制骑，拒敌锋锐。',
        baseEffect: 'ally_power_mult', condition: 'ratio_underdog', phase: 'opening_roll',
        magnitude: 1.1, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '风林火山', sourceQuote: '【武田信玄】日本战国武田家军旗，其疾如风，其徐如林，侵掠如火，不动如山。',
        baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll',
        magnitude: 1, luckMin: 0.7, luckMax: 1.3, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '诱敌疲歼', sourceQuote: '【周亚夫】《史记·绛侯周勃世家》：平七国之乱坚壁不出断敌粮道，待敌疲后一举击破。',
        baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.05, engineStatus: 'ready',
    },
    {
        id: 'ts_174', usageTag: '防御', situationTag: '劣势', layer: 'tactical', series: 'enhance', index: 174,
        displayName: '却月破骑', sourceQuote: '【刘裕】《宋书·武帝纪》：却月阵背水以步制骑，大破北魏铁骑。',
        baseEffect: 'ally_power_mult', condition: 'ratio_underdog', phase: 'opening_roll',
        magnitude: 1.1, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '聚米制胜', sourceQuote: '【马援】《后汉书·马援传》：聚米为山指画地形，沙盘推演料敌制胜。',
        baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll',
        magnitude: 1, luckMin: 0.7, luckMax: 1.3, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '百骑劫营', sourceQuote: '【甘宁】《三国志·甘宁传》：率百骑夜劫曹营，不折一人而还。',
        baseEffect: 'ally_add_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.1, engineStatus: 'ready',
    },
    {
        id: 'ts_181', usageTag: '攻击', situationTag: '均势', layer: 'tactical', series: 'troop', index: 181,
        displayName: '雪夜奇袭', sourceQuote: '【李愬】《旧唐书·李愬传》：雪夜入蔡州擒吴元济。',
        baseEffect: 'ally_add_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.1, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '愈挫愈奋', sourceQuote: '【刘备】《三国志·先主传》：屡败屡战折而不挠，终建蜀汉。',
        baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive',
        magnitude: 0.3, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '狭路争锋', sourceQuote: '【赵奢】《史记·廉颇蔺相如列传》：阏与之战狭路相逢勇者胜。',
        baseEffect: 'ally_power_mult', condition: 'ratio_underdog', phase: 'opening_roll',
        magnitude: 1.1, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '劲弩番射', sourceQuote: '强弩轮番射击压制敌军，秦弩兵、吴玠驻队矢等常用战术。',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.05, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '一箭落雕', sourceQuote: '【斛律光】《北齐书·斛律光传》：射落大雕箭术无双，号落雕都督。',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.05, engineStatus: 'ready',
    ...
    },
    {
        ...
        displayName: '驱徒成军', sourceQuote: '【章邯】《史记·秦始皇本纪》：率骊山囚徒成军镇压陈胜起义。',
        baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive',
        magnitude: 0.3, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '汲水凝冰', sourceQuote: '【杨延昭】《宋史·杨延昭传》：汲水灌城凝冰守遂城，坚不可上。防御典范。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.25, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '胡服骑射', sourceQuote: '【赵武灵王】《史记·赵世家》：推行胡服骑射改革强军。',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.05, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '三箭慑虏', sourceQuote: '【薛仁贵】《旧唐书·薛仁贵传》：三箭定天山。',
        baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.05, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '率部破柔', sourceQuote: '【拓跋珪】《魏书·太祖纪》：率部击破柔然。',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.05, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '收众奋击', sourceQuote: '【石勒】《晋书·石勒载记》：收拢流民奋击建后赵。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.25, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '勇决破众', sourceQuote: '【英布】《史记·黥布列传》：以勇猛决绝破秦军。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.25, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '连岁抗虏', sourceQuote: '【岳飞】连年北伐抗金，持续抵抗外敌。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.25, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '五郡连兵', sourceQuote: '【窦融】《后汉书·窦融传》：东汉初经营河西五郡联兵。',
        baseEffect: 'luck_variance_enemy', condition: 'always', phase: 'opening_roll',
        magnitude: 1, luckMin: 0.7, luckMax: 1.3, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '白杆勤王', sourceQuote: '【秦良玉】《明史·秦良玉传》：率白杆兵北上勤王抗清。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.25, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '火燔连营', sourceQuote: '【陆逊】《三国志·陆逊传》：夷陵之战火烧刘备七百里连营。',
        baseEffect: 'ally_add_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.1, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '车悬奔冲', sourceQuote: '【上杉谦信】日本战国车悬阵轮番冲锋破敌。',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.05, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '逾岭袭国', sourceQuote: '翻越山岭袭击敌国，如邓艾偷渡阴平、司马错灭蜀等。',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.05, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '凭险摧锐', sourceQuote: '【吴玠】《宋史·吴玠传》：和尚原据险大破金军精锐。',
        baseEffect: 'ally_add_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.1, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '孤守绝域', sourceQuote: '【郭昕】《旧唐书·郭昕传》：安西都护孤守龟兹数十年。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.25, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '孤城却众', sourceQuote: '【耿恭】《后汉书·耿恭传》：疏勒孤城却匈奴数万众。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.25, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '并力诛渠', sourceQuote: '【石勒】《晋书·石勒载记》：集中兵力诛杀王浚等割据首领。',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.05, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '扼险歼师', sourceQuote: '【吴玠】《宋史·吴玠传》：和尚原据险大歼金军。',
        baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.05, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '劫营破敌', sourceQuote: '【甘宁】《三国志·甘宁传》：百骑夜劫曹营不折一人，以寡击众。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.25, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '聚众摧军', sourceQuote: '【陈胜】《史记·陈涉世家》：揭竿聚众摧毁秦军。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.25, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '远驱破国', sourceQuote: '【苏定方】《旧唐书·苏定方传》：远征千里灭西突厥。',
        baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.05, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '泛海夺城', sourceQuote: '【郑成功】《清史稿·郑成功传》：跨海收复台湾。',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.05, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '收众摧锋', sourceQuote: '【石勒】《晋书·石勒载记》：收拢流民奋击摧敌。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.25, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '威震绝域', sourceQuote: '【班超】《后汉书·班超传》：定远西域，威震绝域。',
        baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.05, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '深入捣巢', sourceQuote: '【霍去病】《史记·卫将军骠骑列传》：深入漠北捣匈奴王庭。',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.05, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '复土摧坚', sourceQuote: '【祖逖】《晋书·祖逖传》：北伐收复失地，中流击楫。',
        baseEffect: 'ally_power_mult', condition: 'ratio_underdog', phase: 'opening_roll',
        magnitude: 1.1, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '保境安民', sourceQuote: '【钱镠】《旧五代史·钱镠传》：吴越国王修筑海塘保境安民。',
        baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive',
        magnitude: 0.3, engineStatus: 'ready',
    },
    {
        id: 'ts_388', usageTag: '攻击', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 388,
        displayName: '孤胆陷阵', sourceQuote: '【吕布】《三国志·吕布传》：以骁勇闻名，常单骑冲阵，孤胆陷阵。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.25, engineStatus: 'ready',
    },
...
const UNIQUE_T1_GENERAL: TacticalSkillEntry[] = [
    {
        ...
        displayName: '合围攻心', sourceQuote: '【白起】《史记·白起列传》：长平之战围困赵军瓦解其心。',
        baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.05, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '诈北设伏', sourceQuote: '【冒顿】《史记·匈奴列传》：白登之围前佯败诱汉军入伏。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.25, engineStatus: 'ready',
    },
    {
...
const UNIQUE_T1_GENERAL2: TacticalSkillEntry[] = [
    ...
    },
    {
        ...
        displayName: '鸳鸯阵摧', sourceQuote: '【戚继光】《明史·戚继光传》：鸳鸯阵抗倭，以步制骑。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.25, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '号令摧阵', sourceQuote: '【孙武】《史记·孙子吴起列传》：斩美姬整肃军纪，号令摧阵。',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.05, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '倾国摧坚', sourceQuote: '【王翦】《史记·白起王翦列传》：灭楚倾全国兵力，倾国摧坚。',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.05, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '遣间离敌', sourceQuote: '【田单】《史记·田单列传》：反间计使燕王换将乐毅，遣间离敌。',
        baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive',
        magnitude: 0.3, engineStatus: 'ready',
    },
    {
...
const UNIQUE_T1_GENERAL3: TacticalSkillEntry[] = [
    {
        ...
        displayName: '鸦军突陷', sourceQuote: '【李克用】《旧五代史·武皇纪》：沙陀鸦儿军冲锋陷阵。',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.05, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '佯北诈截', sourceQuote: '【冒顿】《史记·匈奴列传》：白登之围前佯败诱汉军。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.25, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '间道奇袭', sourceQuote: '【邓艾】《三国志·邓艾传》：偷渡阴平小道灭蜀，间道奇袭。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.25,engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '庙算先胜', sourceQuote: '【孙武】《孙子兵法·计篇》：夫未战而庙算胜者，得算多也。',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.05, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '袭帐破阵', sourceQuote: '【李靖】《旧唐书·李靖传》：趁夜袭破颉利可汗牙帐。',
        baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll',
        magnitude: 1.05, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '以寡破盟', sourceQuote: '【项羽】《史记·项羽本纪》：巨鹿之战以少胜多破诸侯联军。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.25, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '虎穴夺机', sourceQuote: '【班超】《后汉书·班超传》：不入虎穴，焉得虎子。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.25, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '深垒耗锐', sourceQuote: '【廉颇】《史记·廉颇列传》：深沟高垒，消耗秦军锐气。',
        baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive',
        magnitude: 0.3, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '励志克城', sourceQuote: '【耿弇】《后汉书·耿弇传》：激励将士，攻克强敌。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.25, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '凭坚歼锋', sourceQuote: '【袁崇焕】《明史·袁崇焕传》：宁远之战凭坚城歼敌先锋。',
        baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.05, engineStatus: 'ready',
    },
    {
...
const SANSHILIU: TacticalSkillEntry[] = [
    ...
    },
    {
        ...
        displayName: '指桑骂槐', sourceQuote: '【孙武】《史记·孙子吴起列传》：斩美姬整肃军纪，指桑骂槐立威。',
        baseEffect: 'win_casualty_reduction', condition: 'always', phase: 'mid_battle_passive',
        magnitude: 0.3, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '反间除帅', sourceQuote: '【田单】《史记·田单列传》：反间计使燕惠王换将，乐毅去而骑劫来。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'always', phase: 'post_battle',
        magnitude: 1.25, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '连环离间', sourceQuote: '【王允】《后汉书·王允传》：连环计结吕布诛董卓。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'always', phase: 'post_battle',
        magnitude: 1.25, engineStatus: 'ready',
    },
    {
...
const UNIQUE_T0_REVISE: TacticalSkillEntry[] = [
    ...
    },
    {
        ...
        displayName: '白袍摧阵', sourceQuote: '【陈庆之】《梁书·陈庆之传》：七千白袍横扫中原，以少打多攻克洛阳。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.25, engineStatus: 'ready',
    },
    {
    ...
    },
    {
        ...
        displayName: '潮截归路', sourceQuote: '【村上武吉】日本村上水军利用潮汐截断敌船归路。',
        baseEffect: 'ally_add_troops_opening', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.1, engineStatus: 'ready',
    },
    {
        id: 'ts_440', layer: 'tactical', series: 'enhance', index: 440,
        displayName: '风涛火攻', sourceQuote: '【黄盖】赤壁之战乘风纵火，伏兵遏击曹军水师。',
        baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'pre_opening_troops',
        magnitude: 0.15, engineStatus: 'ready',
...
const UNIQUE_T1_ZHAO: TacticalSkillEntry[] = [
    ...
    },
    {
        ...
        displayName: '死士逆摧', sourceQuote: '【田单】《史记·田单列传》：火牛阵死士突袭破燕军。',
        baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive',
        magnitude: 1.25, engineStatus: 'ready',
    },
    {
...
const UNIQUE_T1_PRECISION: TacticalSkillEntry[] = [
    { id: 'ts_686', usageTag: '防御', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 686, displayName: '据险持重', sourceQuote: '【廉颇】《史记·廉颇列传》：长平坚壁拒王龁，据险持重。', baseEffect: 'win_casualty_reduction', condition: 'ratio_underdog', phase: 'mid_battle_passive', magnitude: 0.3, engineStatus: 'ready' },
    ...
    { id: 'ts_693', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'enhance', index: 693, displayName: '绝漠追袭', sourceQuote: '【霍去病】《史记·卫将军骠骑列传》：漠北封狼居胥，绝漠追袭。', baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll', magnitude: 1.05, engineStatus: 'ready' },
    ...
    { id: 'ts_704', usageTag: '防御', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 704, displayName: '据垒固守', sourceQuote: '【周亚夫】《史记·绛侯周勃世家》：细柳营据垒固守。', baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive', magnitude: 1.25, engineStatus: 'ready' },
    ...
    { id: 'ts_706', usageTag: '攻击', situationTag: '均势', layer: 'tactical', series: 'troop', index: 706, displayName: '钓野诱歼', sourceQuote: '【岛津家久】日本战国岛津家"钓野伏"诱敌合围。', baseEffect: 'ally_add_troops_opening', condition: 'always', phase: 'pre_opening_troops', magnitude: 0.1, engineStatus: 'ready' },
    { id: 'ts_707', usageTag: '防御', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 707, displayName: '草人诱射', sourceQuote: '【张巡】《新唐书·张巡传》：睢阳草人借箭，智守孤城。', baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive', magnitude: 1.25, engineStatus: 'ready' },
    ...
    { id: 'ts_709', usageTag: '防御', situationTag: '均势', layer: 'tactical', series: 'troop', index: 709, displayName: '据险摧敌', sourceQuote: '【王坚】《宋史·王坚传》：钓鱼城据险毙蒙哥。', baseEffect: 'ally_add_troops_opening', condition: 'always', phase: 'pre_opening_troops', magnitude: 0.1, engineStatus: 'ready' },
    ...
    { id: 'ts_714', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'enhance', index: 714, displayName: '攻坚摧碉', sourceQuote: '【阿桂】清平大小金川以火炮攻坚摧碉堡。', baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll', magnitude: 1.05, engineStatus: 'ready' },
    { id: 'ts_715', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'enhance', index: 715, displayName: '矫制绝诛', sourceQuote: '【陈汤】《汉书·陈汤传》：矫诏发兵灭郅支单于。', baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll', magnitude: 1.05, engineStatus: 'ready' },
    ...
    { id: 'ts_737', usageTag: '攻击', situationTag: '均势', layer: 'tactical', series: 'troop', index: 737, displayName: '伏隘摧锋', sourceQuote: '【孙膑】《史记·孙子吴起列传》：马陵道隘口伏击庞涓。', baseEffect: 'ally_add_troops_opening', condition: 'always', phase: 'pre_opening_troops', magnitude: 0.1, engineStatus: 'ready' },
...
const UNIQUE_T1_EXPAND: TacticalSkillEntry[] = [
    ...
    { id: 'ts_746', usageTag: '攻击', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 746, displayName: '白马救围', sourceQuote: '【公孙瓒】《后汉书·公孙瓒传》：白马义从驰援解围。', baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive', magnitude: 1.25, engineStatus: 'ready' },
    ...
    { id: 'ts_756', usageTag: '双行', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 756, displayName: '单刀赴会', sourceQuote: '【关羽】《三国志·关羽传》：单刀赴鲁肃宴，胆略脱身。', baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive', magnitude: 1.25, engineStatus: 'ready' },
    ...
    { id: 'ts_765', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'troop', index: 765, displayName: '火烧连营', sourceQuote: '【陆逊】《三国志·陆逊传》：夷陵之战火攻刘备七百里连营。', baseEffect: 'enemy_sub_troops_opening', condition: 'always', phase: 'pre_opening_troops', magnitude: 0.05, engineStatus: 'ready' },
    ...
    { id: 'ts_770', layer: 'tactical', series: 'enhance', index: 770, displayName: '锦囊妙计', ownerName: '诸葛亮', ownerGeneralId: 'huizhou_zhugeliang', sourceQuote: '《三国演义》诸葛亮预留锦囊，在关键时刻化解敌方计谋', baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll', magnitude: 0.25, engineStatus: 'ready' },    { id: 'ts_772', usageTag: '防御', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 772, displayName: '割须弃袍', sourceQuote: '【曹操】潼关之战败逃割须弃袍，虽狼狈亦得以脱身。', baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive', magnitude: 1.25, engineStatus: 'ready' },
    { id: 'ts_773', layer: 'tactical', series: 'counter', index: 773, displayName: '辕门射戟', sourceQuote: '《三国志·吕布传》吕布射戟解纪灵之围，强行中止敌方攻势', baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'opening_roll', magnitude: 0.25, status: 'retired', engineStatus: 'ready' },
    ...
    // ── 帝王专属 ──
    { id: 'ts_806', usageTag: '防御', situationTag: '劣势', layer: 'tactical', series: 'casualty', index: 806, displayName: '日月重开', sourceQuote: '【于谦】《明史·于谦传》：北京保卫战扭转乾坤，日月重开。', baseEffect: 'lose_enemy_casualty_boost', condition: 'ratio_underdog', phase: 'mid_battle_passive', magnitude: 1.5, engineStatus: 'ready' },
    { id: 'ts_807', usageTag: '攻击', situationTag: '优势', layer: 'tactical', series: 'enhance', index: 807, displayName: '开皇一统', sourceQuote: '【杨坚】《隋书·高祖纪》：灭陈统一，结束三百年分裂。', baseEffect: 'ally_power_mult', condition: 'always', phase: 'opening_roll', magnitude: 1.05, engineStatus: 'ready' },
    // ── 战斗时长 ──
    ...
    { id: 'ts_811', layer: 'tactical', series: 'counter', index: 811, displayName: '长平合围', sourceQuote: '《三十六计·混战计》：“小敌困之。”（白起·长平合围）', baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'opening_roll', magnitude: 1.0, engineStatus: 'ready', note: '【白起】绝品·专属·长平围歼典故' },
