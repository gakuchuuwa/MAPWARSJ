...
const TROOP: TacticalSkillEntry[] = [
    ...
    {
        id: 'ts_027', ownerGeneralId: 'xianyu_hanxin', situationTag: '优势', usageTag: '攻击', layer: 'tactical', series: 'troop', index: 27,
        displayName: '四面楚歌', ownerName: '韩信', sourceQuote: '【张良】《史记·项羽本纪》：汉军及诸侯兵围项羽垓下；夜闻汉军四面皆楚歌，项王大惊。',
...
const UNIQUE_T1: TacticalSkillEntry[] = [
    ...
    {
        id: 'ts_066', ownerName: '郅支单于', ownerGeneralId: 'xijue_ganyanshou', usageTag: '双行', situationTag: '均势', layer: 'tactical', series: 'enhance', index: 66,
...
const UNIQUE_T1_PRECISION: TacticalSkillEntry[] = [
    { id: 'ts_686', usageTag: '防御', situationTag: '均势', layer: 'tactical', series: 'counter', index: 686, displayName: '据险持重', sourceQuote: '【王翦】《史记·白起王翦列传》：翦将六十万伐楚，据垒坚壁，岁余不动，待楚兵罢乃击。', baseEffect: 'negate_enemy_skill', condition: 'always', phase: 'mid_battle_passive', magnitude: 0.8, engineStatus: 'ready',
...
const UNIQUE_T1_EXPAND: TacticalSkillEntry[] = [
    ...
    { id: 'ts_760', ownerGeneralId: 'jiujiang_zhouyu', usageTag: '双行', ownerName: '周瑜', layer: 'tactical', series: 'counter', index: 760, displayName: '将计就计', situationTag: '均势', sourceQuote: '《尚书·武成》牧野之战商军前徒倒戈，敌军战术反助我方', baseEffect: 'steal_enemy_skill', condition: 'always', phase: 'opening_roll', magnitude: 0.5, engineStatus: 'ready' },
