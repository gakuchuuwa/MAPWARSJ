...
export const FACTION_GENERALS: Readonly<Record<string, FactionGeneral>> = {
    ...
    aersasi: { generalId: 'gen_julian_apostate', generalName: '尤里安', portrait: '/assets/LATIN/aersasi_youlian.png' },
    molaweiya: { generalId: 'gen_swatopluk', generalName: '斯瓦托', portrait: '/assets/SLAVIC/molaweiya_siwatuo.png' },
    damolaweiya: { generalId: 'gen_mojmir_i', generalName: '莫伊米尔', portrait: '/assets/SLAVIC/damolaweiya_moyimier.png' },
