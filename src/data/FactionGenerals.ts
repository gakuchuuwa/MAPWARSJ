...
// ── 江南区 2026-06-18 ──
  ...
  aba: { generalId: 'aba_shapuer', generalName: '沙普尔', portrait: '/assets/CENTRAL_ASIA/aba_shapuer.png' },
    ...
    liaozu: { generalId: 'liaozu_saitatila', generalName: '赛塔提腊', portrait: '' },
    kushi: { generalId: 'kushi_amanilunnasi', generalName: '阿玛尼伦纳斯', portrait: '' },
    aimala: { generalId: 'aimala_katali', generalName: '卡塔里', portrait: '' },
    aolisha: { generalId: 'aolisha_anatabamo', generalName: '阿纳塔跋摩', portrait: '' },
    kanata: { generalId: 'kanata_lamalaya', generalName: '拉玛拉亚', portrait: '' },
    adile: { generalId: 'adile_adilesha', generalName: '阿迪勒沙', portrait: '' },
    foluolida: { generalId: 'foluolida_meinendeshi', generalName: '梅嫩德斯', portrait: '' },
    fujisi: { generalId: 'fujisi_fujiweng', generalName: '福基翁', portrait: '' },
    yilisi: { generalId: 'yilisi_yifeituosi', generalName: '伊菲托斯', portrait: '' },
    nuowei: { generalId: 'nuowei_halaer', generalName: '哈拉尔', portrait: '' },
    keernuwaye: { generalId: 'keernuwaye_geladelong', generalName: '格拉德隆', portrait: '' },
    aodesuosi: { generalId: 'aodesuosi_aodesuosi', generalName: '奥德索斯', portrait: '' },
    disidelusi: { generalId: 'disidelusi_disidelusi', generalName: '蒂斯德鲁斯', portrait: '' },
    yisatisi: { generalId: 'yisatisi_yisatisi', generalName: '伊萨提斯', portrait: '' },
    wuer: { generalId: 'wuer_wuernamu', generalName: '乌尔纳姆', portrait: '' },
    pidisha: { generalId: 'pidisha_pidisha', generalName: '毗底沙', portrait: '' },
    jiaye: { generalId: 'jiaye_jiaye', generalName: '伽耶', portrait: '' },
    jienei: { generalId: 'jienei_jienei', generalName: '杰内', portrait: '' },
    kuertaiya: { generalId: 'kuertaiya_kuertaiya', generalName: '库尔泰亚', portrait: '' },
