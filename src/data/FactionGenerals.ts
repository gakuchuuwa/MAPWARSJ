...
export const FACTION_GENERALS: Readonly<Record<string, FactionGeneral>> = {
    ...
    kanpaniya: { generalId: 'gen_charles_i_naples', generalName: '卡洛', portrait: '/assets/generals/gen_charles_i_naples.png' },
    jiatailuoniya: { generalId: 'gen_wifred_hairy', generalName: '威弗雷德', portrait: '/assets/generals/gen_wifred_hairy.png' },
    nasier: { generalId: 'gen_muhammad_i', generalName: '穆罕默德', portrait: '/assets/generals/gen_muhammad_i.png' },
