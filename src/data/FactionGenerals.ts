...
export const FACTION_GENERALS: Readonly<Record<string, FactionGeneral>> = {
    ...
    luodesi: { generalId: 'gen_demetrius', generalName: '波里奥克特', portrait: '/assets/LATIN/luodesi_boliaokete.png' },
    kelite: { generalId: 'gen_minos', generalName: '米诺斯', portrait: '/assets/LATIN/kelite_minuosi.png' },
    ...
    lagusa: { generalId: 'gen_dragan', generalName: '德拉甘', portrait: '/assets/LATIN/lagusa_delagan.png' },

    ruidian_yota: { generalId: 'gen_charles_ix', generalName: '卡尔九世', portrait: '/assets/GERMANIC/ruidian_yota_kaerjiushi.png' },
    meikelunbao: { generalId: 'gen_henry_borwin', generalName: '亨利波罗', portrait: '/assets/GERMANIC/meikelunbao_hengliboluo.png' },
    ...
    yidelisi: { generalId: 'gen_idris_i', generalName: '伊德里斯', portrait: '/assets/CENTRAL_ASIA/yidelisi_yidelisi.png' },
    qiekase: { generalId: 'gen_vyshnevetsky', generalName: '维什尼奥', portrait: '/assets/SLAVIC/qiekase_weishenniao.png' },
    saierdika: { generalId: 'gen_krum', generalName: '克鲁姆', portrait: '/assets/SLAVIC/saierdika_kelumu.png' },
    bosiniya: { generalId: 'gen_tvrtko', generalName: '特夫尔特科', portrait: '/assets/LATIN/bosiniya_tefuerteke.png' },

    mulabite: { generalId: 'gen_tashfin', generalName: '塔什芬', portrait: '/assets/CENTRAL_ASIA/mulabite_tashenfen.png' },

    zhibuluotuo: { generalId: 'gen_henry_navigator', generalName: '恩里克', portrait: '/assets/CENTRAL_ASIA/zhibuluotuo_enlike.png' },
    zhayan: { generalId: 'gen_yaghmurasen', generalName: '亚里摩罗', portrait: '/assets/CENTRAL_ASIA/zhayan_yalimoluo.png' },
    babali: { generalId: 'gen_barbarossa', generalName: '巴巴罗萨', portrait: '/assets/CENTRAL_ASIA/babali_babaluosa.png' },
    hamade: { generalId: 'gen_hammad', generalName: '哈马德', portrait: '/assets/CENTRAL_ASIA/hamade_hamade.png' },
    buni: { generalId: 'gen_hannibal', generalName: '汉尼拔', portrait: '/assets/LATIN/buni_hanniba.png' },
    aguelabu: { generalId: 'gen_uqba', generalName: '奥克巴', portrait: '/assets/CENTRAL_ASIA/aguelabu_aokeba.png' },
    telibolisi: { generalId: 'gen_dragut', generalName: '德拉古特', portrait: '/assets/CENTRAL_ASIA/telibolisi_delagute.png' },
    ...
    langgeduoke: { generalId: 'gen_raymond_v', generalName: '雷蒙五世', portrait: '/assets/GERMANIC/langgeduoke_leimengwushi.png' },
    aermolika: { generalId: 'gen_gilles_de_rais', generalName: '吉尔德雷斯', portrait: '/assets/GERMANIC/aermolika_jierdeleisi.png' },
    ...
    weijing_york: { generalId: 'gen_eric_bloodaxe', generalName: '血斧埃里克', portrait: '/assets/GERMANIC/weijing_york_xuefuailike.png' },
    kanbuliya: { generalId: 'gen_william_wallace', generalName: '威廉·华莱士', portrait: '/assets/GERMANIC/kanbuliya_weilianhualaishi.png' },
    gaolu_luoma: { generalId: 'gen_clovis_i', generalName: '克洛维', portrait: '/assets/GERMANIC/gaolu_luoma_keluowei.png' },
    aquidan: { generalId: 'gen_black_prince', generalName: '黑太子', portrait: '/assets/GERMANIC/aquidan_heitaizi.png' },
    puluowangsi: { generalId: 'gen_raymond_iv', generalName: '雷蒙四世', portrait: '/assets/GERMANIC/puluowangsi_leimengsishi.png' },
    lunbadi: { generalId: 'gen_sforza', generalName: '斯福尔扎', portrait: '/assets/GERMANIC/lunbadi_sifuerzha.png' },
    donggete: { generalId: 'gen_theodoric_great', generalName: '狄奥多里克', portrait: '/assets/GERMANIC/donggete_diaoduolike.png' },
    xigete: { generalId: 'gen_alfonso_vi', generalName: '阿方索六世', portrait: '/assets/GERMANIC/xigete_afangsuoliushi.png' },
    andaluoxiya: { generalId: 'gen_abd_al_rahman_iii', generalName: '阿卜杜拉', portrait: '/assets/CENTRAL_ASIA/andaluoxiya_abudula.png' },
    alagong: { generalId: 'gen_james_i_aragon', generalName: '海梅', portrait: '/assets/GERMANIC/alagong_haimei.png' },
    shaiyue: { generalId: 'gen_dobo_istvan', generalName: '多博伊', portrait: '/assets/GERMANIC/shaiyue_duoboyi.png' },

    nuosi: { generalId: 'gen_olaf_tryggvason', generalName: '奥拉夫', portrait: '/assets/GERMANIC/nuosi_aolafu.png' },
    feiniqi: { generalId: 'gen_hamilcar', generalName: '哈米尔卡', portrait: '/assets/LATIN/feiniqi_hamierka.png' },
    xila: { generalId: 'gen_themistocles', generalName: '地米斯托克利', portrait: '/assets/LATIN/xila_dimisituokeli.png' },
    xilagu: { generalId: 'gen_city_syracuse', generalName: '阿加索克利', portrait: '/assets/LATIN/xilagu_ajiasuokeli.png' },
    fulandesi: { generalId: 'gen_robert_ii', generalName: '罗贝尔二世', portrait: '/assets/GERMANIC/fulandesi_luobeierershi.png' },
    gaolu: { generalId: 'gen_charles_vii', generalName: '查理七世', portrait: '/assets/GERMANIC/gaolu_chaliqishi.png' },
    ...
    bulietani: { generalId: 'gen_alain_i', generalName: '阿兰', portrait: '/assets/GERMANIC/bulietani_alan.png' },
    ...
    putaoya: { generalId: 'gen_afonso_henriques', generalName: '阿方索', portrait: '/assets/generals/gen_afonso_henriques.png' },

    habusibao: { generalId: 'gen_maximilian', generalName: '马克西米', portrait: '/assets/generals/gen_maximilian.png' },
    ...
    shiwaben: { generalId: 'gen_henry_fowler', generalName: '亨利', portrait: '/assets/generals/gen_henry_fowler.png' },
    asikanani: { generalId: 'gen_albrecht_bear', generalName: '阿尔布雷', portrait: '/assets/generals/gen_albrecht_bear.png' },
    ...
    mozeer: { generalId: 'gen_constantine_great', generalName: '君士坦丁', portrait: '/assets/generals/gen_constantine_great.png' },
    ...
    molaweiya: { generalId: 'gen_swatopluk', generalName: '斯瓦托', portrait: '/assets/generals/gen_swatopluk.png' },
    damolaweiya: { generalId: 'gen_mojmir_i', generalName: '莫伊米尔', portrait: '/assets/generals/gen_mojmir_i.png' },

    luosi: { generalId: 'gen_yaroslav', generalName: '雅罗斯拉夫', portrait: '/assets/generals/gen_yaroslav.png' },
    liulike: { generalId: 'gen_alexander_nef', generalName: '涅夫斯基', portrait: '/assets/generals/gen_alexander_nef.png' },
    mosike_gongguo: { generalId: 'gen_dmitry_donskoy', generalName: '顿斯科伊', portrait: '/assets/generals/gen_dmitry_donskoy.png' },
    fulajimier_gongguo: { generalId: 'gen_andrey_bogolyub', generalName: '安德烈', portrait: '/assets/generals/gen_andrey_bogolyub.png' },
    daniebo: { generalId: 'gen_romshlav', generalName: '罗姆什拉夫', portrait: '/assets/generals/gen_romshlav.png' },
    qiernigeweifu_gongguo: { generalId: 'gen_mstislav', generalName: '姆斯蒂', portrait: '/assets/generals/gen_mstislav.png' },
    jialixiya: { generalId: 'gen_daniel_galitsky', generalName: '丹尼尔', portrait: '/assets/generals/gen_daniel_galitsky.png' },
    pusikefu_gongheguo: { generalId: 'gen_daumantas', generalName: '道曼塔斯', portrait: '/assets/generals/gen_daumantas.png' },
    ouka: { generalId: 'gen_yuri_ryazan', generalName: '尤里', portrait: '/assets/generals/gen_yuri_ryazan.png' },
    xideweina: { generalId: 'gen_breslav', generalName: '布列斯拉夫', portrait: '/assets/generals/gen_breslav.png' },
    jinzhang: { generalId: 'gen_batu', generalName: '拔都', portrait: '/assets/generals/gen_batu.png' },
    baojiaer: { generalId: 'gen_ulugh_muhammad', generalName: '兀鲁黑', portrait: '/assets/generals/gen_ulugh_muhammad.png' },
    baizanting: { generalId: 'gen_vladimir_great', generalName: '弗拉基米尔', portrait: '/assets/generals/gen_vladimir_great.png' },
    taolika: { generalId: 'gen_aspurgus', generalName: '阿斯普尔格斯', portrait: '/assets/generals/gen_aspurgus.png' },
    kelimiya: { generalId: 'gen_haci_giray', generalName: '哈吉格来', portrait: '/assets/generals/gen_haci_giray.png' },
    dajiya: { generalId: 'gen_decebalus', generalName: '德切巴鲁斯', portrait: '/assets/generals/gen_decebalus.png' },
    mengtainiya: { generalId: 'gen_basarab_i', generalName: '巴萨拉布', portrait: '/assets/generals/gen_basarab_i.png' },
    litaowan: { generalId: 'gen_gediminas', generalName: '格迪米纳斯', portrait: '/assets/generals/gen_gediminas.png' },
    bolan: { generalId: 'gen_jogaila', generalName: '雅盖沃', portrait: '/assets/generals/gen_jogaila.png' },
    piyasite: { generalId: 'gen_casimir_great', generalName: '卡齐米日', portrait: '/assets/generals/gen_casimir_great.png' },
    baojian_qishi: { generalId: 'gen_albert_riga', generalName: '阿尔伯特', portrait: '/assets/generals/gen_albert_riga.png' },
    teweier_gongguo: { generalId: 'gen_mikhail_tver', generalName: '米哈伊尔', portrait: '/assets/generals/gen_mikhail_tver.png' },
    suzidaer: { generalId: 'gen_dmitry_suzdal', generalName: '康斯坦丁诺', portrait: '/assets/generals/gen_dmitry_suzdal.png' },
    gesake: { generalId: 'gen_bohdan_khmelnitsky', generalName: '赫梅利', portrait: '/assets/generals/gen_bohdan_khmelnitsky.png' },
    moerdaweiya: { generalId: 'gen_stephen_great', generalName: '斯蒂芬大帝', portrait: '/assets/generals/gen_stephen_great.png' },
    walajiyia: { generalId: 'gen_vlad_impaler', generalName: '弗拉德三世', portrait: '/assets/generals/gen_vlad_impaler.png' },
    tiaodun_qishi: { generalId: 'gen_ulrich_jungingen', generalName: '乌尔里希', portrait: '/assets/generals/gen_ulrich_jungingen.png' },
    liwoniya: { generalId: 'gen_prettenberg', generalName: '普雷特贝格', portrait: '/assets/generals/gen_prettenberg.png' },
    chude: { generalId: 'gen_vyacheslav_tartu', generalName: '维切斯拉夫', portrait: '/assets/generals/gen_vyacheslav_tartu.png' },
    deniesite: { generalId: 'gen_mehmed_giray', generalName: '穆罕默德·格里', portrait: '/assets/generals/gen_mehmed_giray.png' },
    ...
    menggu_d: { generalId: 'menggu_d_chengjisihan', generalName: '铁木真', portrait: '/assets/STEPPE/menggu_d_chengjisihan.png' },
...
// ── 中亚区 2026-06-18 ──
    ...
    fanyanna: { generalId: 'fanyanna_xieer', generalName: '谢尔', portrait: '/assets/CENTRAL_ASIA/fanyanna_xieer.png' },
...
// ── 青藏区 2026-06-18 ──
  ...
  // ── 滇缅区 2026-06-18 ──
    ...
    wuman: { generalId: 'wuman_cuanguiwang', generalName: '爨归', portrait: '/assets/DIANQIAN/wuman_cuangui.png' },
...
// ── 江南区 2026-06-18 ──
    ...
    pyu: { generalId: 'pyu_moluo', generalName: '摩罗', portrait: '/assets/DIANQIAN/pyu_moluo.png' },
  ...
  xisi: { generalId: 'xisi_yakubusafaer', generalName: '雅库布', portrait: '/assets/CENTRAL_ASIA/xisi_yakubu.png' },
  ...
  aba: { generalId: 'aba_shapuer', generalName: '沙普尔', portrait: '/assets/CENTRAL_ASIA/aba_shapuer.png' },
    ...
    tuolemi: { generalId: 'tuolemi_tuolemi', generalName: '托勒密', portrait: '/assets/WEST_ASIA/tuolemi_tuolemi.png' },
    ...
    sumeier: { generalId: 'sumeier_jierjiameishen', generalName: '吉尔伽美什', portrait: '/assets/WEST_ASIA/sumeier_jierjiameishen.png' },
    ...
    xike: { generalId: 'xike_lanjite', generalName: '兰季特辛格', portrait: '/assets/CENTRAL_ASIA/xike_lanjite.png' },
    deli: { generalId: 'deli_alawuding', generalName: '阿拉乌丁', portrait: '/assets/CENTRAL_ASIA/deli_alawuding.png' },
    mowoer: { generalId: 'mowoer_akeba', generalName: '阿克巴', portrait: '/assets/CENTRAL_ASIA/mowoer_akeba.png' },
    jieri: { generalId: 'jieri_jieriwang', generalName: '哈尔沙', portrait: '/assets/CENTRAL_ASIA/jieri_jieriwang.png' },
    kongque: { generalId: 'kongque_zhantuoluo', generalName: '旃陀罗笈多', portrait: '/assets/CENTRAL_ASIA/kongque_zhantuoluojiduo.png' },
    mojietuo: { generalId: 'mojietuo_pinbisuoluo', generalName: '频毗娑罗', portrait: '/assets/CENTRAL_ASIA/mojietuo_pinpisuoluo.png' },
    boluo: { generalId: 'boluo_damoboluo', generalName: '达磨波罗', portrait: '/assets/CENTRAL_ASIA/boluo_damoboluo.png' },
    sumo: { generalId: 'sumo_sumowang', generalName: '苏摩', portrait: '/assets/CENTRAL_ASIA/sumo_sumowang.png' },
    jiashi_d: { generalId: 'jiashi_jiashiwang_d', generalName: '梵摩达', portrait: '/assets/CENTRAL_ASIA/jiashi_d_jiashiwang.png' },
