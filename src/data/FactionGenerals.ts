...
export const FACTION_GENERALS: Readonly<Record<string, FactionGeneral>> = {
    ...
    piyasite: { generalId: 'gen_boleslaw_brave', generalName: '勇者波列', portrait: '/assets/SLAVIC/piyasite_kaqimiri.png' },
...
// ── 江南区 2026-06-18 ──
  ...
  aba: { generalId: 'aba_shapuer', generalName: '沙普尔', portrait: '/assets/CENTRAL_ASIA/aba_shapuer.png' },
    ...
    inca: { generalId: 'gen_topa_inca', generalName: '图帕克', portrait: '/assets/AMERICA/inca_pachakuti.png' },
    ...
    samtskhe: { generalId: 'gen_sargis_jaqeli', generalName: '萨尔吉斯', portrait: '/assets/WEST_ASIA/samtskhe_sargis.png' },
    tomara_gwalior: { generalId: 'gen_man_singh_tomar', generalName: '曼辛格', portrait: '/assets/INDIA/tomara_mansingh.png' },
    tawantinsuyu: { generalId: 'gen_pachacuti', generalName: '帕查库提', portrait: '/assets/AMERICA/inca_pachakuti.png' },
    qutb_shahi: { generalId: 'gen_ibrahim_qutb', generalName: '易卜拉欣', portrait: '/assets/INDIA/qutb_ibrahim.png' },
    minangkabau: { generalId: 'gen_adityawarman', generalName: '阿迪蒂亚', portrait: '/assets/MALAY/minangkabau_aditya.png' },
