...
export const FACTION_GENERALS: Readonly<Record<string, FactionGeneral>> = {
    ...
    manzheboyi: { generalId: 'gen_gajah_mada', generalName: '加查马达', portrait: '' },
    zhelouqi: { generalId: 'gen_prithviraj', generalName: '普里特维', portrait: '' },
    suosuo: { generalId: 'gen_sumanguru', generalName: '苏曼古鲁', portrait: '' },
    antiaokegongguo: { generalId: 'gen_bohemond', generalName: '博希蒙德', portrait: '' },
    aoerlianggongguo: { generalId: 'gen_joanofarc', generalName: '贞德', portrait: '' },
    jinquehua: { generalId: 'gen_edward_longshanks', generalName: '长腿爱德华', portrait: '' },
    ...
    aiduoniya: { generalId: 'gen_brasidas', generalName: '巴西达斯', portrait: '' },
    qiesuonisuosi: { generalId: 'gen_lysander', generalName: '吕山德', portrait: '' },
    mixiya: { generalId: 'gen_parmenion', generalName: '帕曼纽', portrait: '' },
    xiaaiji: { generalId: 'gen_perdiccas', generalName: '佩尔狄卡斯', portrait: '' },
    kaliya: { generalId: 'gen_artemisia', generalName: '阿尔特米西亚', portrait: '' },
    bosidiguo: { generalId: 'gen_artaphernes', generalName: '阿尔塔弗涅斯', portrait: '' },
    jikelazes: { generalId: 'gen_aristides', generalName: '阿里斯提德', portrait: '' },
    adiyabeina: { generalId: 'gen_cleitus', generalName: '克雷图斯', portrait: '' },
    youbeiya: { generalId: 'gen_datis', generalName: '达提斯', portrait: '' },
    zeta: { generalId: 'gen_carpini', generalName: '柏朗嘉宾', portrait: '' },
    haerjijiji: { generalId: 'gen_philip_ii', generalName: '腓力二世', portrait: '' },
    telakaigongguo: { generalId: 'gen_kestutis', generalName: '科斯图提斯', portrait: '' },
    duobuluojia: { generalId: 'gen_ivaylo', generalName: '伊瓦伊洛', portrait: '' },
    aertai: { generalId: 'gen_kuchlug', generalName: '屈出律', portrait: '' },
    kumanni: { generalId: 'gen_kotyan', generalName: '忽炭汗', portrait: '' },
    xikuman: { generalId: 'gen_girgen', generalName: '吉尔根汗', portrait: '' },
    feierganna: { generalId: 'gen_qutlugh', generalName: '忽都鲁', portrait: '' },
    qibucha: { generalId: 'gen_pacanchiq', generalName: '帕坎奇克', portrait: '' },
    tamoyue: { generalId: 'gen_cunhambebe', generalName: '昆汉贝贝', portrait: '' },
    naweierbuta: { generalId: 'gen_galvarino', generalName: '加尔瓦里诺', portrait: '' },
    alaokaniya: { generalId: 'gen_guacolda', generalName: '瓜科尔达', portrait: '' },
    bogendigongguo: { generalId: 'gen_john_fearless', generalName: '无畏的约翰', portrait: '' },
    amaniyake: { generalId: 'gen_bernard_armagnac', generalName: '贝尔纳·德·阿马尼亚克', portrait: '' },
    geluositeboguo: { generalId: 'gen_gilbert', generalName: '吉尔伯特', portrait: '' },
    baerta: { generalId: 'gen_alaric', generalName: '亚拉里克', portrait: '' },
    saiputimanniya: { generalId: 'gen_ataulf', generalName: '阿陶尔夫', portrait: '' },
    bogengnidielan: { generalId: 'gen_philip_good', generalName: '好人菲利普', portrait: '' },
    gewennesi: { generalId: 'gen_dafydd', generalName: '戴菲德', portrait: '' },
    weiershigongguo: { generalId: 'gen_llywelyn', generalName: '卢埃林', portrait: '' },
    huanzhou: { generalId: 'gen_dinhle', generalName: '丁礼', portrait: '' },
...
// ── 江南区 2026-06-18 ──
  ...
  aba: { generalId: 'aba_shapuer', generalName: '沙普尔', portrait: '/assets/CENTRAL_ASIA/aba_shapuer.png' },
    ...
    zhuluo: { generalId: 'zhuluo_lajialajia', generalName: '拉贾拉贾一世', portrait: '' },
    ...
    yisatisi: { generalId: 'yisatisi_yisatisi', generalName: '伊萨提斯', portrait: '/assets/CENTRAL_ASIA/yisatisi_yisatisi.png' },
