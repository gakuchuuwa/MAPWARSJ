...
export const FACTION_GENERALS: Readonly<Record<string, FactionGeneral>> = {
    ...
    andaluoxiya: { generalId: 'gen_abd_al_rahman_iii', generalName: '拉赫曼三世', portrait: '/assets/generals/gen_abd_al_rahman_iii.png' },
    ...
    deniesite: { generalId: 'gen_yuri_galitsky', generalName: '尤里大公', portrait: '/assets/generals/gen_yuri_galitsky.png' },
