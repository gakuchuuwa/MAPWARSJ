...
export const FACTION_GENERALS: Readonly<Record<string, FactionGeneral>> = {
    ...
    bing: { generalId: 'bing_liukun', generalName: '李勣', portrait: '/assets/litang/bing_liji.png' },
    ...
    xinluo: { generalId: 'xinluo_jinyixin', generalName: '金庾信', portrait: '/assets/KOREA/xinluo_jinyixin.png' },
    ...
    chenla: { generalId: 'chenla_sheyebamoqishi', generalName: '阇耶跋摩七世', portrait: '/assets/DIANQIAN/chenla_sheyebamoqishi.png' },
    ...
    totomi: { generalId: 'totomi_sakaitadatsugu', generalName: '酒井忠次', portrait: '/assets/JAPAN/totomi_jiujingzhongci.png' },
...
// ── 东北区 2026-06-18 ──
    ...
    hezhe: { generalId: 'hezhe_sharhuda', generalName: '沙尔虎达', portrait: '/assets/NORTHEAST/hezhe_sharhuda.png' },
    dawoer: { generalId: 'dawoer_baldaqi', generalName: '巴尔达齐', portrait: '/assets/NORTHEAST/dawoer_baldaqi.png' },
    ...
    jurchen: { generalId: 'jurchen_wanyanzongbi', generalName: '完颜宗弼', portrait: '/assets/NORTHEAST/jurchen_wanyanzongbi.png' },
        // ── 草原关隘 ──
    wuzhou: { generalId: 'wuzhou_liguang', generalName: '李牧', portrait: '/assets/STEPPE/wuzhou_liguang.png' },
...
// ── 草原区 2026-06-18 ──
    ...
    merkit: { generalId: 'merkit_tuoheituoa', generalName: '伯颜', portrait: '/assets/STEPPE/merkit_tuoheituoa.png' },
    tumed: { generalId: 'tumed_andahan', generalName: '俺答汗', portrait: '/assets/STEPPE/tumed_andahan.png' },
    ...
    zhasaketu: { generalId: 'zhasaketu_zhasaketuhan', generalName: '扎萨克素巴第', portrait: '/assets/STEPPE/zhasaketu_zhasaketuhan.png' },
    ...
    chahar: { generalId: 'chahar_lindanhan', generalName: '燕帖木儿', portrait: '/assets/STEPPE/chahar_lindanhan.png' },
    ...
    chagatai: { generalId: 'chagatai_tuhulutiemuer', generalName: '耿恭', portrait: '/assets/liuhan/chagatai_genggong.png' },
    huihu: { generalId: 'huihu_dongmohedagan', generalName: '顿莫贺达干', portrait: '/assets/STEPPE/huihu_dongmohedagan.png' },
    kelie: { generalId: 'kelie_zhaheganbu', generalName: '札合敢不', portrait: '/assets/STEPPE/kelie_zhaheganbu.png' },
    pugu: { generalId: 'pugu_ashinagudulu', generalName: '阿史那骨咄禄', portrait: '/assets/STEPPE/pugu_ashinagudulu.png' },
    pulei: { generalId: 'pulei_dougu', generalName: '窦固', portrait: '/assets/STEPPE/pulei_dougu.png' },
    xibo_d: { generalId: 'xibo_d_zakulan', generalName: '图伯特', portrait: '/assets/STEPPE/xibo_d_zakulan.png' },
...
// ── 西域区 2026-06-18 ──
    ...
    yarkand: { generalId: 'yarkand_abuladitifu', generalName: '阿卜杜拉提夫', portrait: '/assets/WESTERN/yarkand_abuladitifu.png' },
    yiduhu: { generalId: 'yiduhu_baershu', generalName: '巴尔术阿而忒', portrait: '/assets/WESTERN/yiduhu_baershu.png' },
    ...
    kala: { generalId: 'kala_satuke', generalName: '萨图克博格拉', portrait: '/assets/WESTERN/kala_satuke.png' },
    ...
    xiliao: { generalId: 'xiliao_yelvdashi', generalName: '耶律大石', portrait: '/assets/WESTERN/xiliao_yeldashi.png' },
...
// ── 中亚区 2026-06-18 ──
    ...
    anushidgin: { generalId: 'anushidgin_yile', generalName: '伊勒阿尔斯兰', portrait: '/assets/CENTRAL_ASIA/anushidgin_yile.png' },
    ...
    maer_d: { generalId: 'maer_d_bahelamuchubin', generalName: '巴赫拉姆楚宾', portrait: '/assets/CENTRAL_ASIA/maer_d_bahelamuchubin.png' },
    wugu_d: { generalId: 'wugu_d_tugelile', generalName: '图格里勒', portrait: '/assets/CENTRAL_ASIA/wugu_d_tugelile.png' },
    adao_d: { generalId: 'adao_d_mafushou', generalName: '马福寿', portrait: '/assets/CENTRAL_ASIA/adao_d_mafushou.png' },
    wuyuan_d: { generalId: 'wuyuan_d_chengui', generalName: '陈龟', portrait: '/assets/STEPPE/wuyuan_d_chengui.png' },
...
// ── 青藏区 2026-06-18 ──
    ...
    xiadun: { generalId: 'xiadun_xiazhongawanglangjie', generalName: '夏仲阿旺朗杰', portrait: '/assets/TIBET/xiadun_xiazhongawanglangjie.png' },
    ...
    xiutu: { generalId: 'xiutu_xiutuwang', generalName: '金日磾', portrait: '/assets/TIBET/xiutu_jinridi.png' },
    ...
    pingnan: { generalId: 'pingnan_musheng', generalName: '沐晟', portrait: '/assets/daming/pingnan_musheng.png' }, // 腾越城·镇守云南
  ...
  // ── 岭南/越南/台湾区 2026-06-18 ──
    ...
    yingzhou: { generalId: 'yingzhou_liulong_ying', generalName: '刘龑', portrait: '/assets/LINGNAN/yingzhou_liulong_ying.png' },
    ...
    li_lx_d: { generalId: 'li_lx_d_lichong', generalName: '李广', portrait: '/assets/liuhan/li_lx_d_liguang.png' },
    li_s: { generalId: 'li_s_mayuan', generalName: '高骈', portrait: '/assets/litang/li_s_gaopian.png' },
    ...
    agui: { generalId: 'agui', generalName: '阿桂', portrait: '/assets/manqing/agui.png' },
...
// ── 巴蜀区 2026-06-18 ──
  ...
  // ── 河西区 2026-06-18 ──
    ...
    wudu: { generalId: 'wudu_zhangyi', generalName: '邓艾', portrait: '/assets/BASHU/wudu_zhangyi.png' },
    ...
    didao: { generalId: 'didao_duanjiong', generalName: '王韶', portrait: '/assets/zhaosong/didao_wangshao.png' },
...
// ── 中原区 2026-06-18 ──
    ...
    wazhai: { generalId: 'wazhai_limi_wz', generalName: '章邯', portrait: '/assets/yingqin/wazhai_zhanghan.png' },
    ...
    liwang: { generalId: 'liwang_liguangbi', generalName: '李光弼', portrait: '/assets/litang/liwang_liguangbi.png' }, // 河间·乐成
    ...
    liguo: { generalId: 'liguo_wangmeng', generalName: '赵奢', portrait: '/assets/xianqin/liguo_zhaoshe.png' },
    ...
    xinping: { generalId: 'lingwu_guoziyi', generalName: '郭子仪', portrait: '/assets/litang/lingwu_guoziyi.png' },
    ...
    hao_d: { generalId: 'hao_d_changyuchun', generalName: '韦睿', portrait: '/assets/JIANGNAN/hao_d_weirui.png' },
...
// ── 江南区 2026-06-18 ──
    ...
    taizhou: { generalId: 'li_bian', generalName: '李昪', portrait: '/assets/JIANGNAN/li_bian.png' },
    ...
    mi_chu: { generalId: 'mi_chu_chuzhuangwang', generalName: '熊旅', portrait: '/assets/xianqin/mi_chu_xiongl.png' },
    ...
    danyang: { generalId: 'danyang_yuyunwen', generalName: '桓温', portrait: '/assets/JIANGNAN/danyang_huanwen.png' },
    chizhou: { generalId: 'chizhou_wumingche', generalName: '常遇春', portrait: '/assets/JIANGNAN/chizhou_wumingche.png' },
    ...
    dian: { generalId: 'dian_duanjianwei', generalName: '段俭魏', portrait: '/assets/DIANQIAN/dian_duanjianwei.png' },
    ...
    guzgan: { generalId: 'guzgan_abulihalisi', generalName: '阿布哈里斯', portrait: '/assets/CENTRAL_ASIA/guzgan_abulihalisi.png' },
    ...
    badakhshan: { generalId: 'badakhshan_luozhentan', generalName: '雅尔贝格', portrait: '/assets/CENTRAL_ASIA/badakhshan_luozhentan.png' },
  ...
  baha: { generalId: 'baha_gaiwamu', generalName: '盖瓦姆', portrait: '/assets/CENTRAL_ASIA/baha_gaiwamu.png' },
    hali: { generalId: 'hali_subashi', generalName: '戈达尔兹', portrait: '/assets/CENTRAL_ASIA/hali_subashi.png' },
