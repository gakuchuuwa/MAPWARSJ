...
export const WEST_ASIA_EXPEDITION_ELITE_LEGIONS: Readonly<Record<string, EliteLegionConfig>> = {
    ...
    aosiruowen: { name: '伯国骑', tier: 3 },       // 埃德萨·鲍德温：十字军埃德萨伯国骑军（风土/建制符号；无独立战略大捷故 T3）
    shengdian_qishi: { name: '圣殿骑士', tier: 2 },  // 阿卡·德·莫莱：十字军东征百年主力（1119-1312），哈丁/阿卡战役；战例多败绩降T2与骑士团同档（2026-08-02）
