...
export const WEST_ASIA_EXPEDITION_ELITE_LEGIONS: Readonly<Record<string, EliteLegionConfig>> = {
    ...
    qiliqiya: { name: '罗马军团', tier: 2 },       // 阿达纳·庞培：前 67 年肃清奇里乞亚海盗、置行省，即其麾下军团
    ...
    dibisi: { name: '阿蒙军团', tier: 2 },         // 瓦塞特（底比斯）·图特摩斯：以阿蒙神命名的新王国常备军团，底比斯即阿蒙信仰中心；
    ...
    guyashu: { name: '古亚述战车', tier: 3 },      // 亚述城·沙姆希阿达：古亚述战车，兵种特色明确但战绩记载稀薄
