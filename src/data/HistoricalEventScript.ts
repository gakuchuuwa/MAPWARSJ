...
export const HISTORICAL_EVENT_SCRIPT: HistoricalEvent[] = [
    ...
    // ── 由战场事件编辑器生成（/battlefield-editor.html）──
    {
        ...
        briefing: '波斯小亚细亚诸总督几乎死绝，萨迪斯与以弗所相继开门归附。米利都守将赫格西斯特拉图斯本已答应献城，闻波斯舰队来援又反悔。尼卡诺尔抢先占住城外的莱德岛，波斯舰队只得在港外下锚；帕曼纽劝打海战，亚历山大回绝，只令舰队封港、陆军以投石机轰城。城破后亚历山大解散了海军。',
        type: 'siege',
        title: '公元前334年 米利都战役',
    ...
    // ── 由战场事件编辑器生成（/battlefield-editor.html）──
    {
        ...
        briefing: '米利都既下，门农退守卡里亚坚城哈利卡纳苏斯。',
        type: 'siege',
    ...
    //    引擎现成的 `SiegeManager.startSiegeWithArmy`（AI 攻城与野战战后链在用的同一个入口）。
    {
        ...
        briefing: '公元前332年孟春，亚历山大沿海岸南下腓尼基。推罗人拒绝亚历山大入城向守护神献祭，自恃海岛天险；亚历山大伐尽黎巴嫩山的雪松，在惊涛间筑起跨海长堤，又调塞浦路斯与腓尼基舰队封住南北两港。推罗以火船、弩炮死守，数月之后城破，波斯在地中海的海军基地就此拔除。',
        commanderUnit: 'hero_mounted_alexander',   // 主将队：素材样貌为骑马的亚历山大
        inviteText: '朋友，你来得正好。推罗人拒绝我入城向推罗城的守护神献祭，自恃海岛天险、城高墙厚。我已下令伐尽黎巴嫩山的雪松，要在海上筑一道长堤，把推罗的海军一并拔掉。你可愿随我一同围城？',
        ...
        // 🔴 [2026-09-26 第三片史料到手后核] 路标用的「拉塔基亚」是拿沿海现成据点顶替史料里的比布鲁斯、西顿
        //    （库里没有那两座，按铁律不新建）；但拉塔基亚即古劳迪西亚，约前300 年塞琉古才建，**前332 年还不存在**
        //    —— 与「鲁西翁是中世纪地名」同一类毛病，故此城那一年不上图（路照走、寻路不受影响）。
        absentCities: ['city_latajiya'],
    ...
    // ── 由战场事件编辑器生成（/battlefield-editor.html）──
    {
        ...
        season: 2,
        generalId: 'gen_alexander_great',
        inviteText: '朋友，你来得正好。前头的推罗已经拿下，攻城器械也一并运到了。加沙这座城踞在通往埃及的大道上，巴提斯不肯低头——巴提斯以为一道高墙就能挡住我。你可愿随我再围此城？',
        ...
        briefing: '推罗既下，亚历山大南取埃及大道上的加沙。巴提斯凭高地坚城死守，马其顿军筑土山、架推罗器械破城而入，通往埃及的门户就此打开。',
    },
    {
        year: -331,
        ...
        commanderUnit: 'hero_mounted_alexander',   // 主将队：素材样貌为骑马的亚历山大
        inviteText: '朋友，你来得正好。大流士又派人来了，这回连女儿和半个帝国都舍得给——我都没要。大流士挑了块铲得干干净净的平野，好让镰刀战车跑起来。可惜大流士也给我留了一条路——波斯中军。你可愿随我走这一趟？',
