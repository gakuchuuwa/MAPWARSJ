...
export const HISTORICAL_EVENT_SCRIPT: HistoricalEvent[] = [
    ...
    //    英文维基「亚历山大战役」总表 Balkans 一栏的三场，亚历山大均亲统；开局年份随之由 -334 提前到 -335（GameConfig.TIME）。
    {
        ...
        fieldBattleData: {
            title: '海姆斯山战役',
            description: '公元前335年春，马其顿军北上平定色雷斯，到了海姆斯山下，自治的色雷斯人据守山脊、以大车为垒，要把车推下来冲散队伍；亚历山大令步兵遇车散开或伏地以盾覆身，弓手射乱其阵，方阵一路登顶，色雷斯人溃散。',
    ...
    },
    {
        ...
        sources: {
            ...
            route: { level: 'fact', text: '英文维基百科 Battle at Lyginus River（独立条目）与 Balkan campaign：海姆斯山（战车之战）之后亚历山大北入特里巴利人之地，于莱吉努斯河畔击破其军（3,000 人战死），西尔穆斯退守多瑙河中的波伊刻岛；亚历山大自拜占庭调船上溯，又渡多瑙河击盖塔人，随后闻伊利里亚之叛，折返西南经阿格里安人之地／派奥尼亚进兵佩利昂。游戏路线：自上一处战场（海姆斯山）→ 德鲁斯塔尔（多瑙河畔）→ 布加勒斯特（北岸）→ 索非亚 → 佩利昂；编辑器「行军路线实测」已跑。' },
    ...
    },
    {
        ...
        type: 'siege',
        title: '公元前335年 底比斯战役',
        description: '马其顿军取底比斯：佩利昂一战亚历山大负伤，希腊各地误传他已战死，底比斯流亡者回城鼓动起兵、围困卫城卡德米亚的马其顿守军；亚历山大日夜兼程急行军南下直抵城下，底比斯人拒绝和解，城破后被夷为平地，幸存者尽数卖为奴隶，希腊各邦从此不敢再动，亚历山大得以放手东征。',
        siegeData: {
            title: '底比斯战役',
