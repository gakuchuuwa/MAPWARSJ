...
export const HISTORICAL_EVENT_SCRIPT: HistoricalEvent[] = [
    ...
    },
    {
        ...
        briefing: '海姆斯山一战之后，亚历山大没有回头。他率军继续北上，据说一直打到了多瑙河边：先打散了特里巴利人，又用皮帐扎成筏子渡河，把对岸的格泰人吓退了。就在这时，西边传来急报——伊利里亚王克莱图斯起兵反了，陶兰提王格劳基亚斯也引兵来会合。克莱图斯占着佩利昂，那是伊利里亚人达萨雷提部的一座设防要塞，正扼着伊利里亚通往马其顿的山口；这道山口一丢，马其顿的西大门就敞开了，他南下平定希腊的路也会被截断。亚历山大立刻掉头南下，走的仍是腓力二世当年走熟的那条道——经阿格里安人之地与派奥尼亚。他要赶在两股伊利里亚人合兵之前兵临城下，因为这一仗一旦拖久，克莱图斯与格劳基亚斯就会合到一处。可开头并不顺：格劳基亚斯的援军先占了四周高地，马其顿军初攻不下，据说一度被逼回河对岸；城头上的伊利里亚人似乎也铁了心，据说他们刚祭过神——献了童男童女和黑羊，摆明了要死守。',
    ...
    },
    {
        ...
        briefing: '佩利昂城下，亚历山大负了伤。消息传到南方就变了样——据说他已经死了，雅典的德摩斯梯尼甚至找来一个人作证，说他亲眼看见了。底比斯的流亡者从雅典赶回城里，鼓动起兵，杀了亲马其顿的首领，把驻守卫城卡德米亚的马其顿兵团团围住；波斯大王的金钱也送到了，雅典答应出兵器相助，希腊各地眼看就要跟着倒向底比斯。亚历山大得报，立刻南下。他手边的兵并不算多，赌的是一个快字：赶在各邦把兵凑齐之前，先出现在底比斯城下。他在色萨利没有停留，过了温泉关便直入维奥蒂亚，一路上竟没有一个城邦把消息递出去。底比斯人看见城下的大军，还不肯相信来的是亚历山大，只当是安提帕特；维奥蒂亚诸城纷纷离底比斯而去，雅典按兵不动，斯巴达的援军走到科林斯地峡就停下了——底比斯只剩孤城一座。',
