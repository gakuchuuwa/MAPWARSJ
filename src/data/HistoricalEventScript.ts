...
export const HISTORICAL_EVENT_SCRIPT: HistoricalEvent[] = [
    ...
    //    英文维基「亚历山大战役」总表 Balkans 一栏的三场，亚历山大均亲统；开局年份随之由 -334 提前到 -335（GameConfig.TIME）。
    {
        ...
        inviteText: '朋友，你来得正好。我父亲腓力遇刺，北边的色雷斯人、伊利里亚人都以为马其顿换了个毛头小子，趁机作乱。渡海去打波斯之前，我得先让北境诸部知道谁是马其顿的王。前头就是海姆斯山，色雷斯人守在山脊上，还把大车连成一排，想等我们爬到半山就推下来。随我上山——车冲下来，就让开；来不及让，就趴下举盾，让车从盾上碾过去。',
        sources: {
    ...
    },
    {
        ...
        briefing: '公元前335年，海姆斯山一战之后，亚历山大率军继续北上，深入特里巴利人的领地，在莱吉努斯河畔大破特里巴利军；特里巴利人的王西尔穆斯退守多瑙河中的波伊刻岛，凭水自保。亚历山大从拜占庭调来战舰，溯多瑙河而上，又把随军的皮帐填上干草扎成筏子，全军一夜强渡，击溃了对岸的盖塔人，焚毁盖塔人的聚落——多瑙河畔的北境诸部自此不敢再轻举妄动。大军正在河畔休整，西边却传来伊利里亚叛乱的消息：克莱图斯占了佩利昂这座要塞，陶兰提国王格劳基亚斯也要引兵来会。亚历山大当即折返西南，穿过阿格里安人之地与派奥尼亚，沿索非亚一线急行军，直插佩利昂城下。',
    ...
    },
    {
        ...
        briefing: '公元前335年，佩利昂战局刚定，南方又起变故：雅典演说家德摩斯梯尼到处宣称亚历山大已死在北境，底比斯信了这话，起兵把马其顿驻军围困在卡德米亚卫城，坐等雅典与波斯来援。亚历山大不肯给诸邦观望的工夫，当即率大军日夜兼程南下，途经都城佩拉、跨过温泉关，兵临底比斯城下。',
    ...
    // ── 由战场事件编辑器生成（/battlefield-editor.html）──
    {
        ...
        season: 1,
        generalId: 'gen_alexander_great',
        inviteText: '朋友，你来得正好。前头就是米利都——伊奥尼亚最大的城。米利都守将赫格西斯特拉图斯本已答应把城交给我，听说波斯舰队要来，当场变了卦，如今只肯拿中立换我退兵，好让波斯人的船靠港。我不做这个买卖。你看好了：我拿投石机砸开米利都的墙，尼卡诺尔把港口封死，看那支舰队还能不能往城里送进一粒粮。你可愿随我打这一仗？',
        ...
        briefing: '格拉尼库斯河一仗打完，波斯在小亚细亚的总督几乎死绝，萨迪斯与以弗所相继开门投降。米利都守将赫格西斯特拉图斯本也答应献城，听说波斯舰队要来，又反悔了，只肯让米利都保持中立。亚历山大不肯讲这个价：先分兵去取伊奥尼亚尚未臣服的城镇，自率余部直趋米利都；尼卡诺尔抢先占住城外的莱德岛，把兵运上岛去。波斯舰队赶到时已迟了一步，只得在更远的米克利下锚。帕曼纽劝趁势打一场海战，亚历山大回绝了：马其顿的船少，水手也不如腓尼基与塞浦路斯人老练，输了更要动摇希腊本土。亚历山大只让舰队封住港口，陆军架起投石机轰击城墙，从缺口冲进城去；守军大多被歼，退到小岛上的希腊雇佣兵被亚历山大收编。此后亚历山大解散了自己的海军，改定一条大策：用陆军把波斯的海军基地逐个拔掉，让那支舰队无港可归。',
        type: 'siege',
        title: '公元前334年 米利都战役',
    ...
    // ── 由战场事件编辑器生成（/battlefield-editor.html）──
    {
        ...
        season: 2,
        generalId: 'gen_alexander_great',
        inviteText: '朋友，前头是哈利卡纳苏斯——卡里亚的坚城。门农在那里等着我——波斯在小亚细亚的新任总指挥，手里还攥着一支舰队，港里泊得满满的，摆明了要跟我耗。门农把城防加固过不止一遍，护城河又宽又深。你看着，我把壕填了、把投石机架上去，一段一段把哈利卡纳苏斯的墙打下来。你可愿随我打这一仗？',
        ...
        briefing: '米利都既下，波斯把兵力与希腊雇佣军一齐集中到卡里亚的哈利卡纳苏斯。罗德岛的门农受任小亚细亚总指挥、又统率波斯舰队，把城防处处加固，舰队就泊在港里，摆明要在这里与亚历山大耗下去。被废黜的卡里亚前女王阿妲带着仅剩的要塞阿林达来投，亚历山大收下阿妲，随即围城。填平护城河、架起投石机之后，波斯守军夜里出城烧器械，被马其顿军打退；此后连日轰城，守军不断出城反击，佩尔狄卡斯营中有人莽撞逼近城墙，引得双方大打一场，城墙被撞开一段，城里的泥瓦匠很快又砌起新墙。门农与欧戎托巴提斯见城墙已倒、伤兵日增，决意弃城：波斯残军趁夜退出，放火烧了城中军需，那夜风大，火把整座城吞了进去。亚历山大急令追击，又命人扑火、救护城中百姓；最后到手的不过是座残城。亚历山大留兵驻守，把卡里亚交给阿妲，继续东进。',
        type: 'siege',
    ...
    },
    {
        ...
        inviteText: '朋友，你来得正好。我在戈尔迪乌姆斩断了那个无人能解的结，传说解开它的人将成为亚细亚之王。大流士已在巴比伦集结大军，我要越过托罗斯山，进入奇里乞亚迎战大流士。你可愿随我同往？',
        // 🔴 [2026-09-23] 资料清单：每项依据与可信级别（src/data/eventSources.ts）
        sources: { battle: { level: 'fact', text: '英文维基百科 Battle of Issus：伊苏斯战役，野战，两军在皮纳鲁斯河两岸会战。' }, time: { level: 'fact', text: '英文维基百科 Battle of Issus 信息框：公元前333年11月5日，季节取秋。' }, place: { level: 'fact', text: '英文维基百科 Battle of Issus：伊苏斯城以南的皮纳鲁斯河，今土耳其哈塔伊省；坐标取信息框 36.7525,36.1923。海湾到群山之间仅2.6公里。' }, attacker: { level: 'fact', text: '英文维基百科 Battle of Issus：马其顿与希腊同盟，亚历山大亲统右翼伙伴骑兵，帕曼纽统左翼。' }, attackerTroops: { level: 'fact', text: '英文维基百科 Battle of Issus 信息框：马其顿军共约37000人。' }, attackerLegion: { level: 'fact', text: '同格拉尼库斯河战役：马其顿军，前骑兵、中方阵、后远程，鱼鳞阵；此役亚历山大仍亲率伙伴骑兵为决胜一击。' }, defender: { level: 'fact', text: '英文维基百科 Battle of Issus：阿契美尼德帝国，大流士三世亲征。' }, defenderTroops: { level: 'fact', text: '英文维基百科 Battle of Issus 信息框：现代估计5万至10万，中值75000；主人定守方不超过攻方2倍，37000×2=74000，在区间内，取74000。' }, defenderLegion: { level: 'fact', text: '英文维基百科 Military of the Achaemenid Empire：职业常备军统称 spāda，后世通称阿契美尼德军。英文维基百科 Battle of Issus：骑兵约1.8万、长生军与希腊雇佣兵及亚美尼亚步兵约6万、轻步兵3万至8万；波斯骑兵率先渡河冲击，故前骑兵中步兵后远程，鹤翼阵2-4-3。' }, route: { level: 'fact', text: '英文维基百科 Alexander the Great 与 Battle of the Granicus：格拉尼库斯战后亚历山大南下，经萨迪斯、以弗所、米利都，公元前334年秋冬围哈利卡纳苏斯，其后北上弗里吉亚；公元前333年春在古都戈尔迪乌姆斩断戈尔迪之结，东至安库拉，再南下经卡帕多西亚、过托罗斯山即奇里乞亚门入奇里乞亚，驻军塔尔苏斯，得知大流士在巴比伦集结大军后南下，于伊苏斯迎战。游戏路线：出发地＝上一处战场（哈利卡纳苏斯），不写出发据点（军团此刻就在那座城里，写了就是瞬移）；途经 戈尔迪乌姆 → 安卡拉即古安库拉 → 伊科尼乌姆 → 阿达纳即塔尔苏斯附近 → 伊苏斯（以弗所那一段属格拉尼库斯～米利都两场，本场自哈利卡纳苏斯出发不再绕回以弗所）。🔴 [2026-09-25 复测] 两处缺口**都已修**：① 阿达纳→伊苏斯战场 原 226 公里／2.74 倍（安提俄基亚-阿达纳那条路朝西南绕），接入「⚔伊苏斯-阿达纳」支线后 **67 公里／0.82 倍**、末段离路 0 ✓。② 哈利卡纳苏斯→戈尔迪乌姆 原 **952 公里／1.93 倍** ✗ —— 路网带军团先回米利都、以弗所再北上，等于把前两场走过的海岸线倒着走一遍；按史料补绘「哈利卡纳苏斯-戈尔迪乌姆（经吕基亚、潘菲利亚海岸、凯莱奈）」后 **744 公里／直线 492 公里＝1.51 倍** ✓，走线 哈利卡纳苏斯 → 马尔马里斯 → 费特希耶 → 卡什 → 米拉 → 佩尔格 → 阿斯彭多斯 → 萨加拉索斯 → 凯莱奈（今迪纳尔）→ 阿菲永 → 戈尔迪乌姆，正是阿里安 I.24–29 记的那条「沿吕基亚—潘菲利亚海岸东行、再经皮西迪亚北上」的道。本场红 0。' }, result: { level: 'fact', text: '英文维基百科 Battle of Issus：马其顿胜，大流士弃军逃走，母亲、妻子、两个女儿被俘；伊苏斯是战场，无据点易主。阿里安《亚历山大远征记》II.11：伊苏斯战后亚历山大派帕曼纽南下，取大马士革、夺得波斯王室与总督寄存的战金，大马士革归马其顿。' }, invite: { level: 'fact', text: '英文维基百科 Alexander the Great：戈尔迪乌姆斩断戈尔迪之结，传说能解开者将为亚细亚之王；英文维基百科 Battle of Issus：大流士在巴比伦集结大军。对白措辞为撰写，史事有据。' }, briefing: { level: 'fact', text: '英文维基百科 Battle of Issus：海湾到群山仅2.6公里即两英里；大流士绕到马其顿军后方占领伊苏斯、砍去伤病员之手；马其顿军约3.7万，波斯军按中值7.5万，播报写三万七千、七万五千；方阵居中、亚历山大率伙伴骑兵在右翼。' } },
    ...
    // ── 由战场事件编辑器生成（/battlefield-editor.html）──
    {
        ...
        sources: { battle: { level: 'fact', text: '英文维基百科 Siege of Gaza (332 BC)：亚历山大东征中的攻城战，公元前332年马其顿军攻取加沙要塞。' }, time: { level: 'fact', text: '英文维基百科 Siege of Gaza (332 BC)：公元前332年10月破城（围城历时约两月；日文维基作三个月，从英文）。季节取秋。' }, place: { level: 'fact', text: '英文维基百科 Siege of Gaza (332 BC)：加沙要塞踞于高地、距海约五英里，控扼叙利亚通往埃及的大道，城墙高逾十八米；坐标取本据点记录 31.5017,34.4668。' }, attacker: { level: 'fact', text: '英文维基百科 Siege of Gaza (332 BC)：马其顿军，亚历山大亲统。' }, attackerTroops: { level: 'inferred', text: '英文维基百科 Siege of Gaza (332 BC) 未给攻方兵数；同一支马其顿军推罗战后未获大补，沿用伊苏斯与推罗两场的 35,000–40,000，取 37500 —— 合理推定。' }, attackerLegion: { level: 'fact', text: '同东征诸役：马其顿军，前伙伴骑兵、中方阵步兵、后克里特弓箭手，鱼鳞阵 3-4-2。' }, defender: { level: 'fact', text: '英文维基百科 Siege of Gaza (332 BC)：要塞守将巴提斯（Batis），时属阿契美尼德波斯治下，拒不投降。' }, defenderTroops: { level: 'inferred', text: '英文维基百科 Siege of Gaza (332 BC)：城破时加沙方面阵亡约一万（男丁被杀、妇孺为奴），据此守方兵力取 10000 —— 合理推定（史无守军确数）。' }, defenderLegion: { level: 'fact', text: '英文维基百科 Siege of Gaza (332 BC)：守方为波斯守军与阿拉伯雇佣兵（本据点精锐番号即「加沙雇佣兵」），凭高墙、土山与弩炮据守；番号取阿契美尼德军（巴提斯所部属波斯军系）。' }, route: { level: 'fact', text: '英文维基百科 Siege of Gaza (332 BC) 与 Siege of Tyre (332 BC)：亚历山大公元前332年夏取推罗后率军南下进围加沙，并把推罗用过的攻城器械一并运来破其高墙（承前一场）。游戏路线：自上一处战场（推罗）直接开拔南下抵加沙，路网取道阿音贾鲁特—耶路撒冷—加沙，273 公里（直线 208）。战后：自加沙南下埃及（佩鲁西姆—孟菲斯—亚历山大城），孟菲斯归马其顿、亚历山大在孟菲斯加冕为法老（本场 cityUpdates 已写）；公元前331年回师，军团自加沙开拔北上（见下一场路标）。' }, result: { level: 'fact', text: '英文维基百科 Siege of Gaza (332 BC)：马其顿胜。城破后男丁被杀、妇孺贩为奴，加沙方面阵亡约一万；巴提斯拒不投降，按库尔提乌斯所记被拖于战车之后处死；加沙入马其顿之手。英文维基百科 Alexander the Great 与 Siege of Gaza (332 BC)：加沙既下，通往埃及的门户打开，亚历山大随即进军埃及，波斯埃及总督马扎克斯不战而降，孟菲斯归马其顿，他并在孟菲斯加冕为法老。故本场「战后归属」按历史写两处易主：加沙、孟菲斯。' }, invite: { level: 'fact', text: '邀约对白所据史事：英文维基百科 Siege of Gaza (332 BC)：巴提斯拒不投降，亚历山大以推罗运来的攻城器械破墙，三次强攻后入城；对白措辞为撰写。' }, briefing: { level: 'fact', text: '英文维基百科 Siege of Gaza (332 BC)：加沙踞高地、城墙高逾十八米，马其顿军筑土山、调推罗攻城器械破墙；守军曾出击烧器械，亚历山大在反击中肩部受伤。英文维基百科 Alexander the Great：加沙既下亚历山大进军埃及，马扎克斯不战而降。文案按主人规矩不写兵力确数。' } },
        commanderUnit: 'hero_mounted_alexander',
        foeCommanderUnit: 'hero_aristides',
        type: 'siege',
        title: '公元前332年 加沙战役',
    ...
    },
    {
        ...
        fieldBattleData: {
            ...
            //    🔴 [2026-09-25 主人令「行军不走阿勒颇」] 实测沿路网走的是 大马士革→塔德莫尔→塔普萨库斯→埃德萨→尼西比斯→尼尼微，
    ...
    // ═══════════════════════════════════════════════════════════════
    {
        ...
        description: '公元前329年夏，亚历山大自波斯腹地东来，先取这一带七座城寨中的五座，两天而下；剩下的以居鲁士城最大最坚。他命克拉特鲁斯先围居鲁士城，掘壕立栅、架上攻城器械，使它不敢分兵去救别处。随后他亲至城下，以弩炮轰击城墙。',
        siegeData: {
            title: '居鲁士城战役',
        ...
        briefing: '从波斯门下来，直趋波斯波利斯；王都既下，宫室付之一炬。\n\n大流士既死，亚历山大把矛头转向弑君者贝苏斯。他北上米底，取埃克巴坦那；在那边把随军的希腊盟军遣散回乡，只留下愿意继续东行的人，又就地补进新兵。就在这时传来消息：大流士逃到东边，已经被巴克特里亚总督贝苏斯一伙人扣住了。亚历山大不肯让弑君者替他背这个罪名，立刻轻装向东追，经雷伊赶往厄尔布尔士山那处隘口——他们叫它里海门。\n\n出了里海门，山那一边是赫尔卡尼亚。当地部众来降，亚历山大收下他们，转道东行：过图斯，入阿里亚。阿里亚总督萨提巴扎尼斯先迎降，等马其顿军走远又反了，聚起人马要断东进大军的后路。亚历山大回师快得他来不及跑，叛乱平定，他就在阿塔考纳另筑一座城留守——据说那座城，他叫它阿利亚的亚历山大城。\n\n再往南是德兰吉亚那。首府普罗夫塔西亚的军中出了大事：菲罗塔斯被查出图谋不轨，全军会审之后处死；他的父亲帕曼纽，那位从腓力二世起就统率马其顿右翼的老将，也在埃克巴坦那被自己人杀掉。亚历山大不肯再留这样的后患。此后他东入阿拉霍西亚，在赫尔曼德河一带又筑了一座城，阿拉霍西亚的亚历山大城；据说那一带入冬后风沙极大。\n\n公元前329年春，他过加兹尼、高附，直抵兴都库什山下——阿里安把这道山叫作高加索。据说雪还深，全军还是翻了过去，山北筑起高加索的亚历山大城，随即直下巴克特拉。贝苏斯被自己的部将绑了送来，亚历山大把他交给波斯人依法处死。\n\n当年夏，他渡过乌浒水，进入粟特。这一带有七座城寨，他先取五座，两天而下。剩下的以居鲁士城最大——居鲁士大帝亲手筑的边塞，墙高人多，号称这一带最好的战士都在城中。',
    },
    ...
    // ═══════════════════════════════════════════════════════════════
    {
        ...
        briefing: '加拜一战之后，斯皮塔米尼斯再也没能聚起人马。他退往北方草原，指望马萨革泰人替他报仇，那些人却砍下他的头，派人送到亚历山大帐前求和——中亚这场拖了两年的叛乱，至此才算了结。\n亚历山大在巴克特里亚过了冬。公元前327年的早春，他率军北上索格狄亚那，去拔掉叛军最后几处巢穴。挡在路上的，是索格狄亚那岩：一座立在绝壁之上的岩堡，四面刀削一般，向被称为不可攻。堡里的首领阿里马泽斯自恃天险，回绝马其顿人的招降时说，亚历山大除非有长了翅膀的兵，否则休想上来。\n亚历山大没有强攻。他召集全军，许下重赏，问谁愿意去爬那道崖。',
    },
    // ═══════════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════════
    {
        ...
        description: '公元前325年春，亚历山大自海达斯佩斯河一路南下，穿旱地急进，一日一夜扑到马利人的城下。马利人把老幼家当都搬进了都城卫城，据墙死守。马其顿军破了外门，在墙根下掘墙；亚历山大嫌攻城太慢，亲自扛梯登城，随他上墙的只有寥寥数人，梯子被人挤断，他被困在墙头。',
        siegeData: {
            title: '马里斯战役',
    ...
    // ═══════════════════════════════════════════════════════════════
    {
        ...
        sources: {
            ...
            route: { level: 'inferred', text: '自上一场落点马里斯开拔，经坎大哈、法拉、巴姆、波斯波利斯、苏萨、哈马丹入扎格罗斯科塞亚境。史料：亚历山大自印度西返，经格德罗西亚与卡尔马尼亚回到波斯腹地，公元前324年先后在苏萨与米底，其后动身回巴比伦途中平定科塞亚。路网实测各段皆通 —— 合理推定。' },
        ...
        description: '公元前324年冬，亚历山大自米底南下回巴比伦，取道扎格罗斯山中的科塞亚境。科塞亚人是山地部落，穴居善射，向来靠劫掠与买路钱过活，波斯历代诸王都拿他们没有办法。亚历山大不与他们讲和：先以轻装部队抢占几处入山的隘口，随后分路进剿，把科塞亚人的村寨与牧场逐段扫平。',
        fieldBattleData: {
            title: '科塞亚战役',
        ...
        briefing: '科塞亚一战打完，亚历山大回到巴比伦，准备再往西征阿拉伯、再图迦太基与意大利。可这些计划都没能开始：公元前323年夏天，他在这座城里发起高热，几天之后便死了，年仅三十二岁。他东征十二年，从希腊打到印度河，留下的帝国随即被部将们瓜分——那是另一段故事了。',
    },
];
