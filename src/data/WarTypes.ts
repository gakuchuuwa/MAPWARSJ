...
export const WAR_TYPES: Record<string, WarType> = {
    ...
    companion_cavalry: { name: '马其顿伙伴骑兵高级', cls: 'cav', sz: 1, hp: 90, atk: 11, meleeArmor: 1, pierceArmor: 3, rng: 0, reload: 1.9, spd: 130, dmgType: 'melee', bonus: { 19: 5 }, armorTags: [8, 31, 19] },
