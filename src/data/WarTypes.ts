...
export interface WarType {
    ...
    /**
     * 尺寸倍率（象兵大、骑兵略大）；只作用于 13 的渲染缩放，不参与战斗/碰撞结算。
     * 🔴 [2026-09-09 主人定] 攻城器械一律 sz=1：素材本身的车身尺寸就是它该有的大小，
     *    额外倍率会让攻城塔在 30 秒攻城阶段比同队冲车/投石机大出一圈（原 1.4 已改回 1）。
     */
    sz: number;
    /** 范围伤（象兵） */
    aoe?: boolean;
...
export const WAR_TYPES: Record<string, WarType> = {
    ...
    frankish_paladin: { name: '中世纪枪骑兵高级', cls: 'cav', sz: 1, hp: 160, atk: 14, meleeArmor: 2, pierceArmor: 3, rng: 0, reload: 1.9, spd: 130, dmgType: 'melee', armorTags: [8, 31] },
    jarl: { name: '维京首领骑兵高级', cls: 'cav', sz: 1, hp: 140, atk: 18, meleeArmor: 1, pierceArmor: 1, rng: 0, reload: 2.1, spd: 130, dmgType: 'melee', bonus: { 11: 5 }, armorTags: [8, 31] },
    siege_ballista: { name: '阿契美尼德攻城弩炮重装', cls: 'ranged', sz: 1, hp: 40, atk: 11, meleeArmor: 0, pierceArmor: 7, rng: 280, reload: 3.6, spd: 50, dmgType: 'pierce', bonus: { 1: 1, 5: 7, 11: 180, 17: 1 }, armorTags: [20, 31] },
    ...
    shield: { name: '欧洲近卫兵高级', cls: 'melee', sz: 1, hp: 70, atk: 14, meleeArmor: 1, pierceArmor: 1, rng: 0, reload: 2.0, spd: 47, dmgType: 'melee', bonus: { 21: 4, 29: 8 }, armorTags: [1, 31] },
    ...
    elite_guardsman: { name: '近卫步兵高级', cls: 'melee', sz: 1, hp: 65, atk: 7, meleeArmor: 1, pierceArmor: 1, rng: 0, reload: 2.0, spd: 55, dmgType: 'melee', bonus: { 5: 28, 8: 32, 16: 17, 21: 1, 29: 1, 30: 26, 35: 7 }, armorTags: [27, 1, 31] },
    ...
    imperial_skirmisher: { name: '越南掷矛手高级', cls: 'ranged', sz: 1, hp: 35, atk: 4, meleeArmor: 0, pierceArmor: 5, rng: 200, reload: 3.0, spd: 50, dmgType: 'pierce', bonus: { 15: 5, 27: 4, 28: 3, 35: 3 }, armorTags: [15, 31, 38] },
    ...
    savar: { name: '萨珊波斯萨瓦兰骑兵高级', cls: 'cav', sz: 1, hp: 145, atk: 14, meleeArmor: 3, pierceArmor: 4, rng: 0, reload: 1.8, spd: 130, dmgType: 'melee', bonus: { 15: 2 }, armorTags: [8, 31] },
    ...
    camel_heavy: { name: '骆驼骑兵高级', cls: 'cav', sz: 1, hp: 120, atk: 7, meleeArmor: 0, pierceArmor: 0, rng: 0, reload: 2.0, spd: 130, dmgType: 'melee', bonus: { 8: 18, 16: 9, 30: 9, 35: 7 }, armorTags: [30, 31, 39] },
    cav_archer_heavy: { name: '骑射手高级', cls: 'cav', sz: 1, kite: 70, hp: 60, atk: 7, meleeArmor: 1, pierceArmor: 0, rng: 160, reload: 2.0, spd: 130, dmgType: 'pierce', bonus: { 27: 4 }, armorTags: [28, 15, 8, 31] },
    ...
    champion: { name: '欧洲双手剑士高级', cls: 'melee', sz: 1, hp: 70, atk: 14, meleeArmor: 1, pierceArmor: 1, rng: 0, reload: 2.0, spd: 55, dmgType: 'melee', bonus: { 21: 4, 29: 8 }, armorTags: [1, 31] },
    ...
    paladin: { name: '欧洲游侠高级', cls: 'cav', sz: 1, hp: 160, atk: 14, meleeArmor: 2, pierceArmor: 3, rng: 0, reload: 1.9, spd: 130, dmgType: 'melee', armorTags: [8, 31] },
    ...
    heavy_pikeman: { name: '长枪兵高级', cls: 'melee', sz: 1, hp: 75, atk: 4, meleeArmor: 0, pierceArmor: 0, rng: 0, reload: 3.0, spd: 55, dmgType: 'melee', bonus: { 5: 25, 8: 22, 16: 16, 21: 1, 29: 1, 30: 18, 35: 7 }, armorTags: [27, 1, 31] },
    arbalest: { name: '欧洲劲弩手高级', cls: 'ranged', sz: 1, hp: 40, atk: 6, meleeArmor: 0, pierceArmor: 0, rng: 200, reload: 2.0, spd: 50, dmgType: 'pierce', bonus: { 27: 3 }, armorTags: [15, 31] },
    hei_kuang_heavy: { name: '南北朝黑光铠骑兵高级', cls: 'cav', sz: 1, hp: 90, atk: 12, meleeArmor: 4, pierceArmor: 3, rng: 0, reload: 1.8, spd: 130, dmgType: 'melee', bonus: { 1: 1 }, armorTags: [8, 31] },
    ...
    pattiyoda_longbowman: { name: '帕提尤达长弓兵', cls: 'ranged', sz: 1, hp: 50, atk: 7, meleeArmor: 0, pierceArmor: 0, rng: 160, reload: 2.2, spd: 50, dmgType: 'pierce', bonus: { 5: 4, 27: 2 }, armorTags: [15, 19, 31] },
    elite_pattiyoda_longbowman: { name: '帕提尤达长弓兵精锐', cls: 'ranged', sz: 1, hp: 60, atk: 8, meleeArmor: 2, pierceArmor: 0, rng: 160, reload: 2.2, spd: 50, dmgType: 'pierce', bonus: { 5: 4, 27: 2 }, armorTags: [15, 19, 31] },
    ...
    armored_elephant: { name: '装甲攻城战象', cls: 'melee', sz: 1, aoe: true, hp: 180, atk: 4, meleeArmor: -2, pierceArmor: 140, rng: 0, reload: 3.0, spd: 40, dmgType: 'melee', bonus: { 11: 320, 20: 25 }, armorTags: [5, 8, 20, 17, 31] },
    elite_armored_elephant: { name: '装甲攻城战象高级', cls: 'melee', sz: 1, aoe: true, hp: 220, atk: 4, meleeArmor: -2, pierceArmor: 150, rng: 0, reload: 3.0, spd: 40, dmgType: 'melee', bonus: { 11: 400, 20: 35 }, armorTags: [5, 8, 20, 17, 31] },
    ballista_elephant: { name: '高棉弩炮战象', cls: 'ranged', sz: 1, hp: 250, atk: 9, meleeArmor: 0, pierceArmor: 3, rng: 200, reload: 2.5, spd: 40, dmgType: 'pierce', bonus: { 11: 120, 13: 3, 16: 8, 18: 100, 21: 10 }, armorTags: [8, 19, 5, 20, 31, 37] },
    ...
    heavy_cavalry: { name: '欧洲重骑兵重装', cls: 'cav', sz: 1.15, hp: 100, atk: 10, meleeArmor: 2, pierceArmor: 2, rng: 0, reload: 1.8, spd: 130, dmgType: 'melee', armorTags: [8, 31] },
    general_cavalry: { name: '华夏虎豹骑高级', cls: 'cav', sz: 1.15, hp: 110, atk: 11, meleeArmor: 0, pierceArmor: 4, rng: 0, reload: 1.9, spd: 130, dmgType: 'melee', bonus: { 15: 6 }, armorTags: [8, 19, 31] },
    ...
    ballista: { name: '华夏元戎弩高级', cls: 'ranged', sz: 1, hp: 40, atk: 11, meleeArmor: 0, pierceArmor: 7, rng: 280, reload: 3.6, spd: 35, dmgType: 'pierce', bonus: { 1: 1, 5: 7, 11: 3, 17: 1 }, armorTags: [20, 31] },
    ...
    battering_ram: { name: '轻型攻城槌', cls: 'melee', sz: 1, hp: 175, atk: 2, meleeArmor: -3, pierceArmor: 180, rng: 0, reload: 5.0, spd: 55, dmgType: 'melee', bonus: { 11: 450, 20: 40 }, armorTags: [17, 20, 31] },
    ...
    bombard_cannon: { name: '手推攻城火炮', cls: 'ranged', aoe: true, sz: 1, hp: 80, atk: 40, meleeArmor: 2, pierceArmor: 5, rng: 480, reload: 6.5, spd: 50, dmgType: 'melee', bonus: { 11: 600, 13: 40, 16: 40, 20: 20, 37: 40 }, armorTags: [20, 23, 31] },
    ...
    camel_raider: { name: '沙漠骆驼突袭者高级', cls: 'cav', sz: 1, hp: 90, atk: 10, meleeArmor: 0, pierceArmor: 1, rng: 0, reload: 2.0, spd: 130, dmgType: 'melee', bonus: { 8: 18, 16: 9, 30: 9, 35: 7 }, armorTags: [30, 31, 39] },
    ...
    capped_ram: { name: '欧洲装甲攻城槌高级', cls: 'melee', sz: 1, hp: 200, atk: 3, meleeArmor: -2, pierceArmor: 190, rng: 0, reload: 5.0, spd: 55, dmgType: 'melee', bonus: { 11: 520, 20: 50 }, armorTags: [17, 20, 31] },
    ...
    elite_companion_cavalry: { name: '马其顿伙伴骑兵精锐', cls: 'cav', sz: 1, hp: 120, atk: 13, meleeArmor: 1, pierceArmor: 4, rng: 0, reload: 1.9, spd: 130, dmgType: 'melee', bonus: { 19: 7 }, armorTags: [8, 31, 19] },
    condottiero: { name: '意大利佣兵高级', cls: 'melee', sz: 1, hp: 80, atk: 10, meleeArmor: 1, pierceArmor: 0, rng: 0, reload: 1.9, spd: 55, dmgType: 'melee', bonus: { 21: 2, 23: 10 }, armorTags: [1, 19, 31, 32] },
    ...
    ekdromos: { name: '希腊埃克德罗摩斯高级', cls: 'melee', sz: 1, hp: 80, atk: 13, meleeArmor: 1, pierceArmor: 3, rng: 0, reload: 2.0, spd: 55, dmgType: 'melee', bonus: { 21: 3, 29: 6 }, armorTags: [1, 31] },
    ...
    elite_ballista_elephant: { name: '高棉弩炮战象精锐', cls: 'ranged', sz: 1, aoe: true, hp: 280, atk: 10, meleeArmor: 0, pierceArmor: 3, rng: 200, reload: 2.5, spd: 40, dmgType: 'pierce', bonus: { 11: 160, 13: 4, 16: 8, 18: 100, 21: 15 }, armorTags: [8, 19, 5, 20, 31, 37] },
    ...
    elite_ghulam: { name: '印度斯坦古拉姆精锐', cls: 'melee', sz: 1, hp: 70, atk: 11, meleeArmor: 0, pierceArmor: 6, rng: 0, reload: 2.0, spd: 99, dmgType: 'melee', bonus: { 15: 6, 21: 2, 29: 2 }, armorTags: [1, 19, 31] },
    ...
    elite_organ_gun: { name: '葡萄牙风琴炮精锐', cls: 'ranged', sz: 1, hp: 70, atk: 8, meleeArmor: 2, pierceArmor: 6, rng: 280, reload: 3.45, spd: 50, dmgType: 'pierce', bonus: { 1: 2, 11: 220, 17: 1, 38: 2 }, armorTags: [20, 19, 23, 31] },
    ...
    elite_ratha_melee: { name: '孟加拉拉塔战车高级', cls: 'cav', sz: 1, hp: 115, atk: 12, meleeArmor: 3, pierceArmor: 3, rng: 0, reload: 2.0, spd: 130, dmgType: 'melee', armorTags: [8, 15, 19, 28, 31] },
    elite_ratha_ranged: { name: '孟加拉拉塔弓战车精锐', cls: 'cav', sz: 1, hp: 115, atk: 6, meleeArmor: 3, pierceArmor: 3, rng: 160, reload: 2.0, spd: 130, dmgType: 'pierce', bonus: { 27: 2 }, armorTags: [8, 15, 19, 28, 31] },
    ...
    flaming_camel: { name: '鞑靼火焰骆驼', cls: 'melee', sz: 1, hp: 55, atk: 20, meleeArmor: 0, pierceArmor: 0, rng: 0, reload: 0, spd: 55, dmgType: 'melee', bonus: { 5: 130, 8: 50, 11: 800, 20: 25, 30: 50 }, armorTags: [19, 30, 31, 39] },
    ...
    flemish_pikeman_f: { name: '勃艮第佛兰德民兵高级', cls: 'melee', sz: 1, hp: 40, atk: 5, meleeArmor: 1, pierceArmor: 1, rng: 0, reload: 2.0, spd: 55, dmgType: 'melee', bonus: { 5: 6, 8: 6, 16: 4, 29: 2, 30: 4 }, armorTags: [1, 19, 31] },
    ...
    ghulam: { name: '印度斯坦古拉姆', cls: 'melee', sz: 1, hp: 60, atk: 9, meleeArmor: 0, pierceArmor: 3, rng: 0, reload: 2.0, spd: 99, dmgType: 'melee', bonus: { 15: 5, 21: 2, 29: 2 }, armorTags: [1, 19, 31] },
    ...
    grenadier: { name: '掷弹兵', cls: 'ranged', sz: 1, hp: 40, atk: 12, meleeArmor: 1, pierceArmor: 1, rng: 240, reload: 3.45, spd: 50, dmgType: 'pierce', bonus: { 1: 9, 11: 200, 17: 3, 21: 20, 27: 1 }, armorTags: [15, 19, 31, 23] },
    ...
    heavy_rocket_cart: { name: '重型火箭车', cls: 'ranged', aoe: true, sz: 1, hp: 65, atk: 5, meleeArmor: 0, pierceArmor: 8, rng: 320, reload: 5.35, spd: 50, dmgType: 'melee', bonus: { 11: 420, 20: 2, 22: 7, 26: 7, 37: 5 }, armorTags: [20, 31, 23] },
    heavy_scorpion: { name: '欧洲重型弩炮重装', cls: 'ranged', sz: 1, hp: 60, atk: 14, meleeArmor: 1, pierceArmor: 8, rng: 280, reload: 3.6, spd: 50, dmgType: 'pierce', bonus: { 1: 2, 5: 10, 11: 240, 17: 2 }, armorTags: [20, 31] },
    ...
    hippeus: { name: '斯巴达三百', cls: 'melee', sz: 1, hp: 90, atk: 9, meleeArmor: 2, pierceArmor: 4, rng: 0, reload: 2.0, spd: 55, dmgType: 'melee', bonus: { 21: 4 }, armorTags: [1, 19, 31] },
    elite_hippeus: { name: '斯巴达三百精锐', cls: 'melee', sz: 1, hp: 100, atk: 11, meleeArmor: 2, pierceArmor: 5, rng: 0, reload: 2.0, spd: 55, dmgType: 'melee', bonus: { 21: 5 }, armorTags: [1, 19, 31] },
    hoplite: { name: '希腊步兵', cls: 'melee', sz: 1, hp: 55, atk: 10, meleeArmor: 1, pierceArmor: 1, rng: 20, reload: 2.0, spd: 50, dmgType: 'melee', bonus: { 21: 2 }, armorTags: [1, 19, 31] },
    elite_hoplite: { name: '希腊步兵高级', cls: 'melee', sz: 1, hp: 70, atk: 12, meleeArmor: 2, pierceArmor: 1, rng: 20, reload: 2.0, spd: 50, dmgType: 'melee', bonus: { 21: 2 }, armorTags: [1, 19, 31] },
    houfnice: { name: '手推榴弹炮', cls: 'ranged', aoe: true, sz: 1, hp: 90, atk: 50, meleeArmor: 2, pierceArmor: 6, rng: 480, reload: 6.5, spd: 50, dmgType: 'melee', bonus: { 11: 650, 13: 50, 16: 50, 20: 20, 37: 50 }, armorTags: [20, 23, 31] },
    ...
    hussar: { name: '欧洲骠骑兵高级', cls: 'cav', sz: 1, hp: 75, atk: 7, meleeArmor: 0, pierceArmor: 2, rng: 0, reload: 1.9, spd: 130, dmgType: 'melee', bonus: { 25: 12 }, armorTags: [8, 31] },
    ...
    elite_immortal: { name: '波斯长生军精锐', cls: 'melee', sz: 1, hp: 60, atk: 12, meleeArmor: 1, pierceArmor: 3, rng: 0, reload: 1.8, spd: 55, dmgType: 'melee', armorTags: [15, 19, 31, 1] },
    immortal_ranged: { name: '波斯长生军弓手', cls: 'ranged', sz: 1, hp: 50, atk: 5, meleeArmor: 0, pierceArmor: 3, rng: 160, reload: 1.8, spd: 50, dmgType: 'pierce', armorTags: [15, 19, 31, 1] },
    elite_immortal_ranged: { name: '波斯长生军弓手高级', cls: 'ranged', sz: 1, hp: 60, atk: 6, meleeArmor: 1, pierceArmor: 3, rng: 200, reload: 1.8, spd: 50, dmgType: 'pierce', armorTags: [15, 19, 31, 1] },
    imperial_camel_rider: { name: '印度斯坦帝王骆驼兵高级', cls: 'cav', sz: 1, hp: 140, atk: 8, meleeArmor: 0, pierceArmor: 0, rng: 0, reload: 2.0, spd: 130, dmgType: 'melee', bonus: { 8: 18, 16: 9, 30: 9, 35: 7 }, armorTags: [30, 31, 39] },
    imperial_centurion: { name: '罗马骑兵高级', cls: 'cav', sz: 1, hp: 150, atk: 12, meleeArmor: 2, pierceArmor: 1, rng: 0, reload: 1.7, spd: 130, dmgType: 'melee', bonus: { 1: 12 }, armorTags: [8, 19, 31] },
    ...
    mangonel: { name: '欧洲轻型投石车', cls: 'ranged', aoe: true, sz: 1, hp: 50, atk: 40, meleeArmor: 0, pierceArmor: 6, rng: 280, reload: 6.0, spd: 50, dmgType: 'melee', bonus: { 11: 280, 20: 12, 37: 40 }, armorTags: [20, 31] },
    mercenary_hoplite: { name: '希腊雇佣重步兵高级', cls: 'melee', sz: 1, hp: 55, atk: 10, meleeArmor: 2, pierceArmor: 1, rng: 12, reload: 2.0, spd: 50, dmgType: 'melee', bonus: { 21: 2 }, armorTags: [1, 19, 31] },
    militia: { name: '中东民兵', cls: 'melee', sz: 1, hp: 40, atk: 4, meleeArmor: 0, pierceArmor: 1, rng: 0, reload: 2.0, spd: 55, dmgType: 'melee', armorTags: [1, 31] },
    ...
    mounted_trebuchet: { name: '沙漠骆驼投石机高级', cls: 'cav', sz: 1, hp: 75, atk: 30, meleeArmor: 2, pierceArmor: 4, rng: 400, reload: 6.5, spd: 130, dmgType: 'melee', bonus: { 11: 450, 20: 30, 37: 30 }, armorTags: [20, 31, 19, 37, 30, 39] },
    ...
    onager: { name: '欧洲中型投石车高级', cls: 'ranged', aoe: true, sz: 1, hp: 60, atk: 50, meleeArmor: 0, pierceArmor: 7, rng: 320, reload: 6.0, spd: 50, dmgType: 'melee', bonus: { 11: 360, 20: 12, 37: 50 }, armorTags: [20, 31] },
    organ_gun: { name: '葡萄牙风琴炮', cls: 'ranged', sz: 1, hp: 50, atk: 6, meleeArmor: 2, pierceArmor: 4, rng: 280, reload: 3.45, spd: 50, dmgType: 'pierce', bonus: { 1: 2, 11: 150, 17: 1, 38: 2 }, armorTags: [20, 19, 23, 31] },
    petard: { name: '爆破工兵', cls: 'melee', sz: 1, hp: 50, atk: 25, meleeArmor: 0, pierceArmor: 2, rng: 0, reload: 0, spd: 55, dmgType: 'melee', bonus: { 11: 1200, 20: 60, 22: 900, 26: 100 }, armorTags: [31] },
    ...
    elite_phalangite: { name: '马其顿方阵步兵高级', cls: 'melee', sz: 1, hp: 65, atk: 8, meleeArmor: 2, pierceArmor: 0, rng: 72, reload: 2.5, spd: 50, dmgType: 'melee', bonus: { 5: 20, 8: 26, 30: 6 }, armorTags: [1, 19, 31] },
    ...
    ratha_ranged: { name: '孟加拉拉塔弓战车', cls: 'cav', sz: 1, hp: 100, atk: 5, meleeArmor: 3, pierceArmor: 1, rng: 160, reload: 2.0, spd: 130, dmgType: 'pierce', bonus: { 27: 1 }, armorTags: [8, 15, 19, 28, 31] },
    ...
    elite_rhomphaia_warrior: { name: '色雷斯长刃斩手精锐', cls: 'melee', sz: 1, hp: 60, atk: 10, meleeArmor: 1, pierceArmor: 1, rng: 0, reload: 2.0, spd: 55, dmgType: 'melee', bonus: { 8: 22, 21: 8, 29: 2, 30: 18 }, armorTags: [1, 19, 31] },
    rocket_cart: { name: '火箭车', cls: 'ranged', aoe: true, sz: 1, hp: 45, atk: 5, meleeArmor: 0, pierceArmor: 6, rng: 280, reload: 5.5, spd: 50, dmgType: 'melee', bonus: { 11: 300, 20: 2, 22: 6, 26: 7, 37: 5 }, armorTags: [20, 31, 23] },
    royal_janissary: { name: '奥斯曼皇家亲兵高级', cls: 'ranged', sz: 1, hp: 55, atk: 22, meleeArmor: 2, pierceArmor: 0, rng: 320, reload: 3.45, spd: 50, dmgType: 'pierce', bonus: { 17: 3 }, armorTags: [15, 19, 23, 31] },
    sacred_band: { name: '希腊底比斯圣队高级', cls: 'melee', sz: 1, hp: 65, atk: 13, meleeArmor: 3, pierceArmor: 1, rng: 20, reload: 2.0, spd: 50, dmgType: 'melee', bonus: { 21: 2 }, armorTags: [1, 19, 31] },
    sannahya: { name: '桑纳亚战象', cls: 'melee', sz: 1, aoe: true, hp: 300, atk: 10, meleeArmor: 1, pierceArmor: 3, rng: 0, reload: 2.0, spd: 40, dmgType: 'melee', bonus: { 13: 4, 21: 4 }, armorTags: [5, 8, 31, 19] },
    elite_sannahya: { name: '桑纳亚战象高级', cls: 'melee', sz: 1, aoe: true, hp: 400, atk: 12, meleeArmor: 2, pierceArmor: 4, rng: 0, reload: 2.0, spd: 40, dmgType: 'melee', bonus: { 13: 4, 21: 4 }, armorTags: [5, 8, 31, 19] },
    scorpion: { name: '欧洲弩炮', cls: 'ranged', sz: 1, hp: 40, atk: 11, meleeArmor: 0, pierceArmor: 7, rng: 280, reload: 3.6, spd: 50, dmgType: 'pierce', bonus: { 1: 1, 5: 7, 11: 180, 17: 1 }, armorTags: [20, 31] },
    scythian_axe_cavalry: { name: '斯基泰斧骑兵高级', cls: 'cav', sz: 1, hp: 130, atk: 10, meleeArmor: 2, pierceArmor: 3, rng: 0, reload: 1.9, spd: 130, dmgType: 'melee', armorTags: [8, 31] },
    ...
    siege_onager: { name: '欧洲重型投石车重装', cls: 'ranged', aoe: true, sz: 1, hp: 70, atk: 75, meleeArmor: 0, pierceArmor: 8, rng: 320, reload: 6.0, spd: 50, dmgType: 'melee', bonus: { 11: 480, 20: 12, 37: 50 }, armorTags: [20, 31] },
    siege_ram: { name: '欧洲重型攻城槌重装', cls: 'melee', sz: 1, hp: 270, atk: 4, meleeArmor: -1, pierceArmor: 195, rng: 0, reload: 5.0, spd: 55, dmgType: 'melee', bonus: { 11: 600, 20: 65 }, armorTags: [17, 20, 31] },
    ...
    sogdian_cataphract: { name: '粟特甲胄骑兵高级', cls: 'cav', sz: 1, hp: 110, atk: 12, meleeArmor: 0, pierceArmor: 5, rng: 0, reload: 2.0, spd: 130, dmgType: 'melee', bonus: { 15: 6 }, armorTags: [8, 19, 31] },
    ...
    elite_strategos: { name: '雅典将军卫队精锐', cls: 'melee', sz: 1, hp: 65, atk: 18, meleeArmor: 1, pierceArmor: 1, rng: 0, reload: 2.0, spd: 55, dmgType: 'melee', armorTags: [1, 19, 31] },
    sakan_axeman: { name: '塞种萨迦斧兵高级', cls: 'melee', sz: 1, hp: 80, atk: 9, meleeArmor: 1, pierceArmor: 3, rng: 0, reload: 2.0, spd: 55, dmgType: 'melee', bonus: { 21: 3, 29: 6 }, armorTags: [1, 19, 31, 36] },
    ...
    traction_trebuchet: { name: '华夏牵引投石机重装', cls: 'ranged', sz: 1, hp: 115, atk: 50, meleeArmor: 1, pierceArmor: 8, rng: 560, reload: 11.0, spd: 50, dmgType: 'melee', bonus: { 11: 750 }, armorTags: [17, 20, 31] },
    ...
    winged_hussar: { name: '波兰翼骑兵高级', cls: 'cav', sz: 1, hp: 80, atk: 9, meleeArmor: 1, pierceArmor: 2, rng: 0, reload: 1.9, spd: 130, dmgType: 'melee', bonus: { 23: 4, 25: 14 }, armorTags: [8, 31] },
    ...
    xolotl_warrior: { name: '阿兹特克索洛特尔骑兵高级', cls: 'cav', sz: 1, hp: 100, atk: 10, meleeArmor: 2, pierceArmor: 2, rng: 0, reload: 1.8, spd: 130, dmgType: 'melee', armorTags: [8, 31] },
    longswordsman: {name:"中东剑士",cls:"melee",sz:1,hp:60,atk:9,meleeArmor:1,pierceArmor:1,rng:0,reload:2,spd:45,dmgType:"melee",bonus:{29:6,21:3},armorTags:[1,31]},
    ...
    jian_swordman_unshielded: {name:"华夏双手步兵",cls:"melee",sz:1,hp:70,atk:11,meleeArmor:0,pierceArmor:2,rng:0,reload:2.0,spd:50,dmgType:"melee",bonus:{21:2,15:4},armorTags:[1,19,29,31]},
    cavalier: {name:"骑士高级",cls:"cav",sz:1.2,hp:120,atk:12,meleeArmor:2,pierceArmor:2,rng:0,reload:1.8,spd:130,dmgType:"melee",armorTags:[8,31]},
    flamethrower: { name: '华夏猛火油柜重装',cls:"ranged",sz:1.1,aoe:true,hp:160,atk:4,meleeArmor:2,pierceArmor:2,rng:200,reload:0.25,spd:40,dmgType:"melee",bonus: { 11: 25, 13: 10 },armorTags:[20,31]},
    helepolis: { name: '希腊赫勒波利斯攻城塔重装',cls:"ranged",sz:1,hp:350,atk:20,meleeArmor:-2,pierceArmor:100,rng:440,reload:5,spd:30,dmgType:"pierce",bonus: { 11: 350, 16: 50 },armorTags:[20,17,31]},
    siege_tower: { name: '欧洲攻城塔', cls: 'ranged', sz: 1, hp: 220, atk: 6, meleeArmor: -2, pierceArmor: 100, rng: 240, reload: 4.0, spd: 40, dmgType: 'pierce', bonus: { 11: 180 }, armorTags: [20, 17, 31] },
    halberdier: { name: '欧洲戟兵高级', cls: 'melee', sz: 1, hp: 60, atk: 6, meleeArmor: 0, pierceArmor: 0, rng: 0, reload: 3.0, spd: 55, dmgType: 'melee', bonus: { 5: 28, 8: 32, 16: 17, 21: 1, 29: 1, 30: 26, 35: 7 }, armorTags: [27, 1, 31] },
    ...
    jian_swordman_shielded: { name: '华夏步兵高级', cls: 'melee', sz: 1, hp: 70, atk: 8, meleeArmor: 0, pierceArmor: 5, rng: 0, reload: 2.0, spd: 55, dmgType: 'melee', bonus: { 15: 4, 21: 2 }, armorTags: [1, 29, 19, 31] },
    ...
    imperial_cavalry: { name: '波斯具装铁骑高级', cls: 'cav', sz: 1, hp: 130, atk: 12, meleeArmor: 3, pierceArmor: 2, rng: 0, reload: 1.8, spd: 130, dmgType: 'melee', bonus: { 1: 10 }, armorTags: [8, 19, 31] },
    ...
    sarmatian: { name: '东欧萨尔马提亚骑兵高级', cls: 'cav', sz: 1, hp: 140, atk: 13, meleeArmor: 3, pierceArmor: 3, rng: 0, reload: 1.9, spd: 130, dmgType: 'melee', armorTags: [8, 19, 31] },
    ...
    vanguard: { name: '先锋步兵高级', cls: 'melee', sz: 1, hp: 70, atk: 13, meleeArmor: 1, pierceArmor: 1, rng: 0, reload: 2.0, spd: 55, dmgType: 'melee', bonus: { 21: 4, 29: 6 }, armorTags: [1, 19, 31] },
    ...
    crusader_knight: { name: '欧洲十字军骑士高级', cls: 'cav', sz: 1, hp: 100, atk: 18, meleeArmor: 4, pierceArmor: 4, rng: 0, reload: 2.0, spd: 130, dmgType: 'melee', armorTags: [8, 31] },
    ...
    guardsman: { name: '近卫步兵', cls: 'melee', sz: 1, hp: 60, atk: 6, meleeArmor: 0, pierceArmor: 0, rng: 0, reload: 3.0, spd: 55, dmgType: 'melee', bonus: { 5: 18, 8: 20, 16: 10, 21: 1, 29: 1, 30: 15 }, armorTags: [27, 1, 31] },
    ...
    antiquity_heavy_cavalry_archer: { name: '古典骑射手高级', cls: 'cav', sz: 1, hp: 60, atk: 7, meleeArmor: 1, pierceArmor: 0, rng: 160, reload: 2.0, spd: 130, dmgType: 'pierce', bonus: { 27: 4 }, armorTags: [28, 15, 8, 31] },
    ...
    antiquity_battering_ram: { name: '古典轻型攻城槌', cls: 'melee', sz: 1, hp: 175, atk: 2, meleeArmor: -3, pierceArmor: 180, rng: 0, reload: 5.0, spd: 55, dmgType: 'melee', bonus: { 11: 450, 20: 40 }, armorTags: [17, 20, 31] },
    antiquity_capped_ram: { name: '古典装甲攻城槌高级', cls: 'melee', sz: 1, hp: 200, atk: 3, meleeArmor: -2, pierceArmor: 190, rng: 0, reload: 5.0, spd: 55, dmgType: 'melee', bonus: { 11: 520, 20: 50 }, armorTags: [17, 20, 31] },
    antiquity_scorpion: { name: '古典弩炮', cls: 'ranged', sz: 1, hp: 40, atk: 11, meleeArmor: 0, pierceArmor: 7, rng: 280, reload: 3.6, spd: 50, dmgType: 'pierce', bonus: { 1: 1, 5: 7, 11: 180, 17: 1 }, armorTags: [20, 31] },
    antiquity_heavy_scorpion: { name: '古典重型弩炮重装', cls: 'ranged', sz: 1, hp: 60, atk: 14, meleeArmor: 1, pierceArmor: 8, rng: 280, reload: 3.6, spd: 50, dmgType: 'pierce', bonus: { 1: 2, 5: 10, 11: 240, 17: 2 }, armorTags: [20, 31] },
    antiquity_mangonel: { name: '古典轻型投石车', cls: 'ranged', sz: 1, aoe: true, hp: 50, atk: 40, meleeArmor: 0, pierceArmor: 6, rng: 280, reload: 6.0, spd: 50, dmgType: 'melee', bonus: { 11: 280, 20: 12, 37: 40 }, armorTags: [20, 31] },
    antiquity_onager: { name: '古典中型投石车高级', cls: 'ranged', sz: 1, aoe: true, hp: 60, atk: 50, meleeArmor: 0, pierceArmor: 7, rng: 320, reload: 6.0, spd: 50, dmgType: 'melee', bonus: { 11: 360, 20: 12, 37: 50 }, armorTags: [20, 31] },
    antiquity_siege_onager: { name: '古典重型投石车重装', cls: 'ranged', sz: 1, aoe: true, hp: 70, atk: 75, meleeArmor: 0, pierceArmor: 8, rng: 320, reload: 6.0, spd: 50, dmgType: 'melee', bonus: { 11: 480, 20: 12, 37: 50 }, armorTags: [20, 31] },
    antiquity_siege_ram: { name: '古典重型攻城槌重装', cls: 'melee', sz: 1, hp: 270, atk: 4, meleeArmor: -1, pierceArmor: 195, rng: 0, reload: 5.0, spd: 55, dmgType: 'melee', bonus: { 11: 600, 20: 65 }, armorTags: [17, 20, 31] },
    antiquity_siege_tower: { name: '古典攻城塔', cls: 'ranged', sz: 1, hp: 220, atk: 6, meleeArmor: -2, pierceArmor: 100, rng: 240, reload: 4.0, spd: 40, dmgType: 'pierce', bonus: { 11: 180 }, armorTags: [20, 17, 31] },
    // ── 英雄单位（2026-09-06 补）──
    ...
    hero_basileus: { name: '英雄·皇帝巴西琉斯', cls: 'cav', sz: 1, hp: 40, atk: 4, meleeArmor: 0, pierceArmor: 1, rng: 0, reload: 2, spd: 130, dmgType: 'melee', bonus: { 8: 0, 15: 0, 16: 0, 20: 0, 21: 0, 25: 0, 30: 0 }, armorTags: [1, 19, 31] },
    ...
    hero_ivaylo: { name: '英雄·骑马伊瓦伊洛', cls: 'cav', sz: 1, hp: 180, atk: 14, meleeArmor: 1, pierceArmor: 2, rng: 0, reload: 1.9, spd: 130, dmgType: 'melee', bonus: { 11: 0, 15: 0, 20: 0, 21: 0, 38: 0, 39: -3 }, armorTags: [8, 19, 31, 36] },
    hero_ivaylofoot: { name: '英雄·步战伊瓦伊洛', cls: 'melee', sz: 1, hp: 120, atk: 13, meleeArmor: 0, pierceArmor: 1, rng: 0, reload: 2, spd: 55, dmgType: 'melee', bonus: { 8: 0, 15: 0, 21: 4, 29: 0, 30: 0 }, armorTags: [1, 31, 36] },
    ...
    hero_joanofarc: { name: '英雄·全甲战马圣女贞德', cls: 'cav', sz: 1, hp: 200, atk: 17, meleeArmor: 2, pierceArmor: 2, rng: 0, reload: 2, spd: 130, dmgType: 'melee', bonus: { 20: 0, 38: 0, 39: -3 }, armorTags: [8, 31, 36] },
    ...
    thirisadai: { name: '孟加拉楼船', cls: 'ranged', sz: 1, hp: 250, atk: 10, meleeArmor: 2, pierceArmor: 11, rng: 280, reload: 3.45, spd: 76, dmgType: 'pierce', bonus: { 11: 7, 16: 0, 17: 4, 60: 7 }, armorTags: [2, 16, 19, 31, 60] },
    ...
    onager_ship: { name: '中型投石舰', cls: 'ranged', sz: 1, hp: 150, atk: 50, meleeArmor: 2, pierceArmor: 7, rng: 320, reload: 6.0, spd: 61, dmgType: 'pierce', bonus: { 11: 20, 16: 0, 17: 0 }, armorTags: [16, 31, 60] },
    monoreme: { name: '单列桨座战船', cls: 'melee', sz: 1, hp: 100, atk: 5, meleeArmor: 2, pierceArmor: 2, rng: 0, reload: 2.0, spd: 82, dmgType: 'melee', bonus: { 11: 2, 16: 0, 17: 3, 60: 0 }, armorTags: [16, 31] },
    bireme: { name: '双列桨座战船', cls: 'melee', sz: 1, hp: 120, atk: 10, meleeArmor: 3, pierceArmor: 4, rng: 0, reload: 2.0, spd: 82, dmgType: 'melee', bonus: { 11: 3, 16: 0, 17: 3, 60: 0 }, armorTags: [16, 31] },
    trireme: { name: '三列桨座战船', cls: 'melee', sz: 1, hp: 140, atk: 14, meleeArmor: 4, pierceArmor: 5, rng: 0, reload: 2.0, spd: 82, dmgType: 'melee', bonus: { 11: 5, 16: 0, 17: 3, 60: 0 }, armorTags: [16, 31] },
    lembos: { name: '希腊轻型伦博斯', cls: 'melee', sz: 1, hp: 80, atk: 2, meleeArmor: 0, pierceArmor: 4, rng: 0, reload: 3.2, spd: 88, dmgType: 'melee', bonus: { 11: 0, 16: 0, 17: 3, 60: 2 }, armorTags: [16, 31] },
    war_lembos: { name: '希腊战型伦博斯高级', cls: 'ranged', sz: 1, hp: 90, atk: 4, meleeArmor: 0, pierceArmor: 5, rng: 80, reload: 2.5, spd: 92, dmgType: 'pierce', bonus: { 11: 0, 16: 0, 17: 3, 60: 4 }, armorTags: [16, 31] },
    elite_lembos: { name: '希腊旗舰伦博斯重装', cls: 'ranged', sz: 1, hp: 120, atk: 10, meleeArmor: 0, pierceArmor: 6, rng: 120, reload: 2.5, spd: 98, dmgType: 'pierce', bonus: { 11: 0, 16: 0, 17: 3, 60: 10 }, armorTags: [16, 31] },
    heavy_lembos: { name: '希腊重型伦博斯重装', cls: 'ranged', sz: 1, hp: 100, atk: 8, meleeArmor: 0, pierceArmor: 5, rng: 120, reload: 2.5, spd: 92, dmgType: 'pierce', bonus: { 11: 0, 16: 0, 17: 3, 60: 8 }, armorTags: [16, 31] },
    dromon: { name: '德罗蒙战舰', cls: 'ranged', sz: 1, hp: 125, atk: 8, meleeArmor: 1, pierceArmor: 6, rng: 480, reload: 8.0, spd: 70, dmgType: 'pierce', bonus: { 11: 34, 20: 2, 22: 15, 26: 9 }, armorTags: [16, 31, 60] },
    hulk: { name: '霍克船', cls: 'melee', sz: 1, hp: 90, atk: 4, meleeArmor: 4, pierceArmor: 1, rng: 0, reload: 1.75, spd: 87, dmgType: 'melee', bonus: { 11: 0, 16: 0, 21: -3, 41: 1 }, armorTags: [16] },
    war_hulk: { name: '霍克船高级', cls: 'melee', sz: 1, hp: 115, atk: 4, meleeArmor: 5, pierceArmor: 1, rng: 0, reload: 1.5, spd: 87, dmgType: 'melee', bonus: { 11: 0, 16: 0, 21: -3, 41: 1 }, armorTags: [16] },
    carrack: { name: '克拉克帆船', cls: 'melee', sz: 1, hp: 135, atk: 4, meleeArmor: 6, pierceArmor: 1, rng: 0, reload: 1.5, spd: 93, dmgType: 'melee', bonus: { 11: 0, 16: 0, 21: -3, 41: 1 }, armorTags: [16] },
    incendiary_raft: { name: '燃烧木筏', cls: 'melee', sz: 1, hp: 45, atk: 70, meleeArmor: 0, pierceArmor: 2, rng: 0, reload: 0.0, spd: 92, dmgType: 'melee', bonus: { 11: 180, 16: 0, 17: 0 }, armorTags: [16, 31] },
    canoe: { name: '独木舟', cls: 'ranged', sz: 1, hp: 70, atk: 7, meleeArmor: 0, pierceArmor: 6, rng: 200, reload: 3.0, spd: 92, dmgType: 'pierce', bonus: { 11: 7, 16: 9, 17: 4 }, armorTags: [16, 19, 31, 60] },
    merchant_ship: { name: '商船', cls: 'melee', sz: 1, hp: 80, atk: 0, meleeArmor: 0, pierceArmor: 6, rng: 0, reload: 0.0, spd: 101, dmgType: 'melee', armorTags: [16, 31] },
    junk: { name: '中式帆船', cls: 'ranged', sz: 1, hp: 140, atk: 8, meleeArmor: 0, pierceArmor: 7, rng: 260, reload: 3.0, spd: 82, dmgType: 'pierce', bonus: { 11: 6, 16: 0, 17: 3, 60: 6 }, armorTags: [16, 31, 60] },
    trade_cog: { name: '柯克货船', cls: 'melee', sz: 1, hp: 105, atk: 5, meleeArmor: 4, pierceArmor: 1, rng: 0, reload: 1.75, spd: 83, dmgType: 'melee', bonus: { 11: 0, 16: 0, 21: -3, 41: 1 }, armorTags: [16] },
    transport_ship: { name: '运输船', cls: 'ranged', sz: 1, hp: 95, atk: 4, meleeArmor: 0, pierceArmor: 4, rng: 200, reload: 3.0, spd: 92, dmgType: 'pierce', bonus: { 11: 4, 16: 0, 17: 2, 60: 3 }, armorTags: [16, 31] },
    leviathan: { name: '利维坦', cls: 'ranged', sz: 1, hp: 180, atk: 60, meleeArmor: 2, pierceArmor: 8, rng: 520, reload: 8.0, spd: 67, dmgType: 'pierce', bonus: { 11: 225, 16: 0, 17: 0 }, armorTags: [16, 31, 60] },
    ...
    galleon: { name: '盖伦帆船', cls: 'ranged', sz: 1, hp: 155, atk: 9, meleeArmor: 0, pierceArmor: 6, rng: 280, reload: 3.0, spd: 83, dmgType: 'pierce', bonus: { 11: 6, 16: 0, 17: 3, 60: 9 }, armorTags: [16, 31, 60] },
    ...
    catapult_galleon: { name: '投石盖伦船', cls: 'ranged', sz: 1, hp: 140, atk: 30, meleeArmor: 0, pierceArmor: 6, rng: 480, reload: 6.0, spd: 61, dmgType: 'pierce', bonus: { 11: 130, 20: 10 }, armorTags: [16, 31, 60] },
