...
export const WAR_TYPES: Record<string, WarType> = {
    ...
    frankish_paladin: { name: '中世纪枪骑兵重装', cls: 'cav', sz: 1, hp: 160, atk: 14, meleeArmor: 2, pierceArmor: 3, rng: 0, reload: 1.9, spd: 130, dmgType: 'melee', armorTags: [8, 31] },
    ...
    jian_swordsman: { name: '华夏盾牌步兵', cls: 'melee', sz: 1, hp: 70, atk: 8, meleeArmor: 0, pierceArmor: 5, rng: 0, reload: 2.0, spd: 50, dmgType: 'melee', bonus: { 15: 4, 21: 2 }, armorTags: [1, 31, 29, 19] },
    ...
    savar: { name: '萨珊萨瓦兰骑兵重装', cls: 'cav', sz: 1, hp: 145, atk: 14, meleeArmor: 3, pierceArmor: 4, rng: 0, reload: 1.8, spd: 130, dmgType: 'melee', bonus: { 15: 2 }, armorTags: [8, 31] },
    ...
    elite_bolas_rider: { name: '马普切套索骑兵精锐', cls: 'cav', sz: 1, hp: 65, atk: 6, meleeArmor: 0, pierceArmor: 2, rng: 200, reload: 2.0, spd: 130, dmgType: 'pierce', bonus: { 8: 3, 17: 2, 30: 3 }, armorTags: [19, 28, 15, 8, 31] },
    ...
    elite_hoplite: { name: '希腊重装步兵精锐', cls: 'melee', sz: 1, hp: 70, atk: 12, meleeArmor: 2, pierceArmor: 1, rng: 20, reload: 2.0, spd: 50, dmgType: 'melee', bonus: { 21: 2 }, armorTags: [1, 19, 31] },
    ...
    elite_immortal_ranged: { name: '波斯长生军弓手精锐', cls: 'ranged', sz: 1, hp: 60, atk: 6, meleeArmor: 1, pierceArmor: 3, rng: 200, reload: 1.8, spd: 50, dmgType: 'pierce', armorTags: [15, 19, 31, 1] },
    imperial_camel_rider: { name: '印度斯坦骆驼骑兵', cls: 'cav', sz: 1, hp: 140, atk: 8, meleeArmor: 0, pierceArmor: 0, rng: 0, reload: 2.0, spd: 130, dmgType: 'melee', bonus: { 8: 18, 16: 9, 30: 9, 35: 7 }, armorTags: [30, 31, 39] },
    imperial_centurion: { name: '罗马骑兵重装', cls: 'cav', sz: 1, hp: 150, atk: 12, meleeArmor: 2, pierceArmor: 1, rng: 0, reload: 1.7, spd: 130, dmgType: 'melee', bonus: { 1: 12 }, armorTags: [8, 19, 31] },
    ...
    elite_phalangite: { name: '马其顿方阵步兵精锐', cls: 'melee', sz: 1, hp: 65, atk: 8, meleeArmor: 2, pierceArmor: 0, rng: 72, reload: 2.5, spd: 50, dmgType: 'melee', bonus: { 5: 20, 8: 26, 30: 6 }, armorTags: [1, 19, 31] },
    ...
    sannahya: { name: '孔雀桑纳亚战象', cls: 'melee', sz: 1, aoe: true, hp: 300, atk: 10, meleeArmor: 1, pierceArmor: 3, rng: 0, reload: 2.0, spd: 40, dmgType: 'melee', bonus: { 13: 4, 21: 4 }, armorTags: [5, 8, 31, 19] },
    elite_sannahya: { name: '孔雀桑纳亚战象精锐', cls: 'melee', sz: 1, aoe: true, hp: 400, atk: 12, meleeArmor: 2, pierceArmor: 4, rng: 0, reload: 2.0, spd: 40, dmgType: 'melee', bonus: { 13: 4, 21: 4 }, armorTags: [5, 8, 31, 19] },
    ...
    sogdian_cataphract: { name: '粟特甲胄骑兵重装', cls: 'cav', sz: 1, hp: 110, atk: 12, meleeArmor: 0, pierceArmor: 5, rng: 0, reload: 2.0, spd: 130, dmgType: 'melee', bonus: { 15: 6 }, armorTags: [8, 19, 31] },
    ...
    jian_swordman_unshielded: {name:"华夏双手剑士",cls:"melee",sz:1,hp:70,atk:11,meleeArmor:0,pierceArmor:2,rng:0,reload:2.0,spd:50,dmgType:"melee",bonus:{21:2,15:4},armorTags:[1,19,29,31]},
    ...
    sarmatian: { name: '东欧萨尔马提亚骑兵重装', cls: 'cav', sz: 1, hp: 140, atk: 13, meleeArmor: 3, pierceArmor: 3, rng: 0, reload: 1.9, spd: 130, dmgType: 'melee', armorTags: [8, 19, 31] },
