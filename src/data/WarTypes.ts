...
export const WAR_TYPES: Record<string, WarType> = {
    ...
    sannahya: { name: '孔雀桑纳亚战象高级', cls: 'melee', sz: 1, aoe: true, hp: 300, atk: 10, meleeArmor: 1, pierceArmor: 3, rng: 0, reload: 2.0, spd: 40, dmgType: 'melee', bonus: { 13: 4, 21: 4 }, armorTags: [5, 8, 31, 19] },
