...
export const WAR_TYPES: Record<string, WarType> = {
    ...
    jarl: { name: '维京首领骑兵', cls: 'cav', sz: 1, hp: 140, atk: 18, meleeArmor: 1, pierceArmor: 1, rng: 0, reload: 2.1, spd: 130, dmgType: 'melee', bonus: { 11: 5 }, armorTags: [8, 31] },
    ...
    sakan_axeman: { name: '萨迦斧兵', cls: 'melee', sz: 1, hp: 80, atk: 9, meleeArmor: 1, pierceArmor: 3, rng: 0, reload: 2.0, spd: 55, dmgType: 'melee', bonus: { 21: 3, 29: 6 }, armorTags: [1, 19, 31, 36] },
