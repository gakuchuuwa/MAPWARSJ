...
export const DIANQIAN_EXPEDITION_ELITE_LEGIONS: Readonly<Record<string, { name: string; tier: 0 | 1 | 2 | 3 | 4 }>> = {
  ...
  ava: { name: '王都卫军', tier: 4 },
    ...
    miaomin: { name: '苗疆义军', tier: 4 },
    dongzu: { name: '侗家义军', tier: 4 },
};
