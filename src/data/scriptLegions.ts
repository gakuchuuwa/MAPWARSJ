...
export const SCRIPT_LEGIONS: ScriptLegionDef[] = [
    ...
    },
    {
        ...
        name: '斯基泰军',
        // 🔴 三排＝骑兵、步兵、远程各一排（AGENTS 二·3），前后顺序按「这支军队一贯怎么打、谁先接敌」：
        //    斯基泰是游牧骑兵，在锡尔河战役中隔河以骑射手先接敌骚扰射击，
        //    随后以近战斧骑兵跟进冲击，辅以部落步兵压阵 → 前＝远程、中＝骑兵、后＝步兵。
        //    人数按英文维基百科 Battle of Jaxartes 所述游牧军队以骑射为绝对主体，近战骑兵次之，步兵最少，
        //    取最接近的雁行阵 4-3-2（前4/中3/后2）。
        formationMode: 'echelon',
        slots: [
            { type: 'scythian_horse_archer', count: 4 }, // 前排远程：斯基泰骑射手，隔河齐射与游牧散开奔射放风筝
            { type: 'scythian_axe_cavalry', count: 3 },  // 中排骑兵：斯基泰斧骑兵高级，近战肉搏冲击
            { type: 'vanguard', count: 2 },              // 后排步兵：部落近战步兵（素材样貌：古典时代步兵）
        ],
        ...
        source: '英文维基百科 Battle of Jaxartes：斯基泰骑兵隔锡尔河以骑射嘲弄阻击，'
            ...
            + '三排按游牧战术「远程骑射最前且最多、近战骑兵居中冲击、辅助步兵殿后」取雁行阵 前远程4 / 中骑兵3 / 后步兵2。',
    },
];
