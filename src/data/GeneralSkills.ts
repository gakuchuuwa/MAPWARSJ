...
export const GENERAL_PROFILES: Record<string, GeneralProfile> = {
    ...
    beitiaoshikang: { generalId: 'beitiaoshikang', tier: 'famous', tacticalSkillId: 'tac_05', strategicSkillId: 'str_05' }, // 小田原笼城外交固守
    ...
    zhelemei: { generalId: 'zhelemei', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_01' }, // 者勒蔑轻骑奇袭救主
    weichoutai: { generalId: 'weichoutai', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // 扶余据城固守
    wanyanzongbi: { generalId: 'wanyanzongbi', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_04' }, // 郾城铁浮屠平原突击
    ...
    zudashou: { generalId: 'zudashou', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // 宁远大捷筑城拒敌
    ...
    wanyanloushi: { generalId: 'wanyanloushi', tier: 'famous', tacticalSkillId: 'tac_05', strategicSkillId: 'str_02' }, // 襄阳六年围城
    ...
    zhangzhensun: { generalId: 'zhangzhensun', tier: 'ordinary', tacticalSkillId: 'tac_06' }, // 广州守城抗元
    ...
    maji: { generalId: 'maji', tier: 'famous', tacticalSkillId: 'tac_05', strategicSkillId: 'str_05' }, // 静江抗元
    ...
    zhangshun: { generalId: 'zhangshun', tier: 'famous', tacticalSkillId: 'tac_05', strategicSkillId: 'str_05' }, // 死援襄阳
    ...
    jiangwei: { generalId: 'jiangwei', tier: 'famous', tacticalSkillId: 'tac_05', strategicSkillId: 'str_05' }, // 剑门拒钟会
    ...
    poliuhanbaling: { generalId: 'poliuhanbaling', tier: 'ordinary', tacticalSkillId: 'tac_08' }, // 六镇起义
    ...
    sunbin: { generalId: 'sunbin', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_06' }, // 围魏救赵
    ...
    fengba: { generalId: 'fengba', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // 北燕皇帝
    ...
    zhoutai: { generalId: 'zhoutai', tier: 'ordinary', tacticalSkillId: 'tac_08' }, // 濡须督
    luxun_sunwu: { generalId: 'luxun_sunwu', tier: 'famous', tacticalSkillId: 'tac_01', strategicSkillId: 'str_06' }, // 夷陵火攻
