...
export const TACTICAL_SKILL_CATALOG: Record<string, TacticalSkillDef> = {
    tac_01: { id: 'tac_01', grid: '①', displayName: '以逸待劳', timing: 'opening', effect: 'ally_add_troops', magnitude: 0.20, isOncePerBattle: true },
...
export const GENERAL_PROFILES: Record<string, GeneralProfile> = {
    wuzhou_d_wuzetian: { generalId: 'wuzhou_d_wuzetian', tier: 'famous', tacticalSkillId: 'tac_04', strategicSkillId: 'str_07' },    guishuang_qiuqiujiu: { generalId: 'guishuang_qiuqiujiu', tier: 'ordinary', tacticalSkillId: 'tac_01' },    qidan_shulvping: { generalId: 'qidan_shulvping', tier: 'ordinary', tacticalSkillId: 'tac_09' }, // 辽太祖皇后，政治手腕削弱对手
    hui_bunaihou: { generalId: 'hui_bunaihou', tier: 'ordinary', tacticalSkillId: 'tac_08' }, // ── 中国及外围 ──
    xin_baiqi: { generalId: 'xin_baiqi', tier: 'ordinary', tacticalSkillId: 'tac_03' },    qin_wangjian: { generalId: 'qin_wangjian', tier: 'famous', tacticalSkillId: 'tac_05', strategicSkillId: 'str_03' }, // S②攻城拔寨 + ⑤不动如山（灭国统帅，坚壁挫楚）
    qin_simacuo: { generalId: 'qin_simacuo', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_05' }, // S⑤居高临下 + ②避实击虚（越岭平蜀，奇袭楚国）
    qin_wangben: { generalId: 'qin_wangben', tier: 'famous', tacticalSkillId: 'tac_01', strategicSkillId: 'str_01' }, // S①兵贵神速 + ③侵掠如火（闪击燕齐，水淹大梁）
    qin_mengtian: { generalId: 'qin_mengtian', tier: 'ordinary', tacticalSkillId: 'tac_01' }, // S④长驱直入 + ①以逸待劳（北击匈奴，驻守长城）
    qin_yingji: { generalId: 'qin_yingji', tier: 'famous', tacticalSkillId: 'tac_01', strategicSkillId: 'str_05' },    beidi_yaochang: { generalId: 'beidi_yaochang', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // S②攻城拔寨 + ②避实击虚（擒杀苻坚，攻克长安）
    unassigned_simacuo: { generalId: 'unassigned_simacuo', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // 前316年灭蜀苴巴
    tang_lishimin: { generalId: 'tang_lishimin', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // 虎牢关轻骑冲阵
    ...
    jianzhou_nvzhen_limanzhu: { generalId: 'jianzhou_nvzhen_limanzhu', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 建州：聚合诸部筑城自守
    ...
    chanzhou_chairong: { generalId: 'chanzhou_chairong', tier: 'famous', tacticalSkillId: 'tac_01', strategicSkillId: 'str_04' }, // 澶州：周世宗亲征
    linhu_zhaowulingwang: { generalId: 'linhu_zhaowulingwang', tier: 'ordinary', tacticalSkillId: 'tac_03' },    xianyu_hanxin: { generalId: 'xianyu_hanxin', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_04' },    shizhao_d_shihu: { generalId: 'shizhao_d_shihu', tier: 'ordinary', tacticalSkillId: 'tac_08' }, // 邺都：暴虐突袭
    unassigned_loufanwang: { generalId: 'unassigned_loufanwang', tier: 'ordinary', tacticalSkillId: 'tac_06' }, // 楼烦：亡部哀兵复起
    shanrong_tianchou: { generalId: 'shanrong_tianchou', tier: 'famous', tacticalSkillId: 'tac_01', strategicSkillId: 'str_04' },    xie_cj_d_xingfangde: { generalId: 'xie_cj_d_xingfangde', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 信州：垒山筑寨据守抗元
    wan_liuyuan: { generalId: 'wan_liuyuan', tier: 'ordinary', tacticalSkillId: 'tac_01' }, // 刘源皖口
    huang_d_sunshuao: { generalId: 'huang_d_sunshuao', tier: 'ordinary', tacticalSkillId: 'tac_09' }, // 期思：筑芍陂兴水利
    wenzhou_zhangcong: { generalId: 'wenzhou_zhangcong', tier: 'ordinary', tacticalSkillId: 'tac_07' }, // 永嘉：整顿海防编练水师
    qianzhong_wubayue: { generalId: 'qianzhong_wubayue', tier: 'ordinary', tacticalSkillId: 'tac_08' }, // 乾嘉：苗民决死破清军
    dangchang_liangmiding: { generalId: 'dangchang_liangmiding', tier: 'ordinary', tacticalSkillId: 'tac_06' },    liao_houhongyuan: { generalId: 'liao_houhongyuan', tier: 'ordinary', tacticalSkillId: 'tac_06' }, // 巴僚：酋帅哀兵守土
    ...
    qingyi_fanchangsheng: { generalId: 'qingyi_fanchangsheng', tier: 'ordinary', tacticalSkillId: 'tac_06' }, // 范长生天师道
    guangping_ruanwenzhang: { generalId: 'guangping_ruanwenzhang', tier: 'ordinary', tacticalSkillId: 'tac_06' }, // 广平：象兵水师哀兵抗西山
    nanzhong_mazhong: { generalId: 'nanzhong_mazhong', tier: 'ordinary', tacticalSkillId: 'tac_01' }, // 南中：镇抚夷汉固守边郡
    yueyi_zhangyi: { generalId: 'yueyi_zhangyi', tier: 'famous', tacticalSkillId: 'tac_05', strategicSkillId: 'str_05' }, // 张嶷越嶲
    jingjiang_qushisi: { generalId: 'jingjiang_qushisi', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 永安：固守靖江破李成栋
    duanzhou_d_caojin: { generalId: 'duanzhou_d_caojin', tier: 'ordinary', tacticalSkillId: 'tac_06' }, // 端州：据城拒侬智高
    ...
    leizhou_limao_leizhou: { generalId: 'leizhou_limao_leizhou', tier: 'ordinary', tacticalSkillId: 'tac_06' }, // 雷州：驻防海康
    ketagalan_huangqingyun: { generalId: 'ketagalan_huangqingyun', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 艋舺：汛防戍守
    shuizhen_oudaren: { generalId: 'shuizhen_oudaren', tier: 'ordinary', tacticalSkillId: 'tac_06' }, // 三菩：戍卒驻守
    pingnan_musheng: { generalId: 'pingnan_musheng', tier: 'ordinary', tacticalSkillId: 'tac_08' }, // 腾越：征讨麓川屡立战功
    jingdong_taohong: { generalId: 'jingdong_taohong', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 银生：坚守退敌
    ava_sijifa: { generalId: 'ava_sijifa', tier: 'ordinary', tacticalSkillId: 'tac_06' }, // 阿瓦：哀兵退守
    dian_duanjianwei: { generalId: 'dian_duanjianwei', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // 通海：南诏都督镇守
    unassigned_monuha: { generalId: 'unassigned_monuha', tier: 'ordinary', tacticalSkillId: 'tac_01' }, // 直通：孟族国王
    luohu_ganmuding: { generalId: 'luohu_ganmuding', tier: 'ordinary', tacticalSkillId: 'tac_09' }, // 呵叻：罗斛驻守
    ...
    unassigned_piqiluomo: { generalId: 'unassigned_piqiluomo', tier: 'ordinary', tacticalSkillId: 'tac_09' }, // 骠国：守城戍卒
    ali_gandancaiwang: { generalId: 'ali_gandancaiwang', tier: 'ordinary', tacticalSkillId: 'tac_08' }, // 阿里：远征拉达克
    gaoliang_fengang: { generalId: 'gaoliang_fengang', tier: 'ordinary', tacticalSkillId: 'tac_08' },    bailan_pabala: { generalId: 'bailan_pabala', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 昌都：率僧兵守城
    ...
    unassigned_juemuba: { generalId: 'unassigned_juemuba', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 觉木：宗谿驻兵
    ...
    ming_d_zhudi: { generalId: 'ming_d_zhudi', tier: 'famous', tacticalSkillId: 'tac_09', strategicSkillId: 'str_03' }, // 靖难野战·五征漠北·所向披靡
    ...
    bohai_dazuorong: { generalId: 'bohai_dazuorong', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 渤海开基：筑城固守建国
    goryeo_jiangganzan: { generalId: 'goryeo_jiangganzan', tier: 'famous', tacticalSkillId: 'tac_01', strategicSkillId: 'str_06' }, // 金岘大捷：守土反击破辽
    ashikaga_zulijunshi: { generalId: 'ashikaga_zulijunshi', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 凑川败后据九州水师固守
    tiemuer_tiemuer: { generalId: 'tiemuer_tiemuer', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_01' }, // 六年征服千里闪击
    siam_nalixuan: { generalId: 'siam_nalixuan', tier: 'ordinary', tacticalSkillId: 'tac_03' }, // 象战击杀缅甸王储复国
    ...
    manzhou_nuerhachi: { generalId: 'manzhou_nuerhachi', tier: 'famous', tacticalSkillId: 'tac_09', strategicSkillId: 'str_03' }, // 萨尔浒野战突击
    ...
    chen3_chenwang: { generalId: 'chen3_chenwang', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 马韩辰王治月支国
    jilizhou_chengmingzhen: { generalId: 'jilizhou_chengmingzhen', tier: 'famous', tacticalSkillId: 'tac_06', strategicSkillId: 'str_06' }, // 卑沙城水陆并进攻克
    nuergan_kangwang: { generalId: 'nuergan_kangwang', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 奴儿干都司戍边
    ...
    unassigned_amursana: { generalId: 'unassigned_amursana', tier: 'famous', tacticalSkillId: 'tac_06', strategicSkillId: 'str_05' }, // 金山辉特部反清
    chuyue_shatuonasu: { generalId: 'chuyue_shatuonasu', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // 独山城处月部
    keerkezi_manasi: { generalId: 'keerkezi_manasi', tier: 'famous', tacticalSkillId: 'tac_06', strategicSkillId: 'str_03' }, // 柯尔克孜史诗英雄
    unassigned_zhangyao: { generalId: 'unassigned_zhangyao', tier: 'ordinary', tacticalSkillId: 'tac_03' }, // 星星峡嵩武军入疆
    xiyuduhu_banchao: { generalId: 'xiyuduhu_banchao', tier: 'famous', tacticalSkillId: 'tac_01', strategicSkillId: 'str_04' }, // 疏勒·36骑定西域
    yangguan_banyong: { generalId: 'yangguan_banyong', tier: 'ordinary', tacticalSkillId: 'tac_06' },    wulianghai_chelingwubashi: { generalId: 'wulianghai_chelingwubashi', tier: 'ordinary', tacticalSkillId: 'tac_05' },    tumengken_tumengken: { generalId: 'tumengken_tumengken', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 赛音诺颜抗卫拉特
    bayegu_qulishi: { generalId: 'bayegu_qulishi', tier: 'ordinary', tacticalSkillId: 'tac_01' }, // 拔野古助唐灭薛延陀
    zubu_mogusi: { generalId: 'zubu_mogusi', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // 阻卜酋长叛辽
    wuzhumuqin_duoerji: { generalId: 'wuzhumuqin_duoerji', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 乌珠穆沁随征噶尔丹
    ...
    sunite_sunitezasake: { generalId: 'sunite_sunitezasake', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 苏尼特札萨克
    bulat_boduanchaer: { generalId: 'bulat_boduanchaer', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 蒙古始祖孛端察儿石勒喀河
    ...
    date_d_yidazhengzong: { generalId: 'date_d_yidazhengzong', tier: 'famous', tacticalSkillId: 'tac_07', strategicSkillId: 'str_04' }, // 独眼兜冲阵
    ...
    otomo_d_lihuadaoxue: { generalId: 'otomo_d_lihuadaoxue', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 迁冈筑城拒敌
    higo_d_juchiwuguang: { generalId: 'higo_d_juchiwuguang', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_05' }, // 菊池河山战突击
    aizu_pushengshixiang: { generalId: 'aizu_pushengshixiang', tier: 'ordinary', tacticalSkillId: 'tac_01' }, // 会津五奉行据山城维稳
    chosokabe_changzongwobuyuanqin: { generalId: 'chosokabe_changzongwobuyuanqin', tier: 'famous', tacticalSkillId: 'tac_07', strategicSkillId: 'str_01' }, // 长宗我部奇袭统一四国
    ...
    jibei2_qingshuizongzhi: { generalId: 'jibei2_qingshuizongzhi', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 备中高松城笼城死守
    sagami_hojoujiyasu: { generalId: 'sagami_hojoujiyasu', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 小田原城·天下第一坚城
    ...
    shimotsuke_yudugongguanggang: { generalId: 'shimotsuke_yudugongguanggang', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 宇都宫筑城固守
    ...
    taira_pingzhisheng: { generalId: 'taira_pingzhisheng', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 坛浦决战水师覆没前死战（非④）
    // ── 朝鲜 ──
    joseon_lichenggui: { generalId: 'joseon_lichenggui', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_04' }, // 威化岛斩首奇袭
    gaogouli_yizhiwende: { generalId: 'gaogouli_yizhiwende', tier: 'famous', tacticalSkillId: 'tac_01', strategicSkillId: 'str_06' },    baiji_jiebai: { generalId: 'baiji_jiebai', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_03' }, // 车昌野隘突击
    zhen_zhenxuan: { generalId: 'zhen_zhenxuan', tier: 'ordinary', tacticalSkillId: 'tac_09' },    danluo_jintongjing: { generalId: 'danluo_jintongjing', tier: 'ordinary', tacticalSkillId: 'tac_06' }, // 金通精守城逆袭
    sambyeol_lishunchen: { generalId: 'sambyeol_lishunchen', tier: 'ordinary', tacticalSkillId: 'tac_01' }, // 鸣梁海龟船诱敌待发
    gaya_jinshoulu: { generalId: 'gaya_jinshoulu', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 金官伽倻筑城
    ...
    fuyu_weichoutai: { generalId: 'fuyu_weichoutai', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // 扶余据城固守
    jurchen_wanyanzongbi: { generalId: 'jurchen_wanyanzongbi', tier: 'ordinary', tacticalSkillId: 'tac_03' }, // 郾城铁浮屠平原突击（@女真五国城）
    aisin_d_huangtaiji: { generalId: 'aisin_d_huangtaiji', tier: 'famous', tacticalSkillId: 'tac_04', strategicSkillId: 'str_03' }, // 松锦战后洪承畴部归降
    mohe_wanyanzonghan: { generalId: 'mohe_wanyanzonghan', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_03' },    unassigned_tanshihuai: { generalId: 'unassigned_tanshihuai', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_04' }, // 鲜卑草原长途奔袭
    suolun_bomuboguoer: { generalId: 'suolun_bomuboguoer', tier: 'ordinary', tacticalSkillId: 'tac_08' },    dongxia_puxianwannu: { generalId: 'dongxia_puxianwannu', tier: 'ordinary', tacticalSkillId: 'tac_08' }, // 割据辽东建立东夏国
    ...
    unassigned_wangtai: { generalId: 'unassigned_wangtai', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // 王台部寨固守
    jinzhou_lichengliang: { generalId: 'jinzhou_lichengliang', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_05' }, // 擒王杲、破阿台奇袭
    zu_d_zudashou: { generalId: 'zu_d_zudashou', tier: 'famous', tacticalSkillId: 'tac_05', strategicSkillId: 'str_08' },    wanzhou_shangguankui: { generalId: 'wanzhou_shangguankui', tier: 'ordinary', tacticalSkillId: 'tac_09' }, // 万州天生城抗元
    chenzhou_d_zhanggao: { generalId: 'chenzhou_d_zhanggao', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // 辰州戍守
    mao_wenlong_maowenlong: { generalId: 'mao_wenlong_maowenlong', tier: 'ordinary', tacticalSkillId: 'tac_01' }, // 皮岛东江据岛固守
    dawoer_baldaqi: { generalId: 'dawoer_baldaqi', tier: 'ordinary', tacticalSkillId: 'tac_10' },    heishui_nishuli: { generalId: 'heishui_nishuli', tier: 'ordinary', tacticalSkillId: 'tac_06' },    yeren_nvzhen_boke: { generalId: 'yeren_nvzhen_boke', tier: 'ordinary', tacticalSkillId: 'tac_10' },    wuji_yilizhi: { generalId: 'wuji_yilizhi', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // 勿吉首领朝贡北魏
    jilin_fujun: { generalId: 'jilin_fujun', tier: 'ordinary', tacticalSkillId: 'tac_03' }, // 吉林将军屯田戍边
    ...
    sushen_tudiji: { generalId: 'sushen_tudiji', tier: 'ordinary', tacticalSkillId: 'tac_07' }, // 靺鞨首领突地稽归唐
    yilou_naoya: { generalId: 'yilou_naoya', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // 挹娄首领助战高句丽
    maomingan_gentemuer: { generalId: 'maomingan_gentemuer', tier: 'ordinary', tacticalSkillId: 'tac_01' }, // 达斡尔酋长格尔必齐
    unassigned_kaolangwu: { generalId: 'unassigned_kaolangwu', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // 囊哈儿卫指挥考郎兀
    unassigned_hazheng: { generalId: 'unassigned_hazheng', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // 兀列河卫哈正诺托罗
    unassigned_hudamu: { generalId: 'unassigned_hudamu', tier: 'ordinary', tacticalSkillId: 'tac_01' }, // 野人女真忽答木盆奴里
    ...
    hezhe_sharhuda: { generalId: 'hezhe_sharhuda', tier: 'ordinary', tacticalSkillId: 'tac_05' },    liao_d_yelvabaoji: { generalId: 'liao_d_yelvabaoji', tier: 'famous', tacticalSkillId: 'tac_09', strategicSkillId: 'str_03' }, // 统一契丹灭渤海
    ...
    wuzhou_liguang: { generalId: 'wuzhou_liguang', tier: 'famous', tacticalSkillId: 'tac_08', strategicSkillId: 'str_04' },    yuwen_yuwentai: { generalId: 'yuwen_yuwentai', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_04' }, // 沙苑以少胜多
...
// ── 草原区 2026-06-18 ──
    ...
    merkit_tuoheituoa: { generalId: 'merkit_tuoheituoa', tier: 'famous', tacticalSkillId: 'tac_01', strategicSkillId: 'str_08' },    tumed_andahan: { generalId: 'tumed_andahan', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_04' }, // 庚戌之变长驱围北京
    kiyad_yesugai: { generalId: 'kiyad_yesugai', tier: 'famous', tacticalSkillId: 'tac_10', strategicSkillId: 'str_01' }, // 也速该草原奔袭
    ...
    yuan_d_hubilie: { generalId: 'yuan_d_hubilie', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 襄阳围城六年灭宋
    mengwu_hebulerhan: { generalId: 'mengwu_hebulerhan', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 蒙兀山城抗金
    ...
    kereyid_wanghan: { generalId: 'kereyid_wanghan', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 克烈部固守草原霸主
    ...
    jalair_muhuali: { generalId: 'jalair_muhuali', tier: 'famous', tacticalSkillId: 'tac_05', strategicSkillId: 'str_03' },    hongirad_dexuechan: { generalId: 'hongirad_dexuechan', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 弘吉剌部固守
    choros_tuohuan: { generalId: 'choros_tuohuan', tier: 'famous', tacticalSkillId: 'tac_01', strategicSkillId: 'str_04' },    tiele_qibiheli: { generalId: 'tiele_qibiheli', tier: 'famous', tacticalSkillId: 'tac_05', strategicSkillId: 'str_06' }, // 征高句丽水陆并进
    ...
    cheshihou_cheshihouwang: { generalId: 'cheshihou_cheshihouwang', tier: 'ordinary', tacticalSkillId: 'tac_01' },    kaerka_abadaikehan: { generalId: 'kaerka_abadaikehan', tier: 'famous', tacticalSkillId: 'tac_01', strategicSkillId: 'str_04' }, // 喀尔喀统一待变
    huyan_huyanwang: { generalId: 'huyan_huyanwang', tier: 'ordinary', tacticalSkillId: 'tac_07' }, // 呼衍王西域游击
    chahar_lindanhan: { generalId: 'chahar_lindanhan', tier: 'ordinary', tacticalSkillId: 'tac_03' },    ongut_alagusi: { generalId: 'ongut_alagusi', tier: 'ordinary', tacticalSkillId: 'tac_09' }, // 汪古部外交附蒙
    rouran_shelun: { generalId: 'rouran_shelun', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // 柔然脱鲜卑神速立国
    chagatai_tuhulutiemuer: { generalId: 'chagatai_tuhulutiemuer', tier: 'famous', tacticalSkillId: 'tac_05', strategicSkillId: 'str_05' },    huihu_dongmohedagan: { generalId: 'huihu_dongmohedagan', tier: 'famous', tacticalSkillId: 'tac_05', strategicSkillId: 'str_04' },    huige_gulipeiluo: { generalId: 'huige_gulipeiluo', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_04' },    huizhou_zhugeliang: { generalId: 'huizhou_zhugeliang', tier: 'ordinary', tacticalSkillId: 'tac_01' }, // 诸葛亮元戎弩
    pulei_dougu: { generalId: 'pulei_dougu', tier: 'famous', tacticalSkillId: 'tac_07', strategicSkillId: 'str_03' }, // 蒲类海大破北匈奴呼衍王
    xibo_d_zakulan: { generalId: 'xibo_d_zakulan', tier: 'ordinary', tacticalSkillId: 'tac_10' },    pugu_puguhuaien: { generalId: 'pugu_puguhuaien', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 平乱后叛唐据守
    pugu_ashinagudulu: { generalId: 'pugu_ashinagudulu', tier: 'famous', tacticalSkillId: 'tac_01', strategicSkillId: 'str_03' }, // 后突厥汗国重建者
    kelie_zhaheganbu: { generalId: 'kelie_zhaheganbu', tier: 'ordinary', tacticalSkillId: 'tac_07' },    borjigin_tuolei: { generalId: 'borjigin_tuolei', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_05' }, // 三峰山奇袭灭金主力
    ...
    chechen_chechenhanshuolei: { generalId: 'chechen_chechenhanshuolei', tier: 'ordinary', tacticalSkillId: 'tac_01' }, // 车臣部驻牧固守
    kepantuo_hanritianzhong: { generalId: 'kepantuo_hanritianzhong', tier: 'ordinary', tacticalSkillId: 'tac_10' },    huite_amuersana: { generalId: 'huite_amuersana', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_04' },    unassigned_yuchiyao: { generalId: 'unassigned_yuchiyao', tier: 'ordinary', tacticalSkillId: 'tac_10' },    xingxingxia_zhangyao_x: { generalId: 'xingxingxia_zhangyao_x', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_04' },    xingxingxia_guoxiaoke: { generalId: 'xingxingxia_guoxiaoke', tier: 'ordinary', tacticalSkillId: 'tac_08' }, // 郭孝恪置死地
// ── 西域区 2026-06-18 ──
    shache_xian_suoche_wang: { generalId: 'shache_xian_suoche_wang', tier: 'ordinary', tacticalSkillId: 'tac_09' }, // 莎车王纵横西域外交
    yao_liuyuan: { generalId: 'yao_liuyuan', tier: 'famous', tacticalSkillId: 'tac_10', strategicSkillId: 'str_04' },    kong_d_kongrong: { generalId: 'kong_d_kongrong', tier: 'ordinary', tacticalSkillId: 'tac_05' },    tongma_liuang: { generalId: 'tongma_liuang', tier: 'ordinary', tacticalSkillId: 'tac_08' },    yanchuan_d_hanyu: { generalId: 'yanchuan_d_hanyu', tier: 'ordinary', tacticalSkillId: 'tac_09' },    guide_d_xiaohe: { generalId: 'guide_d_xiaohe', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // 萧何深沟高垒
    tongzhou_liuzhiyuan: { generalId: 'tongzhou_liuzhiyuan', tier: 'ordinary', tacticalSkillId: 'tac_05' },    unassigned_chenpan: { generalId: 'unassigned_chenpan', tier: 'ordinary', tacticalSkillId: 'tac_07' }, // 疏勒王联汉奇袭
    dzungar_gaerdancelin: { generalId: 'dzungar_gaerdancelin', tier: 'famous', tacticalSkillId: 'tac_01', strategicSkillId: 'str_05' },    anxi_guoxin: { generalId: 'anxi_guoxin', tier: 'famous', tacticalSkillId: 'tac_05', strategicSkillId: 'str_08' },    yanqi_longtuqizhi: { generalId: 'yanqi_longtuqizhi', tier: 'ordinary', tacticalSkillId: 'tac_07' }, // 焉耆王劫掠商道游击
    tuerhute_wobaxi: { generalId: 'tuerhute_wobaxi', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_01' }, // 土尔扈特万里东归
    gaochang_quwentai: { generalId: 'gaochang_quwentai', tier: 'ordinary', tacticalSkillId: 'tac_02' },    yarkand_abuladitifu: { generalId: 'yarkand_abuladitifu', tier: 'ordinary', tacticalSkillId: 'tac_08' }, // 叶尔羌名将死战准清
    ...
    kala_satuke: { generalId: 'kala_satuke', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_04' },    tujishi_sulukehan: { generalId: 'tujishi_sulukehan', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_04' }, // 突骑施公牛抗阿拉伯
    xiliao_yelvdashi: { generalId: 'xiliao_yelvdashi', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_01' },    jiazini_mahamaode: { generalId: 'jiazini_mahamaode', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_03' }, // 马哈茂德十七征印度
    an_xibanni: { generalId: 'an_xibanni', tier: 'ordinary', tacticalSkillId: 'tac_03' }, // 昔班尼攻布哈拉建汗国
...
// ── 中亚区 2026-06-18 ──
    huarazim_mohemo: { generalId: 'huarazim_mohemo', tier: 'famous', tacticalSkillId: 'tac_08', strategicSkillId: 'str_03' },    kazakh_hasimu: { generalId: 'kazakh_hasimu', tier: 'famous', tacticalSkillId: 'tac_05', strategicSkillId: 'str_04' }, // 哈萨克汗国统一
    sogdian_dewasitiqi: { generalId: 'sogdian_dewasitiqi', tier: 'ordinary', tacticalSkillId: 'tac_06' }, // 粟特抗阿拉伯
    yanda_touluoman: { generalId: 'yanda_touluoman', tier: 'famous', tacticalSkillId: 'tac_09', strategicSkillId: 'str_04' },    yada_ahexiong: { generalId: 'yada_ahexiong', tier: 'famous', tacticalSkillId: 'tac_06', strategicSkillId: 'str_03' },    anushidgin_yile: { generalId: 'anushidgin_yile', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // 花剌子模沙抗西辽
    unassigned_muhanmodeguli: { generalId: 'unassigned_muhanmodeguli', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // 第二次塔兰战役佯败破印军
    jibin_jianisejia: { generalId: 'jibin_jianisejia', tier: 'ordinary', tacticalSkillId: 'tac_03' }, // 迦腻色迦夏都迦毕试，贵霜极盛野战征服
    ...
    dayuzi_yinalechihei: { generalId: 'dayuzi_yinalechihei', tier: 'ordinary', tacticalSkillId: 'tac_09' }, // 讹答剌守城
    shi_clan_moheduotutun: { generalId: 'shi_clan_moheduotutun', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // 石国王·唐册封吐屯
    mamon_mameng: { generalId: 'mamon_mameng', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_03' }, // 马蒙起兵夺哈里发
    jie_sijinti: { generalId: 'jie_sijinti', tier: 'ordinary', tacticalSkillId: 'tac_03' }, // 羯霜那·唐册封史国王
    unassigned_shaboluo: { generalId: 'unassigned_shaboluo', tier: 'famous', tacticalSkillId: 'tac_05', strategicSkillId: 'str_04' }, // 十箭部落西突厥
    maer_d_bahelamuchubin: { generalId: 'maer_d_bahelamuchubin', tier: 'famous', tacticalSkillId: 'tac_10', strategicSkillId: 'str_04' }, // 萨珊名将·呼罗珊边境机动作战
    wugu_d_tugelile: { generalId: 'wugu_d_tugelile', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 1040丹达内克胜伽色尼建塞尔柱
    loulan_suojie: { generalId: 'loulan_suojie', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // 精绝屯田戍边抗北匈奴
    adao_d_mafushou: { generalId: 'adao_d_mafushou', tier: 'ordinary', tacticalSkillId: 'tac_01' }, // 昆岗军台守驿
    ...
    nuoyan_d_sanyinnuoyan: { generalId: 'nuoyan_d_sanyinnuoyan', tier: 'ordinary', tacticalSkillId: 'tac_01' }, // 赛音诺颜部
    wuli_d_celeng: { generalId: 'wuli_d_celeng', tier: 'famous', tacticalSkillId: 'tac_05', strategicSkillId: 'str_04' }, // 定边左副将军乌里雅苏台
    wudu_zhangyi: { generalId: 'wudu_zhangyi', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_01' },    baishui_yanghuai: { generalId: 'baishui_yanghuai', tier: 'ordinary', tacticalSkillId: 'tac_10' },    dangzhou_dengai: { generalId: 'dangzhou_dengai', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_05' },    jiluo_d_douxian: { generalId: 'jiluo_d_douxian', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_04' }, // 燕然勒石破北匈奴
...
// ── 青藏区 2026-06-18 ──
    ...
    song2_houjunji: { generalId: 'song2_houjunji', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_03' },    gurkha_baduersaye: { generalId: 'gurkha_baduersaye', tier: 'famous', tacticalSkillId: 'tac_01', strategicSkillId: 'str_05' }, // 廓尔喀侵藏
    gongbu_gongbumangbuzhi: { generalId: 'gongbu_gongbumangbuzhi', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 工布小王
    ...
    dulan_dashibatuer: { generalId: 'dulan_dashibatuer', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 青海蒙古亲王
    ...
    gaxa_zhashiduanzhubu: { generalId: 'gaxa_zhashiduanzhubu', tier: 'ordinary', tacticalSkillId: 'tac_07' }, // 噶厦代本
    jinchuan_g_shaluoben: { generalId: 'jinchuan_g_shaluoben', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 金川固守
    xiangxiong_limixia_x: { generalId: 'xiangxiong_limixia_x', tier: 'ordinary', tacticalSkillId: 'tac_06' }, // 象雄末王
    ladakh_senggelangjie: { generalId: 'ladakh_senggelangjie', tier: 'famous', tacticalSkillId: 'tac_09', strategicSkillId: 'str_05' }, // 拉达克王
    khoshut_gushihan: { generalId: 'khoshut_gushihan', tier: 'ordinary', tacticalSkillId: 'tac_03' }, // 和硕特入藏
    ...
    xianlingqiang_dianling: { generalId: 'xianlingqiang_dianling', tier: 'ordinary', tacticalSkillId: 'tac_08' },    shaodang_mitang: { generalId: 'shaodang_mitang', tier: 'ordinary', tacticalSkillId: 'tac_07' }, // 烧当羌
    ...
    gandenpozhang_dibasangjiejiacuo: { generalId: 'gandenpozhang_dibasangjiejiacuo', tier: 'ordinary', tacticalSkillId: 'tac_09' },    khyungpo_qiongbobangse: { generalId: 'khyungpo_qiongbobangse', tier: 'ordinary', tacticalSkillId: 'tac_08' }, // 吐蕃大论
    ...
    tsangpa_pengcuonanjie: { generalId: 'tsangpa_pengcuonanjie', tier: 'ordinary', tacticalSkillId: 'tac_03' }, // 藏巴汗立国
    spurgyal_dariniansai: { generalId: 'spurgyal_dariniansai', tier: 'ordinary', tacticalSkillId: 'tac_01' }, // 悉补野奠基
    ...
    bailang_tangzeng: { generalId: 'bailang_tangzeng', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 白狼王
    ...
    pazhu_redangunsangpa: { generalId: 'pazhu_redangunsangpa', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // ── 滇缅区 2026-06-18 ──
    ...
    mu_lijiang_muzeng: { generalId: 'mu_lijiang_muzeng', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 木天王拓土
    dianguo_zhuangqiao: { generalId: 'dianguo_zhuangqiao', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // 威定滇池王滇
    konbaung_yongjiya: { generalId: 'konbaung_yongjiya', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_04' },    nanzhao_geluofeng: { generalId: 'nanzhao_geluofeng', tier: 'famous', tacticalSkillId: 'tac_01', strategicSkillId: 'str_05' }, // 天宝战争击唐
    ...
    taiyuan_manglai: { generalId: 'taiyuan_manglai', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // 兰纳灭哈里奔猜
    suke_langanheng: { generalId: 'suke_langanheng', tier: 'famous', tacticalSkillId: 'tac_10', strategicSkillId: 'str_04' }, // 素可泰扩张
    ...
    cuanshi_cuanlongyan: { generalId: 'cuanshi_cuanlongyan', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 爨氏镇南中
  ...
  // ── 岭南/越南/台湾区 2026-06-18 ──
    ...
    jing_dingbuling: { generalId: 'jing_dingbuling', tier: 'famous', tacticalSkillId: 'tac_08', strategicSkillId: 'str_03' }, // 丁朝统一
    ...
    nanyue_zhaotuo: { generalId: 'nanyue_zhaotuo', tier: 'ordinary', tacticalSkillId: 'tac_01' }, // 南越武王·绝道聚兵守五岭
    zhancheng_zhimin: { generalId: 'zhancheng_zhimin', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 占城王和亲
    ...
    yingzhou_liulong_ying: { generalId: 'yingzhou_liulong_ying', tier: 'famous', tacticalSkillId: 'tac_07', strategicSkillId: 'str_04' }, // 南汉高祖
    ...
    taiping_shidakai: { generalId: 'taiping_shidakai', tier: 'famous', tacticalSkillId: 'tac_10', strategicSkillId: 'str_04' }, // 翼王征战
    ...
    li_s_mayuan: { generalId: 'li_s_mayuan', tier: 'famous', tacticalSkillId: 'tac_08', strategicSkillId: 'str_06' },    leloi: { generalId: 'leloi', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_04' }, // 黎利抗明
    ...
    xinjiang_maji: { generalId: 'xinjiang_maji', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 肇庆摧锋军抗元
    ...
    zangke_xielongyu: { generalId: 'zangke_xielongyu', tier: 'ordinary', tacticalSkillId: 'tac_09' }, // 牂牁归唐
    ...
    shaozhou_zhangzhensun: { generalId: 'shaozhou_zhangzhensun', tier: 'ordinary', tacticalSkillId: 'tac_03' }, // 韶关抗元·大庾岭殉国
    ...
    chenghan_lite: { generalId: 'chenghan_lite', tier: 'famous', tacticalSkillId: 'tac_08', strategicSkillId: 'str_04' }, // 成汉开国
    agui: { generalId: 'agui', tier: 'famous', tacticalSkillId: 'tac_01', strategicSkillId: 'str_03' },    zuo_d_wufu_zd: { generalId: 'zuo_d_wufu_zd', tier: 'ordinary', tacticalSkillId: 'tac_07' }, // 明代平南中
    wumeng_azi_wm: { generalId: 'wumeng_azi_wm', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // 乌蒙土司
// ── 巴蜀区 2026-06-18 ──
    ...
    unassigned_baochao: { generalId: 'unassigned_baochao', tier: 'famous', tacticalSkillId: 'tac_07', strategicSkillId: 'str_04' }, // 霆军以寡击众
    ...
    shuixi_anbangyan: { generalId: 'shuixi_anbangyan', tier: 'ordinary', tacticalSkillId: 'tac_03' }, // 奢安之乱
    ...
    unassigned_lidingguo_dx: { generalId: 'unassigned_lidingguo_dx', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // 大西抗清
    zi_changhong: { generalId: 'zi_changhong', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // 资中先贤
    yidou_luxun: { generalId: 'yidou_luxun', tier: 'ordinary', tacticalSkillId: 'tac_01' }, // 夷陵火攻
    unassigned_xiangyan: { generalId: 'unassigned_xiangyan', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_03' }, // 楚将破李信
    zhongxiang_ganning: { generalId: 'zhongxiang_ganning', tier: 'famous', tacticalSkillId: 'tac_10', strategicSkillId: 'str_05' },    hezhou_wangjian_dy: { generalId: 'hezhou_wangjian_dy', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 钓鱼城炮击蒙哥·守城36年
    qiuchi_yangnandang: { generalId: 'qiuchi_yangnandang', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_05' },    unassigned_shaluoben_x: { generalId: 'unassigned_shaluoben_x', tier: 'famous', tacticalSkillId: 'tac_05', strategicSkillId: 'str_05' }, // 金川抗清
    cong_puhu: { generalId: 'cong_puhu', tier: 'ordinary', tacticalSkillId: 'tac_07' }, // 宕渠賨人随张飞
    langzhou_zhangfei: { generalId: 'langzhou_zhangfei', tier: 'ordinary', tacticalSkillId: 'tac_03' }, // 瓦口关山道破张郃
    ...
    wuxi_shamoke: { generalId: 'wuxi_shamoke', tier: 'ordinary', tacticalSkillId: 'tac_08' },    kuai_kuaiyue: { generalId: 'kuai_kuaiyue', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // 蒯氏谋士
    bandun_fanmu: { generalId: 'bandun_fanmu', tier: 'ordinary', tacticalSkillId: 'tac_07' }, // 板楯助汉
    she_shechongming: { generalId: 'she_shechongming', tier: 'famous', tacticalSkillId: 'tac_08', strategicSkillId: 'str_04' }, // 叙永奢崇明起兵反明
    ...
    unassigned_luoshao: { generalId: 'unassigned_luoshao', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 乌蒙土官
    jingmen_zhaoyun: { generalId: 'jingmen_zhaoyun', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_04' }, // 长坂坡救主
    unassigned_pengshichou: { generalId: 'unassigned_pengshichou', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // 溪州铜柱
    miaomin_shiliudeng: { generalId: 'miaomin_shiliudeng', tier: 'ordinary', tacticalSkillId: 'tac_08' }, // 苗民起义
    xiqin_xuerengao: { generalId: 'xiqin_xuerengao', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_03' },    beidi_sunang: { generalId: 'beidi_sunang', tier: 'ordinary', tacticalSkillId: 'tac_10' },    baiyang_mengtian: { generalId: 'baiyang_mengtian', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 高阙塞长城戍守
  // ── 河西区 2026-06-18 ──
    didao_duanjiong: { generalId: 'didao_duanjiong', tier: 'famous', tacticalSkillId: 'tac_09', strategicSkillId: 'str_05' },    suzhou_huoqubing: { generalId: 'suzhou_huoqubing', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_01' }, // 骠骑将军闪电战
    ...
    zhai_han_diqing: { generalId: 'zhai_han_diqing', tier: 'famous', tacticalSkillId: 'tac_09', strategicSkillId: 'str_04' },    ganzhou_dourong: { generalId: 'ganzhou_dourong', tier: 'famous', tacticalSkillId: 'tac_01', strategicSkillId: 'str_04' },    unassigned_zhaoponu: { generalId: 'unassigned_zhaoponu', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_04' }, // 破楼兰
    shazhou_zhangyichao: { generalId: 'shazhou_zhangyichao', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_05' }, // 归义收复河西
    dongshengwei_wangyue_ming: { generalId: 'dongshengwei_wangyue_ming', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_04' },    guiyi_caoyijin: { generalId: 'guiyi_caoyijin', tier: 'ordinary', tacticalSkillId: 'tac_02' },    weiming_lijiaqian: { generalId: 'weiming_lijiaqian', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_05' }, // 西夏太祖
    unassigned_lisheng_tang: { generalId: 'unassigned_lisheng_tang', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // 神策平泾原
    unassigned_chuliji: { generalId: 'unassigned_chuliji', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 崤函据守
    helian_helianbobo: { generalId: 'helian_helianbobo', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_04' }, // 统万城阳武
    chile_hulvjin: { generalId: 'chile_hulvjin', tier: 'famous', tacticalSkillId: 'tac_01', strategicSkillId: 'str_04' },    chijin_qiewangshijia: { generalId: 'chijin_qiewangshijia', tier: 'ordinary', tacticalSkillId: 'tac_07' }, // 赤斤蒙古卫
    shuofang_weiqing: { generalId: 'shuofang_weiqing', tier: 'ordinary', tacticalSkillId: 'tac_03' }, // 取河南地
    woye_huangfugui: { generalId: 'woye_huangfugui', tier: 'famous', tacticalSkillId: 'tac_01', strategicSkillId: 'str_04' }, // 度辽将军平羌
    yeli_yeliwangrong: { generalId: 'yeli_yeliwangrong', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // 定川寨破宋
    ...
    ningkou_lubode: { generalId: 'ningkou_lubode', tier: 'famous', tacticalSkillId: 'tac_05', strategicSkillId: 'str_08' },    unassigned_liuquan: { generalId: 'unassigned_liuquan', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 隋破吐谷浑、河源积石屯田（《隋书·刘权传》）
    juqu_d_juqumengxun: { generalId: 'juqu_d_juqumengxun', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_04' }, // 北凉灭西凉
    // ── 中原区 2026-06-18 ──
    li_lx_d_lichong: { generalId: 'li_lx_d_lichong', tier: 'ordinary', tacticalSkillId: 'tac_02' },    sunqin_sunchuanting: { generalId: 'sunqin_sunchuanting', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 潼关抗李自成
    tianxiong_tianchengsi: { generalId: 'tianxiong_tianchengsi', tier: 'famous', tacticalSkillId: 'tac_06', strategicSkillId: 'str_04' }, // 魏博藩镇
    ranwei_d_ranmin: { generalId: 'ranwei_d_ranmin', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_04' }, // 杀胡令
    jin_xianzhen: { generalId: 'jin_xianzhen', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // 城濮崤山
    jingzhou_gs_huangfusong: { generalId: 'jingzhou_gs_huangfusong', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_04' }, // 平黄巾
    unassigned_masui: { generalId: 'unassigned_masui', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // 洹水破田悦
    ...
    zhengzhou_chenqingzhi: { generalId: 'zhengzhou_chenqingzhi', tier: 'famous', tacticalSkillId: 'tac_08', strategicSkillId: 'str_04' }, // 七千白袍入洛阳
    xichu_xiangyu: { generalId: 'xichu_xiangyu', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_03' }, // 巨鹿彭城
    wazhai_limi_wz: { generalId: 'wazhai_limi_wz', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_04' },    jiaodong_tiandan: { generalId: 'jiaodong_tiandan', tier: 'famous', tacticalSkillId: 'tac_01', strategicSkillId: 'str_08' }, // 即墨守城五年·火牛破燕
    jibei_xuxuan_cm: { generalId: 'jibei_xuxuan_cm', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // 赤眉丞相
    qi_qihuangong: { generalId: 'qi_qihuangong', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // 尊王攘夷·九合诸侯
    huaiyang_zhouyafu: { generalId: 'huaiyang_zhouyafu', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 坚壁不出平七国
    ...
    dongxian_sunbin: { generalId: 'dongxian_sunbin', tier: 'ordinary', tacticalSkillId: 'tac_02' },    mi_mizhu: { generalId: 'mi_mizhu', tier: 'ordinary', tacticalSkillId: 'tac_01' }, // 资助刘备
    ...
    ruzhou_sunjian: { generalId: 'ruzhou_sunjian', tier: 'famous', tacticalSkillId: 'tac_10', strategicSkillId: 'str_03' }, // 江东猛虎·破虏将军
    yaozhou_limaozhen: { generalId: 'yaozhou_limaozhen', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 岐国军阀
    jiyuan_huluguang: { generalId: 'jiyuan_huluguang', tier: 'famous', tacticalSkillId: 'tac_10', strategicSkillId: 'str_04' }, // 斛律光 落雕都督
    ...
    li_bian: { generalId: 'li_bian', tier: 'famous', tacticalSkillId: 'tac_01', strategicSkillId: 'str_08' }, // 南唐烈祖，保境息民，固若金汤
    yangshao_zhoubo: { generalId: 'yangshao_zhoubo', tier: 'famous', tacticalSkillId: 'tac_10', strategicSkillId: 'str_08' }, // 诛诸吕安刘氏固若金汤
    unassigned_liuyan_ly: { generalId: 'unassigned_liuyan_ly', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_04' }, // 舂陵起兵
    zhou_jifa: { generalId: 'zhou_jifa', tier: 'famous', tacticalSkillId: 'tac_07', strategicSkillId: 'str_04' }, // 武王伐纣
    quanrong_quanrongwang: { generalId: 'quanrong_quanrongwang', tier: 'ordinary', tacticalSkillId: 'tac_06' }, // 犬戎弑幽王
    unassigned_chairong: { generalId: 'unassigned_chairong', tier: 'ordinary', tacticalSkillId: 'tac_03' }, // 高平之战·殿前诸班
    ruo_wangjian: { generalId: 'ruo_wangjian', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_03' },    unassigned_luhunrongwang: { generalId: 'unassigned_luhunrongwang', tier: 'ordinary', tacticalSkillId: 'tac_06' }, // 陆浑戎
    ...
    liwang_liguangbi: { generalId: 'liwang_liguangbi', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 太原守城·河间突骑
    ...
    shangzhou_shangyang: { generalId: 'shangzhou_shangyang', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 商鞅变法
    ...
    mengcheng_d_gaoqiong: { generalId: 'mengcheng_d_gaoqiong', tier: 'ordinary', tacticalSkillId: 'tac_01' }, // 澶渊主战
    ...
    hao_d_changyuchun: { generalId: 'hao_d_changyuchun', tier: 'famous', tacticalSkillId: 'tac_05', strategicSkillId: 'str_08' },    bozhou_d_yujin: { generalId: 'bozhou_d_yujin', tier: 'ordinary', tacticalSkillId: 'tac_06' },    song_zhaokuangyin: { generalId: 'song_zhaokuangyin', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_04' }, // 陈桥兵变
    ...
    tuoba_tuobagui: { generalId: 'tuoba_tuobagui', tier: 'ordinary', tacticalSkillId: 'tac_03' }, // 参合陂
    bing_liukun: { generalId: 'bing_liukun', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_04' },    unassigned_zhangrou: { generalId: 'unassigned_zhangrou', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // 保定重建
    ...
    hejian_gongsunzan: { generalId: 'hejian_gongsunzan', tier: 'ordinary', tacticalSkillId: 'tac_03' }, // 白马义从
    linyu_wusangui: { generalId: 'linyu_wusangui', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 山海关
    ...
    yangshe_yangshezhi: { generalId: 'yangshe_yangshezhi', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 铜鞮大夫
    guzhu_tianyu: { generalId: 'guzhu_tianyu', tier: 'ordinary', tacticalSkillId: 'tac_01' }, // 征北将军镇乌桓鲜卑
    dizhou_wangyanzhang: { generalId: 'dizhou_wangyanzhang', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_04' }, // 王铁枪乐安破晋
    dai_d_shijingtang: { generalId: 'dai_d_shijingtang', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_01' }, // 兵贵神速+侵掠如火
    ...
    heng1_limu_yanyue: { generalId: 'heng1_limu_yanyue', tier: 'famous', tacticalSkillId: 'tac_01', strategicSkillId: 'str_05' },    yan_leyi: { generalId: 'yan_leyi', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_03' }, // 伐齐下七十城
    ...
    liguo_zhaoshe_zd: { generalId: 'liguo_zhaoshe_zd', tier: 'ordinary', tacticalSkillId: 'tac_01' }, // 阏与之战
    yunzhong_tuobaliwei: { generalId: 'yunzhong_tuobaliwei', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // ── 北方关隘 2026-06-19 ──
    you_wangba: { generalId: 'you_wangba', tier: 'ordinary', tacticalSkillId: 'tac_03' }, // 耿况上谷突骑
    unassigned_zhouyuji: { generalId: 'unassigned_zhouyuji', tier: 'famous', tacticalSkillId: 'tac_05', strategicSkillId: 'str_05' }, // 宁武殉国
    yi_yuqian: { generalId: 'yi_yuqian', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 京师保卫战·固若金汤
    huo_songlaosheng: { generalId: 'huo_songlaosheng', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 宋老生霍邑
    wuling_xiangdancheng: { generalId: 'wuling_xiangdancheng', tier: 'ordinary', tacticalSkillId: 'tac_06' }, // ── 江南区 2026-06-18 ──
    ...
    fangla_fangla_jn: { generalId: 'fangla_fangla_jn', tier: 'ordinary', tacticalSkillId: 'tac_08' },    fang_guozhen_fangguozhen: { generalId: 'fang_guozhen_fangguozhen', tier: 'ordinary', tacticalSkillId: 'tac_08' }, // 方国珍割据浙东
    ouyue_zouyao: { generalId: 'ouyue_zouyao', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 东瓯王
    ruochu_doulian: { generalId: 'ruochu_doulian', tier: 'ordinary', tacticalSkillId: 'tac_07' }, // 若敖夜袭
    mi_chu_chuzhuangwang: { generalId: 'mi_chu_chuzhuangwang', tier: 'famous', tacticalSkillId: 'tac_06', strategicSkillId: 'str_04' }, // 邲之战
    ...
    yue_goujian: { generalId: 'yue_goujian', tier: 'ordinary', tacticalSkillId: 'tac_01' }, // 卧薪尝胆
    heng_hetengjiao: { generalId: 'heng_hetengjiao', tier: 'ordinary', tacticalSkillId: 'tac_06' }, // 衡州抗清
    xushouhui_zhaopusheng: { generalId: 'xushouhui_zhaopusheng', tier: 'ordinary', tacticalSkillId: 'tac_08' },    sui_yangjian: { generalId: 'sui_yangjian', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_04' }, // 隋文帝
    yang_aner_yanganer: { generalId: 'yang_aner_yanganer', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_04' }, // 杨安儿红袄军克登莱
    unassigned_mayin: { generalId: 'unassigned_mayin', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 马楚开国
    qi_d_qijiguang: { generalId: 'qi_d_qijiguang', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_05' }, // 戚继光横屿灭倭
    yezongliu_yezongliu: { generalId: 'yezongliu_yezongliu', tier: 'ordinary', tacticalSkillId: 'tac_08' },    zhangshicheng_zhangshicheng: { generalId: 'zhangshicheng_zhangshicheng', tier: 'famous', tacticalSkillId: 'tac_01', strategicSkillId: 'str_04' }, // 大周盐丁
    gumie_liuyu: { generalId: 'gumie_liuyu', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // 却月阵水陆协同灭南燕
    hu_d_husansheng: { generalId: 'hu_d_husansheng', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // 胡三省浙东义兵抗元
    unassigned_ganning: { generalId: 'unassigned_ganning', tier: 'famous', tacticalSkillId: 'tac_06', strategicSkillId: 'str_06' }, // 锦帆百骑
    ...
    shenshi_shenqingzhi: { generalId: 'shenshi_shenqingzhi', tier: 'ordinary', tacticalSkillId: 'tac_03' }, // 沈氏老将
    huangwang_huangchao: { generalId: 'huangwang_huangchao', tier: 'ordinary', tacticalSkillId: 'tac_03' }, // 冲天大将军
    ...
    liu_yingbu: { generalId: 'liu_yingbu', tier: 'famous', tacticalSkillId: 'tac_07', strategicSkillId: 'str_04' }, // 九江王
    unassigned_wangchao: { generalId: 'unassigned_wangchao', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // 光州入闽
    shuntian_linshuangwen: { generalId: 'shuntian_linshuangwen', tier: 'ordinary', tacticalSkillId: 'tac_08' },    chunshen_huangxie: { generalId: 'chunshen_huangxie', tier: 'ordinary', tacticalSkillId: 'tac_01' }, // 春申君
    ...
    unassigned_pushougeng: { generalId: 'unassigned_pushougeng', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 泉州蒲氏
    ...
    danyang_yuyunwen: { generalId: 'danyang_yuyunwen', tier: 'ordinary', tacticalSkillId: 'tac_01' },    chizhou_wumingche: { generalId: 'chizhou_wumingche', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_04' },    zhong_xiexuan: { generalId: 'zhong_xiexuan', tier: 'famous', tacticalSkillId: 'tac_01', strategicSkillId: 'str_04' }, // 淝水之战
    yuan_cj_d_yuanshu_zn: { generalId: 'yuan_cj_d_yuanshu_zn', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // 仲家皇帝
    daxi_ming_zhangxianzhong: { generalId: 'daxi_ming_zhangxianzhong', tier: 'famous', tacticalSkillId: 'tac_06', strategicSkillId: 'str_04' }, // 大西王
    sunwu_d_sunquan: { generalId: 'sunwu_d_sunquan', tier: 'ordinary', tacticalSkillId: 'tac_01' }, // 赤壁抗曹
    zhao_lianpo: { generalId: 'zhao_lianpo', tier: 'famous', tacticalSkillId: 'tac_01', strategicSkillId: 'str_05' }, // ── 2026-06-20 批量补充缺失档案 ──
    unassigned_liduozuo: {
    ...
    naju_d_wangjian_kr: { generalId: 'naju_d_wangjian_kr', tier: 'ordinary', tacticalSkillId: 'tac_03' },
    huimo_gaoyanshou: {
    ...
    haixi_nvzhen_baiyindali: { generalId: 'haixi_nvzhen_baiyindali', tier: 'ordinary', tacticalSkillId: 'tac_07' },
    dazhen_wanyantiege: {
    ...
    nguyen_guangnan_ruanfuying: { generalId: 'nguyen_guangnan_ruanfuying', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_01' },
    fushi_fuhong: {
    ...
    lushui_dongzhuo: { generalId: 'lushui_dongzhuo', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_04' },
    cen_d_cenmeng: {
    ...
    kalun_dexinga: { generalId: 'kalun_dexinga', tier: 'ordinary', tacticalSkillId: 'tac_10' },
    golog_wandezhaxi: {
    ...
    unassigned_weitou_wang: { generalId: 'unassigned_weitou_wang', tier: 'ordinary', tacticalSkillId: 'tac_03' }, // ???
    unassigned_yumi_wang: { generalId: 'unassigned_yumi_wang', tier: 'ordinary', tacticalSkillId: 'tac_01' }, // ???
    unassigned_qiemo_wang: { generalId: 'unassigned_qiemo_wang', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // ???
    ...
    unassigned_bailong_shuai: { generalId: 'unassigned_bailong_shuai', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // ?????
    unassigned_wensu_wang: { generalId: 'unassigned_wensu_wang', tier: 'ordinary', tacticalSkillId: 'tac_03' }, // ???
    duerbote_duerbote_taiji: { generalId: 'duerbote_duerbote_taiji', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // ??????
    unassigned_sai_wang: { generalId: 'unassigned_sai_wang', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // ??
    xiye_xiye_wang: { generalId: 'xiye_xiye_wang', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // ???
    unassigned_huibu_boke: { generalId: 'unassigned_huibu_boke', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // ????
    unassigned_faqiang_wang: { generalId: 'unassigned_faqiang_wang', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // ???
    ...
    unassigned_yongguo_jun: { generalId: 'unassigned_yongguo_jun', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // ????
    xingliao_dayanlin: { generalId: 'xingliao_dayanlin', tier: 'ordinary', tacticalSkillId: 'tac_01' }, // ??????
    unassigned_jingcheng_fushi: { generalId: 'unassigned_jingcheng_fushi', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // ????
    unassigned_wangmang: { generalId: 'unassigned_wangmang', tier: 'ordinary', tacticalSkillId: 'tac_07' }, // ????
    xihai_d_fulianchou: { generalId: 'xihai_d_fulianchou', tier: 'ordinary', tacticalSkillId: 'tac_03' }, // 吐谷浑可汗伏俟城
    ...
    wuhu_dukake: { generalId: 'wuhu_dukake', tier: 'ordinary', tacticalSkillId: 'tac_09' }, // 铁弓苏巴什真珠河
    unassigned_farighun: { generalId: 'unassigned_farighun', tier: 'ordinary', tacticalSkillId: 'tac_09' },    unassigned_ali_asad: { generalId: 'unassigned_ali_asad', tier: 'ordinary', tacticalSkillId: 'tac_10' },    unassigned_afshin: { generalId: 'unassigned_afshin', tier: 'ordinary', tacticalSkillId: 'tac_10' },    unassigned_aral_bek: { generalId: 'unassigned_aral_bek', tier: 'ordinary', tacticalSkillId: 'tac_10' },    unassigned_seljuk: { generalId: 'unassigned_seljuk', tier: 'ordinary', tacticalSkillId: 'tac_01' },    unassigned_xingan_zhang: { generalId: 'unassigned_xingan_zhang', tier: 'ordinary', tacticalSkillId: 'tac_10' },    unassigned_dongping_zhang: { generalId: 'unassigned_dongping_zhang', tier: 'ordinary', tacticalSkillId: 'tac_10' },    yun_wuli: { generalId: 'yun_wuli', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 卢氏戎子吾离陆浑关
    unassigned_yuchisheng_k: { generalId: 'unassigned_yuchisheng_k', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // 尉迟胜克里雅山口
    bailong_suomai: { generalId: 'bailong_suomai', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // 索劢屯田楼兰三陇沙
    sai_gejiayun: { generalId: 'sai_gejiayun', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // 盖嘉运拔换城握瑟德
    weiwuer_yusubu: { generalId: 'weiwuer_yusubu', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 玉素布阿克苏玉尔滚
    kangba_suonuomugunbu: { generalId: 'kangba_suonuomugunbu', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // 索诺木衮布理塘宣抚司
    yong_lujili: { generalId: 'yong_lujili', tier: 'ordinary', tacticalSkillId: 'tac_01' }, // 庐戢黎庸将竹山
    jingcheng_d_yuyouzhao: { generalId: 'jingcheng_d_yuyouzhao', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // 鱼有沼镜城笼耳
    ...
    nifuhe_barhudai: { generalId: 'nifuhe_barhudai', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 巴尔虎代·尼夫河
    ...
    oirat_ming_gaerdan: { generalId: 'oirat_ming_gaerdan', tier: 'famous', tacticalSkillId: 'tac_08', strategicSkillId: 'str_04' },    jilimi_takuna: { generalId: 'jilimi_takuna', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // 塔库纳·吉里密
    qianhui_baiyanhu: { generalId: 'qianhui_baiyanhu', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_04' }, // 白彦虎回军
    ganden_zongkaba: { generalId: 'ganden_zongkaba', tier: 'ordinary', tacticalSkillId: 'tac_06' },    mon_monuhe: { generalId: 'mon_monuhe', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 摩奴诃·孟族
    weili_fan_d: { generalId: 'weili_fan_d', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 尉犁泛
    ...
    feiyaka_cemutehe: { generalId: 'feiyaka_cemutehe', tier: 'ordinary', tacticalSkillId: 'tac_03' }, // 策穆特赫·费雅喀
    ...
    dong_nangqianjiabo: { generalId: 'dong_nangqianjiabo', tier: 'ordinary', tacticalSkillId: 'tac_09' }, // 囊谦加波·隆庆
    xingan_kalunshiwei: { generalId: 'xingan_kalunshiwei', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_03' },    lingqiu_zhaowuling: { generalId: 'lingqiu_zhaowuling', tier: 'ordinary', tacticalSkillId: 'tac_03' },    unassigned_zhouyuji_nw: { generalId: 'unassigned_zhouyuji_nw', tier: 'famous', tacticalSkillId: 'tac_05', strategicSkillId: 'str_05' }, // 周遇吉·楼烦
    yumi_anguo: { generalId: 'yumi_anguo', tier: 'ordinary', tacticalSkillId: 'tac_07' }, // 扜弥王安国
    ...
    niang_suonanjiabo: { generalId: 'niang_suonanjiabo', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 索南加波·觉木宗
    wensu_guyi: { generalId: 'wensu_guyi', tier: 'ordinary', tacticalSkillId: 'tac_04' }, // 姑翼·温宿
    qiemo_anmoshenpan: { generalId: 'qiemo_anmoshenpan', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // 安末深盘·且末
    weitou_douti: { generalId: 'weitou_douti', tier: 'ordinary', tacticalSkillId: 'tac_05' }, // 兜题·尉头
    ...
    haikou_wangzhi_pirate: { generalId: 'haikou_wangzhi_pirate', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // 汪直·海寇
    shanshan_weituqi: { generalId: 'shanshan_weituqi', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // 尉屠耆·鄯善
    pangzha_halixingge: { generalId: 'pangzha_halixingge', tier: 'ordinary', tacticalSkillId: 'tac_03' }, // 哈里·辛格·旁遮普：攻战计侵掠如火+攻城拔寨，开伯尔山口工程
    najie_minande: { generalId: 'najie_minande', tier: 'ordinary', tacticalSkillId: 'tac_03' }, // 米南德·那竭：攻战计侵掠如火+攻城拔寨，印度-希腊东进兴都库什
    dulan_d_aihamaide: { generalId: 'dulan_d_aihamaide', tier: 'ordinary', tacticalSkillId: 'tac_03' }, // 艾哈迈德·杜兰尼：攻战计侵掠如火+攻城拔寨，九征印度建帝国
    muer_mujier: { generalId: 'muer_mujier', tier: 'ordinary', tacticalSkillId: 'tac_10' },    baha_gaiwamu: { generalId: 'baha_gaiwamu', tier: 'ordinary', tacticalSkillId: 'tac_10' }, // 盖瓦姆·巴哈尔兹：深沟高垒守泰巴德
    hali_subashi: { generalId: 'hali_subashi', tier: 'ordinary', tacticalSkillId: 'tac_08' },    kalan_suhela: { generalId: 'kalan_suhela', tier: 'ordinary', tacticalSkillId: 'tac_02' }, // 苏赫拉·卡伦：敌战计避实击虚+攻城拔寨，萨珊东北铁壁
    xisi_yakubusafaer: { generalId: 'xisi_yakubusafaer', tier: 'ordinary', tacticalSkillId: 'tac_03' }, // 雅库布·萨法尔·锡斯坦：攻战计侵掠如火+攻城拔寨，铜匠起兵席卷呼罗珊
    ...
    huluo_abumusilin: { generalId: 'huluo_abumusilin', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_03' },    aba_shapuer: { generalId: 'aba_shapuer', tier: 'ordinary', tacticalSkillId: 'tac_03' }, // 沙普尔·阿巴尔：攻战计侵掠如火+长驱直入，三破罗马擒瓦勒良
    wenling_shilang: {
    ...
    xiao_d_xiaomohe: { generalId: 'xiao_d_xiaomohe', tier: 'famous', tacticalSkillId: 'tac_04', strategicSkillId: 'str_03' },
    ...
    liguo_wangmeng: { generalId: 'liguo_wangmeng', tier: 'famous', tacticalSkillId: 'tac_04', strategicSkillId: 'str_01' },
    hongnong_jun_yangsu: {
    ...
    // ── 2026-06-29 新增：马殷 ──
    shaozhou_d_mayin: { generalId: 'shaozhou_d_mayin', tier: 'ordinary', tacticalSkillId: 'tac_10' },    zizhou_wangjian: { generalId: 'zizhou_wangjian', tier: 'ordinary', tacticalSkillId: 'tac_07' },    cangzhou_liurengong: { generalId: 'cangzhou_liurengong', tier: 'ordinary', tacticalSkillId: 'tac_04' },    yuezhi_xihou: { generalId: 'yuezhi_xihou', tier: 'ordinary', tacticalSkillId: 'tac_07' },    minyue_wuzhu: { generalId: 'minyue_wuzhu', tier: 'ordinary', tacticalSkillId: 'tac_08' },    funan_fanman: { generalId: 'funan_fanman', tier: 'famous', tacticalSkillId: 'tac_09', strategicSkillId: 'str_06' },    lancang_faang: { generalId: 'lancang_faang', tier: 'ordinary', tacticalSkillId: 'tac_08' },    ahaomu_laqite: { generalId: 'ahaomu_laqite', tier: 'famous', tacticalSkillId: 'tac_05', strategicSkillId: 'str_06' },    elunchunzu_gaishan: { generalId: 'elunchunzu_gaishan', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_05' },    wazu_banhongwang: { generalId: 'wazu_banhongwang', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_05' },    tajikezu_kuerban: { generalId: 'tajikezu_kuerban', tier: 'ordinary', tacticalSkillId: 'tac_08' },    jingpozu_zaodan: { generalId: 'jingpozu_zaodan', tier: 'ordinary', tacticalSkillId: 'tac_08' },    shuizu_panxinjian: { generalId: 'shuizu_panxinjian', tier: 'ordinary', tacticalSkillId: 'tac_10' },    liuzhou_shenxiyi: { generalId: 'liuzhou_shenxiyi', tier: 'famous', tacticalSkillId: 'tac_02', strategicSkillId: 'str_05' },    luming_luxiangsheng: { generalId: 'luming_luxiangsheng', tier: 'famous', tacticalSkillId: 'tac_01', strategicSkillId: 'str_05' },    dingzhou_d_murongchui: { generalId: 'dingzhou_d_murongchui', tier: 'ordinary', tacticalSkillId: 'tac_03' },    shanzhou_wangzhongsi: { generalId: 'shanzhou_wangzhongsi', tier: 'famous', tacticalSkillId: 'tac_01', strategicSkillId: 'str_03' },    weizhou_weigao: { generalId: 'weizhou_weigao', tier: 'ordinary', tacticalSkillId: 'tac_01' },    xidong_mayuan: { generalId: 'xidong_mayuan', tier: 'famous', tacticalSkillId: 'tac_03', strategicSkillId: 'str_06' },    yingzhou_d2_licunxu: { generalId: 'yingzhou_d2_licunxu', tier: 'famous', tacticalSkillId: 'tac_07', strategicSkillId: 'str_04' },    dongsheng_weishang: { generalId: 'dongsheng_weishang', tier: 'ordinary', tacticalSkillId: 'tac_08' },    weiyuan_d_niangengyao: { generalId: 'weiyuan_d_niangengyao', tier: 'ordinary', tacticalSkillId: 'tac_01' },
};
