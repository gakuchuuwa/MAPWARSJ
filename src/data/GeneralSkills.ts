...
export const GENERAL_PROFILES: Record<string, GeneralProfile> = {
    ...
    qingqiang_jiangwei: { generalId: 'qingqiang_jiangwei', tier: 'famous', tacticalSkillId: 'ts_270', strategicSkillId: 'str_03', advantageSkillId: 'ts_270', balanceSkillId: 'ts_393', disadvantageSkillId: 'ts_031', aptitude: 'reverse' }, // 九伐中原
    ...
    jinling_tandaoji: { generalId: 'jinling_tandaoji', tier: 'famous', tacticalSkillId: 'ts_262', strategicSkillId: 'str_02', advantageSkillId: 'ts_390', balanceSkillId: 'ts_014', disadvantageSkillId: 'ts_262', aptitude: 'leverage' }, // 2026-07-12 升名将：唱筹量沙·奇正因地制宜
    ...
    xinluo_jinyuxin: { generalId: 'xinluo_jinyuxin', tier: 'famous', tacticalSkillId: 'ts_330', strategicSkillId: 'str_08', advantageSkillId: 'ts_330', balanceSkillId: 'ts_015', disadvantageSkillId: 'ts_036', aptitude: 'create' }, // 萨円大捷守城反攻
    ...
    xiyuduhu_banchao: { generalId: 'xiyuduhu_banchao', tier: 'famous', tacticalSkillId: 'ts_064', strategicSkillId: 'str_06', advantageSkillId: 'ts_651', balanceSkillId: 'ts_652', disadvantageSkillId: 'ts_064', aptitude: 'leverage' }, // 2026-07-12 六系校准：西域招抚·招降纳叛
    ...
    // ── 朝鲜 ──
    joseon_lichenggui: { generalId: 'joseon_lichenggui', tier: 'ordinary', tacticalSkillId: 'ts_072', advantageSkillId: 'ts_543', balanceSkillId: 'ts_544', disadvantageSkillId: 'ts_072', aptitude: 'create' }, // 2026-07-12 降普将：威化岛为夺权非战役级胜绩
    ...
    sabeol_jinshimin: { generalId: 'sabeol_jinshimin', tier: 'famous', tacticalSkillId: 'ts_100', strategicSkillId: 'str_03', advantageSkillId: 'ts_023', balanceSkillId: 'ts_699', disadvantageSkillId: 'ts_100', aptitude: 'reverse' }, // 2026-07-12 六系校准：灭百济攻战·所向披靡
    // ── 东北
    ...
    aisin_d_huangtaiji: { generalId: 'aisin_d_huangtaiji', tier: 'famous', tacticalSkillId: 'ts_077', strategicSkillId: 'str_03', advantageSkillId: 'ts_465', balanceSkillId: 'ts_077', disadvantageSkillId: 'ts_467', aptitude: 'leverage' }, // 2026-07-12 六系校准：伐明收蒙·所向披靡
...
// ── 青藏区 2026-06-18 ──
    ...
    supi_xinuoluo: { generalId: 'supi_xinuoluo', tier: 'ordinary', tacticalSkillId: 'ts_372', advantageSkillId: 'ts_372', balanceSkillId: 'ts_405', disadvantageSkillId: 'ts_036', aptitude: 'create' }, // 2026-07-12 剥战略：附唐非亲统胜仗
  ...
  // ── 岭南/越南/台湾区 2026-06-18 ──
    ...
    unassigned_ruanhuang: { generalId: 'unassigned_ruanhuang', tier: 'ordinary', tacticalSkillId: 'ts_001', advantageSkillId: 'ts_001', balanceSkillId: 'ts_393', disadvantageSkillId: 'ts_035', aptitude: 'create' }, // 2026-07-12 剥战略：史料待核
...
// ── 巴蜀区 2026-06-18 ──
      huizhou_zhugeliang: { generalId: 'huizhou_zhugeliang', tier: 'famous', tacticalSkillId: 'ts_159', strategicSkillId: 'str_02', advantageSkillId: 'ts_002', balanceSkillId: 'ts_695', disadvantageSkillId: 'ts_159', aptitude: 'leverage' }, // 2026-07-12 六系校准：南征奇正·因地制宜
    ...
    shu_liubei: { generalId: 'shu_liubei', tier: 'famous', tacticalSkillId: 'ts_168', strategicSkillId: 'str_03', advantageSkillId: 'ts_028', balanceSkillId: 'ts_686', disadvantageSkillId: 'ts_168', aptitude: 'reverse' }, // 2026-07-12 六系校准：入蜀汉中·所向披靡
  ...
  // ── 河西区 2026-06-18 ──
    ...
    unassigned_chuliji: { generalId: 'unassigned_chuliji', tier: 'ordinary', tacticalSkillId: 'ts_033', advantageSkillId: 'ts_390', balanceSkillId: 'ts_393', disadvantageSkillId: 'ts_033', aptitude: 'reverse' }, // 2026-07-12 剥战略：史料待核
    ...
    qi_simarangju: { generalId: 'qi_simarangju', tier: 'famous', tacticalSkillId: 'ts_185', strategicSkillId: 'str_05', advantageSkillId: 'ts_185', balanceSkillId: 'ts_044', disadvantageSkillId: 'ts_710', aptitude: 'create' }, // 2026-07-12 升名将：却燕晋·坚壁立威
    ...
    unassigned_geshuhan: { generalId: 'unassigned_geshuhan', tier: 'famous', tacticalSkillId: 'ts_031', strategicSkillId: 'str_03', advantageSkillId: 'ts_400', balanceSkillId: 'ts_397', disadvantageSkillId: 'ts_031', aptitude: 'reverse' }, // 2026-07-12 六系校准：石堡城·所向披靡
    ...
    yangshao_zhoubo: { generalId: 'yangshao_zhoubo', tier: 'famous', tacticalSkillId: 'ts_206', advantageSkillId: 'ts_206', balanceSkillId: 'ts_397', disadvantageSkillId: 'ts_410', strategicSkillId: 'str_06', aptitude: 'create' },
    ...
    sima_d_simayi: { generalId: 'sima_d_simayi', tier: 'famous', tacticalSkillId: 'ts_188', advantageSkillId: 'ts_702', balanceSkillId: 'ts_188', disadvantageSkillId: 'ts_008', strategicSkillId: 'str_05', aptitude: 'leverage' }, // 2026-07-12 六系校准：坚壁拖亮·坚壁清野
    ...
    lulin_liuxiu: { generalId: 'lulin_liuxiu', tier: 'famous', tacticalSkillId: 'ts_054', strategicSkillId: 'str_09', advantageSkillId: 'ts_400', balanceSkillId: 'ts_043', disadvantageSkillId: 'ts_054', aptitude: 'reverse' }, // 2026-07-12 六系校准：昆阳以寡·以寡击众
    ...
    bing_liji: { generalId: 'bing_liji', tier: 'famous', tacticalSkillId: 'ts_208', strategicSkillId: 'str_08', advantageSkillId: 'ts_208', balanceSkillId: 'ts_015', disadvantageSkillId: 'ts_034', aptitude: 'create' }, // 晋阳坚守（固若金汤）
    ...
    gaoqi_d_gaohuan: { generalId: 'gaoqi_d_gaohuan', tier: 'famous', tacticalSkillId: 'ts_211', strategicSkillId: 'str_03', advantageSkillId: 'ts_007', balanceSkillId: 'ts_407', disadvantageSkillId: 'ts_211', aptitude: 'create' }, // 2026-07-12 六系校准：沙苑前野战·所向披靡
    ...
    linyu_wusangui: { generalId: 'linyu_wusangui', tier: 'famous', tacticalSkillId: 'ts_148', strategicSkillId: 'str_05', advantageSkillId: 'ts_148', balanceSkillId: 'ts_393', disadvantageSkillId: 'ts_411', aptitude: 'leverage' }, // 2026-07-12 升名将：山海关等亲统胜
    ...
    yan_leyi: { generalId: 'yan_leyi', tier: 'famous', tacticalSkillId: 'ts_223', strategicSkillId: 'str_03', advantageSkillId: 'ts_223', balanceSkillId: 'ts_658', disadvantageSkillId: 'ts_659', aptitude: 'create' }, // 2026-07-12 六系校准：连下七十城·所向披靡
    ...
    liguo_zhaoshe_zd: { generalId: 'liguo_zhaoshe_zd', tier: 'famous', tacticalSkillId: 'ts_294', strategicSkillId: 'str_03', advantageSkillId: 'ts_294', balanceSkillId: 'ts_403', disadvantageSkillId: 'ts_045', aptitude: 'create' }, // 2026-07-12 六系校准：阏与破秦·所向披靡
    // ── 北方关隘 2026-06-19 ──
    ...
    unassigned_zhouyuji: { generalId: 'unassigned_zhouyuji', tier: 'ordinary', tacticalSkillId: 'ts_038', advantageSkillId: 'ts_005', balanceSkillId: 'ts_396', disadvantageSkillId: 'ts_038', aptitude: 'reverse' }, // 2026-07-12 降普将：宁武殉城未改大局
    ...
    yue_goujian: { generalId: 'yue_goujian', tier: 'famous', tacticalSkillId: 'ts_177', strategicSkillId: 'str_02', advantageSkillId: 'ts_003', balanceSkillId: 'ts_408', disadvantageSkillId: 'ts_177', aptitude: 'reverse' }, // 2026-07-12 升名将：灭吴·奇正因地制宜
    ...
    unassigned_mayin: { generalId: 'unassigned_mayin', tier: 'famous', tacticalSkillId: 'ts_024', strategicSkillId: 'str_10', advantageSkillId: 'ts_005', balanceSkillId: 'ts_393', disadvantageSkillId: 'ts_024', aptitude: 'reverse' }, // 2026-07-12 升名将：湖南开国战·如履平地
    qi_d_qijiguang: { generalId: 'qi_d_qijiguang', tier: 'famous', tacticalSkillId: 'ts_093', strategicSkillId: 'str_08', advantageSkillId: 'ts_389', balanceSkillId: 'ts_395', disadvantageSkillId: 'ts_093', aptitude: 'create' }, // 2026-07-12 六系校准：御倭守台·固若金汤
    ...
    fushi_wangmeng: { generalId: 'fushi_wangmeng', tier: 'famous', tacticalSkillId: 'ts_279', strategicSkillId: 'str_03', advantageSkillId: 'ts_279', balanceSkillId: 'ts_393', disadvantageSkillId: 'ts_036', aptitude: 'create' }, // 2026-07-12 六系校准：潞川灭燕·所向披靡
    ba_bamanzi: {
    ...
    unassigned_zhouyuji_nw: { generalId: 'unassigned_zhouyuji_nw', tier: 'ordinary', tacticalSkillId: 'ts_031', advantageSkillId: 'ts_402', balanceSkillId: 'ts_406', disadvantageSkillId: 'ts_031', aptitude: 'reverse' }, // 2026-07-12 降普将：宁武殉城未改大局
    ...
    liguo_zhaoshe: { generalId: 'liguo_zhaoshe', tier: 'famous', tacticalSkillId: 'ts_189', strategicSkillId: 'str_03', advantageSkillId: 'ts_399', balanceSkillId: 'ts_697', disadvantageSkillId: 'ts_189', aptitude: 'leverage' }, // 2026-07-12 六系校准：阏与破秦·所向披靡
