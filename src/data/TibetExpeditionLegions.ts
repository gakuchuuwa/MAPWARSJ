...
export const TIBET_EXPEDITION_ELITE_LEGIONS: Readonly<Record<string, { name: string; tier: 0 | 1 | 2 | 3 }>> = {
  ...
  tubo: { name: '吐蕃桂级骑', tier: 3 },      // 逻些·唐史「桂」级人马俱披甲（§12 #3/#6 合挂）
  ...
  khoshut: { name: '和硕特铁骑', tier: 1 },   // 当雄·固始汗卫拉特铁骑（§12 #9）
  pazhu: { name: '帕竹甲兵', tier: 3 },       // 江孜·帕木竹巴绛曲坚赞甲兵（§12 #10）
  gurkha: { name: '廓尔喀弯刀', tier: 3 },    // 加德满都·廓尔喀库克里勇士（§12 #11）
  tsangpa: { name: '藏巴汗卫队', tier: 3 },   // 桑珠孜·藏巴汗亲卫
  // ── 2026-06-16 新增：青藏大区平衡补全（23支） ──
  yangtong: { name: '羊同勇士', tier: 2 },
  supi: { name: '苏毗女卫', tier: 3 },
  xiaobolu: { name: '勃律轻骑', tier: 2 },
  ...
  monpa: { name: '门巴勇士', tier: 2 },
  lopi: { name: '珞巴武士', tier: 2 },
  humi: { name: '瓦罕弓骑', tier: 3 },
  nvguo: { name: '女国禁卫', tier: 1 },
  kangba: { name: '康区长刀卒', tier: 3 },
  bailang: { name: '白狼锐卒', tier: 2 },
  faqiang: { name: '发羌劲卒', tier: 2 },
  duomi: { name: '多弥山兵', tier: 3 },
  xiutu: { name: '休屠王骑', tier: 1 },
