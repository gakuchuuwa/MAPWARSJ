...
export const TIBET_EXPEDITION_ELITE_LEGIONS: Readonly<Record<string, { name: string; tier: 0 | 1 | 2 | 3 }>> = {
  ...
  xihai_d: { name: '西海骁锐', tier: 3 },     // 伏俟城·隋西海郡属县戍兵（郡治无专将）
  heyuan_d: { name: '河源军', tier: 1 },        // 花石峡·黑齿常之夜袭吐蕃大营的战略主力
  ...
  nanjie: { name: '日土铁卫', tier: 3 },          // 日土宗·南杰旺秋拉达克边军
