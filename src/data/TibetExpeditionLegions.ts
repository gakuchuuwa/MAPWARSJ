...
export const TIBET_EXPEDITION_ELITE_LEGIONS: Readonly<Record<string, { name: string; tier: 0 | 1 | 2 | 3 | 4 }>> = {
  ...
  dafeichuan: { name: '退浑骑', tier: 3 },    // 吐谷浑（退浑），吐蕃崛起前长期盘踞青海一带的庞大王国，隋唐宿敌，升入T3知名
  ...
  supi: { name: '苏毗女卫', tier: 3 }, // “东女国”及苏毗，中国史书中最著名的“女儿国”原型之一，极具风土文化名气，升入T3知名
  xiaobolu: { name: '勃律轻骑', tier: 4 },
    gandenpozhang: { name: '扎敦卫藏兵', tier: 4 },
  gaxa: { name: '噶厦代本', tier: 4 },
  ladakh: { name: '拉达克卫队', tier: 4 },
  spurgyal: { name: '悉补野王军', tier: 3 }, // 悉补野（雅隆部落）一步步建立吐蕃帝国的龙兴原点，升入T3知名
  khon: { name: '萨迦法王军', tier: 3 },               // 元代统治全西藏的萨迦政权力量，曾经的高原之王，升入T3知名
  lang_clan: { name: '帕木竹巴军', tier: 3 }, // 明代统治全西藏的帕木竹巴政权力量，曾经的高原之王，升入T3知名
