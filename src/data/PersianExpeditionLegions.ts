...
export const PERSIAN_EXPEDITION_ELITE_LEGIONS: Readonly<Record<string, EliteLegionConfig>> = {
    ...
    //    定级 T4「存在之兵」：扎格罗斯山地部落常规部众，按 §12.3.1 从 T0 下试命中 T4。
    kesaiya: { name: '科塞亚山地兵', tier: 4 },

    // 🔴 [2026-09-19 主人令「一个战场一个防守方的武将一个势力一个精锐」] 乌克西亚（前331 乌克西亚隘口战役守方）
    //    在此之前没有城也没有番号，按同一规矩补上它**自己的**番号。
    //    史料：英文维基百科 Uxians —— 乌克西亚人是扎格罗斯山脉中的半游牧部落联盟，靠放牧与劫掠过活，
    //    被 Nearchus 列为西南四大掠夺民族之一，向来往军队索取买路钱；前331年亚历山大应约纳贡而暗中分兵，
    //    袭其村落、夺其隘口，退往高地的部落战士被克拉特鲁斯合围。故番号取「山地弓手」。
    //    定级 T3「风土之兵」：名号靠文化辨识度与地理特色，**无明确战术大捷记录**，按 §12.3.1 从 T0 下试命中 T3。
    wukexiya: { name: '乌克西亚山地弓手', tier: 3 },
