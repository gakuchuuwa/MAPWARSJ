...
export const PERSIAN_EXPEDITION_ELITE_LEGIONS: Readonly<Record<string, EliteLegionConfig>> = {
    ...
    //    科塞亚（前324 科塞亚战役守方）此前没有城也没有番号，守方只能去借哈马丹的「米底骑射」
    //    （米底的兵）—— 番号归属错的。这里补上它**自己的**番号。
    //    史料：斯特拉波《地理学》15.3.6 —— 科塞亚人是扎格罗斯山脉的山地部族，弓手为主，
    //    波斯历代大王过境皆须向他们缴纳过路贡；前324年亚历山大四十日山地扫荡迫其乞降。
    //    定级 T3「风土之兵」：名号靠文化辨识度与地理特色，**无明确战术大捷记录**，按 §12.3.1 从 T0 下试命中 T3。
    kesaiya: { name: '科塞亚山地兵', tier: 3 },
