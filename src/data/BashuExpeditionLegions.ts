...
export const BASHU_EXPEDITION_ELITE_LEGIONS: Readonly<Record<string, { name: string; tier: 0 | 1 | 2 | 3 }>> = {
  ...
  dangzhou: { name: '平蜀先锋军', tier: 0 },     // 宕昌·邓艾偷渡阴平（经典进攻性以少胜多，升T0）
  ...
  langzhou: { name: '巴西劲卒', tier: 1 },       // 隆城·张飞巴西劲卒（有名且胜仗，升T1）
  ...
  // 悬棺武士除名
  chenghan: { name: '六夷突骑', tier: 1 },      // 鹿头关·§8 #9 成汉李特六夷铁骑（破晋建国，升T1）
  ...
  cheng: { name: '西川绿营', tier: 1 },          // 阳安·岳钟琪川督绿营（开疆拓土主战，升T1）
