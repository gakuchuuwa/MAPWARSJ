...
export const BASHU_EXPEDITION_ELITE_LEGIONS: Readonly<Record<string, { name: string; tier: 0 | 1 | 2 | 3 }>> = {
  ...
  shu: { name: '无当飞军', tier: 0 },           // 成都·§8 #6 王平无当飞军
  ...
  ba: { name: '合州水军', tier: 1 },            // 重庆·南宋合州钓鱼城水军（旗=巴·巴郡）
  // ── 2026-06-16 新增：4座西南名关 ──
  lizhou_d: { name: '白水军', tier: 1 },        // 剑门关·刘璋白水关旧部
  xiazhou: { name: '峡江水军', tier: 1 },       // 瞿塘关·三峡重防区（原白杆兵防重）
  zuo_d: { name: '南中叟兵', tier: 3 },         // 清溪关·西南夷王牌
  zangke: { name: '夜郎锐卒', tier: 2 },        // 胜境关·古夜郎国地
};
