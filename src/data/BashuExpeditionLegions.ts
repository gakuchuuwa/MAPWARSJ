...
export const BASHU_EXPEDITION_ELITE_LEGIONS: Readonly<Record<string, { name: string; tier: 0 | 1 | 2 | 3 }>> = {
  ...
  bandun: { name: '賨人勇士', tier: 4 },       // 汉昌·范目率板楯七姓助刘邦定三秦（特色兵种）（缺乏极其著名的战术高光，降T3）
  ...
  ba: { name: '巴渝劲卒', tier: 4 },          // 重庆·巴国巴蔓子劲卒（《华阳国志·巴志》）（缺乏极其著名的战术高光，降T3）
...
qianzhong: { name: '乾嘉苗兵', tier: 4 },     // 芷江·吴八月攻克沅州（缺乏极其著名的战术高光，降T3）
  ...
  qingyi: { name: '天师道众', tier: 4 },       // 严道·范长生
