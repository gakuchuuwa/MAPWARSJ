...
'kongque': '孔雀',
    ...
    'talasike': '塔拉',
    'tailuona': '泰罗',
    'teweierqie': '尔切',  // 「特维」已被特维尔公国(teweier_gongguo)占用，取后两字
'inca': '印加',
    'maya': '玛雅',
    'mapuche': '马普',
    'muisca': '穆伊',
...
'valois_angouleme': '瓦卢',
    ...
    'naxos_ancient': '纳克',
    'yamaxun': '亚马',
    'aswaka': '斯瓦', // 🔴 [2026-09-19 主人指出审计警告] 原登记「阿斯」与 asikanani(阿斯坎尼) 撞车；「阿瓦」又撞 ava(阿瓦王国) → 取其所居**斯瓦特**河谷之「斯瓦」
    'aornos': '奥诺', // 奥诺斯岩（前326年奥诺斯岩围城战守方）：势力名前两字，全库不撞
    'julushi': '居鲁', // 居鲁士城（前329年居鲁士城围攻守方）：势力名前两字，全库不撞
    'malli': '马利',
    'kesaiya': '科塞',
    // 乌克西亚（前331年乌克西亚隘口战役守方）：旗号按本文件规则取**势力名前两字** = 「乌克」，
    //    实测未与任何势力撞车（全库无第二个以「乌克」开头的旗号）。
    'wukexiya': '乌克',
    'genji': '镰仓',
    // 🔴 [2026-09-19 主人指出审计警告「缺旗号」] 源氏·伊予（松山，守将源义经）的旗号。
    //    规则（本文件头）：未登记则取**势力名前两字** = 「源氏」—— 实测**未与任何势力撞车**
    //    （genji 源氏本家登记的是「镰仓」），故这里把默认值显式登记下来，消掉审计警告。
    'genji_iyo': '源氏',
    // 🔴 [2026-09-19 主人令「用窦夏」] 夏（窦建德，621 虎牢关战役守方）的旗号 = **「窦夏」**。
    //    为什么不用单字「夏」：那个字已被势力 `夏州`(xiazhou) 登记占用（两面旗不得严格相等）。
    //    取「窦夏」= 窦[建德]之夏，主人 2026-09-19 亲定。
    'xia': '窦夏',
    'dasaleiti': '达萨',
};
