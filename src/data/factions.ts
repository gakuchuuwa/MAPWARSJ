...
export const FACTIONS: Faction[] = [
  ...
  { id: 'wende', name: '萨克森' },
  { id: 'bafaliya', name: '巴伐利亚' },
  { id: 'huohengsuolun', name: '霍亨索伦' },
  { id: 'mozeer', name: '摩泽尔' },
  { id: 'ruishi', name: '瑞士' },
  { id: 'aersasi', name: '阿尔萨斯' },
  { id: 'molaweiya', name: '摩拉维亚' },
  { id: 'damolaweiya', name: '大摩拉维亚' },
...
{ id: 'guo', name: '果州' },
   ...
   // 高句丽国都平壤（427 起）；「高丽」留给 goryeo
    ...
    // 🔴 [2026-09-19 主人令「村上武吉换成源义经」] **源氏·伊予**：
    //    源义经 1184 年一之谷后受任**伊予守**，伊予国即其守地（1185 年他在伊予忽那岛统水军）。
    //    单独立键的原因：`STARTING_CAPITALS` 是「一势力一座城」，
    //    镰仓（源赖朝）与本城（源义经）必须各有势力键，才能各挂各的守将。
    { id: 'genji_iyo', name: '源氏·伊予' },
    { id: 'gaya', name: '伽倻' },
    { id: 'aki', name: '安艺' },
    { id: 'echigo', name: '越后' },
    { id: 'kai', name: '甲斐' },
...
// 土褐 - 吐火罗(员渠城/焉耆盆地)
{ id: 'sogdian', name: '粟特' },
// 岩堡灰褐 - 索格狄亚那岩（阿里马泽斯之岩）的岩堡部众；前327年索格狄亚那岩战役守方
{ id: 'suogediyana', name: '索格狄亚那' },
// 边塞土黄 - 居鲁士城（Cyropolis，居鲁士大帝所建粟特边塞）的守方部众；前329年居鲁士城围攻守方
{ id: 'julushi', name: '居鲁士' },
// 崖壁灰褐 - 奥诺斯岩（Pir Sar 崖顶岩堡）的守方部众；前326年奥诺斯岩围城战守方
{ id: 'aornos', name: '奥诺斯' },
...
// ── 2026-05-26 新增：漠北草原势力 ──
    ...
    { id: 'gandenpozhang', name: '冈底斯' },
                // 甘丹颇章(扎敦宗/旧仲巴), Ganden Phodrang
    { id: 'dawoer', name: '嫩江' },
                         // 达斡尔(莫尔根), Daur
                    // 广南国(洞海城), Guangnan
 ...
 // 王彦八字军@飞狐；旗号取地名太行（禁人名「彦」）
    ...
    { id: 'guide_d', name: '芒砀' },            // 归德@永城（归德府/州治）
...
// ── 2026-06-19 新增：马尔吉亚纳（彭迪）·乌古斯（毡的）──
  ...
  { id: 'inca', name: '印加' },
   ...
   // 阿克苏姆·埃塞俄比亚
    ...
    { id: 'sanfoqi', name: '三佛齐' },        // 巨港·室利佛逝王国（苏门答腊海上佛教贸易帝国）
  ...
  { id: 'chatigangren', name: '查蒂冈人' },
    ...
    { id: 'kanan', name: '迦南' },   // 推罗（腓尼基母城）· 2026-09-12 主人批；亚历山大剧本第三章「推罗战役」守方
    ...
    { id: 'yamaxun', name: '亚马逊' },
    { id: 'aswaka', name: '阿斯瓦卡' },  // 斯瓦特·马萨加（阿萨卡诺伊王族）· 前327年「马萨加战役」守方
    { id: 'malli', name: '马利' },  // 摩罗婆·马里斯（木尔坦卫城）· 前325年「马里斯战役」守方
    { id: 'kesaiya', name: '科塞亚' },  // 扎格罗斯·科塞亚人（山地部落联军）· 前324年「科塞亚战役」守方
    { id: 'wukexiya', name: '乌克西亚' },  // 扎格罗斯·乌克西亚人（非伊朗裔半游牧部落联盟）· 前331年「乌克西亚隘口战役」守方
    // 🔴 [2026-09-19 主人令「都给我删了」] 两个**孤儿势力**已删除（没有任何战役/战场在用它们）：
    //    · `kapaduoxiya` 卡帕多细亚 —— 它那一仗（前321赫勒斯滂战役）已被主人令全删；
    //    · `zheng` 郑 —— 只是我给王世充多建的，虎牢关这一仗只有攻(唐)守(夏)两方，从来没有第三方。
    // 🔴 [2026-09-25 主人令「删除，删除干净，就没错了」] 孤儿势力 `xia`（夏·窦建德，621 虎牢关战役守方）已删除 ——
    //    那一仗早已被主人令全删，它**一座据点都没有**（`faction:sync-audit` 报「势力无首都」），故连同它下面这一串一并删净：
    //    武将窦建德 / 精锐「长枪义军」/ 旗号「窦夏」/ 势力色 / 世纪·时代·技能档案 / 战场人物记录。
