...
// ── 2026-06-19 新增：马尔吉亚纳（彭迪）·乌古斯（毡的）──
  ...
  { id: 'chatigangren', name: '查蒂冈人' },
    ...
    // 🔴 [2026-09-19 主人令「全面检查」时自查出的缺口] 隋末双雄此前只写了兵、漏了**政权**势力记录：
    //    621年「虎牢关战役」的守方势力 `xia` 在 factions.ts 里根本不存在（精锐「长枪义军」倒是早就写了），
    //    王世充的 `zheng` 连势力带番号都缺 —— 现已补齐。
    { id: 'xia', name: '夏' },     // 窦建德·夏（618-621，都乐寿）· 621年「虎牢关战役」守方主帅
    { id: 'zheng', name: '郑' },   // 王世充·郑（619-621，都洛阳）· 窦建德即为其驰援而败于虎牢
];
