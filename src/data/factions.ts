...
// ── 2026-05-26 新增：漠北草原势力 ──
    ...
    { id: 'cong', name: '賨族' },
    // 瘗棺苔绿 - 僰人(僰王山/珙县悬棺)
    { id: 'qiao_d', name: '谯氏' },                    // 阆苑明黄 - 谯氏(蜀地第一高门/阆中)
    { id: 'zhe_d', name: '折氏' },
    { id: 'shanyue', name: '山越' },
    ...
    { id: 'jingjiang', name: '靖江' },                      // 靖江王(桂林/明藩王)
    ...
    { id: 'guangnanguo', name: '广南' },                    // 广南国(洞海城), Guangnan
   ...
   // 淮阳郡治宛丘(陈州)
    ...
    { id: 'sambyeol', name: '沃州' },
    // ── 2026-06-11 顺天·全罗左道·龟船水军（李舜臣；旗号「左」≠据点名顺天）──
    { id: 'jeolla', name: '全罗左道' },
    ...
    // ── 2026-06-16 新增：东海道五国（间距审计合格；旗号完整专名）──
    { id: 'ise_d', name: '伊势' },       // 宇治山田·伊势神宫；志摩代指
    { id: 'totomi_d', name: '远江' },   // 滨松·远江国
    { id: 'hitachi_d', name: '常陆' },  // 水户·常陆国
    { id: 'awa_d', name: '安房' },       // 馆山·安房国府
    { id: 'kazusa_d', name: '上总' },    // 佐原·上总国府
    // ── 2026-06-16 新增：东山道七国（间距审计合格；旗号完整专名）──
    { id: 'mino_d', name: '美浓' },       // 岩村·美浓国
    { id: 'hida_d', name: '飞驒' },       // 高山·飞驒国府
    { id: 'kozuke_d', name: '上野' },     // 前桥·上野国府
    { id: 'rikuzen_d', name: '陆前' },    // 仙台·陆前国府
    { id: 'rikuchu_d', name: '陆中' },    // 盛冈·陆中国府
    { id: 'uzen_d', name: '羽前' },       // 酒田·庄内/羽前
    { id: 'ugo_d', name: '羽后' },        // 秋田·羽后国府
    // ── 2026-06-16 新增：北陆道六国（城名优先；越后已有春日山）──
    { id: 'wakasa_d', name: '若狭' },       // 小滨城·若狭国
    { id: 'echizen_d', name: '越前' },     // 一乘谷城·越前国
    { id: 'kaga_d', name: '加贺' },         // 金泽城·加贺国
    { id: 'noto_d', name: '能登' },         // 羽咋城·能登国
    { id: 'etchu_d', name: '越中' },       // 富山城·越中国
    { id: 'sado_d', name: '佐渡' },         // 金井山城·佐渡国
    // ── 2026-06-16 新增：山阴道五国（知名度优先；出云@月山富田已有）──
    { id: 'inaba_d', name: '因幡' },       // 鸟取城·因幡国
    { id: 'tajima_d', name: '但马' },       // 丰冈城·但马国
    { id: 'hoki_d', name: '伯耆' },         // 鬼山城·伯耆国
    { id: 'iwami_d', name: '石见' },       // 滨田城·石见国
    { id: 'oki_d', name: '隐岐' },          // 油津·隐岐国（无大城，国衙港）
    // ── 2026-06-16 新增：山阳道四国（间距≥50km；播磨@姬路、备中@鬼之城、安艺@吉田郡山、长门@赤间关已有）──
    { id: 'mimasaka_d', name: '美作' },     // 久米·美作国久米郡（津山·林野城址距邻城<50km）
    { id: 'bizen_d', name: '备前' },        // 牛窗城·备前国南端
    { id: 'bingo_d', name: '备后' },        // 三原城·备后国
    { id: 'suo_d', name: '周防' },          // 柳井城·周防国
    // ── 2026-06-16 新增：南海道五国（淡路岛距和歌山/德岛<50km 暂缺；土佐@冈丰已有）──
    { id: 'kii_d', name: '纪伊' },          // 和歌山城·纪伊国
    { id: 'awa2_d', name: '阿波' },         // 德岛城·阿波国（≠ awa_d 安房）
    { id: 'sanuki_d', name: '赞岐' },       // 丸龟城·赞岐国
    { id: 'iyo_d', name: '伊予' },          // 松山城·伊予国
    { id: 'yanda', name: '嚈哒' },
    { id: 'qincha', name: '钦察' },
    { id: 'anxi', name: '安西' },
