...
export const FACTIONS: Faction[] = [
  ...
  { id: 'yadian_chengbang', name: '雅典城邦' },
  { id: 'keduowa', name: '科尔多瓦' },
  { id: 'putaoya', name: '葡萄牙' },
  ...
  { id: 'fulajimier_gongguo', name: '弗拉基米尔公国' },
  { id: 'daniebo', name: '第聂伯' },
  { id: 'qiernigeweifu_gongguo', name: '切尔尼戈夫公国' },
  { id: 'jialixiya', name: '加利西亚' },
  { id: 'pusikefu_gongheguo', name: '普斯科夫共和国' },
  { id: 'ouka', name: '奥卡' },
  ...
  { id: 'peilieya_gongguo', name: '佩列亚斯拉夫公国' },
  { id: 'weijiebusike_gongguo', name: '维捷布斯克公国' },
