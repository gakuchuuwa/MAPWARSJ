...
export const WESTERN_EXPEDITION_ELITE_LEGIONS: Readonly<Record<string, { name: string; tier: 0 | 1 | 2 | 3 }>> = {
  ...
  chagatai: { name: '蒙兀儿铁骑', tier: 2 }, // 别失八里·称霸西域的东察合台汗国主力
  dayuan: { name: '汗血天马骑', tier: 2 },   // 贵山城·大宛（守城非以少胜多）
  shache: { name: '莎车左右骑', tier: 2 },   // 渠莎·汉代西域强国
  // §14 #9 叶尔羌火枪兵（火绳枪）→ 不收
  loulan: { name: '精绝都护营', tier: 3 },      // 精绝·都护府直属屯田卫（旗号楼·§12.1）
  zhuxie: { name: '朱邪部兵', tier: 3 },      // 大石城·沙陀朱邪部
  // 重复行已删
  juandu: { name: '捐毒锐卒', tier: 3 },     // 排修城·汉西域捐毒国
  ...
  yiwu: { name: '哈密卫镇军', tier: 3 },       // 哈密卫·明关西七卫（都城高昌，咸通前）
  adao_d: { name: '昆岗军台营', tier: 3 },      // 昆岗·阿克苏道军台驿卒
  weitou: { name: '尉头国飞军', tier: 3 },    // 阿合奇·尉头国王城
  yumi: { name: '扜弥锐兵', tier: 3 },        // 阿赫雅尔·扜弥国王都
  qiemo: { name: '且末守捉', tier: 3 },       // 播仙·唐安西四镇且末
  pishan: { name: '皮山国兵', tier: 3 },      // 固玛·皮山国
  ruoqiang: { name: '婼羌部族兵', tier: 3 },  // 卡克里克·婼羌部落
  weili: { name: '尉犁飞骑', tier: 3 },       // 库尔勒·尉犁国王城
  duerbote: { name: '杜尔伯特骑', tier: 3 }, // 托克逊·杜尔伯特部
  sai: { name: '塞种弓骑', tier: 3 },         // 握瑟德·塞种部落
  xiye: { name: '西夜国兵', tier: 3 },        // 叶城·西夜国
  weiwuer: { name: '回部伯克卫', tier: 3 },   // 玉尔滚·回部伯克
