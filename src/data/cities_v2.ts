...
export const T0_CAPITALS: CityDataV2[] = [
    ...
    { id: 'city_datong', name: '大同', factionId: 'tuoba', lat: 40.08, lng: 113.3, type: 'medium_city', troops: 30000, region: 'NORTH' },
    ...
    { id: 'city_ueda', name: '上田城', factionId: 'sanada_d', lat: 36.4025, lng: 138.2464, type: 'small_city', troops: 30000, region: 'JAPAN' },
...
export const T1_MEDIUM_CITIES: CityDataV2[] = [
    ...
    { id: 'city_hanzhong', name: '南郑', factionId: 'han_d', lat: 33.07, lng: 107.02, type: 'medium_city', troops: 30000, region: 'CENTRAL', note: '汉中郡治，秦岭南麓枢纽' },
    ...
    // ── 中原北线/冀南走廊 (洛阳→安阳 的中城) ──
    // ── 幽冀古道/平原走廊 (安阳→北京 的中城) ──
    { id: 'city_handan', name: '邯郸', factionId: 'zhao', lat: 36.61, lng: 114.49, type: 'small_city', troops: 30000, region: 'CENTRAL' },
        ...
        note: '渤海蓨县；北齐神武帝高欢故里（《北齐书·神武帝纪》）' },
    {
        ...
        // ── 京同山川走廊 (北京→大同 的中城) ──
    // ── 晋陕走廊/汾河谷地 (大同→长安 的中城) ──
    { id: 'city_linfen', name: '临汾', factionId: 'yao', lat: 36.088, lng: 111.516724, type: 'small_city', troops: 30000, region: 'CENTRAL' },
    ...
    { id: 'city_boyang', name: '奉高', factionId: 'jibei', lat: 36.15, lng: 117.05, type: 'small_city', troops: 20000, region: 'CENTRAL' },
    ...
    { id: 'city_linzi', name: '临淄', factionId: 'qi', lat: 36.88, lng: 118.43, type: 'medium_city', troops: 30000, region: 'CENTRAL' },
    ...
    { id: 'city_ying', name: '金鳞', factionId: 'chu', lat: 30.35, lng: 112.18, type: 'medium_city', troops: 30000, region: 'JIANGNAN' },
    ...
    // ── 陇右与河西走廊中城 ──
    { id: 'city_tianshui', name: '天水', factionId: 'qin', lat: 34.58, lng: 105.73, type: 'small_city', troops: 30000, region: 'CENTRAL' },
    ...
    { id: 'city_zhangye', name: '张掖', factionId: 'ganzhou', lat: 38.93, lng: 100.45, type: 'small_city', troops: 30000, region: 'HEXI' },
    ...
    // ── 塞北与西域中城 ──
    { id: 'city_zhizhicheng', name: '郅支城', factionId: 'xijue', lat: 42.906205, lng: 72.765198, type: 'small_city', troops: 30000, region: 'STEPPE' },
        ...
        note: '楼兰/鄯善故城（罗布泊西）；楼兰旗号迁精绝' },
    {
        ...
        troops: 30000,
        note: '莎车国都；≠西夜叶城' },
    { id: 'city_shule', name: '盘橐', factionId: 'shule', lat: 39.4850, lng: 76.0007, type: 'small_city', troops: 30000,        region: 'WESTERN', tier: 1,
        note: '盘橐；疏勒治所/重镇',
    },
    ...
    { id: 'city_toumancheng', name: '头曼城', factionId: 'xiongnu', lat: 41.302589, lng: 108.506470, type: 'small_city', region: 'STEPPE', troops: 30000,
        note: '头曼城；匈奴小城',
    },
    ...
    { id: 'city_liaoyang', name: '襄平', factionId: 'gongsun_d', lat: 41.270000, lng: 123.170000, type: 'small_city', region: 'NORTH', troops: 30000, note: '公孙度辽东治所；辽东铁骑' },

    { id: 'city_chaoyang', name: '朝阳', factionId: 'yingzhou_ying_d', lat: 41.57, lng: 120.45, type: 'small_city', troops: 20000, region: 'NORTHEAST' },
...
//镜像
    ...
    { id: 'city_feihu', name: '飞狐', factionId: 'wangyan', lat: 39.3487, lng: 114.6986, type: 'small_city', region: 'NORTH', troops: 30000,
        note: '飞狐；太行小城',
    },
    ...
    { id: 'city_diezhou', name: '迭部', factionId: 'dangchang', lat: 33.975273, lng: 103.482971, type: 'small_city', troops: 30000, region: 'BASHU' },
    ...
    { id: 'city_xiuxun', name: '休循', factionId: 'khoja', lat: 39.709286, lng: 73.229370, type: 'small_city', region: 'WESTERN', troops: 30000,
        note: '休循；和卓小城',
    },
...
export const PERIPHERY: CityDataV2[] = [
    ...
    { id: 'city_pyongyang', name: '平壤', factionId: 'gaogouli', lat: 39.02, lng: 125.76, type: 'small_city', troops: 30000, region: 'KOREA' },
    ...
    { id: 'city_qishan', name: '岐山', factionId: 'zhou', lat: 34.506539, lng: 107.487488, type: 'small_city', region: 'CENTRAL', troops: 30000,
        note: '岐山；周国小城',
    },
    { id: 'city_tongwancheng', name: '统万城', factionId: 'helian', lat: 38.024286, lng: 109.14917, type: 'small_city', troops: 30000, region: 'HEXI' },
    ...
    { id: 'city_dangchang', name: '阴平', factionId: 'dangzhou', lat: 33.6997, lng: 104.5239, type: 'small_city', troops: 30000, region: 'BASHU' },
    ...
    { id: 'city_hetuala', name: '赫图阿拉', factionId: 'aisin_d', lat: 41.715981, lng: 125.032654, type: 'small_city', region: 'NORTHEAST', troops: 30000, tier: 1, note: '爱新觉罗氏兴起地；≠大清皇朝旗号' },
    ...
    { id: 'city_luoxie', name: '逻些', factionId: 'tubo', lat: 29.65, lng: 91.1, type: 'medium_city', troops: 20000, region: 'TIBET', mirror: true },
    ...
    { id: 'city_edo', name: '江户城', factionId: 'edo', lat: 35.68, lng: 139.76, type: 'big_city', troops: 30000, region: 'JAPAN' },
 ...
 // [2026-05-30] 升 big_city: 江户幕府 264 年 + 1700 年代百万人口世界第一
    ...
    { id: 'city_weirong', name: '威戎', factionId: 'quanrong', lat: 35.585841, lng: 105.512695, type: 'small_city', region: 'CENTRAL', troops: 30000,
        note: '威戎；犬戎小城',
    },
    { id: 'city_xingtai', name: '邢台', factionId: 'shizhao_d', lat: 37.08, lng: 114.48, type: 'small_city', troops: 30000, region: 'NORTH' },
    ...
    { id: 'city_shuri', name: '首里', factionId: 'ryukyu', lat: 26.22, lng: 127.72, type: 'small_city', region: 'LINGNAN', troops: 30000, tier: 1, note: '琉球王国都城；那霸水师' },
    ...
    { id: 'city_tsutsujigasaki', name: '躑躅崎馆', factionId: 'kai', lat: 35.6688, lng: 138.4991, type: 'small_city', troops: 20000, region: 'NORTH' },
    ...
    { id: 'city_himeji', name: '姬路城', factionId: 'hashiba', lat: 34.8394, lng: 134.6939, type: 'small_city', troops: 30000, region: 'JAPAN' },
    ...
    { id: 'city_tsuruga', name: '鹤之城', factionId: 'aizu', lat: 37.4878, lng: 139.9297, type: 'small_city', region: 'JAPAN', troops: 30000,
        note: '鹤之城；会津小城',
    },
    // ── 2026-06-11 日本精锐：北条@小田原、伊贺@名张（恶党/千早城距飞鸟宫旧址3km）──
    { id: 'city_nabari', name: '名张', factionId: 'iga_d', lat: 34.627, lng: 136.108, type: 'small_city', troops: 30000, region: 'JAPAN' },

    // ── 2026-06-16 新增：日本令制国补点（方案A·6城）──
    { id: 'city_jianghu', name: '金泽', factionId: 'kaga_d', lat: 36.56, lng: 136.65, type: 'small_city', region: 'JAPAN', troops: 30000, note: '加贺一向一揆尾山御坊故地（金泽古名）；下间赖廉守备' },
    ...
    { id: 'city_gaodao', name: '高岛', factionId: 'suwa_d', lat: 36.0138, lng: 137.9662, type: 'small_city', region: 'JAPAN', troops: 30000, note: '信浓国诹访郡高岛；诹访氏中世本据（考据138.0515°E；与躑躅崎馆<50km，经度西移约7.7km）' },
    { id: 'city_shangdang', name: '长子', factionId: 'xin', lat: 36.148974, lng: 113.008118, type: 'small_city', troops: 30000, region: 'CENTRAL' },




    { id: 'city_fanyang', name: '范阳', factionId: 'zhuozhou', lat: 39.48, lng: 115.98, type: 'small_city', region: 'NORTH', troops: 30000, note: '安禄山范阳节度使根基；安史叛军' },
    ...
    { id: 'city_yongzhou', name: '晋兴', factionId: 'nongzhigao', lat: 22.81, lng: 108.31, type: 'small_city', region: 'LINGNAN', troops: 30000, note: '侬智高破邕州建南天国' },
    ...
    { id: 'city_emil', name: '也迷里', factionId: 'ogodei', lat: 46.481378, lng: 83.633423, type: 'small_city', region: 'STEPPE', troops: 30000, note: '草原环线锚点；环线所称也迷离即本据点' },
    // 第三类：蒙古草原部落
    ...
    { id: 'city_tatar', name: '哈拉哈河', factionId: 'tatar', lat: 47.182253, lng: 117.726746, type: 'small_city', region: 'STEPPE', troops: 30000,
        note: '哈拉哈河；塔塔尔小城',
    },

    { id: 'city_merkit', name: '色楞格河', factionId: 'merkit', lat: 50.264779, lng: 106.152649, type: 'small_city', troops: 30000, region: 'STEPPE' },
    ...
    // ── 2026-05-25 明朝势力新增城市 ──
    // 第二类：元末群雄
    { id: 'city_qingyuan_zj', name: '宁波', factionId: 'fang_guozhen', lat: 29.87, lng: 121.54, type: 'small_city', troops: 30000, region: 'JIANGNAN' },
    ...
    { id: 'city_yeren_base', name: '瑷珲', factionId: 'yeren_nvzhen', lat: 50.25, lng: 127.5, type: 'small_city', troops: 30000, region: 'NORTHEAST' },
    ...
    { id: 'city_angkor', name: '吴哥', factionId: 'chenla', lat: 13.41, lng: 103.87, type: 'big_city', troops: 30000, region: 'DIANQIAN' },
    ...
    { id: 'city_yadong', name: '卓木', factionId: 'gaxa', lat: 28.243709, lng: 89.376526, type: 'small_city', region: 'TIBET', troops: 30000,
        note: '卓木；噶厦小城',
    },
 ...
 // 镜像
    { id: 'city_meinuozhai', name: '美诺寨', factionId: 'agui', lat: 31, lng: 102.4, type: 'small_city', troops: 30000, region: 'BASHU' },



 // 镜像
    { id: 'city_zhaoqing', name: '肇庆', factionId: 'duanzhou_d', lat: 23.05, lng: 112.45, type: 'small_city', troops: 30000, region: 'LINGNAN' },
    ...
    { id: 'city_kathmandu', name: '加德满都', factionId: 'gurkha', lat: 27.715138, lng: 85.185242, type: 'small_city', region: 'TIBET', troops: 30000, tier: 1,
        note: '加德满都；廓喀小城',
    },
    {
    ...
    { id: 'city_kokand', name: '浩罕', factionId: 'kokand', lat: 40.5333, lng: 70.9333, type: 'small_city', region: 'WESTERN', troops: 30000,
        note: '浩罕；霍罕小城',
    },
    ...
    { id: 'city_piandaoshui', name: '偏刀水', factionId: 'qianhui', lat: 27.921633, lng: 107.685242, type: 'small_city', region: 'BASHU', troops: 30000,
        note: '偏刀水；回军小城',
    },
    // 第九类：黔西南回军
    // 第十类：苗民起义
    ...
    // 第十五类：越南阮朝
    { id: 'city_nanghar', name: '囊哈儿', factionId: 'jilimi', lat: 52.209343, lng: 141.951599, type: 'small_city', region: 'NORTHEAST', troops: 30000,
        note: '囊哈儿；吉里小城',
    },
    {
    ...
    { id: 'city_fenglin', name: '凤林城', factionId: 'yilou', lat: 46.318508, lng: 132.187500, type: 'small_city', region: 'NORTHEAST', troops: 30000,
        note: '凤林城；挹娄小城',
    },
    ...
    { id: 'city_kerulen', name: '克鲁伦河', factionId: 'jalair', lat: 47.969654, lng: 113.005371, type: 'small_city', troops: 30000, region: 'STEPPE' },
    ...
    { id: 'city_hanhai', name: '瀚海', factionId: 'tiele', lat: 44.144832, lng: 103.697205, type: 'small_city', troops: 30000, region: 'STEPPE' },
    ...
    { id: 'city_qingtang', name: '青唐城', factionId: 'tufa_d', lat: 36.644182, lng: 101.738892, type: 'small_city', troops: 20000, region: 'TIBET' },
    ...
    { id: 'city_cuona', name: '错那', factionId: 'monpa', lat: 27.979850, lng: 91.928101, type: 'small_city', region: 'TIBET', troops: 30000, note: '梅惹·洛珠嘉措门巴归附达赖' },
    ...
    // === 第三类：世袭门阀与政教寡头 ===
    { id: 'city_chubusi', name: '楚布寺', factionId: 'karmapa', lat: 30.059496, lng: 90.532837, type: 'small_city', region: 'TIBET', troops: 30000,
        note: '楚布寺；噶玛小城',
    },
    ...
    // ── 第六类：岭南土司、安南权臣与海商门阀 ──
    { id: 'city_cen', name: '凌云', factionId: 'cen_d', lat: 24.462119, lng: 106.627808, type: 'small_city', troops: 30000, region: 'LINGNAN' },
    ...
    { id: 'city_langzhong_gucheng', name: '隆城', factionId: 'langzhou', lat: 31.583, lng: 105.97, type: 'small_city', troops: 30000, region: 'BASHU' },
    ...
    { id: 'city_wulingshan', name: '壶头山', factionId: 'wuling', lat: 29.1167, lng: 110.4667, type: 'small_city', troops: 30000, region: 'BASHU' },
...
{ id: 'city_xingqing', name: '合水', factionId: 'qing', lat: 36.01, lng: 107.87, type: 'small_city', troops: 30000, region: 'CENTRAL' },
...
{ id: 'city_yongan', name: '永安', factionId: 'jingjiang', lat: 24.066563, lng: 110.626831, type: 'small_city', troops: 30000, 
    ...
    // ── 2026-05-27 新增：生苗(甲定) ──
    { id: 'city_jiading', name: '甲定', factionId: 'shengmiao', lat: 26.485279, lng: 107.523193, type: 'small_city', region: 'LINGNAN', troops: 30000,
        note: '甲定；生苗小城',
    },
...
export const CITIES_V2: CityDataV2[] = [
    { id: 'city_weiyeena', name: '维也纳', factionId: 'habusibao', lat: 48.2, lng: 16.37, type: 'big_city', troops: 30000, region: 'WEST_EUROPE' },
    { id: 'city_bulage', name: '布拉格', factionId: 'boximiya', lat: 50.07, lng: 14.43, type: 'big_city', troops: 30000, region: 'WEST_EUROPE' },
    { id: 'city_budapeisi', name: '布达佩斯', factionId: 'mazhaer', lat: 47.49, lng: 19.04, type: 'medium_city', troops: 30000, region: 'WEST_EUROPE' },
    { id: 'city_kelong', name: '科隆', factionId: 'falanji', lat: 50.93, lng: 6.95, type: 'medium_city', troops: 30000, region: 'WEST_EUROPE' },
    { id: 'city_yachen', name: '亚琛', factionId: 'jialuolin', lat: 50.77, lng: 6.08, type: 'medium_city', troops: 30000, region: 'WEST_EUROPE' },
    { id: 'city_meiyinci', name: '美因茨', factionId: 'rierman', lat: 50, lng: 8.27, type: 'medium_city', troops: 30000, region: 'WEST_EUROPE' },
    { id: 'city_aogesibao', name: '奥格斯堡', factionId: 'shiwaben', lat: 48.37, lng: 10.89, type: 'small_city', troops: 30000, region: 'WEST_EUROPE' },
    { id: 'city_bolandengbao', name: '勃兰登堡', factionId: 'asikanani', lat: 52.41, lng: 12.55, type: 'small_city', troops: 30000, region: 'WEST_EUROPE' },
    { id: 'city_magedebao', name: '马格德堡', factionId: 'wende', lat: 52.13, lng: 11.61, type: 'small_city', troops: 30000, region: 'WEST_EUROPE' },
    { id: 'city_leigensibao', name: '雷根斯堡', factionId: 'bafaliya', lat: 49.01, lng: 12.09, type: 'small_city', troops: 30000, region: 'WEST_EUROPE' },
    { id: 'city_niulunbao', name: '纽伦堡', factionId: 'huohengsuolun', lat: 49.45, lng: 11.07, type: 'small_city', troops: 30000, region: 'WEST_EUROPE' },
    { id: 'city_teerier', name: '特里尔', factionId: 'mozeer', lat: 49.75, lng: 6.64, type: 'medium_city', troops: 30000, region: 'WEST_EUROPE' },
    { id: 'city_basaier', name: '巴塞尔', factionId: 'ruishi', lat: 47.55, lng: 7.58, type: 'small_city', troops: 30000, region: 'WEST_EUROPE' },
    { id: 'city_sitelasibao', name: '斯特拉斯堡', factionId: 'aersasi', lat: 48.57, lng: 7.75, type: 'small_city', troops: 30000, region: 'WEST_EUROPE' },
    { id: 'city_aoermuci', name: '奥尔穆茨', factionId: 'molaweiya', lat: 49.59, lng: 17.25, type: 'small_city', troops: 30000, region: 'WEST_EUROPE' },
    { id: 'city_buernuo', name: '布尔诺', factionId: 'damolaweiya', lat: 49.19, lng: 16.6, type: 'small_city', troops: 30000, region: 'WEST_EUROPE' },

    { id: 'city_jifu', name: '基辅', factionId: 'luosi', lat: 50.45, lng: 30.52, type: 'big_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_nuofugeerdede', name: '诺夫哥罗德', factionId: 'liulike', lat: 58.52, lng: 31.27, type: 'medium_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_mosike', name: '莫斯科', factionId: 'mosike_gongguo', lat: 55.75, lng: 37.61, type: 'big_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_fulajimier', name: '弗拉基米尔', factionId: 'fulajimier_gongguo', lat: 56.12, lng: 40.4, type: 'medium_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_simolengsike', name: '斯摩棱斯克', factionId: 'daniebo', lat: 54.78, lng: 32.04, type: 'medium_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_qiernigeweifu', name: '切尔尼戈夫', factionId: 'qiernigeweifu_gongguo', lat: 51.49, lng: 31.28, type: 'small_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_jialiqi', name: '加利奇', factionId: 'jialixiya', lat: 49.12, lng: 24.72, type: 'small_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_pusikefu', name: '普斯科夫', factionId: 'pusikefu_gongheguo', lat: 57.82, lng: 28.33, type: 'small_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_liangzan', name: '梁赞', factionId: 'ouka', lat: 54.62, lng: 39.74, type: 'small_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_boluocike', name: '波洛茨克', factionId: 'xideweina', lat: 55.48, lng: 28.76, type: 'small_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_salai', name: '萨莱', factionId: 'jinzhang', lat: 48.15, lng: 47.15, type: 'medium_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_kashan', name: '喀山', factionId: 'baojiaer', lat: 55.79, lng: 49.11, type: 'medium_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_heersongniesi', name: '赫尔松涅斯', factionId: 'baizanting', lat: 44.61, lng: 33.49, type: 'pass', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_kafa', name: '卡法', factionId: 'kelimiya', lat: 45.03, lng: 35.38, type: 'small_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_saermizerhetusha', name: '萨尔米泽热图萨', factionId: 'dajiya', lat: 45.51, lng: 22.96, type: 'pass', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_salatuofu', name: '萨拉托夫', factionId: 'qincha', lat: 51.53, lng: 46.03, type: 'small_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_weierniwusi', name: '维尔纽斯', factionId: 'litaowan', lat: 54.68, lng: 25.27, type: 'medium_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_huasha', name: '华沙', factionId: 'bolan', lat: 52.22, lng: 21.01, type: 'big_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_kelakefu', name: '克拉科夫', factionId: 'piyasite', lat: 50.06, lng: 19.94, type: 'medium_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_liga', name: '里加', factionId: 'baojian_qishi', lat: 56.95, lng: 24.1, type: 'small_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_teweier', name: '特维尔', factionId: 'teweier_gongguo', lat: 56.86, lng: 35.9, type: 'small_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_xianuofugeerdede', name: '下诺夫哥罗德', factionId: 'suzidaer', lat: 56.32, lng: 44, type: 'small_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_zhapoluore', name: '扎波罗热', factionId: 'gesake', lat: 47.83, lng: 35.16, type: 'small_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_yaxi', name: '雅西', factionId: 'moerdaweiya', lat: 47.16, lng: 27.58, type: 'small_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_teergewishite', name: '特尔格维什特', factionId: 'walajiyia', lat: 44.86, lng: 25.46, type: 'small_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_kenisibao', name: '柯尼斯堡', factionId: 'tiaodun_qishi', lat: 54.71, lng: 20.51, type: 'medium_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_talin', name: '塔林', factionId: 'liwoniya', lat: 59.43, lng: 24.75, type: 'small_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_youliyefu', name: '尤里耶夫', factionId: 'chude', lat: 58.37, lng: 26.72, type: 'small_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_akeman', name: '阿克曼', factionId: 'deniesite', lat: 46.19, lng: 30.34, type: 'pass', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_geluodenuo', name: '格罗德诺', factionId: 'nieman', lat: 53.68, lng: 23.83, type: 'small_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_chalijin', name: '察里津', factionId: 'fuerjia', lat: 48.7, lng: 44.51, type: 'pass', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_samala', name: '萨马拉', factionId: 'nuogai', lat: 53.2, lng: 50.15, type: 'small_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_wufa', name: '乌法', factionId: 'bashekeer', lat: 54.73, lng: 55.96, type: 'small_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_bieergeleide', name: '别尔哥罗德', factionId: 'beisilafu', lat: 50.6, lng: 36.58, type: 'small_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_peilieyasilafu', name: '佩列亚斯拉夫', factionId: 'peilieya_gongguo', lat: 50.07, lng: 31.45, type: 'small_city', troops: 30000, region: 'EAST_EUROPE' },
    { id: 'city_weijiebusike', name: '维捷布斯克', factionId: 'weijiebusike_gongguo', lat: 55.19, lng: 30.2, type: 'small_city', troops: 30000, region: 'EAST_EUROPE' },
    ...
    { id: 'city_genjo', name: '根城', factionId: 'nanbu', lat: 40.5047, lng: 141.4644, type: 'small_city', region: 'JAPAN', troops: 30000, tier: 4,
        note: '根城；陆奥小城',
    },
    ...
    { id: 'city_qiji', name: '普禄', factionId: 'feiyaka', lat: 51.5800, lng: 140.0000, type: 'small_city', region: 'NORTHEAST', troops: 30000, tier: 4,
        note: '普禄；费雅喀小城',
    },
    ...
    { id: 'city_rituzong', name: '日土宗', factionId: 'nanjie', lat: 33.367241, lng: 79.705811, type: 'small_city', region: 'TIBET', troops: 30000,
        note: '日土宗；南杰小城',
    },


    // ── 2026-05-28 新增：甘丹颇章(扎敦宗)、叛军(三陇沙/肩水金关) ──
    { id: 'city_zhadunzong', name: '扎敦宗', factionId: 'gandenpozhang', lat: 29.645092, lng: 84.171753, type: 'small_city', troops: 30000, region: 'TIBET' },
    ...
    { id: 'city_jiegu', name: '结古宗', factionId: 'gling', lat: 33.001753, lng: 97.012024, type: 'small_city', troops: 30000, region: 'TIBET' },



    { id: 'city_qiongbu', name: '丁青宗', factionId: 'khyungpo', lat: 31.4100, lng: 95.5900, type: 'small_city', region: 'TIBET', troops: 30000, tier: 4,
        note: '丁青宗；琼波小城',
    },
    ...
    { id: 'city_akaogicheng', name: '赤尾木城', factionId: 'osumi', lat: 30.7300, lng: 131.0000, type: 'small_city', troops: 30000, tier: 4, 
    ...
    { id: 'city_dajianlu', name: '打箭炉', factionId: 'mingzheng', lat: 30.0500, lng: 101.9600, type: 'small_city', region: 'DIANQIAN', troops: 30000, tier: 4,
        note: '打箭炉；明正小城',
    },
    // ── 2026-05-28 新增：波密(博窝/西藏) ──
    // ── 2026-05-28 新增：达擦(八宿宗/达察呼图克图/家族) ──
    { id: 'city_basu', name: '八宿宗', factionId: 'daca', lat: 30.185461, lng: 97.283936, type: 'small_city', region: 'TIBET', troops: 30000,
        note: '八宿宗；达擦小城',
    },
    ...
    { id: 'city_suozong', name: '索宗', factionId: 'hor', lat: 31.889225, lng: 93.804016, type: 'small_city', region: 'TIBET', troops: 30000,
        note: '索宗；霍尔小城',
    },

    // ── 2026-05-28 新增：董(囊谦宗/玉树/家族) ──
    { id: 'city_nangqian', name: '囊谦宗', factionId: 'dong', lat: 32.2000, lng: 96.4800, type: 'small_city', region: 'TIBET', troops: 30000, tier: 4,
        note: '囊谦宗；隆庆小城',
    },

    // ── 工布土王(尼池/林芝)；巴塘宗改叛军点 ──
    { id: 'city_nichi', name: '太昭', factionId: 'gongbu', lat: 29.752, lng: 93.232, type: 'small_city', region: 'TIBET', troops: 30000,
        note: '太昭；工布小城',
    },
    { id: 'city_litangzong', name: '理塘宗', factionId: 'kangba', lat: 30.0000, lng: 100.2700, type: 'small_city', region: 'TIBET', troops: 30000, note: '康巴骁骑招抚理塘' },
    ...
    { id: 'city_gaochangcheng', name: '高昌', factionId: 'yiduhu', lat: 42.8533, lng: 89.53, type: 'small_city', region: 'WESTERN', troops: 30000, mirror: true, tier: 1,
        note: '高昌；亦都护小城',
    },
    ...
    { id: 'city_luntai', name: '轮台', factionId: 'quli', lat: 41.77, lng: 84.25, type: 'small_city', troops: 30000, region: 'WESTERN' },

    { id: 'city_duluohe', name: '独逻河', factionId: 'kaerka', lat: 45.826868, lng: 101.878967, type: 'small_city', region: 'STEPPE', troops: 30000,
        note: '独逻河；喀尔喀小城',
    },
    ...
    { id: 'city_taizaifu', name: '太宰府', factionId: 'zhuqian', lat: 33.51, lng: 130.52, type: 'small_city', troops: 30000, region: 'JAPAN' },
    ...
    { id: 'city_junfucheng', name: '骏府', factionId: 'jinchuan', lat: 34.97, lng: 138.38, type: 'small_city', region: 'JAPAN', troops: 30000,
        note: '骏府；骏河治所/重镇',
    },
    { id: 'city_hamamatsu', name: '浜松城', factionId: 'totomi', lat: 34.71, lng: 137.73, type: 'small_city', troops: 30000, region: 'JAPAN' },

    { id: 'city_atsuta', name: '热田城', factionId: 'owari', lat: 35.12, lng: 136.95, type: 'small_city', region: 'JAPAN', troops: 30000,
        note: '热田城；尾张小城',
    },
    {
        id: 'city_xuanhua',
    ...
    { id: 'city_xinghe', name: '高原城', factionId: 'chahar', lat: 41.15, lng: 114.7, type: 'small_city', troops: 30000, region: 'STEPPE' },
    ...
    { id: 'city_huixian', name: '河池', factionId: 'huizhou_d', lat: 33.80, lng: 106.06, type: 'small_city', region: 'BASHU', troops: 30000, note: '河池；诸葛亮元戎' },
{ id: 'city_huojia', name: '获嘉', factionId: 'sima_d', lat: 35.26, lng: 113.66, type: 'small_city', troops: 30000, region: 'CENTRAL' },
    ...
    { id: 'city_changze', name: '长泽', factionId: 'kang', lat: 39.1, lng: 107.98, type: 'small_city', troops: 30000, region: 'HEXI' },
    ...
    { id: 'city_ningyuan', name: '宁远城', factionId: 'zu_d', lat: 40.618, lng: 120.72, type: 'small_city', troops: 30000, region: 'NORTH' },
    ...
    { id: 'city_woluduocheng', name: '青岭牙帐', factionId: 'huihu', lat: 47.698601, lng: 102.631531, type: 'small_city', troops: 30000, region: 'STEPPE' },


    { id: 'city_douweihunhe', name: '都尉溷河', factionId: 'kelie', lat: 47.859243, lng: 103.96637, type: 'small_city', troops: 30000, region: 'STEPPE' },

    { id: 'city_xicheng', name: '息城', factionId: 'lelang', lat: 39.62, lng: 125.66, type: 'small_city', troops: 20000, region: 'KOREA' },

    { id: 'city_qudiaoalan', name: '曲雕阿兰', factionId: 'borjigin', lat: 47.146753, lng: 109.204102, type: 'small_city', region: 'STEPPE', troops: 30000,
        note: '曲雕阿兰；孛儿只斤小城',
    },
    ...
    { id: 'city_sangguer', name: '斡难河', factionId: 'zhuerqi', lat: 47.262466, lng: 110.717468, type: 'small_city', region: 'STEPPE', troops: 30000,
        note: '斡难河；主儿乞小城',
    },
    { id: 'city_bayantumen', name: '巴彦图门', factionId: 'chechen', lat: 48.053, lng: 114.538, type: 'small_city', region: 'STEPPE', troops: 30000,
        note: '巴彦图门；车臣小城',
    },
    { id: 'city_huzhan', name: '忽毡', factionId: 'zhaowu', lat: 40.248096, lng: 69.658813, type: 'small_city', troops: 30000, region: 'CENTRAL_ASIA' },

    { id: 'city_aoshen', name: '奥什', factionId: 'kala', lat: 40.53, lng: 72.79, type: 'small_city', troops: 30000, region: 'CENTRAL_ASIA' },




    { id: 'city_dawushenkate', name: '三重城', factionId: 'wensu', lat: 41.13, lng: 82.78, type: 'small_city', region: 'WESTERN', troops: 30000, note: '温宿国王城常备武装' },
    ...
    { id: 'city_yutian2', name: '于阗', factionId: 'yuchi', lat: 37.1000, lng: 79.9200, type: 'small_city', region: 'WESTERN', troops: 30000,
        note: '于阗；尉迟治所/重镇',
    },
    ...
    { id: 'city_sangzhuzi', name: '桑珠孜', factionId: 'tsangpa', lat: 29.303155, lng: 88.862915, type: 'small_city', region: 'TIBET', troops: 30000,
        note: '桑珠孜；藏巴汗小城',
    },

    { id: 'city_jiamachikang', name: '甲玛赤康', factionId: 'spurgyal', lat: 29.74, lng: 91.7, type: 'small_city', troops: 30000, region: 'TIBET' },

    { id: 'city_juemuzong', name: '觉木宗', factionId: 'niang', lat: 29.571086, lng: 94.476929, type: 'small_city', region: 'TIBET', troops: 30000,
        note: '觉木宗；觉木宗小城',
    },
    { id: 'city_galangzong', name: '噶朗宗', factionId: 'galangdiba', lat: 29.86, lng: 95.77, type: 'small_city', region: 'TIBET', troops: 30000, note: '旺钦顿堆波密土王抗清' },
    { id: 'city_mangkangzong', name: '芒康宗', factionId: 'fuguo', lat: 29.67, lng: 98.59, type: 'small_city', region: 'TIBET', troops: 30000,
        note: '芒康宗；附国小城',
    },
    ...
    { id: 'city_yandao', name: '严道', factionId: 'qingyi', lat: 30.000133, lng: 102.972107, type: 'small_city', region: 'BASHU', troops: 30000,
        note: '严道；范长生天师道',
    },
    { id: 'city_qingxiguan', name: '清溪关', factionId: 'zuo_d', lat: 29.3667, lng: 102.6333, type: 'pass', region: 'DIANQIAN', troops: 30000, tier: 2,
        note: '清溪关；笮人关隘',
    },
    { id: 'city_yuegui', name: '越嶲', factionId: 'yueyi', lat: 28.422864, lng: 102.680969, type: 'small_city', troops: 30000, region: 'DIANQIAN' },
    ...
    { id: 'city_cangwu', name: '苍梧', factionId: 'guangxin', lat: 23.47, lng: 111.31, type: 'small_city', region: 'LINGNAN', troops: 30000,
        note: '苍梧；广信小城',
    },
    {
        id: 'city_panyu',
    ...
    { id: 'city_kuaiji', name: '会稽', factionId: 'yue', lat: 29.987000, lng: 120.582000, type: 'small_city', region: 'JIANGNAN', troops: 30000, note: '越国都城；lat 南微调 0.01° 与临安间距≥50km' },
    ...
    { id: 'city_bianliang', name: '开封', factionId: 'song', lat: 34.8, lng: 114.31, type: 'big_city', troops: 30000, region: 'CENTRAL' },
    ...
    { id: 'city_wancheng', name: '皖口', factionId: 'wan', lat: 30.51, lng: 117.04, type: 'small_city', region: 'JIANGNAN', troops: 30000,
        note: '皖口；刘源安庆',
    },
    ...
    { id: 'city_huifa', name: '辉发', factionId: 'haixi_nvzhen', lat: 42.70463, lng: 125.922546, type: 'small_city', troops: 30000, region: 'NORTHEAST' },


    { id: 'city_julunbo', name: '俱轮泊', factionId: 'shiwei', lat: 49.251593, lng: 118.262329, type: 'small_city', region: 'STEPPE', troops: 30000,
        note: '俱轮泊；室韦小城',
    },
    ...
    { id: 'city_sailan', name: '讹答剌', factionId: 'dayuzi', lat: 42.2863, lng: 69.5709, type: 'small_city', troops: 30000, region: 'CENTRAL_ASIA' },
    ...
    { id: 'city_temermen', name: '特尔门',
        factionId: 'heisha_d', lat: 48.7386, lng: 97.8387, type: 'small_city', region: 'STEPPE', troops: 30000, note: '土拉河支流；漠北牧地，近后突厥黑沙道（与黑沙城同系北疆要冲）' },
    ...
    { id: 'city_bohuancheng', name: '拨换城', factionId: 'anxi', lat: 41.17, lng: 80.25, type: 'small_city', troops: 30000, region: 'WESTERN' },
    ...
    { id: 'city_nuergan', name: '特林', factionId: 'nuergan', lat: 52.92, lng: 139.77, type: 'small_city', region: 'NORTHEAST', troops: 30000, note: '明奴儿干都司；康旺；旗面「都卫」避与据点名 §4.1 防重' },
    ...
    { id: 'city_wuyun', name: '乌云', factionId: 'hezhe', lat: 49.018048, lng: 129.91539, type: 'small_city', troops: 30000, region: 'NORTHEAST' },
    ...
    { id: 'city_nuotuoluo', name: '诺托罗', factionId: 'eluoke', lat: 49.2, lng: 143.1, type: 'small_city', region: 'NORTHEAST', troops: 30000, note: '库页岛东岸中部河口，鄂罗克渔猎放牧聚散中心' },
    { id: 'city_baizhu', name: '白主', factionId: 'kuye', lat: 46.71, lng: 142.52, type: 'small_city', region: 'NORTHEAST', troops: 30000, note: '库页岛南部白主土城，元代征骨嵬遗址，库页族核心聚落' },
    { id: 'city_bailao', name: '白老', factionId: 'ayinu', lat: 42.55, lng: 141.36, type: 'small_city', region: 'JAPAN', troops: 30000, note: '北海道南端据泊地方，阿伊努传统聚落（白老古名）' },
    { id: 'city_zonggu', name: '宗谷', factionId: 'beihai', lat: 45.5, lng: 141.93, type: 'small_city', region: 'JAPAN', troops: 30000, note: '宗谷海峡界城；日本—库页（白主）水陆枢纽；地名江户期可考' },
    { id: 'city_xierka', name: '锡尔喀', factionId: 'dongping', lat: 46.9, lng: 134.1, type: 'small_city', region: 'NORTHEAST', troops: 30000, note: '郎坦东平戍卒锡尔喀' },
    ...
    { id: 'city_nibuchu', name: '尼布楚', factionId: 'ewenki', lat: 51.99, lng: 116.58, type: 'small_city', troops: 30000, region: 'NORTHEAST' },
    ...
    { id: 'city_geerbiqi', name: '格尔必齐', factionId: 'maomingan', lat: 53.33, lng: 121.45, type: 'small_city', troops: 30000, region: 'NORTHEAST' },

    { id: 'city_shilekahe', name: '石勒喀河', factionId: 'bulat', lat: 51.7321, lng: 115.8151, type: 'small_city', region: 'STEPPE', troops: 30000, note: '石勒喀河（黑龙江上游），清代舆图所称斡难河源段，布拉特等部游牧地' },
    ...
    { id: 'city_zhande', name: '毡的', factionId: 'wugu_d', lat: 44.85, lng: 65.5, type: 'small_city', troops: 30000, region: 'CENTRAL_ASIA' },

    // ── 2026-06-11 新增：琉球/台湾据点（叛军旗）──
    { id: 'city_mengjia', name: '艋舺', factionId: 'ketagalan', lat: 25.03, lng: 121.50, type: 'small_city', region: 'LINGNAN', troops: 30000, note: '清代台北府淡水厅南境要地，万华故称艋舺' },
    { id: 'city_diaoyudao', name: '钓鱼岛', factionId: 'haikou', lat: 25.75, lng: 123.5, type: 'small_city', troops: 30000, region: 'BASHU' },



    { id: 'city_gugudao', name: '平良', factionId: 'gonggu', lat: 24.805, lng: 125.281, type: 'small_city', troops: 30000, region: 'JAPAN' },

    { id: 'city_qihe', name: '七河', factionId: 'qincha', lat: 44.2219, lng: 64.3332, type: 'small_city', region: 'CENTRAL_ASIA', troops: 30000, note: '钦察汗国七河草原核心带' },
    ...
    { id: 'city_kandaha', name: '坎大哈', factionId: 'dulan_d', lat: 31.6289, lng: 65.7372, type: 'medium_city', troops: 30000, region: 'CENTRAL_ASIA' },
    ...
    { id: 'city_hengyu', name: '横屿', factionId: 'qi_d', lat: 26.77, lng: 119.7, type: 'small_city', troops: 30000, region: 'JIANGNAN' },
    ...
    { id: 'city_penghu', name: '澎湖', factionId: 'wenling', lat: 23.5, lng: 119.5, type: 'small_city', troops: 30000, region: 'BASHU' },
    ...
    { id: 'city_piyetuo', name: '毗耶陀', factionId: 'funan', lat: 11.66, lng: 104.93, type: 'small_city', troops: 30000, region: 'LINGNAN' },
    ...
    { id: 'city_huma', name: '呼玛', factionId: 'elunchunzu', lat: 51.72, lng: 126.65, type: 'small_city', troops: 30000, region: 'NORTHEAST' },
    ...
    { id: 'city_zhongshan', name: '中山', factionId: 'dingzhou', lat: 38.4708, lng: 115.0626, type: 'small_city', troops: 30000, region: 'NORTH' },
    ...
    { id: 'city_zhangguojuncheng', name: '彰国军城', factionId: 'yingzhou_d2', lat: 39.5761, lng: 113.1894, type: 'small_city', troops: 30000, region: 'NORTH' },

    { id: 'city_yunzhongcheng', name: '君子津', factionId: 'dongsheng', lat: 40.2732, lng: 111.1404, type: 'small_city', troops: 30000, region: 'STEPPE' },

    { id: 'city_haomen', name: '浩门', factionId: 'weiyuan', lat: 37.464, lng: 101.4258, type: 'small_city', troops: 30000, region: 'HEXI' },
    ...
    { id: 'city_mubang', name: '木邦', factionId: 'xingwei', lat: 23.32, lng: 97.98, type: 'small_city', troops: 20000, region: 'DIANQIAN' },
    { id: 'city_baihage', name: '白哈格', factionId: 'saerbadaer', lat: 36.21, lng: 57.68, type: 'small_city', troops: 20000, region: 'CENTRAL_ASIA' },
    { id: 'city_damugan', name: '达姆甘', factionId: 'kumisi', lat: 36.17, lng: 54.35, type: 'small_city', troops: 20000, region: 'CENTRAL_ASIA' },
    { id: 'city_leiyi', name: '雷伊', factionId: 'ribale', lat: 35.6, lng: 51.44, type: 'medium_city', troops: 20000, region: 'CENTRAL_ASIA' },
    { id: 'city_jiaziwen', name: '加兹温', factionId: 'safawei', lat: 36.27, lng: 50, type: 'small_city', troops: 20000, region: 'CENTRAL_ASIA' },


    { id: 'city_zanzhan', name: '赞詹', factionId: 'yilihanguo', lat: 36.67, lng: 48.48, type: 'small_city', troops: 20000, region: 'CENTRAL_ASIA' },



    { id: 'city_dabulishi', name: '大不里士', factionId: 'yilihanguo_d', lat: 38.08, lng: 46.29, type: 'medium_city', troops: 20000, region: 'CENTRAL_ASIA' },
    { id: 'city_malagai', name: '马拉盖', factionId: 'asaibaijiang', lat: 37.39, lng: 46.24, type: 'small_city', troops: 20000, region: 'CENTRAL_ASIA' },
    { id: 'city_ailiwen', name: '埃里温', factionId: 'wulaertu', lat: 40.18, lng: 44.51, type: 'small_city', troops: 20000, region: 'CENTRAL_ASIA' },
    { id: 'city_dibilisi', name: '第比利斯', factionId: 'gelujiya', lat: 41.72, lng: 44.79, type: 'medium_city', troops: 20000, region: 'CENTRAL_ASIA' },
    { id: 'city_telabuzong', name: '特拉布宗', factionId: 'bendou', lat: 41, lng: 39.73, type: 'small_city', troops: 20000, region: 'WEST_ASIA' },

    { id: 'city_kutayixi', name: '库塔伊西', factionId: 'keerjisi', lat: 42.27, lng: 42.7, type: 'small_city', troops: 20000, region: 'CENTRAL_ASIA' },
    { id: 'city_amaxiya', name: '阿马西亚', factionId: 'bendou_d', lat: 40.65, lng: 35.83, type: 'small_city', troops: 20000, region: 'WEST_ASIA' },
    { id: 'city_hatusha', name: '哈图沙', factionId: 'heti', lat: 40.02, lng: 34.61, type: 'small_city', troops: 20000, region: 'WEST_ASIA' },
    { id: 'city_geerdiweng', name: '戈尔迪乌姆', factionId: 'fulijiya', lat: 39.65, lng: 31.98, type: 'small_city', troops: 20000, region: 'WEST_ASIA' },
    { id: 'city_sifaerde', name: '斯法尔德', factionId: 'ldiya', lat: 38.48, lng: 28.03, type: 'small_city', troops: 20000, region: 'WEST_ASIA' },
    { id: 'city_peierjiameng', name: '佩尔加蒙', factionId: 'pajiama', lat: 39.12, lng: 27.18, type: 'small_city', troops: 20000, region: 'WEST_ASIA' },
    { id: 'city_nixiya', name: '尼凯亚', factionId: 'bitiniya', lat: 40.43, lng: 29.72, type: 'small_city', troops: 20000, region: 'WEST_ASIA' },
    { id: 'city_junshitandingbao', name: '君士坦丁堡', factionId: 'baizhanting', lat: 41.01, lng: 28.97, type: 'big_city', troops: 20000, region: 'WEST_ASIA' },
    { id: 'city_yikeniwumu', name: '伊科尼乌姆', factionId: 'luomu', lat: 37.87, lng: 32.48, type: 'medium_city', troops: 20000, region: 'WEST_ASIA' },
    { id: 'city_antiejiya', name: '安提俄基亚', factionId: 'sailiugu', lat: 36.2, lng: 36.16, type: 'medium_city', troops: 20000, region: 'WEST_ASIA', mirror: true },
    { id: 'city_damasikusi', name: '大马士革', factionId: 'womaya', lat: 33.51, lng: 36.29, type: 'medium_city', troops: 20000, region: 'WEST_ASIA', note: '倭马亚都，西亚千年都会' },

    { id: 'city_yelusaleng', name: '耶路撒冷', factionId: 'xibolai', lat: 31.77, lng: 35.21, type: 'small_city', troops: 20000, region: 'WEST_ASIA' },
    { id: 'city_mengfeisi', name: '孟菲斯', factionId: 'aiji', lat: 29.85, lng: 31.25, type: 'big_city', troops: 20000, region: 'WEST_ASIA' },
    { id: 'city_wasaite', name: '瓦塞特', factionId: 'dibisi', lat: 25.7, lng: 32.64, type: 'small_city', troops: 20000, region: 'WEST_ASIA' },
    { id: 'city_yalishanda', name: '亚历山大', factionId: 'tuolemi', lat: 31.2, lng: 29.91, type: 'big_city', troops: 20000, region: 'WEST_ASIA', mirror: true },
    { id: 'city_babilun', name: '巴比伦', factionId: 'jialedi', lat: 32.53, lng: 44.42, type: 'big_city', troops: 20000, region: 'WEST_ASIA' },
    { id: 'city_tademoer', name: '塔德莫尔', factionId: 'paermila', lat: 34.55, lng: 38.27, type: 'small_city', troops: 20000, region: 'WEST_ASIA' },
    { id: 'city_bageda', name: '巴格达', factionId: 'abasi', lat: 33.33, lng: 44.37, type: 'big_city', troops: 20000, region: 'WEST_ASIA' },
    { id: 'city_awalisi', name: '阿瓦里斯', factionId: 'xikesuosi', lat: 30.79, lng: 31.83, type: 'small_city', troops: 20000, region: 'WEST_ASIA' },
    { id: 'city_duershelujin', name: '尼尼微', factionId: 'yashu', lat: 36.36, lng: 43.15, type: 'small_city', troops: 20000, region: 'WEST_ASIA' },

    { id: 'city_anate', name: '阿纳特', factionId: 'youfaladi', lat: 34.47, lng: 41.96, type: 'small_city', troops: 20000, region: 'WEST_ASIA' },
    { id: 'city_hamadan', name: '哈马丹', factionId: 'midi', lat: 34.8, lng: 48.51, type: 'medium_city', troops: 20000, region: 'CENTRAL_ASIA' },
    { id: 'city_adana', name: '阿达纳', factionId: 'qiliqiya', lat: 37.06, lng: 35.77, type: 'small_city', troops: 20000, region: 'WEST_ASIA' },
    { id: 'city_bosibolisi', name: '波斯波利斯', factionId: 'aqimeinide', lat: 29.93, lng: 52.89, type: 'small_city', troops: 20000, region: 'CENTRAL_ASIA' },
    { id: 'city_susa', name: '苏萨', factionId: 'ailan', lat: 32.19, lng: 48.24, type: 'small_city', troops: 20000, region: 'CENTRAL_ASIA' },
    { id: 'city_yisifahan', name: '伊斯法罕', factionId: 'safawei_d', lat: 32.65, lng: 51.66, type: 'big_city', troops: 20000, region: 'CENTRAL_ASIA' },
    { id: 'city_wuluke', name: '乌鲁克', factionId: 'sumeier', lat: 31.32, lng: 45.64, type: 'small_city', troops: 20000, region: 'WEST_ASIA' },
    { id: 'city_alepo', name: '阿勒颇', factionId: 'ayoubu', lat: 36.2, lng: 37.16, type: 'medium_city', troops: 20000, region: 'WEST_ASIA', note: '阿尤布都，黎凡特商路枢纽' },
    { id: 'city_daerban', name: '打耳班', factionId: 'kesa', lat: 42.06, lng: 48.3, type: 'small_city', troops: 20000, region: 'CENTRAL_ASIA' },
    { id: 'city_yifusuo', name: '以弗所', factionId: 'aiaoniya', lat: 37.94, lng: 27.34, type: 'medium_city', troops: 20000, region: 'WEST_ASIA', note: '亚细亚省府，爱琴海巨港' },
    { id: 'city_ankala', name: '安卡拉', factionId: 'jialatai', lat: 39.93, lng: 32.87, type: 'small_city', troops: 20000, region: 'WEST_ASIA' },
    { id: 'city_yashucheng', name: '亚述城', factionId: 'guyashu', lat: 35.46, lng: 43.26, type: 'small_city', troops: 20000, region: 'WEST_ASIA' },
    { id: 'city_nisa', name: '尼萨', factionId: 'ansxi', lat: 37.9, lng: 58.2, type: 'small_city', troops: 20000, region: 'CENTRAL_ASIA', note: '安息（帕提亚）帝国第一个首都与皇家陵园，UNESCO世界遗产' },
    ...
    { id: 'city_deli', name: '德里', factionId: 'deli', lat: 28.61, lng: 77.23, type: 'big_city', troops: 20000, region: 'DIANQIAN', note: '德里苏丹国首都（1206–1526），阿拉乌丁·卡尔吉击退蒙古入侵，帝国版图巅峰' },
    { id: 'city_agela', name: '阿格拉', factionId: 'mowoer', lat: 27.18, lng: 78.02, type: 'medium_city', troops: 20000, region: 'DIANQIAN', note: '莫卧儿帝国首都（阿克巴大帝），泰姬陵所在地' },
        { id: 'city_qunvcheng', name: '曲女城', factionId: 'jieri', lat: 27.05, lng: 79.92, type: 'medium_city', troops: 20000, region: 'DIANQIAN', note: '戒日帝国首都，玄奘到访，统一北印度' },
    { id: 'city_walanaxi', name: '瓦拉纳西', factionId: 'jiashi_d', lat: 25.32, lng: 83.01, type: 'medium_city', troops: 30000, region: 'DIANQIAN', note: '迦尸国（十六雄国之一）首都，印度教圣城，佛陀初转法轮处' },
        { id: 'city_huashicheng', name: '华氏城', factionId: 'kongque', lat: 25.61, lng: 85.13, type: 'big_city', troops: 20000, region: 'DIANQIAN', mirror: true },

        { id: 'city_wangshecheng', name: '王舍城', factionId: 'mojietuo', lat: 25.03, lng: 85.42, type: 'small_city', troops: 20000, region: 'DIANQIAN', note: '摩揭陀王国古都（频毗娑罗/阿阇世王），佛陀弘法地' },
    { id: 'city_gaodacheng', name: '高达城', factionId: 'boluo', lat: 24.88, lng: 88.13, type: 'small_city', troops: 20000, region: 'DIANQIAN', note: '波罗帝国首都（达磨波罗），印度最后一个佛教大帝国' },
        { id: 'city_danmoledi', name: '耽摩栗底', factionId: 'sumo', lat: 22.28, lng: 87.92, type: 'small_city', troops: 20000, region: 'DIANQIAN', note: '古代孟加拉湾第一大港，海上丝路起点，法显回国出发港' },
    { id: 'city_beileinisi', name: '贝雷尼斯', factionId: 'beileinisi', lat: 23.91, lng: 35.48, type: 'small_city', troops: 20000, region: 'WEST_ASIA', note: '托勒密/罗马时期埃及红海第一大港，通往印度商路起点' },
    { id: 'city_taima', name: '泰马', factionId: 'dedan', lat: 27.6, lng: 38.5, type: 'small_city', troops: 20000, region: 'WEST_ASIA', note: '德丹王国古商路大绿洲，纳巴泰/阿拉伯贸易枢纽' },
        { id: 'city_maidina', name: '麦地那', factionId: 'maidina', lat: 24.5, lng: 39.6, type: 'small_city', troops: 20000, region: 'WEST_ASIA', note: '伊斯兰第二圣城，第一个伊斯兰国家首都，先知迁徙地' },
        { id: 'city_maijia', name: '麦加', factionId: 'gulaishi', lat: 21.4, lng: 39.8, type: 'small_city', troops: 20000, region: 'WEST_ASIA', note: '伊斯兰第一圣城，古莱什部落控制，克尔白天房所在地' },
    ...
    { id: 'city_mangshilake', name: '曼格什拉克', factionId: 'mangshi', lat: 44, lng: 52, type: 'small_city', troops: 20000, region: 'STEPPE', note: '里海东岸曼格什拉克半岛，乌古斯/塞尔柱草原商路门户' },
        ];
// ── 14 文化区（RegionType）────────────────────────────────
// region: 'JAPAN',         // 日本
// region: 'KOREA',         // 朝鲜
