...
export const BATTLEFIELDS: BattlefieldData[] = [
    ...
    // ── 前 333 年 伊苏斯战役（马其顿 vs 波斯） ──
    {
        ...
        briefing: '格拉尼库斯河大捷扫平了小亚细亚，但真正的风暴接踵而至。\n波斯大帝“万王之王”大流士三世御驾亲征，率十万铁骑神速迂回到远征军背后，切断了退路。公元前333年深秋，地中海畔狭窄的伊苏斯海滩上，两具帝国的统帅退无可退。\n战鼓震颤山海，方阵已然回转——全速奔赴伊苏斯，万王之王的王冠就在前方！',
    },
    ...
    //    剧本：`HistoricalEventScript` `-332`（`type: 'siege'` 攻城战）。
    {
        ...
        briefing: '伊苏斯大捷让大流士仓皇东逃，但波斯强大的海上舰队依旧扼着地中海的咽喉。\n公元前332年初，亚历山大挥师南下黎凡特，孤悬海岛、城墙高耸的腓尼基商业帝国核心——推罗城，拒绝臣服。他们依仗千米海峡与百尺巨壁，誓要将马其顿的陆地雄狮阻挡于狂涛之外。\n移山填海的史诗工程已经启动，投石机与战船的咆哮撕裂海风——全速赶赴推罗前线，准备踏上海上筑起的血色长堤！',
    },
