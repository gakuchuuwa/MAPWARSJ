...
export const BATTLEFIELDS: BattlefieldData[] = [
    ...
    // ── 前 333 年 伊苏斯战役（马其顿 vs 波斯） ──
    {
        ...
        briefing: '格拉尼库斯河被鲜血染透。波斯人愚蠢地将精锐步兵弃置阵后，反让骑兵死守湿滑河滩；亚历山大亲率骑兵强渡撕裂中军，长矛方阵随即踏碎了岸防。\n然而初战告捷，退路却已断绝。万王之王大流士三世亲率十万大军神速绕后，堵死了归途。公元前333年深秋，地中海畔狭窄的伊苏斯平原上，远征军背水回转。\n长矛已然掉头——全速赶赴伊苏斯，唯有冲垮波斯大阵才能活下去！',
    },
    ...
    //    剧本：`HistoricalEventScript` `-331`（`type: 'field_battle'` 野战）。
    {
        ...
        briefing: '推罗的巨壁已化为灰烬，埃及的金字塔亦已俯首称臣。\n公元前331年秋，亚历山大挥师横渡幼发拉底与底格里斯双河，直插美索不达米亚腹地。在此绝境下，大流士三世在广袤的高加米拉平原上集结了全帝国的家底——近十万各族铁骑、两百辆刀轮战车与冲天战象，誓要在此毕其功于一役。\n天地肃杀，两军的营火将黑夜照耀如昼。波斯平原已经铲平，刀轮正蓄势待发——催马向前，高加米拉的帝国终局之战即将打响！',
    },
