...
const _FIXED: Record<string, string> = {
    ...
    'khon': '#4C3876', // 萨迦（八思巴）
    'lang_clan': '#4A3874', // 帕竹/朗氏（绛曲坚赞）
    'karmapa': '#523A80', // 噶玛巴（却英多吉）
    ...
    'jiantang': '#4E3674', // 建塘（桑杰嘉措）
    'gongbu': '#4E3E88', // 工布（工布莽布支）
    'niang': '#4E3C84', // 娘氏（索南加波）
    'galangdiba': '#503A78', // 嘎朗第巴（旺钦顿堆）
