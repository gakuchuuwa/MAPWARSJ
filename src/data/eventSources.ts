...
export const EVENT_SOURCE_ITEMS = [
    ...
    { key: 'attackerTroops', label: '攻方兵力', hint: '史料数字；各说不一时取哪一说' },
    { key: 'attackerLegion', label: '攻方军团编成', hint: '这支军队史称什么；主要兵种；一贯怎么打' },
    { key: 'defender', label: '守方统帅与势力', hint: '谁领兵；属于哪个政权' },
    { key: 'defenderTroops', label: '守方兵力', hint: '史料数字；各说不一时取哪一说' },
    { key: 'defenderLegion', label: '守方军团编成', hint: '这支军队史称什么；主要兵种；一贯怎么打' },
