...
export const JIANGNAN_EXPEDITION_ELITE_LEGIONS: Readonly<Record<string, { name: string; tier: 0 | 1 | 2 | 3 }>> = {
  ...
  chu: { name: '申息之师', tier: 3 },        // 郢城·§9 #3 楚国申息故地精兵
  sunwu_d: { name: '解烦兵', tier: 2 },      // 武昌·§1 #34 孙吴解烦（江南交叉）
  ...
  lu: { name: '逍遥津死士', tier: 2 },       // 合肥·张辽八百破十万（旗=庐·庐州）
  min: { name: '长乐控鹤', tier: 1 },        // 冶城·闽国控鹤军（≠武周洛阳控鹤军）
  chen: { name: '建康水军', tier: 1 },       // 清远·§9 #6 陈霸先江南水师
  xiao_d: { name: '白袍军', tier: 0 },       // 兰陵·§9 #7 陈庆之南梁
  yue_d: { name: '背嵬军', tier: 0 },        // 巴陵·§9 #8 岳飞岳云
  jingzhou: { name: '忠顺军', tier: 2 },     // 襄阳·§9 #11 《宋史·孟珙传》忠顺军（旗=荆·荆州；成军枣阳）
  song: { name: '御前诸军', tier: 1 },       // 临安·孟珙南宋御前诸军
  ...
  wu: { name: '锦帆贼', tier: 2 },           // 姑苏·§1 #35 甘宁（江南交叉）
  ruochu: { name: '六卒精锐', tier: 3 },     // 竟陵·§9 #1 若敖六卒（旗=若敖）
  mi_chu: { name: '左右广军', tier: 1 },     // 云梦·§9 #2 楚左广与右广（旗=芈）
