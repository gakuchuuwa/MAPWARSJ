...
name: string; tier: 0 | 1 | 2 | 3 }>> = {
  ...
  jinling: { name: '量沙军', tier: 2 },     // 金陵·檀道济唱筹量沙（战术疑兵）
  ...
  quanzhou: { name: '清源军', tier: 3 },        // 刺桐·留从效清源军
  chen: { name: '建康水军', tier: 3 },       // 清远·陈霸先水师

  yue_d: { name: '背嵬军', tier: 0 },        // 巴陵·§9 #8 岳飞岳云
      xiangzhou: { name: '襄阳镇军', tier: 2 },     // 襄阳·坚守六年的重镇防卫力量
  ...
  changshaguo: { name: '飞虎军', tier: 2 },      // 临湘·辛弃疾长沙飞虎军（地方防卫军）
  hongzhou: { name: '洪都戍卒', tier: 2 },    // 豫章·朱文正洪都保卫战（防御战术铁壁）
  ...
  taizhou: { name: '海陵镇兵', tier: 2 },       // 海陵·李昪发迹之地
