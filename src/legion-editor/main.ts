...
export const DE_UNITS_CATALOG: DeUnitDef[] = [
    ...
    { id: 'elite_blackwood_archer', name: '图皮精锐黑木弓箭手', category: 'ranged', age: 'unknown', pathPrefix: '/SUCAI/ELITEBLACKWOODARCHER/' },
    { id: 'elite_bolas_rider', name: '马普切精锐套索骑兵', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITEBOLASRIDER/' },
    ...
    { id: 'elite_genoese_crossbowman', name: '意大利精锐热那亚弩手', category: 'ranged', age: 'imperial', pathPrefix: '/SUCAI/ELITEGENOESECROSSBOWMAN/' },
    ...
    { id: 'elite_kona', name: '马普切精锐科纳勇士', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/ELITEKONA/' },
    ...
    { id: 'elite_temple_guard', name: '穆伊斯卡精锐神庙守卫', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/ELITETEMPLEGUARD/' },
