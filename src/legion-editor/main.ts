...
export const DE_UNITS_CATALOG: DeUnitDef[] = [
    ...
    { id: 'champion', name: '欧洲冠军剑士精锐', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/CHAMPION/' },
    ...
    { id: 'jian_swordsman', name: '华夏刀剑手精锐', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/JIAN_SWORDSMAN/' },
    ...
    { id: 'legionary', name: '罗马军团步兵精锐', category: 'infantry', age: 'antiquity', pathPrefix: '/SUCAI/LEGIONARY/' },
    ...
    { id: 'savar', name: '波斯萨瓦尔重骑精锐', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/SAVAR/' },
    { id: 'camel_heavy', name: '骆驼兵重装', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/CAMEL_HEAVY/' },
    { id: 'paladin', name: '欧洲游侠精锐', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/PALADIN/' },
    ...
    { id: 'arbalest', name: '欧洲劲弩手高级', category: 'ranged', age: 'imperial', pathPrefix: '/SUCAI/ARBALEST/' },
    ...
    { id: 'companion_cavalry', name: '马其顿伙伴骑兵精锐', category: 'cavalry', age: 'antiquity', pathPrefix: '/SUCAI/COMPANION_CAVALRY/' },
    { id: 'condottiero', name: '意大利佣兵精锐', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/CONDOTTIERO/' },
    ...
    { id: 'eagle_scout', name: '美洲鹰斥候', category: 'infantry', age: 'antiquity', pathPrefix: '/SUCAI/EAGLESCOUT/' },
    { id: 'eagle_warrior', name: '鹰勇士', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/EAGLEWARRIOR/' },
    { id: 'ekdromos', name: '希腊埃克德罗摩斯精锐', category: 'infantry', age: 'antiquity', pathPrefix: '/SUCAI/EKDROMOS/' },
    ...
    { id: 'elite_ratha_ranged', name: '孟加拉拉塔弓战车精锐', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITERATHARANGED/' },
    ...
    { id: 'hippeus', name: '斯巴达希皮乌斯精锐', category: 'infantry', age: 'antiquity', pathPrefix: '/SUCAI/HIPPEUS/' },
    { id: 'hoplite', name: '希腊重装步兵', category: 'infantry', age: 'antiquity', pathPrefix: '/SUCAI/HOPLITE/' },
    { id: 'strategos', name: '雅典将军卫队精锐', category: 'infantry', age: 'antiquity', pathPrefix: '/SUCAI/STRATEGOS/' },
    ...
    { id: 'militia', name: '民兵', category: 'infantry', age: 'antiquity', pathPrefix: '/SUCAI/MILITIA/' },
    ...
    { id: 'qizilbash_warrior', name: '波斯红头骑士精锐', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/QIZILBASHWARRIOR/' },
    { id: 'ratha_melee', name: '孟加拉拉塔战车', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/RATHAMELEE/' },
    { id: 'ratha_ranged', name: '孟加拉拉塔弓战车', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/RATHARANGED/' },
    ...
    { id: 'royal_janissary', name: '奥斯曼皇家亲兵精锐', category: 'ranged', age: 'imperial', pathPrefix: '/SUCAI/ROYALJANISSARY/' },
    { id: 'sacred_band', name: '希腊底比斯圣队精锐', category: 'infantry', age: 'antiquity', pathPrefix: '/SUCAI/SACRED_BAND/' },
    { id: 'sannahya', name: '孔雀桑纳亚战象精锐', category: 'cavalry', age: 'antiquity', pathPrefix: '/SUCAI/SANNAHYA/' },
    { id: 'scorpion', name: '欧洲弩炮', category: 'siege', age: 'castle', pathPrefix: '/SUCAI/SCORPION/' },
    { id: 'scythian_axe_cavalry', name: '斯基泰斧骑兵精锐', category: 'cavalry', age: 'antiquity', pathPrefix: '/SUCAI/SCYTHIAN_AXE_CAVALRY/' },
    ...
    { id: 'sakan_axeman', name: '塞种萨迦斧兵精锐', category: 'infantry', age: 'antiquity', pathPrefix: '/SUCAI/SAKAN_AXEMAN/' },
    ...
    { id: 'warrior_priest', name: '亚美尼亚修士战士精锐', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/WARRIORPRIEST/' },
    { id: 'winged_hussar', name: '波兰翼骑兵精锐', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/WINGEDHUSSAR/' },
    { id: 'woad_raider', name: '凯尔特靛蓝突袭者', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/WOADRAIDER/' },
    { id: 'xolotl_warrior', name: '阿兹特克索洛特尔骑兵精锐', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/XOLOTLWARRIOR/' },
    ...
    { id: 'jian_swordman_unshielded', name: '华夏双手剑士精锐', category: 'infantry', age: 'feudal', pathPrefix: '/SUCAI/JIAN_SWORDMAN_UNSHIELDED/' },
    ...
    { id: 'halberdier', name: '欧洲重装戟兵', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/HALBERDIER/' },
    { id: 'norse_warrior', name: '诺斯狂暴战士', category: 'infantry', age: 'feudal', pathPrefix: '/SUCAI/NORSE_WARRIOR/' },
    { id: 'sosso_guard', name: '西非索索禁卫军精锐', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/SOSSO_GUARD/' },
    { id: 'elite_greek_cavalry', name: '希腊贵族骑兵高级', category: 'cavalry', age: 'antiquity', pathPrefix: '/SUCAI/ELITE_GREEK_CAVALRY/' },
    { id: 'jian_swordman_shielded', name: '华夏持盾刀剑手精锐', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/JIANSWORDMANSHIELDED/' },
    { id: 'levy', name: '征召民兵', category: 'infantry', age: 'antiquity', pathPrefix: '/SUCAI/LEVY/' },
    ...
    { id: 'paragon', name: '十字军圣殿楷模武士精锐', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/PARAGON/' },
    { id: 'shock_cavalry', name: '希腊化冲击骑兵重装', category: 'cavalry', age: 'antiquity', pathPrefix: '/SUCAI/SHOCK_CAVALRY/' },
    { id: 'imperial_cavalry', name: '拜占庭骑兵重装', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/IMPERIAL_CAVALRY/' },
    { id: 'equites', name: '罗马伴随骑士精锐', category: 'cavalry', age: 'antiquity', pathPrefix: '/SUCAI/EQUITES/' },
    ...
    { id: 'crusader_knight', name: '欧洲十字军骑士精锐', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/CRUSADERKNIGHT/' },
    ...
    { id: 'antiquity_capped_ram', name: '古典装甲攻城槌高级', category: 'siege', age: 'antiquity', pathPrefix: '/SUCAI/ANTIQUITY_CAPPED_RAM/' },
    { id: 'antiquity_scorpion', name: '古典弩炮', category: 'siege', age: 'antiquity', pathPrefix: '/SUCAI/ANTIQUITY_SCORPION/' },
    { id: 'antiquity_heavy_scorpion', name: '古典重型弩炮重装', category: 'siege', age: 'antiquity', pathPrefix: '/SUCAI/ANTIQUITY_HEAVY_SCORPION/' },
    { id: 'antiquity_mangonel', name: '古典轻型投石车', category: 'siege', age: 'antiquity', pathPrefix: '/SUCAI/ANTIQUITY_MANGONEL/' },
    { id: 'antiquity_onager', name: '古典中型投石车高级', category: 'siege', age: 'antiquity', pathPrefix: '/SUCAI/ANTIQUITY_ONAGER/' },
    { id: 'antiquity_siege_onager', name: '古典重型投石车重装', category: 'siege', age: 'antiquity', pathPrefix: '/SUCAI/ANTIQUITY_SIEGE_ONAGER/' },
    { id: 'antiquity_siege_ram', name: '古典重型攻城槌重装', category: 'siege', age: 'antiquity', pathPrefix: '/SUCAI/ANTIQUITY_SIEGE_RAM/' },
    ...
    { id: 'hero_basileus', name: '英雄·皇帝巴西琉斯', category: 'hero', age: 'antiquity', pathPrefix: '/SUCAI/BASILEUS/' },
    ...
    { id: 'hero_ivaylo', name: '英雄·骑马伊瓦伊洛', category: 'hero', age: 'castle', pathPrefix: '/SUCAI/IVAYLO/' },
    { id: 'hero_ivaylofoot', name: '英雄·步战伊瓦伊洛', category: 'hero', age: 'castle', pathPrefix: '/SUCAI/IVAYLOFOOT/' },
    { id: 'hero_janzizka', name: '英雄·扬·杰式卡', category: 'hero', age: 'castle', pathPrefix: '/SUCAI/JANZIZKA/' },
    { id: 'hero_joanofarc', name: '英雄·全甲战马圣女贞德', category: 'hero', age: 'castle', pathPrefix: '/SUCAI/JOANOFARC/' },
    ...
    { id: 'sunda_royal_fighter', name: '爪哇巽他皇家战士精锐', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/SUNDA_ROYAL_FIGHTER/' },
    ...
    { id: 'frankish_paladin', name: '法兰克圣骑士精锐', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/FRANKISHPALADIN/' },
    { id: 'jarl', name: '维京首领骑兵精锐', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/JARL/' },
