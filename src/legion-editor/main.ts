...
export const DE_UNITS_CATALOG: DeUnitDef[] = [
    ...
    { id: 'bayinnaung_elephant',        name: '莽应龙战象',     category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/BAYINNAUNG_ELEPHANT/' },
    { id: 'dagnajan_elephant',          name: '达格纳詹战象',   category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/DAGNAJAN_ELEPHANT/' },
    { id: 'porus_elephant',             name: '波鲁斯战象',     category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/PORUS_ELEPHANT/' },
    ...
    { id: 'sannahya', name: '桑纳亚象兵', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/SANNAHYA/' },
    ...
    { id: 'foot_konnik', name: '贵族近卫步兵', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/FOOTKONNIK/' },
    { id: 'champi_warrior', name: '尚皮勇士', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/CHAMPIWARRIOR/' },
    { id: 'champi_runner', name: '尚皮飞毛腿', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/CHAMPIRUNNER/' },
    { id: 'champi_scout', name: '尚皮斥候', category: 'infantry', age: 'feudal', pathPrefix: '/SUCAI/CHAMPISCOUT/' },
    ...
    { id: 'macedon_infantry', name: '马其顿重步兵', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/MACEDON/' },
    { id: 'roman_legion', name: '罗马军团步兵', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/ROMAN_LEGION/' },
    { id: 'sakan_axeman', name: '塞种战斧兵', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/SAKAN_AXEMAN/' },
    { id: 'ibirapema_elite', name: '精锐伊比拉佩马勇士', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/IBIRAPEMA_ELITE/' },
    { id: 'levy', name: '征召民兵', category: 'infantry', age: 'dark', pathPrefix: '/SUCAI/LEVY/' },
    { id: 'norse_warrior', name: '诺斯狂战士步兵', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/NORSE_WARRIOR/' },
    { id: 'paragon', name: '圣殿楷模武士', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/PARAGON/' },
    { id: 'sosso_guard', name: '索索禁卫军', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/SOSSO_GUARD/' },
    { id: 'vanguard', name: '先锋突击步兵', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/VANGUARD/' },
    ...
    { id: 'huaxia_iron_cavalry', name: '华夏具装铁骑', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/HUAXIA_IRON_CAVALRY/' },
    ...
    { id: 'tarantine_cavarly', name: '塔兰托标枪骑兵', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/TARANTINE_CAVARLY/' },
    { id: 'camel_imperial', name: '帝王骆驼兵', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/CAMEL_IMPERIAL/' },
    { id: 'huaxia_crossbow', name: '华夏连弩兵', category: 'ranged', age: 'castle', pathPrefix: '/SUCAI/HUAXIA_CROSSBOW/' },
    { id: 'steppe_horse_archer', name: '草原弓骑兵', category: 'ranged', age: 'castle', pathPrefix: '/SUCAI/STEPPE_HORSE_ARCHER/' },
    ...
    { id: 'guecha_elite', name: '精锐格查投石射手', category: 'ranged', age: 'imperial', pathPrefix: '/SUCAI/GUECHA_ELITE/' },
    ...
    { id: 'ranged_immortal', name: '波斯不死军(投矛)', category: 'ranged', age: 'castle', pathPrefix: '/SUCAI/RANGED_IMMORTAL/' },
    { id: 'flamethrower', name: '猛火油柜', category: 'siege', age: 'imperial', pathPrefix: '/SUCAI/FLAMETHROWER/' },
    { id: 'helepolis', name: '赫勒波利斯巨型攻城塔', category: 'siege', age: 'imperial', pathPrefix: '/SUCAI/HELEPOLIS/' },
    { id: 'organ_elite', name: '精锐风琴炮', category: 'siege', age: 'imperial', pathPrefix: '/SUCAI/ORGAN_ELITE/' },
    { id: 'siege_ballista', name: '精锐巨型弩炮', category: 'siege', age: 'imperial', pathPrefix: '/SUCAI/SIEGE_BALLISTA/' },
];
