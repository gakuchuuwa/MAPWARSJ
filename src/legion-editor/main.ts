...
export const DE_UNITS_CATALOG: DeUnitDef[] = [
    ...
    { id: 'elite_fire_lancer', name: '南宋火矛手高级', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/ELITE_FIRE_LANCER/' },
    ...
    { id: 'karambit_warrior', name: '马来爪刀勇士', category: 'infantry', age: 'feudal', pathPrefix: '/SUCAI/KARAMBIT_WARRIOR/' },
    { id: 'karambit_warrior_elite', name: '马来爪刀勇士精锐', category: 'infantry', age: 'feudal', pathPrefix: '/SUCAI/KARAMBIT_WARRIOR_ELITE/' },
    ...
    { id: 'savar', name: '波斯萨瓦尔重骑高级', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/SAVAR/' },
    { id: 'camel_heavy', name: '骆驼兵重装', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/CAMEL_HEAVY/' },
    { id: 'paladin', name: '欧洲游侠高级', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/PALADIN/' },
    ...
    { id: 'elite_chukonu', name: '中国诸葛弩精锐', category: 'ranged', age: 'antiquity', pathPrefix: '/SUCAI/ELITE_CHUKONU/' },
    { id: 'longbowman_elite', name: '不列颠长弓兵精锐', category: 'ranged', age: 'castle', pathPrefix: '/SUCAI/LONGBOWMAN_ELITE/' },
    { id: 'fire_archer', name: '吴火焰弓箭手', category: 'ranged', age: 'antiquity', pathPrefix: '/SUCAI/FIRE_ARCHER/' },
    { id: 'elite_fire_archer', name: '吴火焰弓箭手精锐', category: 'ranged', age: 'antiquity', pathPrefix: '/SUCAI/ELITE_FIRE_ARCHER/' },
    { id: 'kipchak', name: '库曼钦察弓骑', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/KIPCHAK/' },
    { id: 'elite_kipchak', name: '库曼钦察弓骑精锐', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/ELITE_KIPCHAK/' },
    ...
    { id: 'elite_composite_bowman', name: '亚美尼亚复合弓手精锐', category: 'ranged', age: 'feudal', pathPrefix: '/SUCAI/ELITE_COMPOSITE_BOWMAN/' },
    ...
    { id: 'war_elephant', name: '波斯战象', category: 'cavalry', age: 'feudal', pathPrefix: '/SUCAI/WAR_ELEPHANT/' },
    ...
    { id: 'companion_cavalry', name: '马其顿伙伴骑兵高级', category: 'cavalry', age: 'antiquity', pathPrefix: '/SUCAI/COMPANION_CAVALRY/' },
    { id: 'condottiero', name: '意大利佣兵高级', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/CONDOTTIERO/' },
    { id: 'conquistador', name: '西班牙征服者', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/CONQUISTADOR/' },
    ...
    { id: 'ekdromos', name: '希腊埃克德罗摩斯高级', category: 'infantry', age: 'antiquity', pathPrefix: '/SUCAI/EKDROMOS/' },
    { id: 'elite_arambai', name: '缅甸飞镖骑兵精锐', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/ELITEARAMBAI/' },
    { id: 'elite_ballista_elephant', name: '高棉弩炮战象精锐', category: 'siege', age: 'castle', pathPrefix: '/SUCAI/ELITEBALLISTAELEPHANT/' },
    ...
    { id: 'elite_chakram_thrower', name: '古吉拉特飞轮掷手精锐', category: 'ranged', age: 'feudal', pathPrefix: '/SUCAI/ELITECHAKRAMTHROWER/' },
    { id: 'elite_champi_warrior', name: '印加尚皮勇士高级', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/ELITECHAMPIWARRIOR/' },
    { id: 'elite_conquistador', name: '西班牙征服者精锐', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITECONQUISTADOR/' },
    { id: 'elite_coustillier', name: '勃艮第马上轻骑精锐', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/ELITECOUSTILLIER/' },
    { id: 'elite_eagle_warrior', name: '鹰勇士高级', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/ELITEEAGLEWARRIOR/' },
    { id: 'elite_elephant_archer', name: '象弓骑兵高级', category: 'ranged', age: 'feudal', pathPrefix: '/SUCAI/ELITEELEPHANTARCHER/' },
    { id: 'elite_gbeto', name: '马里格贝托女兵精锐', category: 'ranged', age: 'castle', pathPrefix: '/SUCAI/ELITEGBETO/' },
    { id: 'elite_genitour', name: '标枪骑兵高级', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/ELITEGENITOUR/' },
    { id: 'elite_genoese_crossbowman', name: '意大利热那亚弩手精锐', category: 'ranged', age: 'castle', pathPrefix: '/SUCAI/ELITEGENOESECROSSBOWMAN/' },
    { id: 'elite_ghulam', name: '印度斯坦古拉姆精锐', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/ELITEGHULAM/' },
    ...
    { id: 'elite_janissary', name: '土耳其苏丹亲兵精锐', category: 'ranged', age: 'castle', pathPrefix: '/SUCAI/ELITEJANISSARY/' },
    ...
    { id: 'elite_mameluke', name: '萨拉森马穆鲁克精锐', category: 'cavalry', age: 'feudal', pathPrefix: '/SUCAI/ELITEMAMELUKE/' },
    { id: 'elite_monaspa', name: '格鲁吉亚莫纳斯帕精锐', category: 'cavalry', age: 'feudal', pathPrefix: '/SUCAI/ELITEMONASPA/' },
    ...
    { id: 'elite_ratha_melee', name: '孟加拉拉塔战车精锐', category: 'cavalry', age: 'feudal', pathPrefix: '/SUCAI/ELITERATHAMELEE/' },
    { id: 'elite_ratha_ranged', name: '孟加拉拉塔弓战车精锐', category: 'cavalry', age: 'feudal', pathPrefix: '/SUCAI/ELITERATHARANGED/' },
    ...
    { id: 'elite_urumi_swordsman', name: '达罗毗荼软剑士精锐', category: 'infantry', age: 'feudal', pathPrefix: '/SUCAI/ELITEURUMISWORDSMAN/' },
    ...
    { id: 'elite_war_elephant', name: '波斯战象精锐', category: 'cavalry', age: 'feudal', pathPrefix: '/SUCAI/ELITEWARELEPHANT/' },
    ...
    { id: 'elite_war_wagon', name: '高丽战车精锐', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/ELITEWARWAGON/' },
    ...
    { id: 'kona', name: '马普切科纳勇士', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/KONA/' },
    { id: 'konnik', name: '保加利亚骑兵', category: 'cavalry', age: 'feudal', pathPrefix: '/SUCAI/KONNIK/' },
    { id: 'konnik_foot', name: '锤炼兵', category: 'infantry', age: 'feudal', pathPrefix: '/SUCAI/FOOTKONNIK/' },
    ...
    { id: 'mameluke', name: '萨拉森马穆鲁克', category: 'cavalry', age: 'feudal', pathPrefix: '/SUCAI/MAMELUKE/' },
    ...
    { id: 'monaspa', name: '格鲁吉亚莫纳斯帕', category: 'cavalry', age: 'feudal', pathPrefix: '/SUCAI/MONASPA/' },
    ...
    { id: 'ratha_melee', name: '孟加拉拉塔战车', category: 'cavalry', age: 'feudal', pathPrefix: '/SUCAI/RATHAMELEE/' },
    { id: 'ratha_ranged', name: '孟加拉拉塔弓战车', category: 'cavalry', age: 'feudal', pathPrefix: '/SUCAI/RATHARANGED/' },
    ...
    { id: 'urumi_swordsman', name: '达罗毗荼软剑士', category: 'infantry', age: 'feudal', pathPrefix: '/SUCAI/URUMISWORDSMAN/' },
    ...
    { id: 'warrior_priest', name: '亚美尼亚修士战士高级', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/WARRIORPRIEST/' },
    ...
    { id: 'xolotl_warrior', name: '阿兹特克索洛特尔骑兵高级', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/XOLOTLWARRIOR/' },
    ...
    { id: 'sunda_royal_fighter', name: '爪哇巽他皇家战士高级', category: 'infantry', age: 'feudal', pathPrefix: '/SUCAI/SUNDA_ROYAL_FIGHTER/' },
    ...
    { id: 'lembos', name: '希腊轻型伦博斯', category: 'naval', age: 'antiquity', pathPrefix: '/SUCAI/LEMBOS/' },
