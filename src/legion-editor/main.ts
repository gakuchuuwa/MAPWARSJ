...
export const DE_UNITS_CATALOG: DeUnitDef[] = [
    { id: 'swordsman', name: '剑士', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/SWORDSMAN/' },
    { id: 'champion', name: '冠军剑士', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/CHAMPION/' },
    { id: 'liao_dao', name: '契丹辽刀手', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/LIAO_DAO/' },
    { id: 'elite_liao_dao', name: '契丹辽刀手精锐', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/ELITE_LIAO_DAO/' },
    ...
    { id: 'samurai', name: '日本武士', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/SAMURAI_DE/' },
    { id: 'samurai_elite', name: '日本武士精锐', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/SAMURAI_ELITE/' },
    { id: 'fire_lancer', name: '南宋火矛手', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/FIRE_LANCER/' },
    { id: 'elite_fire_lancer', name: '南宋火矛手高级', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/ELITE_FIRE_LANCER/' },
    { id: 'white_feather_guard', name: '蜀白毦兵', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/WHITE_FEATHER_GUARD/' },
    { id: 'elite_white_feather_guard', name: '蜀白毦兵精锐', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/ELITE_WHITE_FEATHER_GUARD/' },
    { id: 'karambit_warrior', name: '马来爪刀勇士', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/KARAMBIT_WARRIOR/' },
    { id: 'karambit_warrior_elite', name: '马来爪刀勇士精锐', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/KARAMBIT_WARRIOR_ELITE/' },
    ...
    { id: 'legionary', name: '军团步兵', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/LEGIONARY/' },
    { id: 'throwing_axeman', name: '法兰克掷斧兵', category: 'ranged', age: 'unknown', pathPrefix: '/SUCAI/THROWING_AXEMAN/' },
    { id: 'heavy_pikeman', name: '长枪兵重装', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/HEAVY_PIKEMAN/' },
    ...
    { id: 'xianbei_raider', name: '鲜卑掠骑兵', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/XIANBEI_RAIDER/' },
    { id: 'iron_pagoda', name: '女真铁浮屠', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/IRON_PAGODA/' },
    { id: 'hei_kuang', name: '南北朝黑光铠骑兵', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/HEI_KUANG/' },
    ...
    { id: 'camel_heavy', name: '骆驼兵重装', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/CAMEL_HEAVY/' },
    ...
    { id: 'light_riders', name: '中世纪轻骑兵', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/LIGHT_RIDERS/' },
    { id: 'chukonu', name: '中国诸葛弩', category: 'ranged', age: 'unknown', pathPrefix: '/SUCAI/CHUKONU/' },
    { id: 'elite_chukonu', name: '中国诸葛弩精锐', category: 'ranged', age: 'imperial', pathPrefix: '/SUCAI/ELITE_CHUKONU/' },
    { id: 'longbowman_elite', name: '不列颠长弓兵精锐', category: 'ranged', age: 'unknown', pathPrefix: '/SUCAI/LONGBOWMAN_ELITE/' },
    { id: 'fire_archer', name: '吴火焰弓箭手', category: 'ranged', age: 'castle', pathPrefix: '/SUCAI/FIRE_ARCHER/' },
    { id: 'elite_fire_archer', name: '吴火焰弓箭手精锐', category: 'ranged', age: 'imperial', pathPrefix: '/SUCAI/ELITE_FIRE_ARCHER/' },
    ...
    { id: 'mangudai_elite', name: '蒙古突骑精锐', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/MANGUDAI_ELITE/' },
    { id: 'rattan_archer', name: '越南藤弓兵', category: 'ranged', age: 'castle', pathPrefix: '/SUCAI/RATTAN_ARCHER/' },
    { id: 'rattan_archer_elite', name: '越南藤弓兵精锐', category: 'ranged', age: 'unknown', pathPrefix: '/SUCAI/RATTAN_ARCHER_ELITE/' },
    { id: 'imperial_skirmisher', name: '帝王掷矛手', category: 'ranged', age: 'imperial', pathPrefix: '/SUCAI/IMPERIAL_SKIRMISHER/' },
    { id: 'archer', name: '南方步弓手', category: 'ranged', age: 'unknown', pathPrefix: '/SUCAI/ARCHER/' },
    { id: 'cav_archer', name: '骑射手', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/CAV_ARCHER/' },
    { id: 'cav_archer_heavy', name: '骑射手重装', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/CAV_ARCHER_HEAVY/' },
    { id: 'pattiyoda_longbowman', name: '僧伽罗帕提尤达长弓手', category: 'ranged', age: 'unknown', pathPrefix: '/SUCAI/PATTIYODA_LONGBOWMAN/' },
    { id: 'composite_bowman', name: '亚美尼亚复合弓手', category: 'ranged', age: 'castle', pathPrefix: '/SUCAI/COMPOSITE_BOWMAN/' },
    { id: 'elite_composite_bowman', name: '亚美尼亚复合弓手精锐', category: 'ranged', age: 'imperial', pathPrefix: '/SUCAI/ELITE_COMPOSITE_BOWMAN/' },
    { id: 'crossbowman', name: '弩兵', category: 'ranged', age: 'castle', pathPrefix: '/SUCAI/CROSSBOWMAN/' },
    { id: 'arbalest', name: '劲弩手', category: 'ranged', age: 'unknown', pathPrefix: '/SUCAI/ARBALEST/' },
    { id: 'arambai', name: '缅甸飞镖骑兵', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/ARAMBAI/' },
    { id: 'war_elephant', name: '波斯战象', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/WAR_ELEPHANT/' },
    ...
    { id: 'elite_armored_elephant', name: '装甲攻城战象高级', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/ELITEARMOREDELEPHANT/' },
    ...
    { id: 'battering_ram', name: '轻型攻城槌', category: 'siege', age: 'unknown', pathPrefix: '/SUCAI/BATTERINGRAM/' },
    ...
    { id: 'bombard_cannon', name: '火炮', category: 'siege', age: 'unknown', pathPrefix: '/SUCAI/BOMBARDCANNON/' },
    ...
    { id: 'camel_rider', name: '骆驼骑兵', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/CAMELRIDER/' },
    { id: 'camel_scout', name: '古吉拉特骆驼斥候', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/CAMELSCOUT/' },
    { id: 'capped_ram', name: '装甲攻城槌', category: 'siege', age: 'imperial', pathPrefix: '/SUCAI/CAPPEDRAM/' },
    { id: 'cataphract', name: '拜占庭圣骑兵', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/CATAPHRACT/' },
    ...
    { id: 'condottiero', name: '佣兵', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/CONDOTTIERO/' },
    ...
    { id: 'elite_blackwood_archer', name: '图皮黑木弓箭手高级', category: 'ranged', age: 'imperial', pathPrefix: '/SUCAI/ELITEBLACKWOODARCHER/' },
    ...
    { id: 'elite_champi_warrior', name: '印加尚皮勇士高级', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/ELITECHAMPIWARRIOR/' },
    ...
    { id: 'elite_kona', name: '马普切科纳勇士高级', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITEKONA/' },
    ...
    { id: 'elite_scythian_horse_archer', name: '斯基泰骑射手高级', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITE_SCYTHIAN_HORSE_ARCHER/' },
    ...
    { id: 'elite_temple_guard', name: '穆伊斯卡神庙守卫高级', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/ELITETEMPLEGUARD/' },
    ...
    { id: 'elite_tiger_cavalry', name: '魏虎骑兵精锐', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITETIGERCAVALRY/' },
    { id: 'elite_urumi_swordsman', name: '达罗毗荼软剑士精锐', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/ELITEURUMISWORDSMAN/' },
    { id: 'elite_war_chariot', name: '双轮战车高级', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITE_WAR_CHARIOT/' },
    { id: 'elite_war_dog', name: '战犬高级', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/ELITEWARDOG/' },
    { id: 'elite_war_elephant', name: '波斯战象精锐', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITEWARELEPHANT/' },
    { id: 'bayinnaung_elephant', name: '莽应龙御驾战象', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/BAYINNAUNG_ELEPHANT/' },
    { id: 'dagnajan_elephant', name: '达格纳詹御驾战象', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/DAGNAJAN_ELEPHANT/' },
    { id: 'porus_elephant', name: '波鲁斯王战象', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/PORUS_ELEPHANT/' },
    ...
    { id: 'flemish_pikeman_f', name: '勃艮第佛兰德民兵F', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/FLEMISHPIKEMAN_F/' },
    ...
    { id: 'genoese_crossbowman', name: '意大利热那亚弩手', category: 'ranged', age: 'unknown', pathPrefix: '/SUCAI/GENOESECROSSBOWMAN/' },
    ...
    { id: 'imperial_centurion', name: '帝国百夫长', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/IMPERIALCENTURION/' },
    ...
    { id: 'kona', name: '马普切科纳勇士', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/KONA/' },
    { id: 'konnik', name: '保加利亚骑兵', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/KONNIK/' },
    { id: 'konnik_foot', name: '锤炼兵', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/FOOTKONNIK/' },
    ...
    { id: 'mameluke', name: '萨拉森马穆鲁克', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/MAMELUKE/' },
    { id: 'mangonel', name: '轻型投石车', category: 'siege', age: 'unknown', pathPrefix: '/SUCAI/MANGONEL/' },
    { id: 'mercenary_hoplite', name: '希腊雇佣重步兵', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/ELITE_HOPLITE/' },
    { id: 'militia', name: '民兵', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/MILITIA/' },
    { id: 'monaspa', name: '格鲁吉亚莫纳斯帕', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/MONASPA/' },
    { id: 'mounted_trebuchet', name: '骆驼投石机', category: 'siege', age: 'imperial', pathPrefix: '/SUCAI/MOUNTEDTREBUCHET/' },
    ...
    { id: 'ratha_melee', name: '孟加拉拉塔战车', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/RATHAMELEE/' },
    ...
    { id: 'scorpion', name: '弩炮', category: 'siege', age: 'unknown', pathPrefix: '/SUCAI/SCORPION/' },
    ...
    { id: 'serjeant', name: '西西里军士长', category: 'infantry', age: 'feudal', pathPrefix: '/SUCAI/SERJEANT/' },
    ...
    { id: 'traction_trebuchet', name: '牵引投石机', category: 'siege', age: 'imperial', pathPrefix: '/SUCAI/TRACTIONTREBUCHET/' },
    ...
    { id: 'xolotl_warrior', name: '阿兹特克索洛特尔骑兵', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/XOLOTLWARRIOR/' },
    ...
    { id: 'champi_runner', name: '印加尚皮飞毛腿', category: 'infantry', age: 'feudal', pathPrefix: '/SUCAI/CHAMPIRUNNER/' },
    { id: 'champi_scout', name: '印加尚皮斥候', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/CHAMPISCOUT/' },
    { id: 'jian_swordman_unshielded', name: '双手剑士(华夏)', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/JIAN_SWORDMAN_UNSHIELDED/' },
    { id: 'cavalier', name: '骑士重装', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/CAVALIER/' },
    { id: 'flamethrower', name: '猛火油柜(喷火器)', category: 'siege', age: 'unknown', pathPrefix: '/SUCAI/FLAMETHROWER/' },
    { id: 'helepolis', name: '希腊赫勒波利斯攻城塔', category: 'siege', age: 'unknown', pathPrefix: '/SUCAI/HELEPOLIS/' },
    { id: 'siege_tower', name: '攻城塔', category: 'siege', age: 'unknown', pathPrefix: '/SUCAI/SIEGETOWER/' },
    { id: 'halberdier', name: '戟兵', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/HALBERDIER/' },
    { id: 'norse_warrior', name: '诺斯狂暴战士', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/NORSE_WARRIOR/' },
    { id: 'sosso_guard', name: '西非索索禁卫军', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/SOSSO_GUARD/' },
    { id: 'elite_greek_cavalry', name: '希腊贵族骑兵高级', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/ELITE_GREEK_CAVALRY/' },
    { id: 'jian_swordman_shielded', name: '持盾刀剑手', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/JIANSWORDMANSHIELDED/' },
    { id: 'levy', name: '征召民兵', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/LEVY/' },
    { id: 'gastraphetes', name: '希腊腹弩手', category: 'ranged', age: 'unknown', pathPrefix: '/SUCAI/GASTRAPHETES/' },
    { id: 'laminated_bowman', name: '层压复合弓手', category: 'ranged', age: 'unknown', pathPrefix: '/SUCAI/LAMINATED_BOWMAN/' },
    { id: 'recurve_bowman', name: '反曲长弓手', category: 'ranged', age: 'unknown', pathPrefix: '/SUCAI/RECURVE_BOWMAN/' },
    { id: 'paragon', name: '圣殿楷模武士', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/PARAGON/' },
    { id: 'shock_cavalry', name: '冲击重骑兵', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/SHOCK_CAVALRY/' },
    { id: 'imperial_cavalry', name: '帝国具装骑兵', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/IMPERIAL_CAVALRY/' },
    { id: 'equites', name: '罗马伴随骑士', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/EQUITES/' },
    { id: 'sarmatian', name: '萨尔马提亚重骑兵', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/SARMATIAN/' },
    { id: 'elite_peltast', name: '色雷斯标枪手高级', category: 'ranged', age: 'unknown', pathPrefix: '/SUCAI/ELITE_PELTAST/' },
    { id: 'vanguard', name: '先锋重装步兵', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/VANGUARD/' },
    { id: 'bowman', name: '弓兵', category: 'ranged', age: 'unknown', pathPrefix: '/SUCAI/BOWMAN/' },
    { id: 'crusader_knight', name: '十字军骑士', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/CRUSADERKNIGHT/' },
    { id: 'raider', name: '掠骑兵', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/RAIDER/' },
    { id: 'guardsman', name: '近卫军', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/GUARDSMAN/' },
    { id: 'antiquity_skirmisher', name: '古典掷矛手', category: 'ranged', age: 'unknown', pathPrefix: '/SUCAI/ANTIQUITY_SKIRMISHER/' },
    { id: 'elite_antiquity_skirmisher', name: '古典掷矛手高级', category: 'ranged', age: 'unknown', pathPrefix: '/SUCAI/ELITE_ANTIQUITY_SKIRMISHER/' },
    { id: 'antiquity_cavalry_archer', name: '古典骑射手', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/ANTIQUITY_CAVALRY_ARCHER/' },
    { id: 'antiquity_heavy_cavalry_archer', name: '古典骑射手重装', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/ANTIQUITY_HEAVY_CAVALRY_ARCHER/' },
    { id: 'antiquity_light_cavalry', name: '古典轻骑兵', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/ANTIQUITY_LIGHT_CAVALRY/' },
    { id: 'antiquity_scout_cavalry', name: '古典斥候骑兵', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/ANTIQUITY_SCOUT_CAVALRY/' },
    { id: 'antiquity_spearman', name: '古典长矛兵', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/ANTIQUITY_SPEARMAN/' },
    { id: 'antiquity_battering_ram', name: '古典轻型攻城槌', category: 'siege', age: 'unknown', pathPrefix: '/SUCAI/ANTIQUITY_BATTERINGRAM/' },
    { id: 'antiquity_capped_ram', name: '古典装甲攻城槌', category: 'siege', age: 'unknown', pathPrefix: '/SUCAI/ANTIQUITY_CAPPED_RAM/' },
    { id: 'antiquity_scorpion', name: '古典弩炮', category: 'siege', age: 'unknown', pathPrefix: '/SUCAI/ANTIQUITY_SCORPION/' },
    { id: 'antiquity_heavy_scorpion', name: '古典重型弩炮', category: 'siege', age: 'unknown', pathPrefix: '/SUCAI/ANTIQUITY_HEAVY_SCORPION/' },
    { id: 'antiquity_mangonel', name: '古典轻型投石车', category: 'siege', age: 'unknown', pathPrefix: '/SUCAI/ANTIQUITY_MANGONEL/' },
    { id: 'antiquity_onager', name: '古典中型投石车', category: 'siege', age: 'unknown', pathPrefix: '/SUCAI/ANTIQUITY_ONAGER/' },
    { id: 'antiquity_siege_onager', name: '古典重型投石车', category: 'siege', age: 'unknown', pathPrefix: '/SUCAI/ANTIQUITY_SIEGE_ONAGER/' },
    { id: 'antiquity_siege_ram', name: '古典重型攻城槌', category: 'siege', age: 'unknown', pathPrefix: '/SUCAI/ANTIQUITY_SIEGE_RAM/' },
    { id: 'antiquity_siege_tower', name: '古典攻城塔', category: 'siege', age: 'unknown', pathPrefix: '/SUCAI/ANTIQUITY_SIEGE_TOWER/' },
    { id: 'galley', name: '桨帆船', category: 'naval', age: 'unknown', pathPrefix: '/SUCAI/GALLEY/' },
    { id: 'war_galley', name: '大战舰', category: 'naval', age: 'unknown', pathPrefix: '/SUCAI/WAR_GALLEY/' },
    ...
    { id: 'fire_galley', name: '喷火桨帆船', category: 'naval', age: 'unknown', pathPrefix: '/SUCAI/FIRE_GALLEY/' },
    { id: 'fire_ship', name: '喷火船', category: 'naval', age: 'unknown', pathPrefix: '/SUCAI/FIRE_SHIP/' },
    { id: 'fast_fire_ship', name: '快速喷火船', category: 'naval', age: 'unknown', pathPrefix: '/SUCAI/FAST_FIRE_SHIP/' },
    ...
    { id: 'cannon_galleon', name: '炮舰', category: 'naval', age: 'unknown', pathPrefix: '/SUCAI/CANNON_GALLEON/' },
    { id: 'elite_cannon_galleon', name: '炮舰高级', category: 'naval', age: 'unknown', pathPrefix: '/SUCAI/ELITE_CANNON_GALLEON/' },
    { id: 'caravel', name: '卡拉维尔帆船', category: 'naval', age: 'unknown', pathPrefix: '/SUCAI/CARAVEL/' },
    { id: 'elite_caravel', name: '卡拉维尔帆船高级', category: 'naval', age: 'imperial', pathPrefix: '/SUCAI/ELITE_CARAVEL/' },
    { id: 'demo_ship', name: '爆破舰', category: 'naval', age: 'unknown', pathPrefix: '/SUCAI/DEMO_SHIP/' },
    { id: 'heavy_demo_ship', name: '重型爆破舰', category: 'naval', age: 'unknown', pathPrefix: '/SUCAI/HEAVY_DEMO_SHIP/' },
    { id: 'longboat', name: '维京长船', category: 'naval', age: 'unknown', pathPrefix: '/SUCAI/LONGBOAT/' },
    ...
    { id: 'dragon_ship', name: '龙头战舰', category: 'naval', age: 'unknown', pathPrefix: '/SUCAI/DRAGON_SHIP/' },
    { id: 'thirisadai', name: '提利萨代战舰', category: 'naval', age: 'imperial', pathPrefix: '/SUCAI/THIRISADAI/' },
    ...
    { id: 'hero_alaric', name: '英雄·亚拉里克', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/ALARIC/' },
    { id: 'hero_algirdas', name: '英雄·阿尔吉尔达斯', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/ALGIRDAS/' },
    { id: 'hero_arariboiamelee', name: '英雄·阿拉里博亚', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/ARARIBOIAMELEE/' },
    { id: 'hero_aristagoras', name: '英雄·阿里斯塔哥拉斯', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/ARISTAGORAS/' },
    { id: 'hero_aristides', name: '英雄·阿里斯提德', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/ARISTIDES/' },
    { id: 'hero_artaphernes', name: '英雄·阿尔塔弗涅斯', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/ARTAPHERNES/' },
    { id: 'hero_ataulf', name: '英雄·阿陶尔夫', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/ATAULF/' },
    { id: 'hero_attila', name: '英雄·阿提拉', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/ATTILA/' },
    { id: 'hero_basileus', name: '英雄·巴西琉斯(皇帝)', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/BASILEUS/' },
    { id: 'hero_bernardarmagnac', name: '英雄·贝尔纳·德·阿马尼亚克', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/BERNARDARMAGNAC/' },
    { id: 'hero_bohemond', name: '英雄·博希蒙德', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/BOHEMOND/' },
    { id: 'hero_brasidas', name: '英雄·巴西达斯', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/BRASIDAS/' },
    { id: 'hero_caocao', name: '英雄·曹操', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/CAOCAO/' },
    { id: 'hero_cleitus', name: '英雄·克雷图斯', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/CLEITUS/' },
    { id: 'hero_cumanchief', name: '英雄·库曼酋长', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/CUMANCHIEF/' },
    { id: 'hero_cunhambebe', name: '英雄·昆汉贝贝', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/CUNHAMBEBE/' },
    { id: 'hero_cusiyupanqui', name: '英雄·库西尤潘基', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/CUSIYUPANQUI/' },
    { id: 'hero_dafyddapgruffydd', name: '英雄·戴菲德', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/DAFYDDAPGRUFFYDD/' },
    { id: 'hero_datis', name: '英雄·达提斯', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/DATIS/' },
    { id: 'hero_dinhle', name: '英雄·丁礼', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/DINHLE/' },
    { id: 'hero_dismounted_alexander', name: '英雄·步战亚历山大', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/DISMOUNTED_ALEXANDER/' },
    { id: 'hero_mounted_alexander', name: '英雄·骑马亚历山大', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/MOUNTED_ALEXANDER/' },
    { id: 'hero_edwardlongshanks', name: '英雄·长腿爱德华', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/EDWARDLONGSHANKS/' },
    { id: 'hero_gajahmada', name: '英雄·加查·马达', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/GAJAHMADA/' },
    { id: 'hero_galvarino', name: '英雄·加尔瓦里诺', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/GALVARINO/' },
    { id: 'hero_generalaraiyan', name: '英雄·阿赖扬将军', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/GENERALARAIYAN/' },
    { id: 'hero_gidajan', name: '英雄·吉达扬', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/GIDAJAN/' },
    { id: 'hero_gilbertdeclare', name: '英雄·吉尔伯特', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/GILBERTDECLARE/' },
    { id: 'hero_girgenkhan', name: '英雄·吉尔根汗', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/GIRGENKHAN/' },
    { id: 'hero_guacolda', name: '英雄·瓜科尔达', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/GUACOLDA/' },
    { id: 'hero_guanyu', name: '英雄·关羽', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/GUANYU/' },
    { id: 'hero_ivaylo', name: '英雄·伊瓦伊洛(骑马)', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/IVAYLO/' },
    { id: 'hero_ivaylofoot', name: '英雄·伊瓦伊洛(步战)', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/IVAYLOFOOT/' },
    { id: 'hero_janzizka', name: '英雄·扬·杰式卡', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/JANZIZKA/' },
    { id: 'hero_joanofarc', name: '英雄·圣女贞德(全甲战马)', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/JOANOFARC/' },
    { id: 'hero_joanthemaid', name: '英雄·奥尔良少女贞德', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/JOANTHEMAID/' },
    { id: 'hero_jogaila', name: '英雄·雅盖沃', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/JOGAILA/' },
    { id: 'hero_johnthefearless', name: '英雄·无畏的约翰', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/JOHNTHEFEARLESS/' },
    { id: 'hero_kestutis', name: '英雄·科斯图提斯', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/KESTUTIS/' },
    { id: 'hero_kotyankhan', name: '英雄·忽炭汗', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/KOTYANKHAN/' },
    { id: 'hero_kushluk', name: '英雄·屈出律', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/KUSHLUK/' },
    { id: 'hero_lautaro', name: '英雄·劳塔罗', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/LAUTARO/' },
    { id: 'hero_leloi', name: '英雄·黎利', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/LELOI/' },
    { id: 'hero_liubei', name: '英雄·刘备', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/LIUBEI/' },
    { id: 'hero_llywelynapgruffydd', name: '英雄·卢埃林', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/LLYWELYNAPGRUFFYDD/' },
    { id: 'hero_lubu', name: '英雄·吕布', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/LUBU/' },
    { id: 'hero_lysander', name: '英雄·吕山德', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/LYSANDER/' },
    { id: 'hero_macedonian_commander', name: '英雄·马其顿指挥官', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/MACEDONIAN_COMMANDER/' },
    { id: 'hero_osman', name: '英雄·奥斯曼一世', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/OSMAN/' },
    { id: 'hero_pacanchique', name: '英雄·帕坎奇克', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/PACANCHIQUE/' },
    { id: 'hero_pachacuti', name: '英雄·帕查库特克', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/PACHACUTI/' },
    { id: 'hero_parmenion', name: '英雄·帕曼纽', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/PARMENION/' },
    { id: 'hero_perdiccas', name: '英雄·佩尔狄卡斯', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/PERDICCAS/' },
    { id: 'hero_philipthegood', name: '英雄·好人菲利普', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/PHILIPTHEGOOD/' },
    { id: 'hero_prithviraj', name: '英雄·普里特维拉吉', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/PRITHVIRAJ/' },
    { id: 'hero_qutlugh', name: '英雄·忽都鲁', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/QUTLUGH/' },
    { id: 'hero_rajendrachola', name: '英雄·罗贞陀罗·朱罗', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/RAJENDRACHOLA/' },
    { id: 'hero_robertguiscard', name: '英雄·罗贝尔·吉斯卡尔', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/ROBERTGUISCARD/' },
    { id: 'hero_rogerbosso', name: '英雄·罗杰·博索', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/ROGERBOSSO/' },
    { id: 'hero_sforza', name: '英雄·斯福尔扎', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/SFORZA/' },
    { id: 'hero_shahismail', name: '英雄·沙阿·伊斯玛仪', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/SHAHISMAIL/' },
    { id: 'hero_subotai', name: '英雄·速不台', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/SUBOTAI/' },
    { id: 'hero_sumanguru', name: '英雄·苏曼古鲁', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/SUMANGURU/' },
    { id: 'hero_sunce', name: '英雄·孙策', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/SUNCE/' },
    { id: 'hero_sundjata', name: '英雄·松迪亚塔', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/SUNDJATA/' },
    { id: 'hero_sunjian', name: '英雄·孙坚', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/SUNJIAN/' },
    { id: 'hero_sunquan', name: '英雄·孙权', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/SUNQUAN/' },
    { id: 'hero_tariqibnziyad', name: '英雄·塔里克', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/TARIQIBNZIYAD/' },
    { id: 'hero_thoros', name: '英雄·托罗斯', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/THOROS/' },
    { id: 'hero_thracian_chieftain', name: '英雄·色雷斯酋长', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/THRACIAN_CHIEFTAIN/' },
    { id: 'hero_tsarkonstantin', name: '英雄·君士坦丁沙皇', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/TSARKONSTANTIN/' },
    { id: 'hero_ulrichvonjungingen', name: '英雄·容金根', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/ULRICHVONJUNGINGEN/' },
    { id: 'hero_vladdracula', name: '英雄·穿刺公德古拉', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/VLADDRACULA/' },
    { id: 'hero_vytautasthegreat', name: '英雄·维陶塔斯大帝', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/VYTAUTASTHEGREAT/' },
    { id: 'hero_williamwallace', name: '英雄·威廉·华莱士', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/WILLIAMWALLACE/' },
    { id: 'hero_yodit', name: '英雄·尤迪特', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/YODIT/' },
    { id: 'hero_zhangfei', name: '英雄·张飞', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/ZHANGFEI/' },
    { id: 'manatarms', name: '装甲步兵', category: 'infantry', age: 'feudal', pathPrefix: '/SUCAI/MANATARMS/' },
    { id: 'sunda_royal_fighter', name: '巽他皇家战士', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/SUNDA_ROYAL_FIGHTER/' },
    { id: 'envoy', name: '和平使者', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/ENVOY/' },
    { id: 'lancer', name: '枪骑兵', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/LANCER/' },
    ...
    { id: 'frankish_paladin', name: '法兰克圣骑士', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/FRANKISHPALADIN/' },
    { id: 'jarl', name: '首领骑士', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/JARL/' },
    { id: 'siege_ballista', name: '攻城床弩车', category: 'siege', age: 'unknown', pathPrefix: '/SUCAI/SIEGE_BALLISTA/' },
    { id: 'monoreme', name: '单层桨座战船', category: 'naval', age: 'unknown', pathPrefix: '/SUCAI/MONOREME/' },
    { id: 'bireme', name: '双层桨座战船', category: 'naval', age: 'castle', pathPrefix: '/SUCAI/BIREME/' },
    { id: 'trireme', name: '三层桨座战船', category: 'naval', age: 'imperial', pathPrefix: '/SUCAI/TRIREME/' },
    { id: 'lembos', name: '伦波斯轻战船', category: 'naval', age: 'unknown', pathPrefix: '/SUCAI/LEMBOS/' },
    { id: 'war_lembos', name: '作战伦波斯船', category: 'naval', age: 'feudal', pathPrefix: '/SUCAI/WAR_LEMBOS/' },
    { id: 'elite_lembos', name: '精锐伦波斯船', category: 'naval', age: 'imperial', pathPrefix: '/SUCAI/ELITE_LEMBOS/' },
    { id: 'heavy_lembos', name: '重型伦波斯船', category: 'naval', age: 'castle', pathPrefix: '/SUCAI/HEAVY_LEMBOS/' },
    { id: 'dromon', name: '德罗蒙重弩炮舰', category: 'naval', age: 'imperial', pathPrefix: '/SUCAI/DROMON/' },
    { id: 'hulk', name: '柯克大战船', category: 'naval', age: 'feudal', pathPrefix: '/SUCAI/HULK/' },
    { id: 'war_hulk', name: '重型柯克战船', category: 'naval', age: 'castle', pathPrefix: '/SUCAI/WAR_HULK/' },
    { id: 'galleon', name: '大型多桅战船', category: 'naval', age: 'unknown', pathPrefix: '/SUCAI/GALLEON/' },
    { id: 'carrack', name: '克拉克重帆船', category: 'naval', age: 'imperial', pathPrefix: '/SUCAI/CARRACK/' },
    { id: 'catapult_galleon', name: '投石帆船', category: 'naval', age: 'unknown', pathPrefix: '/SUCAI/CATAPULT_GALLEON/' },
    { id: 'demo_raft', name: '爆破排筏', category: 'naval', age: 'unknown', pathPrefix: '/SUCAI/DEMO_RAFT/' },
    { id: 'incendiary_raft', name: '燃烧排筏', category: 'naval', age: 'unknown', pathPrefix: '/SUCAI/INCENDIARY_RAFT/' },
    { id: 'canoe', name: '独木战舟', category: 'naval', age: 'unknown', pathPrefix: '/SUCAI/CANOE/' },
    { id: 'merchant_ship', name: '远洋贸易船', category: 'naval', age: 'feudal', pathPrefix: '/SUCAI/MERCHANT_SHIP/' },
    { id: 'lou_chuan', name: '中国楼船', category: 'naval', age: 'unknown', pathPrefix: '/SUCAI/LOU_CHUAN/' },
    { id: 'leviathan', name: '利维坦巨舰', category: 'naval', age: 'unknown', pathPrefix: '/SUCAI/LEVIATHAN/' },
    { id: 'hero_themistocles', name: '英雄·地米斯托克利', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/HERO_THEMISTOCLES/' },
    { id: 'hero_artemisia', name: '英雄·阿尔特米西亚', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/HERO_ARTEMISIA/' },
    { id: 'hero_dionysus', name: '英雄·狄奥尼索斯', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/HERO_DIONYSUS/' },
    { id: 'hero_aeginetan', name: '英雄·埃伊纳指挥官', category: 'hero', age: 'unknown', pathPrefix: '/SUCAI/HERO_AEGINETAN/' },
...
// 兼容外部系统（如战斗场景、势力方阵配置）对去重前旧 ID 的引用
...
export const UNIT_SUBCATEGORY: Record<string, SubCategory> = {
    ...
    // 弩手
    chukonu: 'crossbow', elite_chukonu: 'crossbow', crossbowman: 'crossbow', arbalest: 'crossbow', arbalester: 'crossbow',
    ...
    <table class="le-table">
      <thead>
        <tr>
          ...
          <th data-col="legionPower" style="width:64px;" title="军团战力：按格位人数加权平均的兵种战力，口径与单兵战力一致（中位兵=100）。不含相克与阵型战术收益">战力${sortArrow('legionPower')}</th>
      ...
      <tbody>
        ${filteredRows.map(r => `
          <tr data-fid="${r.factionId}" class="${r.factionId === selectedFactionId ? 'selected' : ''}">
            ...
            <td>${(() => {
                const lp = getLegionPower(r.slots);
                if (!lp) return '<span style="color:#5a5348;">—</span>';
                ...
                return `<b style="color:${color};font-family:monospace;font-size:13px;" title="${detail}${lp.unknownCount ? '\n（有 ' + lp.unknownCount + ' 人查不到战力，未计入平均）' : ''}">${lp.index}</b>`;
            })()}</td>
...
const REGION_TAB_LABEL_SET = new Set<string>(Object.values(REGION_LABELS));

/** 名字是否属于「地区军团」（地区名 / 地区默认军团名，精确匹配） */
function isRegionLegionName(name: string): boolean {
    const base = (name || '').replace(/军团$/, '').trim();
...
function renderEditPanel(row: FactionLegionRow): void {
    ...
    <div class="le-wizard-step">
      ...
      <div class="le-step-title">三排兵种搭配（点击选择兵种）</div>
    ...
    <!-- 第二步 · 阵型 -->
    <div class="le-wizard-step">
      <div class="le-step-no">第二步</div>
      <div class="le-step-title">阵型选择（七阵体系 · 全阵型 9 人 · 精锐主力优先 4 档）</div>
    ...
    <details id="le-tune-details" class="le-form-section">
      <summary class="le-collapse-toggle">⚙ 军团实时动态预览<span style="color:#8a8070;">▾</span></summary>
...
/** 该军团名是否已被其他势力/武将使用（独立军团单占用判据，排除当前势力） */
function isLegionUsedByOther(factionId: string, legionName: string): boolean {
    if (!legionName) return false;
    for (const fid of Object.keys(localCustomCompositions)) {
        if (fid === factionId) continue;
        if (localCustomCompositions[fid]?.legionName?.trim() === legionName) return true;
    }
    return false;
}
