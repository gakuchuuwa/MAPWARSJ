...
export const DE_UNITS_CATALOG: DeUnitDef[] = [
    ...
    { id: 'elite_fire_lancer', name: '高级南宋火矛手',     category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/ELITE_FIRE_LANCER/' },
    ...
    { id: 'elite_guardsman', name: '高级近卫军',     category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/ELITE_GUARDSMAN/' },
    ...
    { id: 'hei_kuang_heavy', name: '重装黑光铠骑兵', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/HEI_KUANG_HEAVY/' },
    { id: 'steppe_lancer', name: '草原枪骑兵',       category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/STEPPE_LANCER/' },
    { id: 'elite_steppe_lancer', name: '高级草原枪骑兵',   category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITE_STEPPE_LANCER/' },
    ...
    { id: 'elite_armored_elephant', name: '高级装甲攻城战象',   category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITEARMOREDELEPHANT/' },
    ...
    { id: 'elite_battle_elephant', name: '高级战斗象', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITEBATTLEELEPHANT/' },
    { id: 'elite_berserk', name: '维京狂战士精锐', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/ELITEBERSERK/' },
    { id: 'elite_blackwood_archer', name: '高级图皮黑木弓箭手', category: 'ranged', age: 'unknown', pathPrefix: '/SUCAI/ELITEBLACKWOODARCHER/' },
    { id: 'elite_bolas_rider', name: '高级马普切套索骑兵', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITEBOLASRIDER/' },
    ...
    { id: 'elite_champi_warrior', name: '高级印加尚皮勇士', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/ELITECHAMPIWARRIOR/' },
    ...
    { id: 'elite_eagle_warrior', name: '高级鹰勇士', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/ELITEEAGLEWARRIOR/' },
    { id: 'elite_elephant_archer', name: '高级象弓骑兵', category: 'ranged', age: 'imperial', pathPrefix: '/SUCAI/ELITEELEPHANTARCHER/' },
    { id: 'elite_gbeto', name: '马里格贝托女兵精锐', category: 'ranged', age: 'imperial', pathPrefix: '/SUCAI/ELITEGBETO/' },
    { id: 'elite_genitour', name: '高级标枪骑兵', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITEGENITOUR/' },
    ...
    { id: 'elite_guecha_warrior', name: '高级穆伊斯卡格查勇士', category: 'ranged', age: 'unknown', pathPrefix: '/SUCAI/ELITEGUECHAWARRIOR/' },
    ...
    { id: 'elite_ibirapema_warrior', name: '高级图皮战棍勇士', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/ELITEIBIRAPEMAWARRIOR/' },
    ...
    { id: 'elite_kona', name: '高级马普切科纳勇士', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/ELITEKONA/' },
    { id: 'elite_konnik', name: '保加利亚骑兵精锐', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITEKONNIK/' },
    { id: 'elite_konnik_foot', name: '高级锤炼兵', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/ELITEFOOTKONNIK/' },
    ...
    { id: 'elite_scythian_horse_archer', name: '高级斯基泰骑射手', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/ELITE_SCYTHIAN_HORSE_ARCHER/' },
    ...
    { id: 'elite_shrivamsha_rider', name: '高级什里瓦姆沙骑手', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITESHRIVAMSHARIDER/' },
    { id: 'elite_skirmisher', name: '高级掷矛手', category: 'ranged', age: 'castle', pathPrefix: '/SUCAI/ELITESKIRMISHER/' },
    { id: 'elite_temple_guard', name: '高级穆伊斯卡神庙守卫', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/ELITETEMPLEGUARD/' },
    ...
    { id: 'elite_war_chariot', name: '高级双轮战车', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/ELITE_WAR_CHARIOT/' },
    { id: 'elite_war_dog', name: '高级战犬', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/ELITEWARDOG/' },
    ...
    { id: 'elite_greek_cavalry', name: '高级希腊贵族骑兵', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITE_GREEK_CAVALRY/' },
    ...
    { id: 'elite_peltast', name: '高级色雷斯标枪手', category: 'ranged', age: 'castle', pathPrefix: '/SUCAI/ELITE_PELTAST/' },
    ...
    { id: 'elite_antiquity_skirmisher', name: '高级古典掷矛手', category: 'ranged', age: 'castle', pathPrefix: '/SUCAI/ELITE_ANTIQUITY_SKIRMISHER/' },
    ...
    { id: 'ant_elite_galley', name: '高级古典桨帆船', category: 'naval', age: 'unknown', pathPrefix: '/SUCAI/ANT_ELITE_GALLEY/' },
    ...
    { id: 'elite_cannon_galleon', name: '高级炮舰', category: 'naval', age: 'imperial', pathPrefix: '/SUCAI/ELITE_CANNON_GALLEON/' },
    { id: 'caravel', name: '卡拉维尔帆船', category: 'naval', age: 'castle', pathPrefix: '/SUCAI/CARAVEL/' },
    { id: 'elite_caravel', name: '高级卡拉维尔帆船', category: 'naval', age: 'imperial', pathPrefix: '/SUCAI/ELITE_CARAVEL/' },
    ...
    { id: 'elite_longboat', name: '高级维京长船', category: 'naval', age: 'imperial', pathPrefix: '/SUCAI/ELITE_LONGBOAT/' },
    { id: 'turtle_ship', name: '龟船', category: 'naval', age: 'castle', pathPrefix: '/SUCAI/TURTLE_SHIP/' },
    { id: 'elite_turtle_ship', name: '高级龟船', category: 'naval', age: 'imperial', pathPrefix: '/SUCAI/ELITE_TURTLE_SHIP/' },
