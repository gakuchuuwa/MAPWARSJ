...
export const DE_UNITS_CATALOG: DeUnitDef[] = [
    ...
    { id: 'fire_archer', name: '东吴火箭手',     category: 'ranged', age: 'unknown', pathPrefix: '/SUCAI/FIRE_ARCHER/' },
    { id: 'elite_fire_archer', name: '东吴火箭手精锐', category: 'ranged', age: 'unknown', pathPrefix: '/SUCAI/ELITE_FIRE_ARCHER/' },
