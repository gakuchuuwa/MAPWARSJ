...
export const DE_UNITS_CATALOG: DeUnitDef[] = [
    ...
    { id: 'elite_liao_dao', name: '精锐辽国大刀兵',       category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/ELITE_LIAO_DAO/' },
    ...
    { id: 'elite_fire_lancer', name: '精锐南宋火矛手',     category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/ELITE_FIRE_LANCER/' },
    { id: 'white_feather_guard', name: '蜀汉白毦兵',         category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/WHITE_FEATHER_GUARD/' },
    { id: 'elite_white_feather_guard', name: '精锐蜀汉白毦兵',     category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/ELITE_WHITE_FEATHER_GUARD/' },
    { id: 'karambit_warrior', name: '马来爪刀勇士',       category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/KARAMBIT_WARRIOR/' },
    { id: 'karambit_warrior_elite', name: '精锐马来爪刀勇士',   category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/KARAMBIT_WARRIOR_ELITE/' },
    ...
    { id: 'elite_steppe_lancer', name: '精锐草原枪骑兵',   category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITE_STEPPE_LANCER/' },
    ...
    { id: 'elite_tarkan', name: '精锐匈奴答剌罕骑兵', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITE_TARKAN/' },
    ...
    { id: 'elite_chukonu', name: '精锐华夏诸葛弩',     category: 'ranged', age: 'imperial', pathPrefix: '/SUCAI/ELITE_CHUKONU/' },
    { id: 'longbowman_elite', name: '精锐不列颠长弓兵',     category: 'ranged', age: 'imperial', pathPrefix: '/SUCAI/LONGBOWMAN_ELITE/' },
    { id: 'fire_archer', name: '华夏火箭手',     category: 'ranged', age: 'unknown', pathPrefix: '/SUCAI/FIRE_ARCHER/' },
    { id: 'elite_fire_archer', name: '精锐华夏火箭手', category: 'ranged', age: 'unknown', pathPrefix: '/SUCAI/ELITE_FIRE_ARCHER/' },
    { id: 'kipchak', name: '库曼钦察弓骑',       category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/KIPCHAK/' },
    { id: 'elite_kipchak', name: '精锐库曼钦察弓骑',   category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITE_KIPCHAK/' },
    ...
    { id: 'rattan_archer_elite', name: '精锐越南藤弓兵',     category: 'ranged', age: 'imperial', pathPrefix: '/SUCAI/RATTAN_ARCHER_ELITE/' },
    ...
    { id: 'elite_composite_bowman', name: '精锐亚美尼亚复合弓手', category: 'ranged', age: 'unknown', pathPrefix: '/SUCAI/ELITE_COMPOSITE_BOWMAN/' },
    ...
    { id: 'elite_armored_elephant',     name: '精锐皮甲战象',   category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITEARMOREDELEPHANT/' },
    ...
    { id: 'blackwood_archer', name: '黑木弓箭手', category: 'ranged', age: 'unknown', pathPrefix: '/SUCAI/BLACKWOODARCHER/' },
    { id: 'bolas_rider', name: '南美套索骑兵', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/BOLASRIDER/' },
    ...
    { id: 'elite_arambai', name: '精锐缅甸飞镖骑兵', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITEARAMBAI/' },
    { id: 'elite_ballista_elephant', name: '精锐高棉弩炮战象', category: 'siege', age: 'imperial', pathPrefix: '/SUCAI/ELITEBALLISTAELEPHANT/' },
    { id: 'elite_battle_elephant', name: '精锐东南亚战斗象', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITEBATTLEELEPHANT/' },
    { id: 'elite_berserk', name: '精锐维京狂战士', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/ELITEBERSERK/' },
    { id: 'elite_blackwood_archer', name: '精锐黑木弓箭手', category: 'ranged', age: 'unknown', pathPrefix: '/SUCAI/ELITEBLACKWOODARCHER/' },
    { id: 'elite_bolas_rider', name: '精锐南美套索骑兵', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITEBOLASRIDER/' },
    { id: 'elite_boyar', name: '精锐斯拉夫贵族铁骑', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITEBOYAR/' },
    { id: 'elite_camel_archer', name: '精锐柏柏尔骆驼弓骑', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITECAMELARCHER/' },
    { id: 'elite_cataphract', name: '精锐拜占庭圣骑兵', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITECATAPHRACT/' },
    { id: 'elite_centurion', name: '精锐罗马百夫长', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITECENTURION/' },
    { id: 'elite_chakram_thrower', name: '精锐古吉拉特飞轮掷手', category: 'ranged', age: 'imperial', pathPrefix: '/SUCAI/ELITECHAKRAMTHROWER/' },
    { id: 'elite_champi_warrior', name: '精锐印加尚皮勇士', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/ELITECHAMPIWARRIOR/' },
    { id: 'elite_conquistador', name: '精锐西班牙征服者', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITECONQUISTADOR/' },
    { id: 'elite_coustillier', name: '精锐勃艮第马上轻骑', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITECOUSTILLIER/' },
    { id: 'elite_eagle_warrior', name: '精锐美洲鹰勇士', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/ELITEEAGLEWARRIOR/' },
    { id: 'elite_elephant_archer', name: '精锐印度象弓骑兵', category: 'ranged', age: 'imperial', pathPrefix: '/SUCAI/ELITEELEPHANTARCHER/' },
    { id: 'elite_gbeto', name: '精锐马里格贝托女兵', category: 'ranged', age: 'imperial', pathPrefix: '/SUCAI/ELITEGBETO/' },
    { id: 'elite_genitour', name: '精锐柏柏尔标枪骑兵', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITEGENITOUR/' },
    { id: 'elite_genoese_crossbowman', name: '精锐热那亚弩手', category: 'ranged', age: 'imperial', pathPrefix: '/SUCAI/ELITEGENOESECROSSBOWMAN/' },
    { id: 'elite_ghulam', name: '精锐印度斯坦古拉姆', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/ELITEGHULAM/' },
    { id: 'elite_guecha_warrior', name: '精锐穆伊斯卡格查勇士', category: 'ranged', age: 'unknown', pathPrefix: '/SUCAI/ELITEGUECHAWARRIOR/' },
    { id: 'elite_huskarl', name: '精锐哥特近卫军', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/ELITEHUSKARL/' },
    { id: 'elite_hussite_wagon', name: '精锐波希米亚胡斯战车', category: 'siege', age: 'imperial', pathPrefix: '/SUCAI/ELITEHUSSITEWAGON/' },
    { id: 'elite_ibirapema_warrior', name: '精锐图皮战棍勇士', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/ELITEIBIRAPEMAWARRIOR/' },
    { id: 'elite_iron_pagoda', name: '精锐金国铁浮屠', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/ELITEIRONPAGODA/' },
    { id: 'elite_jaguar_warrior', name: '精锐阿兹特克豹勇士', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/ELITEJAGUARWARRIOR/' },
    { id: 'elite_janissary', name: '精锐土耳其禁卫军', category: 'ranged', age: 'imperial', pathPrefix: '/SUCAI/ELITEJANISSARY/' },
    { id: 'elite_kamayuk', name: '精锐印加枪兵长', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/ELITEKAMAYUK/' },
    { id: 'elite_keshik', name: '精锐鞑靼怯薛军', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITEKESHIK/' },
    { id: 'elite_kona', name: '精锐波利尼西亚科纳勇士', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/ELITEKONA/' },
    { id: 'elite_konnik', name: '精锐保加利亚骑兵', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITEKONNIK/' },
    { id: 'elite_konnik_foot', name: '精锐下马保加利亚骑兵', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/ELITEFOOTKONNIK/' },
    { id: 'elite_leitis', name: '精锐立陶宛列提斯', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITELEITIS/' },
    { id: 'elite_mameluke', name: '精锐萨拉森马穆鲁克', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITEMAMELUKE/' },
    { id: 'elite_monaspa', name: '精锐格鲁吉亚莫纳斯帕', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITEMONASPA/' },
    { id: 'elite_obuch', name: '精锐波兰奥布奇战锤兵', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/ELITEOBUCH/' },
    { id: 'elite_organ_gun', name: '精锐葡萄牙风琴炮', category: 'siege', age: 'imperial', pathPrefix: '/SUCAI/ELITEORGANGUN/' },
    { id: 'elite_plumed_archer', name: '精锐玛雅羽箭手', category: 'ranged', age: 'imperial', pathPrefix: '/SUCAI/ELITEPLUMEDARCHER/' },
    { id: 'elite_ratha_melee', name: '精锐孟加拉拉塔战车', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITERATHAMELEE/' },
    { id: 'elite_ratha_ranged', name: '精锐孟加拉拉塔战车(弓)', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITERATHARANGED/' },
    { id: 'elite_scythian_horse_archer', name: '精锐斯基泰骑射手', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/ELITE_SCYTHIAN_HORSE_ARCHER/' },
    { id: 'elite_serjeant', name: '精锐西西里军士长', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/ELITESERJEANT/' },
    { id: 'elite_shotel_warrior', name: '精锐埃塞俄比亚弯刀勇士', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/ELITESHOTELWARRIOR/' },
    { id: 'elite_shrivamsha_rider', name: '精锐古吉拉特什里瓦姆沙骑手', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITESHRIVAMSHARIDER/' },
    { id: 'elite_skirmisher', name: '精锐掷矛手', category: 'ranged', age: 'castle', pathPrefix: '/SUCAI/ELITESKIRMISHER/' },
    { id: 'elite_temple_guard', name: '精锐高棉神庙守卫', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/ELITETEMPLEGUARD/' },
    { id: 'elite_teutonic_knight', name: '精锐条顿武士', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/ELITETEUTONICKNIGHT/' },
    { id: 'elite_throwing_axeman', name: '精锐法兰克掷斧兵', category: 'ranged', age: 'imperial', pathPrefix: '/SUCAI/ELITETHROWINGAXEMAN/' },
    { id: 'elite_tiger_cavalry', name: '精锐曹魏虎豹骑', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/ELITETIGERCAVALRY/' },
    { id: 'elite_urumi_swordsman', name: '精锐达罗毗荼软剑士', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/ELITEURUMISWORDSMAN/' },
    ...
    { id: 'elite_war_wagon', name: '精锐高丽战车', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITEWARWAGON/' },
    { id: 'elite_woad_raider', name: '精锐凯尔特靛蓝突袭者', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/ELITEWOADRAIDER/' },
    ...
    { id: 'hippeus', name: '希腊古骑兵(希皮乌斯)', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/HIPPEUS/' },
    ...
    { id: 'kona', name: '波利尼西亚科纳勇士', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/KONA/' },
    ...
    { id: 'mounted_trebuchet', name: '巨型投石机', category: 'siege', age: 'unknown', pathPrefix: '/SUCAI/MOUNTEDTREBUCHET/' },
    ...
    { id: 'strategos', name: '希腊将军卫队', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/STRATEGOS/' },
    ...
    { id: 'warrior_priest', name: '格鲁吉亚修士战士', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/WARRIORPRIEST/' },
