...
export const DE_UNITS_CATALOG: DeUnitDef[] = [
    ...
    { id: 'white_feather_guard', name: '蜀白羽卫兵',         category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/WHITE_FEATHER_GUARD/' },
    { id: 'elite_white_feather_guard', name: '蜀白羽卫兵精锐',     category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/ELITE_WHITE_FEATHER_GUARD/' },
    ...
    { id: 'elite_kamayuk', name: '枪兵长精锐', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/ELITEKAMAYUK/' },
