 ...
 */
export type UnitAge = 'antiquity' | 'feudal' | 'castle' | 'imperial';
...
export const DE_UNITS_CATALOG: DeUnitDef[] = [
    ...
    { id: 'jian_swordsman', name: '华夏刀剑手', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/JIAN_SWORDSMAN/' },
    ...
    { id: 'elite_guardsman', name: '近卫军高级', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/ELITE_GUARDSMAN/' },
    { id: 'eastern_swordsman', name: '东方剑士', category: 'infantry', age: 'feudal', pathPrefix: '/SUCAI/EASTERN_SWORDSMAN/' },
    { id: 'legionary', name: '军团步兵', category: 'infantry', age: 'antiquity', pathPrefix: '/SUCAI/LEGIONARY/' },
    ...
    { id: 'tiger_rider', name: '魏虎骑兵', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/TIGER_RIDER/' },
    ...
    { id: 'hei_kuang_heavy', name: '南北朝黑光铠骑兵重装', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/HEI_KUANG_HEAVY/' },
    ...
    { id: 'pattiyoda_longbowman', name: '僧伽罗帕提尤达长弓手', category: 'ranged', age: 'castle', pathPrefix: '/SUCAI/PATTIYODA_LONGBOWMAN/' },
    ...
    { id: 'arbalest', name: '劲弩手', category: 'ranged', age: 'feudal', pathPrefix: '/SUCAI/ARBALEST/' },
    ...
    { id: 'armored_elephant', name: '装甲攻城战象', category: 'cavalry', age: 'feudal', pathPrefix: '/SUCAI/ARMORED_ELEPHANT/' },
    ...
    { id: 'camel_raider', name: '骆驼突袭者', category: 'cavalry', age: 'feudal', pathPrefix: '/SUCAI/CAMEL_RAIDER/' },
    { id: 'camel_rider', name: '骆驼骑兵', category: 'cavalry', age: 'feudal', pathPrefix: '/SUCAI/CAMELRIDER/' },
    { id: 'camel_scout', name: '古吉拉特骆驼斥候', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/CAMELSCOUT/' },
    ...
    { id: 'companion_cavalry', name: '马其顿伙伴骑兵', category: 'cavalry', age: 'antiquity', pathPrefix: '/SUCAI/COMPANION_CAVALRY/' },
    { id: 'condottiero', name: '佣兵', category: 'infantry', age: 'feudal', pathPrefix: '/SUCAI/CONDOTTIERO/' },
    { id: 'conquistador', name: '西班牙征服者', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/CONQUISTADOR/' },
    { id: 'cretan_archer', name: '克里特弓箭手', category: 'ranged', age: 'antiquity', pathPrefix: '/SUCAI/CRETAN_ARCHER/' },
    ...
    { id: 'ekdromos', name: '埃克德罗摩斯', category: 'infantry', age: 'antiquity', pathPrefix: '/SUCAI/EKDROMOS/' },
    ...
    { id: 'elite_centurion', name: '罗马百夫长精锐', category: 'cavalry', age: 'antiquity', pathPrefix: '/SUCAI/ELITECENTURION/' },
    ...
    { id: 'elite_konnik_foot', name: '锤炼兵高级', category: 'infantry', age: 'antiquity', pathPrefix: '/SUCAI/ELITEFOOTKONNIK/' },
    ...
    { id: 'elite_ratha_ranged', name: '孟加拉拉塔战车(弓)精锐', category: 'cavalry', age: 'antiquity', pathPrefix: '/SUCAI/ELITERATHARANGED/' },
    ...
    { id: 'elite_skirmisher', name: '掷矛手高级', category: 'ranged', age: 'antiquity', pathPrefix: '/SUCAI/ELITESKIRMISHER/' },
    ...
    { id: 'bayinnaung_elephant', name: '莽应龙御驾战象', category: 'cavalry', age: 'feudal', pathPrefix: '/SUCAI/BAYINNAUNG_ELEPHANT/' },
    ...
    { id: 'elite_war_wagon', name: '高丽战车精锐', category: 'cavalry', age: 'antiquity', pathPrefix: '/SUCAI/ELITEWARWAGON/' },
    ...
    { id: 'hippeus', name: '斯巴达希皮乌斯', category: 'infantry', age: 'antiquity', pathPrefix: '/SUCAI/HIPPEUS/' },
    ...
    { id: 'imperial_centurion', name: '帝国百夫长', category: 'cavalry', age: 'antiquity', pathPrefix: '/SUCAI/IMPERIALCENTURION/' },
    { id: 'indian_tribesman', name: '印度部落民', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/INDIAN_TRIBESMAN/' },
    { id: 'iroquois_warrior', name: '易洛魁战士', category: 'infantry', age: 'feudal', pathPrefix: '/SUCAI/IROQUOISWARRIOR/' },
    ...
    { id: 'konnik_foot', name: '锤炼兵', category: 'infantry', age: 'antiquity', pathPrefix: '/SUCAI/FOOTKONNIK/' },
    ...
    { id: 'mangonel', name: '轻型投石车', category: 'siege', age: 'feudal', pathPrefix: '/SUCAI/MANGONEL/' },
    { id: 'mercenary_hoplite', name: '希腊雇佣重步兵', category: 'infantry', age: 'antiquity', pathPrefix: '/SUCAI/ELITE_HOPLITE/' },
    { id: 'militia', name: '民兵', category: 'infantry', age: 'feudal', pathPrefix: '/SUCAI/MILITIA/' },
    ...
    { id: 'qizilbash_warrior', name: '红头骑士(奇兹尔巴什)', category: 'cavalry', age: 'feudal', pathPrefix: '/SUCAI/QIZILBASHWARRIOR/' },
    { id: 'ratha_melee', name: '孟加拉拉塔战车', category: 'cavalry', age: 'antiquity', pathPrefix: '/SUCAI/RATHAMELEE/' },
    { id: 'ratha_ranged', name: '孟加拉拉塔战车(弓)', category: 'cavalry', age: 'antiquity', pathPrefix: '/SUCAI/RATHARANGED/' },
    { id: 'rhodian_slinger', name: '罗得岛投石兵', category: 'ranged', age: 'antiquity', pathPrefix: '/SUCAI/RHODIAN_SLINGER/' },
    { id: 'rhomphaia_warrior', name: '色雷斯长刃斩手', category: 'infantry', age: 'antiquity', pathPrefix: '/SUCAI/RHOMPHAIA_WARRIOR/' },
    { id: 'rocket_cart', name: '火箭车', category: 'siege', age: 'castle', pathPrefix: '/SUCAI/ROCKETCART/' },
    { id: 'royal_janissary', name: '皇家苏丹亲兵', category: 'ranged', age: 'feudal', pathPrefix: '/SUCAI/ROYALJANISSARY/' },
    { id: 'sacred_band', name: '底比斯圣队', category: 'infantry', age: 'antiquity', pathPrefix: '/SUCAI/SACRED_BAND/' },
    { id: 'sannahya', name: '孔雀王朝桑纳亚战象', category: 'cavalry', age: 'antiquity', pathPrefix: '/SUCAI/SANNAHYA/' },
    { id: 'scorpion', name: '弩炮', category: 'siege', age: 'feudal', pathPrefix: '/SUCAI/SCORPION/' },
    { id: 'scythian_axe_cavalry', name: '斯基泰斧骑兵', category: 'cavalry', age: 'antiquity', pathPrefix: '/SUCAI/SCYTHIAN_AXE_CAVALRY/' },
    ...
    { id: 'skirmisher', name: '掷矛手', category: 'ranged', age: 'antiquity', pathPrefix: '/SUCAI/SKIRMISHER/' },
    { id: 'slinger', name: '投石兵', category: 'ranged', age: 'castle', pathPrefix: '/SUCAI/SLINGER/' },
    { id: 'sogdian_cataphract', name: '粟特甲胄骑兵', category: 'cavalry', age: 'antiquity', pathPrefix: '/SUCAI/SOGDIANCATAPHRACT/' },
    ...
    { id: 'sakan_axeman', name: '萨迦斧兵', category: 'infantry', age: 'antiquity', pathPrefix: '/SUCAI/SAKAN_AXEMAN/' },
    ...
    { id: 'war_dog', name: '战犬', category: 'infantry', age: 'antiquity', pathPrefix: '/SUCAI/WARDOG/' },
    { id: 'war_wagon', name: '高丽战车', category: 'cavalry', age: 'antiquity', pathPrefix: '/SUCAI/WARWAGON/' },
    ...
    { id: 'jian_swordman_unshielded', name: '双手剑士(华夏)', category: 'infantry', age: 'feudal', pathPrefix: '/SUCAI/JIAN_SWORDMAN_UNSHIELDED/' },
    { id: 'cavalier', name: '骑士重装', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/CAVALIER/' },
    { id: 'flamethrower', name: '猛火油柜(喷火器)', category: 'siege', age: 'feudal', pathPrefix: '/SUCAI/FLAMETHROWER/' },
    { id: 'helepolis', name: '希腊赫勒波利斯攻城塔', category: 'siege', age: 'antiquity', pathPrefix: '/SUCAI/HELEPOLIS/' },
    { id: 'siege_tower', name: '攻城塔', category: 'siege', age: 'feudal', pathPrefix: '/SUCAI/SIEGETOWER/' },
    ...
    { id: 'levy', name: '征召民兵', category: 'infantry', age: 'feudal', pathPrefix: '/SUCAI/LEVY/' },
    ...
    { id: 'paragon', name: '圣殿楷模武士', category: 'infantry', age: 'feudal', pathPrefix: '/SUCAI/PARAGON/' },
    { id: 'shock_cavalry', name: '冲击重骑兵', category: 'cavalry', age: 'antiquity', pathPrefix: '/SUCAI/SHOCK_CAVALRY/' },
    { id: 'imperial_cavalry', name: '帝国具装骑兵', category: 'cavalry', age: 'antiquity', pathPrefix: '/SUCAI/IMPERIAL_CAVALRY/' },
    { id: 'equites', name: '罗马伴随骑士', category: 'cavalry', age: 'antiquity', pathPrefix: '/SUCAI/EQUITES/' },
    { id: 'sarmatian', name: '萨尔马提亚重骑兵', category: 'cavalry', age: 'antiquity', pathPrefix: '/SUCAI/SARMATIAN/' },
    ...
    { id: 'crusader_knight', name: '十字军骑士', category: 'cavalry', age: 'feudal', pathPrefix: '/SUCAI/CRUSADERKNIGHT/' },
    { id: 'raider', name: '掠骑兵', category: 'cavalry', age: 'feudal', pathPrefix: '/SUCAI/RAIDER/' },
    { id: 'guardsman', name: '近卫军', category: 'infantry', age: 'feudal', pathPrefix: '/SUCAI/GUARDSMAN/' },
    ...
    { id: 'antiquity_battering_ram', name: '古典轻型攻城槌', category: 'siege', age: 'antiquity', pathPrefix: '/SUCAI/ANTIQUITY_BATTERINGRAM/' },
    { id: 'antiquity_capped_ram', name: '古典装甲攻城槌', category: 'siege', age: 'antiquity', pathPrefix: '/SUCAI/ANTIQUITY_CAPPED_RAM/' },
    { id: 'antiquity_scorpion', name: '古典弩炮', category: 'siege', age: 'antiquity', pathPrefix: '/SUCAI/ANTIQUITY_SCORPION/' },
    { id: 'antiquity_heavy_scorpion', name: '古典重型弩炮', category: 'siege', age: 'antiquity', pathPrefix: '/SUCAI/ANTIQUITY_HEAVY_SCORPION/' },
    { id: 'antiquity_mangonel', name: '古典轻型投石车', category: 'siege', age: 'antiquity', pathPrefix: '/SUCAI/ANTIQUITY_MANGONEL/' },
    { id: 'antiquity_onager', name: '古典中型投石车', category: 'siege', age: 'antiquity', pathPrefix: '/SUCAI/ANTIQUITY_ONAGER/' },
    { id: 'antiquity_siege_onager', name: '古典重型投石车', category: 'siege', age: 'antiquity', pathPrefix: '/SUCAI/ANTIQUITY_SIEGE_ONAGER/' },
    { id: 'antiquity_siege_ram', name: '古典重型攻城槌', category: 'siege', age: 'antiquity', pathPrefix: '/SUCAI/ANTIQUITY_SIEGE_RAM/' },
    { id: 'antiquity_siege_tower', name: '古典攻城塔', category: 'siege', age: 'antiquity', pathPrefix: '/SUCAI/ANTIQUITY_SIEGE_TOWER/' },
    { id: 'galley', name: '桨帆船', category: 'naval', age: 'castle', pathPrefix: '/SUCAI/GALLEY/' },
    { id: 'war_galley', name: '大战舰', category: 'naval', age: 'imperial', pathPrefix: '/SUCAI/WAR_GALLEY/' },
    { id: 'ant_galley', name: '古典桨帆船', category: 'naval', age: 'antiquity', pathPrefix: '/SUCAI/ANT_GALLEY/' },
    { id: 'ant_war_galley', name: '古典大战舰', category: 'naval', age: 'antiquity', pathPrefix: '/SUCAI/ANT_WAR_GALLEY/' },
    { id: 'ant_elite_galley', name: '古典桨帆船高级', category: 'naval', age: 'antiquity', pathPrefix: '/SUCAI/ANT_ELITE_GALLEY/' },
    { id: 'fire_galley', name: '喷火桨帆船', category: 'naval', age: 'castle', pathPrefix: '/SUCAI/FIRE_GALLEY/' },
    { id: 'fire_ship', name: '喷火船', category: 'naval', age: 'castle', pathPrefix: '/SUCAI/FIRE_SHIP/' },
    { id: 'fast_fire_ship', name: '快速喷火船', category: 'naval', age: 'castle', pathPrefix: '/SUCAI/FAST_FIRE_SHIP/' },
    ...
    { id: 'hero_aristagoras', name: '英雄·阿里斯塔哥拉斯', category: 'hero', age: 'antiquity', pathPrefix: '/SUCAI/ARISTAGORAS/' },
    { id: 'hero_aristides', name: '英雄·阿里斯提德', category: 'hero', age: 'antiquity', pathPrefix: '/SUCAI/ARISTIDES/' },
    { id: 'hero_artaphernes', name: '英雄·阿尔塔弗涅斯', category: 'hero', age: 'antiquity', pathPrefix: '/SUCAI/ARTAPHERNES/' },
    { id: 'hero_ataulf', name: '英雄·阿陶尔夫', category: 'hero', age: 'antiquity', pathPrefix: '/SUCAI/ATAULF/' },
    { id: 'hero_attila', name: '英雄·阿提拉', category: 'hero', age: 'antiquity', pathPrefix: '/SUCAI/ATTILA/' },
    { id: 'hero_basileus', name: '英雄·巴西琉斯(皇帝)', category: 'hero', age: 'antiquity', pathPrefix: '/SUCAI/BASILEUS/' },
    { id: 'hero_bernardarmagnac', name: '英雄·贝尔纳·德·阿马尼亚克', category: 'hero', age: 'castle', pathPrefix: '/SUCAI/BERNARDARMAGNAC/' },
    { id: 'hero_bohemond', name: '英雄·博希蒙德', category: 'hero', age: 'castle', pathPrefix: '/SUCAI/BOHEMOND/' },
    ...
    { id: 'hero_datis', name: '英雄·达提斯', category: 'hero', age: 'antiquity', pathPrefix: '/SUCAI/DATIS/' },
    { id: 'hero_dinhle', name: '英雄·丁礼', category: 'hero', age: 'castle', pathPrefix: '/SUCAI/DINHLE/' },
    { id: 'hero_dismounted_alexander', name: '英雄·步战亚历山大', category: 'hero', age: 'antiquity', pathPrefix: '/SUCAI/DISMOUNTED_ALEXANDER/' },
    { id: 'hero_mounted_alexander', name: '英雄·骑马亚历山大', category: 'hero', age: 'antiquity', pathPrefix: '/SUCAI/MOUNTED_ALEXANDER/' },
    ...
    { id: 'hero_guanyu', name: '英雄·关羽', category: 'hero', age: 'antiquity', pathPrefix: '/SUCAI/GUANYU/' },
    { id: 'hero_ivaylo', name: '英雄·伊瓦伊洛(骑马)', category: 'hero', age: 'castle', pathPrefix: '/SUCAI/IVAYLO/' },
    { id: 'hero_ivaylofoot', name: '英雄·伊瓦伊洛(步战)', category: 'hero', age: 'castle', pathPrefix: '/SUCAI/IVAYLOFOOT/' },
    { id: 'hero_janzizka', name: '英雄·扬·杰式卡', category: 'hero', age: 'castle', pathPrefix: '/SUCAI/JANZIZKA/' },
    { id: 'hero_joanofarc', name: '英雄·圣女贞德(全甲战马)', category: 'hero', age: 'castle', pathPrefix: '/SUCAI/JOANOFARC/' },
    { id: 'hero_joanthemaid', name: '英雄·奥尔良少女贞德', category: 'hero', age: 'castle', pathPrefix: '/SUCAI/JOANTHEMAID/' },
    { id: 'hero_jogaila', name: '英雄·雅盖沃', category: 'hero', age: 'castle', pathPrefix: '/SUCAI/JOGAILA/' },
    { id: 'hero_johnthefearless', name: '英雄·无畏的约翰', category: 'hero', age: 'castle', pathPrefix: '/SUCAI/JOHNTHEFEARLESS/' },
    { id: 'hero_kestutis', name: '英雄·科斯图提斯', category: 'hero', age: 'castle', pathPrefix: '/SUCAI/KESTUTIS/' },
    { id: 'hero_kotyankhan', name: '英雄·忽炭汗', category: 'hero', age: 'castle', pathPrefix: '/SUCAI/KOTYANKHAN/' },
    { id: 'hero_kushluk', name: '英雄·屈出律', category: 'hero', age: 'castle', pathPrefix: '/SUCAI/KUSHLUK/' },
    { id: 'hero_lautaro', name: '英雄·劳塔罗', category: 'hero', age: 'imperial', pathPrefix: '/SUCAI/LAUTARO/' },
    { id: 'hero_leloi', name: '英雄·黎利', category: 'hero', age: 'castle', pathPrefix: '/SUCAI/LELOI/' },
    { id: 'hero_liubei', name: '英雄·刘备', category: 'hero', age: 'antiquity', pathPrefix: '/SUCAI/LIUBEI/' },
    ...
    { id: 'hero_parmenion', name: '英雄·帕曼纽', category: 'hero', age: 'antiquity', pathPrefix: '/SUCAI/PARMENION/' },
    { id: 'hero_perdiccas', name: '英雄·佩尔狄卡斯', category: 'hero', age: 'antiquity', pathPrefix: '/SUCAI/PERDICCAS/' },
    { id: 'hero_philipthegood', name: '英雄·好人菲利普', category: 'hero', age: 'castle', pathPrefix: '/SUCAI/PHILIPTHEGOOD/' },
    { id: 'hero_prithviraj', name: '英雄·普里特维拉吉', category: 'hero', age: 'castle', pathPrefix: '/SUCAI/PRITHVIRAJ/' },
    { id: 'hero_qutlugh', name: '英雄·忽都鲁', category: 'hero', age: 'castle', pathPrefix: '/SUCAI/QUTLUGH/' },
    { id: 'hero_rajendrachola', name: '英雄·罗贞陀罗·朱罗', category: 'hero', age: 'feudal', pathPrefix: '/SUCAI/RAJENDRACHOLA/' },
    { id: 'hero_robertguiscard', name: '英雄·罗贝尔·吉斯卡尔', category: 'hero', age: 'castle', pathPrefix: '/SUCAI/ROBERTGUISCARD/' },
    { id: 'hero_rogerbosso', name: '英雄·罗杰·博索', category: 'hero', age: 'castle', pathPrefix: '/SUCAI/ROGERBOSSO/' },
    { id: 'hero_sforza', name: '英雄·斯福尔扎', category: 'hero', age: 'castle', pathPrefix: '/SUCAI/SFORZA/' },
    { id: 'hero_shahismail', name: '英雄·沙阿·伊斯玛仪', category: 'hero', age: 'imperial', pathPrefix: '/SUCAI/SHAHISMAIL/' },
    { id: 'hero_subotai', name: '英雄·速不台', category: 'hero', age: 'castle', pathPrefix: '/SUCAI/SUBOTAI/' },
    { id: 'hero_sumanguru', name: '英雄·苏曼古鲁', category: 'hero', age: 'castle', pathPrefix: '/SUCAI/SUMANGURU/' },
    { id: 'hero_sunce', name: '英雄·孙策', category: 'hero', age: 'antiquity', pathPrefix: '/SUCAI/SUNCE/' },
    { id: 'hero_sundjata', name: '英雄·松迪亚塔', category: 'hero', age: 'castle', pathPrefix: '/SUCAI/SUNDJATA/' },
    { id: 'hero_sunjian', name: '英雄·孙坚', category: 'hero', age: 'antiquity', pathPrefix: '/SUCAI/SUNJIAN/' },
    ...
    { id: 'hero_vytautasthegreat', name: '英雄·维陶塔斯大帝', category: 'hero', age: 'castle', pathPrefix: '/SUCAI/VYTAUTASTHEGREAT/' },
    ...
    { id: 'frankish_paladin', name: '法兰克圣骑士', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/FRANKISHPALADIN/' },
    { id: 'jarl', name: '维京首领骑兵', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/JARL/' },
    { id: 'siege_ballista', name: '攻城床弩车', category: 'siege', age: 'feudal', pathPrefix: '/SUCAI/SIEGE_BALLISTA/' },
    ...
    { id: 'lembos', name: '小艇', category: 'naval', age: 'antiquity', pathPrefix: '/SUCAI/LEMBOS/' },
    { id: 'war_lembos', name: '小艇高级', category: 'naval', age: 'antiquity', pathPrefix: '/SUCAI/WAR_LEMBOS/' },
    ...
    { id: 'demo_raft', name: '爆破木筏', category: 'naval', age: 'castle', pathPrefix: '/SUCAI/DEMO_RAFT/' },
    { id: 'incendiary_raft', name: '燃烧木筏', category: 'naval', age: 'castle', pathPrefix: '/SUCAI/INCENDIARY_RAFT/' },
...
function injectStyles(): void {
    ...
    s.textContent = `
      ...
      .age-antiquity{ background:#1a1816; color:#8a8276; border:1px solid #332e28; }
