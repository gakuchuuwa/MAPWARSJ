...
export const DE_UNITS_CATALOG: DeUnitDef[] = [
    ...
    { id: 'jian_swordsman', name: '华夏刀剑手', category: 'infantry', age: 'feudal', pathPrefix: '/SUCAI/JIAN_SWORDSMAN/' },
    ...
    { id: 'amazon_archer', name: '亚马逊女弓手', category: 'ranged', age: 'castle', pathPrefix: '/SUCAI/AMAZONARCHER/' },
    { id: 'amazon_warrior', name: '亚马逊女战士', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/AMAZONWARRIOR/' },
    { id: 'bactrian_archer', name: '巴克特里亚弓手', category: 'ranged', age: 'castle', pathPrefix: '/SUCAI/BACTRIAN_ARCHER/' },
    ...
    { id: 'camel_raider', name: '骆驼突袭者', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/CAMEL_RAIDER/' },
    ...
    { id: 'companion_cavalry', name: '马其顿伙伴骑兵', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/COMPANION_CAVALRY/' },
    ...
    { id: 'cretan_archer', name: '克里特弓箭手', category: 'ranged', age: 'castle', pathPrefix: '/SUCAI/CRETAN_ARCHER/' },
    ...
    { id: 'ekdromos', name: '埃克德罗摩斯', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/EKDROMOS/' },
    ...
    { id: 'flaming_camel', name: '鞑靼火焰骆驼', category: 'siege', age: 'imperial', pathPrefix: '/SUCAI/FLAMINGCAMEL/' },
    ...
    { id: 'greek_noble_cavalry', name: '希腊贵族骑兵', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/GREEK_NOBLE_CAVALRY/' },
    ...
    { id: 'immortal', name: '波斯长生军', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/IMMORTAL/' },
    { id: 'immortal_ranged', name: '波斯长生军(弓)', category: 'ranged', age: 'castle', pathPrefix: '/SUCAI/RANGED_IMMORTAL/' },
    ...
    { id: 'mercenary_hoplite', name: '希腊雇佣重步兵', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/ELITE_HOPLITE/' },
    ...
    { id: 'mounted_trebuchet', name: '骆驼投石机', category: 'siege', age: 'castle', pathPrefix: '/SUCAI/MOUNTEDTREBUCHET/' },
    ...
    { id: 'phalangite', name: '马其顿方阵步兵', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/PHALANGITE/' },
    { id: 'plumed_archer', name: '玛雅羽箭手', category: 'ranged', age: 'castle', pathPrefix: '/SUCAI/PLUMEDARCHER/' },
    { id: 'qizilbash_warrior', name: '红头骑士(奇兹尔巴什)', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/QIZILBASHWARRIOR/' },
    ...
    { id: 'rhodian_slinger', name: '罗得岛投石兵', category: 'ranged', age: 'feudal', pathPrefix: '/SUCAI/RHODIAN_SLINGER/' },
    { id: 'rhomphaia_warrior', name: '色雷斯长刃斩手', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/RHOMPHAIA_WARRIOR/' },
    ...
    { id: 'sickle_warrior', name: '达罗毗荼镰刀战士', category: 'infantry', age: 'castle', pathPrefix: '/SUCAI/SICKLE_WARRIOR/' },
    ...
    { id: 'ant_galley', name: '古典桨帆船', category: 'naval', age: 'feudal', pathPrefix: '/SUCAI/ANT_GALLEY/' },
    { id: 'ant_war_galley', name: '古典大战舰', category: 'naval', age: 'castle', pathPrefix: '/SUCAI/ANT_WAR_GALLEY/' },
    { id: 'ant_elite_galley', name: '古典桨帆船高级', category: 'naval', age: 'imperial', pathPrefix: '/SUCAI/ANT_ELITE_GALLEY/' },
    ...
    { id: 'frankish_paladin', name: '法兰克圣骑士', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/FRANKISHPALADIN/' },
    { id: 'jarl', name: '首领骑士', category: 'cavalry', age: 'castle', pathPrefix: '/SUCAI/JARL/' },
    { id: 'siege_ballista', name: '攻城床弩车', category: 'siege', age: 'castle', pathPrefix: '/SUCAI/SIEGE_BALLISTA/' },
    { id: 'monoreme', name: '单层桨座战船', category: 'naval', age: 'dark', pathPrefix: '/SUCAI/MONOREME/' },
    { id: 'bireme', name: '双层桨座战船', category: 'naval', age: 'feudal', pathPrefix: '/SUCAI/BIREME/' },
    { id: 'trireme', name: '三层桨座战船', category: 'naval', age: 'castle', pathPrefix: '/SUCAI/TRIREME/' },
    { id: 'lembos', name: '伦波斯轻战船', category: 'naval', age: 'feudal', pathPrefix: '/SUCAI/LEMBOS/' },
    { id: 'war_lembos', name: '作战伦波斯船', category: 'naval', age: 'castle', pathPrefix: '/SUCAI/WAR_LEMBOS/' },
    { id: 'elite_lembos', name: '精锐伦波斯船', category: 'naval', age: 'imperial', pathPrefix: '/SUCAI/ELITE_LEMBOS/' },
    { id: 'heavy_lembos', name: '重型伦波斯船', category: 'naval', age: 'imperial', pathPrefix: '/SUCAI/HEAVY_LEMBOS/' },
    { id: 'dromon', name: '德罗蒙重弩炮舰', category: 'naval', age: 'castle', pathPrefix: '/SUCAI/DROMON/' },
    { id: 'hulk', name: '柯克大战船', category: 'naval', age: 'castle', pathPrefix: '/SUCAI/HULK/' },
    { id: 'war_hulk', name: '重型柯克战船', category: 'naval', age: 'imperial', pathPrefix: '/SUCAI/WAR_HULK/' },
    { id: 'galleon', name: '大型多桅战船', category: 'naval', age: 'imperial', pathPrefix: '/SUCAI/GALLEON/' },
    { id: 'carrack', name: '克拉克重帆船', category: 'naval', age: 'imperial', pathPrefix: '/SUCAI/CARRACK/' },
    { id: 'catapult_galleon', name: '投石帆船', category: 'naval', age: 'castle', pathPrefix: '/SUCAI/CATAPULT_GALLEON/' },
    { id: 'demo_raft', name: '爆破排筏', category: 'naval', age: 'feudal', pathPrefix: '/SUCAI/DEMO_RAFT/' },
    { id: 'incendiary_raft', name: '燃烧排筏', category: 'naval', age: 'feudal', pathPrefix: '/SUCAI/INCENDIARY_RAFT/' },
    { id: 'canoe', name: '独木战舟', category: 'naval', age: 'dark', pathPrefix: '/SUCAI/CANOE/' },
    ...
    { id: 'leviathan', name: '利维坦巨舰', category: 'naval', age: 'imperial', pathPrefix: '/SUCAI/LEVIATHAN/' },
    { id: 'hero_themistocles', name: '英雄·地米斯托克利', category: 'hero', age: 'imperial', pathPrefix: '/SUCAI/HERO_THEMISTOCLES/' },
