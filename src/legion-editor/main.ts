...
export const DE_UNITS_CATALOG: DeUnitDef[] = [
    ...
    { id: 'liao_dao', name: '契丹辽刀',           category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/LIAO_DAO/' },
    { id: 'elite_liao_dao', name: '契丹辽刀精锐',       category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/ELITE_LIAO_DAO/' },
    ...
    { id: 'white_feather_guard', name: '蜀白毦卫',         category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/WHITE_FEATHER_GUARD/' },
    { id: 'elite_white_feather_guard', name: '蜀白毦卫精锐',     category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/ELITE_WHITE_FEATHER_GUARD/' },
    ...
    { id: 'tiger_rider', name: '魏虎豹骑',         category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/TIGER_RIDER/' },
    ...
    { id: 'fire_archer', name: '吴火箭手',     category: 'ranged', age: 'unknown', pathPrefix: '/SUCAI/FIRE_ARCHER/' },
    { id: 'elite_fire_archer', name: '吴火箭手精锐', category: 'ranged', age: 'unknown', pathPrefix: '/SUCAI/ELITE_FIRE_ARCHER/' },
    ...
    { id: 'elite_battle_elephant', name: '战斗象精锐', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITEBATTLEELEPHANT/' },
    ...
    { id: 'elite_eagle_warrior', name: '鹰勇士精锐', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/ELITEEAGLEWARRIOR/' },
    { id: 'elite_elephant_archer', name: '象弓骑兵精锐', category: 'ranged', age: 'imperial', pathPrefix: '/SUCAI/ELITEELEPHANTARCHER/' },
    { id: 'elite_gbeto', name: '马里格贝托女兵精锐', category: 'ranged', age: 'imperial', pathPrefix: '/SUCAI/ELITEGBETO/' },
    { id: 'elite_genitour', name: '标枪骑兵精锐', category: 'cavalry', age: 'imperial', pathPrefix: '/SUCAI/ELITEGENITOUR/' },
    ...
    { id: 'elite_tiger_cavalry', name: '魏虎豹骑精锐', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/ELITETIGERCAVALRY/' },
    { id: 'elite_urumi_swordsman', name: '达罗毗荼软剑士精锐', category: 'infantry', age: 'imperial', pathPrefix: '/SUCAI/ELITEURUMISWORDSMAN/' },
    { id: 'elite_war_chariot', name: '双轮战车精锐', category: 'cavalry', age: 'unknown', pathPrefix: '/SUCAI/ELITE_WAR_CHARIOT/' },
    { id: 'elite_war_dog', name: '战犬精锐', category: 'infantry', age: 'unknown', pathPrefix: '/SUCAI/ELITEWARDOG/' },
    ...
    { id: 'elite_peltast', name: '色雷斯标枪手精锐', category: 'ranged', age: 'castle', pathPrefix: '/SUCAI/ELITE_PELTAST/' },
    ...
    { id: 'elite_antiquity_skirmisher', name: '古典掷矛手精锐', category: 'ranged', age: 'castle', pathPrefix: '/SUCAI/ELITE_ANTIQUITY_SKIRMISHER/' },
