...
export const DE_UNITS_CATALOG: DeUnitDef[] = [
    ...
    { id: 'elite_guardsman', name: '近卫步兵', category: 'infantry', age: 'antiquity', pathPrefix: '/SUCAI/ELITE_GUARDSMAN/' },
    ...
    { id: 'guardsman', name: '近卫步兵高级', category: 'infantry', age: 'antiquity', pathPrefix: '/SUCAI/GUARDSMAN/' },
