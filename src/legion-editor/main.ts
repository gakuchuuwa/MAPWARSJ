...
export const DE_UNITS_CATALOG: DeUnitDef[] = [
    ...
    { id: 'elite_ballista_elephant', name: '精锐弩炮战象', category: 'ranged', categoryLabel: '远程', pathPrefix: '/SUCAI/ELITEBALLISTAELEPHANT/', defaultScale: 1.2 },
    { id: 'elite_battle_elephant', name: '精锐战斗象', category: 'infantry', categoryLabel: '步兵', pathPrefix: '/SUCAI/ELITEBATTLEELEPHANT/', defaultScale: 1.2 },
    ...
    { id: 'elite_boyar', name: '精锐波雅尔', category: 'cavalry', categoryLabel: '骑兵', pathPrefix: '/SUCAI/ELITEBOYAR/', defaultScale: 1.2 },
    ...
    { id: 'elite_coustillier', name: '精锐库斯蒂耶', category: 'cavalry', categoryLabel: '骑兵', pathPrefix: '/SUCAI/ELITECOUSTILLIER/', defaultScale: 1.2 },
    { id: 'elite_eagle_warrior', name: '精锐鹰勇士', category: 'infantry', categoryLabel: '步兵', pathPrefix: '/SUCAI/ELITEEAGLEWARRIOR/' },
    { id: 'elite_elephant_archer', name: '精锐象弓骑兵', category: 'ranged', categoryLabel: '远程', pathPrefix: '/SUCAI/ELITEELEPHANTARCHER/', defaultScale: 1.2 },
    ...
    { id: 'elite_iron_pagoda', name: '精锐铁浮屠', category: 'cavalry', categoryLabel: '骑兵', pathPrefix: '/SUCAI/ELITEIRONPAGODA/', defaultScale: 1.2 },
    ...
    { id: 'elite_kamayuk', name: '精锐卡马尤克', category: 'ranged', categoryLabel: '远程', pathPrefix: '/SUCAI/ELITEKAMAYUK/' },
    { id: 'elite_keshik', name: '精锐怯薛', category: 'cavalry', categoryLabel: '骑兵', pathPrefix: '/SUCAI/ELITEKESHIK/', defaultScale: 1.2 },
    ...
    { id: 'elite_tiger_cavalry', name: '精锐猛虎骑兵', category: 'cavalry', categoryLabel: '骑兵', pathPrefix: '/SUCAI/ELITETIGERCAVALRY/', defaultScale: 1.2 },
    ...
    { id: 'elite_war_elephant', name: '精锐战象', category: 'infantry', categoryLabel: '步兵', pathPrefix: '/SUCAI/ELITEWARELEPHANT/', defaultScale: 1.2 },
    ...
    { id: 'sannahya', name: '桑纳亚', category: 'infantry', categoryLabel: '步兵', pathPrefix: '/SUCAI/SANNAHYA/', defaultScale: 1.2 },
    ...
    { id: 'xolotl_warrior', name: '索洛特尔勇士', category: 'cavalry', categoryLabel: '骑兵', pathPrefix: '/SUCAI/XOLOTLWARRIOR/', defaultScale: 1.2 },
];
