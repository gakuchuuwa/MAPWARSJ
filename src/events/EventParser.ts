...
export class EventParser {
    ...
    private static factionMap: { [key: string]: string } = {
        ...
        '殿前诸班': 'chaizhou_d', '殿前司': 'chaizhou_d', '后周': 'chaizhou_d', '柴周': 'chaizhou_d',
        '柴荣': 'chaizhou_d', '郭威': 'chaizhou_d', '晋阳': 'chaizhou_d', '太原': 'chaizhou_d',
        '赵边骑': 'zhao', '赵武灵王': 'zhao',
        '幽州突骑': 'yan', '幽州': 'yan',
        ...
        '黄龙兵': 'yin',
        '两池军': 'chile', '高洋': 'chile',
        '鲜卑燕骑': 'murong', '慕容恪': 'murong', '连环马': 'murong',
