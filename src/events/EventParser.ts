...
export const T1_MEDIUM_CITIES: CityDataV2[] = [
    ...
    // ── 太行山脉走廊/八陉周边中城 ──
                // ── 淮海与齐鲁中原走廊中城 ──
    { id: 'city_shangqiu', name: '商丘', factionId: 'liang_d', lat: 34.41, lng: 115.66, type: 'medium_city', region: 'CENTRAL', troops: 20000 },
...
export const T2_STRATEGIC: CityDataV2[] = [
    ...
    { id: 'city_xiaoguan', name: '萧关', factionId: 'beidi', lat: 35.657289, lng: 106.32019, type: 'pass', region: 'CENTRAL', troops: 10000, mirror: true, note: '萧关道，北地郡萧关·姚苌羌骑' },
...
export const CITIES_V2: CityDataV2[] = [
    ...
    { id: 'city_zhedi', name: '折墌', factionId: 'xiqin', lat: 35.5, lng: 107.94, type: 'pass', region: 'HEXI', troops: 10000, note: '薛举据折墌城；薛举西秦第二据点' },
    ...
    { id: 'city_bohuancheng', name: '拨换城', factionId: 'anxi', lat: 41.17, lng: 80.25, type: 'small_city', region: 'WESTERN', troops: 10000, note: '高仙芝安西节度使治所；征小勃律、战怛罗斯' },
    ...
    { id: 'city_tusi', name: '图斯', factionId: 'kalan', lat: 36.45, lng: 59.57, type: 'small_city', region: 'CENTRAL_ASIA', troops: 10000, note: '古图斯；卡伦家族领地' },
