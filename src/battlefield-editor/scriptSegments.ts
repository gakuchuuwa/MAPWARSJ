...
export const SCRIPT_SEGMENTS: ScriptSegment[] = [
    ...
    { id: '3-3', part: 3, partName: '黎凡特与埃及走廊', from: '加沙', to: '亚历山大', via: ['佩鲁西姆', '孟菲斯'], events: [10], hasBattle: false, briefedBy: [10],
      note: '纯行军段（埃及不战而降、孟菲斯加冕、尼罗河口建城）；由第 10 场的赶路播报念。NN 复核后划归第三片' },

    // ── 第四片（前331–330）：4 段 / 3 场 ────────────────────────
    { id: '4-1', part: 4, partName: '波斯帝国心脏', from: '亚历山大', to: '高加米拉（战争点 10）', via: ['（回程）佩鲁西姆', '加沙', '推罗', '大马士革', '塔德莫尔', '塔普萨库斯', '埃德萨', '尼西比斯', '尼尼微'], events: [10], hasBattle: true, briefedBy: [10] },
    ...
    { id: '5-4', part: 5, partName: '中亚与粟特平叛', from: '坎大哈', to: '巴克特拉（过冬）', via: ['加兹尼', '喀布尔', '德拉普萨卡'], events: [13], hasBattle: false, briefedBy: [13],
      note: '纯行军段（翻兴都库什入巴克特里亚、拿贝苏斯、巴克特拉过冬）；实测 635 公里' },
    { id: '5-5', part: 5, partName: '中亚与粟特平叛', from: '巴克特拉', to: '居鲁士城', via: ['撒马尔罕'], events: [13], hasBattle: true, briefedBy: [13],
    ...
    { id: '6-1', part: 6, partName: '印度远征与班师', from: '索格狄亚那岩', to: '马萨加（战争点 16）', via: ['撒马尔罕', '阿母城', '巴克特拉', '巴米扬', '喀布尔', '难揭'], events: [16], hasBattle: true, briefedBy: [16] },
    ...
    { id: '6-9', part: 6, partName: '印度远征与班师', from: '苏萨', to: '哈马丹（埃克巴坦那）', via: ['巴比伦', '巴格达（欧皮斯一带）', '呼勒万', '伊拉姆', '古尔帕耶甘'], events: [20], hasBattle: false, briefedBy: [20],
