...
const WAR_TYPES: Record<string, WarType> = {
    ...
    elite_kamayuk: { name: '精锐卡马尤克', cls: 'ranged', sz: 1, hp: 80, atk: 8, meleeArmor: 1, pierceArmor: 1, rng: 40, reload: 2.0, spd: 50, dmgType: 'melee', bonus: { 5: 20, 8: 12, 30: 10 }, armorTags: [1, 19, 31] },
