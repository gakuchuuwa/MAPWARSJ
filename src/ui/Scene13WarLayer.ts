...
const WAR_TYPES: Record<string, WarType> = {
    ...
    samurai:        { name: '日本武士', cls: 'melee', sz: 0.85, hp: 168, dmg: 42, spd: 50 },// 视觉替换藤甲兵，数值不变（sz 0.85 缩身，主人 2026-08-14 嫌大）
    samurai_elite:  { name: '精锐武士', cls: 'melee', sz: 0.85, hp: 168, dmg: 42, spd: 50 },// AoE2 DE 精锐武士，视觉替换藤甲兵，数值不变
