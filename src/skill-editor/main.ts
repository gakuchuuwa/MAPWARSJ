...
async function loadSixSlotData() {
    ...
    const SIX: Record<string,string> = {'ally_power_mult':'攻战计','first_sortie_power_mult':'攻战计','enemy_mult_0_8':'攻战计','enemy_sub_troops_opening':'胜战计','dual_sub_troops_opening':'胜战计','ally_add_troops_opening':'胜战计','self_casualty_reduction':'胜战计','lose_enemy_casualty_boost':'败战计','win_casualty_reduction':'敌战计','elite_casualty_reduction':'敌战计','post_recovery_rate':'敌战计','steal_enemy_skill':'混战计','negate_enemy_skill':'混战计','partial_negate_enemy_skill':'混战计','reflect_enemy_opening_cut':'混战计','nullify_enemy_opening_cut':'混战计','cancel_enemy_terrain_buff':'混战计','halve_enemy_terrain_buff':'混战计','luck_variance_self':'并战计','luck_variance_enemy':'并战计','luck_lock_self':'并战计','recompute_comeback':'败战计','lose_zero_enemy_recovery':'败战计','ally_add_troops_comeback':'败战计','first_sortie_comeback_mult':'败战计'};
